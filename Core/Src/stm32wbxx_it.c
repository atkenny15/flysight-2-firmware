...
void EXTI2_IRQHandler(void) {
    ...
    HAL_GPIO_EXTI_IRQHandler(VBUS_DIV_Pin);
...
void EXTI4_IRQHandler(void) {
    ...
    HAL_GPIO_EXTI_IRQHandler(HUM_DRDY_Pin);
...
/**
 * @brief This function handles USB low priority interrupt, USB wake-up interrupt through EXTI
 * line 28.
 */
