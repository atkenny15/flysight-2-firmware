...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc) {
    ...
    if (hadc->Instance == ADC1) {
        ...
        */
        ...
        GPIO_InitStruct.Pin = VBAT_DIV_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc) {
    if (hadc->Instance == ADC1) {
        ...
        */
        ...
        HAL_GPIO_DeInit(VBAT_DIV_GPIO_Port, VBAT_DIV_Pin);
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c) {
    ...
    if (hi2c->Instance == I2C1) {
        ...
        */
        ...
        /* I2C3_TX Init */
        hdma_i2c3_tx.Instance = DMA1_Channel6;
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart) {
    ...
    if (huart->Instance == LPUART1) {
        ...
        */
        ...
        PB6     ------> USART1_TX
        */
        GPIO_InitStruct.Pin = GNSS_TXD_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
        GPIO_InitStruct.Alternate = GPIO_AF7_USART1;
        HAL_GPIO_Init(GNSS_TXD_GPIO_Port, &GPIO_InitStruct);

        GPIO_InitStruct.Pin = GNSS_RXD_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
        GPIO_InitStruct.Alternate = GPIO_AF7_USART1;
        HAL_GPIO_Init(GNSS_RXD_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart) {
    if (huart->Instance == LPUART1) {
        ...
        */
        ...
        PB6     ------> USART1_TX
        */
        HAL_GPIO_DeInit(GNSS_TXD_GPIO_Port, GNSS_TXD_Pin);

        HAL_GPIO_DeInit(GNSS_RXD_GPIO_Port, GNSS_RXD_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi) {
    ...
    if (hspi->Instance == SPI1) {
        ...
        PA5     ------> SPI1_SCK
        */
        GPIO_InitStruct.Pin = IMU_MOSI_Pin | IMU_MISO_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
        ...
        PB15     ------> SPI2_MOSI
        */
        GPIO_InitStruct.Pin = MMC_CLK_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
        GPIO_InitStruct.Alternate = GPIO_AF5_SPI2;
        HAL_GPIO_Init(MMC_CLK_GPIO_Port, &GPIO_InitStruct);

        GPIO_InitStruct.Pin = MMC_DO_Pin | MMC_DI_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
        GPIO_InitStruct.Alternate = GPIO_AF5_SPI2;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi) {
    if (hspi->Instance == SPI1) {
        ...
        PA5     ------> SPI1_SCK
        */
        HAL_GPIO_DeInit(GPIOB, IMU_MOSI_Pin | IMU_MISO_Pin);
        ...
        PB15     ------> SPI2_MOSI
        */
        HAL_GPIO_DeInit(MMC_CLK_GPIO_Port, MMC_CLK_Pin);

        HAL_GPIO_DeInit(GPIOB, MMC_DO_Pin | MMC_DI_Pin);
...
void HAL_SAI_MspInit(SAI_HandleTypeDef* hsai) {
    ...
    if (hsai->Instance == SAI1_Block_A) {
        ...
        PeriphClkInitStruct.PLLSAI1.PLLN = 48;
        ...
        PA3     ------> SAI1_MCLK_A
        */
        GPIO_InitStruct.Pin = AUDIO_SDIN_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
        GPIO_InitStruct.Alternate = GPIO_AF13_SAI1;
        HAL_GPIO_Init(AUDIO_SDIN_GPIO_Port, &GPIO_InitStruct);

        GPIO_InitStruct.Pin = AUDIO_LRCLK_Pin | AUDIO_BCLK_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
        GPIO_InitStruct.Alternate = GPIO_AF13_SAI1;
        ...
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
        GPIO_InitStruct.Alternate = GPIO_AF13_SAI1;
        HAL_GPIO_Init(AUDIO_MCLK_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SAI_MspDeInit(SAI_HandleTypeDef* hsai) {
    ...
    if (hsai->Instance == SAI1_Block_A) {
        ...
        PA3     ------> SAI1_MCLK_A
        */
        HAL_GPIO_DeInit(AUDIO_SDIN_GPIO_Port, AUDIO_SDIN_Pin);

        HAL_GPIO_DeInit(GPIOB, AUDIO_LRCLK_Pin | AUDIO_BCLK_Pin);

        HAL_GPIO_DeInit(AUDIO_MCLK_GPIO_Port, AUDIO_MCLK_Pin);
