...
#    define __STM32WBxx_CMSIS_DEVICE_VERSION                                               \
        ((__STM32WBxx_CMSIS_VERSION_MAIN << 24) | (__STM32WBxx_CMSIS_VERSION_SUB1 << 16) | \
         (__STM32WBxx_CMSIS_VERSION_SUB2 << 8) | (__STM32WBxx_CMSIS_VERSION_RC))
...
#    else
#        error \
            "Please select first the target STM32WBxx device used in your application, for instance xxx (in stm32wbxx.h file)"
#    endif
/**
 * @}
 */
