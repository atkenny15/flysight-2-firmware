...
#    define LL_MPU_CTRL_HARDFAULT_NMI                                                       \
        MPU_CTRL_HFNMIENA_Msk /*!< Enables the operation of MPU during hard fault, NMI, and \
                                 FAULTMASK handlers */
...
#    define LL_MPU_REGION_PRIV_RW_URO                                                              \
        (0x02U << MPU_RASR_AP_Pos) /*!< RW privileged - RO user (Write in a user program generates \
                                      a fault) */
...
__STATIC_INLINE uint32_t LL_SYSTICK_IsActiveCounterFlag(void) {
    return (((SysTick->CTRL & SysTick_CTRL_COUNTFLAG_Msk) == (SysTick_CTRL_COUNTFLAG_Msk)) ? 1UL
                                                                                           : 0UL);
}
...
/**
 * @brief  Get Revision number (The p value in the rnpn product revision identifier, indicates patch
 * release)
 ...
 *         @arg @ref LL_MPU_REGION_SIZE_32B (*) or @ref LL_MPU_REGION_SIZE_64B (*) or @ref
 * LL_MPU_REGION_SIZE_128B (*) or @ref LL_MPU_REGION_SIZE_256B or @ref LL_MPU_REGION_SIZE_512B or
 * @ref LL_MPU_REGION_SIZE_1KB or @ref LL_MPU_REGION_SIZE_2KB or @ref LL_MPU_REGION_SIZE_4KB or @ref
 * LL_MPU_REGION_SIZE_8KB or @ref LL_MPU_REGION_SIZE_16KB or @ref LL_MPU_REGION_SIZE_32KB or @ref
 * LL_MPU_REGION_SIZE_64KB or @ref LL_MPU_REGION_SIZE_128KB or @ref LL_MPU_REGION_SIZE_256KB or @ref
 * LL_MPU_REGION_SIZE_512KB or @ref LL_MPU_REGION_SIZE_1MB or @ref LL_MPU_REGION_SIZE_2MB or @ref
 * LL_MPU_REGION_SIZE_4MB or @ref LL_MPU_REGION_SIZE_8MB or @ref LL_MPU_REGION_SIZE_16MB or @ref
 * LL_MPU_REGION_SIZE_32MB or @ref LL_MPU_REGION_SIZE_64MB or @ref LL_MPU_REGION_SIZE_128MB or @ref
 ...
 *         @arg @ref LL_MPU_REGION_NO_ACCESS or @ref LL_MPU_REGION_PRIV_RW or @ref
 * LL_MPU_REGION_PRIV_RW_URO or @ref LL_MPU_REGION_FULL_ACCESS or @ref LL_MPU_REGION_PRIV_RO or @ref
 * LL_MPU_REGION_PRIV_RO_URO
 *         @arg @ref LL_MPU_TEX_LEVEL0 or @ref LL_MPU_TEX_LEVEL1 or @ref LL_MPU_TEX_LEVEL2 or @ref
 * LL_MPU_TEX_LEVEL4
 ...
 * @retval None
 */
__STATIC_INLINE void LL_MPU_ConfigRegion(uint32_t Region, uint32_t SubRegionDisable,
                                         uint32_t Address, uint32_t Attributes) {
    /* Set Region number */
    WRITE_REG(MPU->RNR, Region);
    /* Set base address */
