...
typedef struct {
    ...
    uint32_t AsynchPrescaler; /*!< Specifies the RTC Asynchronous Predivider value.
                                This parameter must be a number between Min_Data = 0x00 and Max_Data
                                = 0x7F
...
typedef struct {
    ...
    uint8_t Hours; /*!< Specifies the RTC Time Hours.
                        This parameter must be a number between Min_Data = 0 and Max_Data = 12 if
                      the @ref LL_RTC_TIME_FORMAT_PM is selected. This parameter must be a number
                      between Min_Data = 0 and Max_Data = 23 if the @ref LL_RTC_TIME_FORMAT_AM_OR_24
                      is selected.
...
typedef struct {
    ...
    uint32_t
        AlarmMask; /*!< Specifies the RTC Alarm Masks.
                        This parameter can be a value of @ref RTC_LL_EC_ALMA_MASK for ALARM A or
                      @ref RTC_LL_EC_ALMB_MASK for ALARM B.

                        This feature can be modified afterwards using unitary function @ref
                      LL_RTC_ALMA_SetMask() for ALARM A or @ref LL_RTC_ALMB_SetMask() for ALARM B
                   */

    uint32_t AlarmDateWeekDaySel; /*!< Specifies the RTC Alarm is on day or WeekDay.
                                       This parameter can be a value of @ref
                                     RTC_LL_EC_ALMA_WEEKDAY_SELECTION for ALARM A or @ref
                                     RTC_LL_EC_ALMB_WEEKDAY_SELECTION for ALARM B

                                       This feature can be modified afterwards using unitary
                                     function @ref LL_RTC_ALMA_EnableWeekday() or @ref
                                     LL_RTC_ALMA_DisableWeekday() for ALARM A or @ref
                                     LL_RTC_ALMB_EnableWeekday() or @ref
                                     LL_RTC_ALMB_DisableWeekday() for ALARM B
                                  */

    uint8_t AlarmDateWeekDay; /*!< Specifies the RTC Alarm Day/WeekDay.
                                   If AlarmDateWeekDaySel set to day, this parameter  must be a
                                 number between Min_Data = 1 and Max_Data = 31.

                                   This feature can be modified afterwards using unitary function
                                 @ref LL_RTC_ALMA_SetDay() for ALARM A or @ref LL_RTC_ALMB_SetDay()
                                 for ALARM B.

                                   If AlarmDateWeekDaySel set to Weekday, this parameter can be a
                                 value of @ref RTC_LL_EC_WEEKDAY.

                                   This feature can be modified afterwards using unitary function
                                 @ref LL_RTC_ALMA_SetWeekDay() for ALARM A or @ref
...
#        define LL_RTC_ALMA_DATEWEEKDAYSEL_WEEKDAY \
            RTC_ALRMAR_WDSEL /*!< Alarm A WeekDay is selected */
/**
 * @}
 */
...
#        define LL_RTC_ALMB_DATEWEEKDAYSEL_WEEKDAY \
            RTC_ALRMBR_WDSEL /*!< Alarm B WeekDay is selected */
/**
 * @}
 */
 ...
 * @{
 */
#        define LL_RTC_ALARM_OUTPUTTYPE_OPENDRAIN \
            0x00000000U /*!< RTC_ALARM, when mapped on PC13, is open-drain output */
#        define LL_RTC_ALARM_OUTPUTTYPE_PUSHPULL \
            RTC_OR_ALARMOUTTYPE /*!< RTC_ALARM, when mapped on PC13, is push-pull output */
/**
 * @}
 */
 ...
 * @{
 */
#    define LL_RTC_OUTPUTPOLARITY_PIN_HIGH \
        0x00000000U /*!< Pin is high when ALRAF/ALRBF/WUTF is asserted (depending on OSEL)*/
#    define LL_RTC_OUTPUTPOLARITY_PIN_LOW \
        RTC_CR_POL /*!< Pin is low when ALRAF/ALRBF/WUTF is asserted (depending on OSEL) */
/**
 * @}
 */
...
#    define LL_RTC_SHIFT_SECOND_ADVANCE \
        RTC_SHIFTR_ADD1S /* Advance (seconds) = (1 - (SUBFS / (PREDIV_S + 1))) */
/**
 * @}
 */
...
#    define LL_RTC_ALMA_MASK_DATEWEEKDAY \
        RTC_ALRMAR_MSK4 /*!< Date/day do not care in Alarm A comparison */
#    define LL_RTC_ALMA_MASK_HOURS RTC_ALRMAR_MSK3 /*!< Hours do not care in Alarm A comparison */
#    define LL_RTC_ALMA_MASK_MINUTES \
        RTC_ALRMAR_MSK2 /*!< Minutes do not care in Alarm A comparison */
#    define LL_RTC_ALMA_MASK_SECONDS \
        RTC_ALRMAR_MSK1 /*!< Seconds do not care in Alarm A comparison */
#    define LL_RTC_ALMA_MASK_ALL \
        (RTC_ALRMAR_MSK4 | RTC_ALRMAR_MSK3 | RTC_ALRMAR_MSK2 | RTC_ALRMAR_MSK1) /*!< Masks all */
/**
 * @}
 */
...
#    define LL_RTC_ALMB_MASK_DATEWEEKDAY \
        RTC_ALRMBR_MSK4 /*!< Date/day do not care in Alarm B comparison */
#    define LL_RTC_ALMB_MASK_HOURS RTC_ALRMBR_MSK3 /*!< Hours do not care in Alarm B comparison */
#    define LL_RTC_ALMB_MASK_MINUTES \
        RTC_ALRMBR_MSK2 /*!< Minutes do not care in Alarm B comparison */
#    define LL_RTC_ALMB_MASK_SECONDS \
        RTC_ALRMBR_MSK1 /*!< Seconds do not care in Alarm B comparison */
#    define LL_RTC_ALMB_MASK_ALL \
        (RTC_ALRMBR_MSK4 | RTC_ALRMBR_MSK3 | RTC_ALRMBR_MSK2 | RTC_ALRMBR_MSK1) /*!< Masks all */
/**
 * @}
 */
 ...
 * @{
 */
#    define LL_RTC_TIMESTAMP_EDGE_RISING \
        0x00000000U /*!< RTC_TS input rising edge generates a time-stamp event */
#    define LL_RTC_TIMESTAMP_EDGE_FALLING \
        RTC_CR_TSEDGE /*!< RTC_TS input falling edge generates a time-stamp event */
/**
 * @}
 */
 ...
 */
#    if defined(RTC_TAMPER1_SUPPORT)
#        define LL_RTC_TAMPER_MASK_TAMPER1                                                         \
            RTC_TAMPCR_TAMP1MF /*!< Tamper 1 event generates a trigger event. TAMP1F is masked and \
                                  internally cleared by hardware.The backup registers are not      \
                                  erased */
#    endif                     /* RTC_TAMPER1_SUPPORT */
#    if defined(RTC_TAMPER2_SUPPORT)
#        define LL_RTC_TAMPER_MASK_TAMPER2                                                         \
            RTC_TAMPCR_TAMP2MF /*!< Tamper 2 event generates a trigger event. TAMP2F is masked and \
                                  internally cleared by hardware. The backup registers are not     \
                                  erased. */
#    endif                     /* RTC_TAMPER2_SUPPORT */
#    if defined(RTC_TAMPER3_SUPPORT)
#        define LL_RTC_TAMPER_MASK_TAMPER3                                                         \
            RTC_TAMPCR_TAMP3MF /*!< Tamper 3 event generates a trigger event. TAMP3F is masked and \
                                  internally cleared by hardware. The backup registers are not     \
                                  erased */
#    endif                     /* RTC_TAMPER3_SUPPORT */
/**
 ...
 */
#    if defined(RTC_TAMPER1_SUPPORT)
#        define LL_RTC_TAMPER_NOERASE_TAMPER1 \
            RTC_TAMPCR_TAMP1NOERASE /*!< Tamper 1 event does not erase the backup registers. */
#    endif                          /* RTC_TAMPER1_SUPPORT */
#    if defined(RTC_TAMPER2_SUPPORT)
#        define LL_RTC_TAMPER_NOERASE_TAMPER2 \
            RTC_TAMPCR_TAMP2NOERASE /*!< Tamper 2 event does not erase the backup registers. */
#    endif                          /* RTC_TAMPER2_SUPPORT */
#    if defined(RTC_TAMPER3_SUPPORT)
#        define LL_RTC_TAMPER_NOERASE_TAMPER3 \
            RTC_TAMPCR_TAMP3NOERASE /*!< Tamper 3 event does not erase the backup registers. */
#    endif                          /* RTC_TAMPER3_SUPPORT */
/**
 * @}
 */
 ...
 * @{
 */
#        define LL_RTC_TAMPER_DURATION_1RTCCLK \
            0x00000000U /*!< Tamper pins are pre-charged before sampling during 1 RTCCLK cycle  */
#        define LL_RTC_TAMPER_DURATION_2RTCCLK                                                     \
            RTC_TAMPCR_TAMPPRCH_0 /*!< Tamper pins are pre-charged before sampling during 2 RTCCLK \
                                     cycles */
#        define LL_RTC_TAMPER_DURATION_4RTCCLK                                                     \
            RTC_TAMPCR_TAMPPRCH_1 /*!< Tamper pins are pre-charged before sampling during 4 RTCCLK \
                                     cycles */
#        define LL_RTC_TAMPER_DURATION_8RTCCLK                                                   \
            RTC_TAMPCR_TAMPPRCH /*!< Tamper pins are pre-charged before sampling during 8 RTCCLK \
                                   cycles */
/**
 * @}
 */
...
#        define LL_RTC_TAMPER_FILTER_2SAMPLE                                                 \
            RTC_TAMPCR_TAMPFLT_0 /*!< Tamper is activated after 2 consecutive samples at the \
                                    active level */
#        define LL_RTC_TAMPER_FILTER_4SAMPLE                                                 \
            RTC_TAMPCR_TAMPFLT_1 /*!< Tamper is activated after 4 consecutive samples at the \
                                    active level */
#        define LL_RTC_TAMPER_FILTER_8SAMPLE                                                      \
            RTC_TAMPCR_TAMPFLT /*!< Tamper is activated after 8 consecutive samples at the active \
                                  level. */
/**
 * @}
 */
...
#        define LL_RTC_TAMPER_SAMPLFREQDIV_32768                                                \
            0x00000000U /*!< Each of the tamper inputs are sampled with a frequency =  RTCCLK / \
                           32768 */
#        define LL_RTC_TAMPER_SAMPLFREQDIV_16384                                                \
            RTC_TAMPCR_TAMPFREQ_0 /*!< Each of the tamper inputs are sampled with a frequency = \
                                     RTCCLK / 16384 */
#        define LL_RTC_TAMPER_SAMPLFREQDIV_8192                                                 \
            RTC_TAMPCR_TAMPFREQ_1 /*!< Each of the tamper inputs are sampled with a frequency = \
                                     RTCCLK / 8192 */
#        define LL_RTC_TAMPER_SAMPLFREQDIV_4096                                                   \
            (RTC_TAMPCR_TAMPFREQ_1 |                                                              \
             RTC_TAMPCR_TAMPFREQ_0) /*!< Each of the tamper inputs are sampled with a frequency = \
                                       RTCCLK / 4096 */
#        define LL_RTC_TAMPER_SAMPLFREQDIV_2048                                                 \
            RTC_TAMPCR_TAMPFREQ_2 /*!< Each of the tamper inputs are sampled with a frequency = \
                                     RTCCLK / 2048 */
#        define LL_RTC_TAMPER_SAMPLFREQDIV_1024                                                   \
            (RTC_TAMPCR_TAMPFREQ_2 |                                                              \
             RTC_TAMPCR_TAMPFREQ_0) /*!< Each of the tamper inputs are sampled with a frequency = \
                                       RTCCLK / 1024 */
#        define LL_RTC_TAMPER_SAMPLFREQDIV_512                                                    \
            (RTC_TAMPCR_TAMPFREQ_2 |                                                              \
             RTC_TAMPCR_TAMPFREQ_1) /*!< Each of the tamper inputs are sampled with a frequency = \
                                       RTCCLK / 512 */
#        define LL_RTC_TAMPER_SAMPLFREQDIV_256                                                \
            RTC_TAMPCR_TAMPFREQ /*!< Each of the tamper inputs are sampled with a frequency = \
                                   RTCCLK / 256 */
/**
 * @}
 */
...
#        define LL_RTC_TAMPER_ACTIVELEVEL_TAMP1                                                \
            RTC_TAMPCR_TAMP1TRG /*!< RTC_TAMP1 input falling edge (if TAMPFLT = 00) or staying \
                                   high (if TAMPFLT != 00) triggers a tamper detection event*/
#    endif                      /* RTC_TAMPER1_SUPPORT */
#    if defined(RTC_TAMPER2_SUPPORT)
#        define LL_RTC_TAMPER_ACTIVELEVEL_TAMP2                                                \
            RTC_TAMPCR_TAMP2TRG /*!< RTC_TAMP2 input falling edge (if TAMPFLT = 00) or staying \
                                   high (if TAMPFLT != 00) triggers a tamper detection event*/
#    endif                      /* RTC_TAMPER2_SUPPORT */
#    if defined(RTC_TAMPER3_SUPPORT)
#        define LL_RTC_TAMPER_ACTIVELEVEL_TAMP3                                                \
            RTC_TAMPCR_TAMP3TRG /*!< RTC_TAMP3 input falling edge (if TAMPFLT = 00) or staying \
                                   high (if TAMPFLT != 00) triggers a tamper detection event*/
#    endif                      /* RTC_TAMPER3_SUPPORT */
/**
 * @}
...
#    define LL_RTC_WAKEUPCLOCK_DIV_2 \
        (RTC_CR_WUCKSEL_1 | RTC_CR_WUCKSEL_0) /*!< RTC/2 clock is selected */
#    define LL_RTC_WAKEUPCLOCK_CKSPRE \
        (RTC_CR_WUCKSEL_2) /*!< ck_spre (usually 1 Hz) clock is selected */
...
#    define LL_RTC_CALIB_INSERTPULSE_SET                                                           \
        RTC_CALR_CALP /*!< One RTCCLK pulse is effectively inserted every 2exp11 pulses (frequency \
...
#    define LL_RTC_CALIB_PERIOD_16SEC \
 ...
 */
#    define __LL_RTC_CONVERT_BIN2BCD(__VALUE__) \
        (uint8_t)((((__VALUE__) / 10U) << 4U) | ((__VALUE__) % 10U))
...
#    define __LL_RTC_CONVERT_BCD2BIN(__VALUE__)                                        \
        (uint8_t)((((uint8_t)((__VALUE__) & (uint8_t)0xF0U) >> (uint8_t)0x4U) * 10U) + \
                  ((__VALUE__) & (uint8_t)0x0FU))
 ...
 */
#    define __LL_RTC_GET_WEEKDAY(__RTC_DATE__) \
        (((__RTC_DATE__) >> RTC_OFFSET_WEEKDAY) & 0x000000FFU)
 ...
 * @note   Bit is write-protected. @ref LL_RTC_DisableWriteProtection function should be called
 * before.
...
__STATIC_INLINE void LL_RTC_EnableInitMode(RTC_TypeDef* RTCx) {
    ...
    WRITE_REG(RTCx->ISR, 0xFFFFFFFFU);
}
 ...
 * before.
 * @note   It can be written in initialization mode only (@ref LL_RTC_EnableInitMode function)
 * @note helper macro __LL_RTC_CONVERT_BIN2BCD is available to convert hour from binary to BCD
 * format
 * @rmtoll TR           HT            LL_RTC_TIME_SetHour\n
 *         TR           HU            LL_RTC_TIME_SetHour
 * @param  RTCx RTC Instance
 * @param  Hours Value between Min_Data=0x01 and Max_Data=0x12 or between Min_Data=0x00 and
 * Max_Data=0x23
 * @retval None
 */
 ...
 * before.
 * @note   It can be written in initialization mode only (@ref LL_RTC_EnableInitMode function)
 * @note helper macro __LL_RTC_CONVERT_BIN2BCD is available to convert Minutes from binary to BCD
 * format
...
__STATIC_INLINE uint32_t LL_RTC_TIME_GetMinute(RTC_TypeDef* RTCx) {
    ...
    return (uint32_t)((((temp & RTC_TR_MNT) >> RTC_TR_MNT_Pos) << 4U) |
                      ((temp & RTC_TR_MNU) >> RTC_TR_MNU_Pos));
}
 ...
 * before.
 * @note   It can be written in initialization mode only (@ref LL_RTC_EnableInitMode function)
 * @note helper macro __LL_RTC_CONVERT_BIN2BCD is available to convert Seconds from binary to BCD
 * format
...
__STATIC_INLINE uint32_t LL_RTC_TIME_GetSecond(RTC_TypeDef* RTCx) {
    ...
    return (uint32_t)((((temp & RTC_TR_ST) >> RTC_TR_ST_Pos) << 4U) |
                      ((temp & RTC_TR_SU) >> RTC_TR_SU_Pos));
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_TIME_Config(RTC_TypeDef* RTCx, uint32_t Format12_24, uint32_t Hours,
...
__STATIC_INLINE uint32_t LL_RTC_TIME_Get(RTC_TypeDef* RTCx) {
    ...
    return (uint32_t)((((((temp & RTC_TR_HT) >> RTC_TR_HT_Pos) << 4U) |
                      ...
                      (((((temp & RTC_TR_MNT) >> RTC_TR_MNT_Pos) << 4U) |
                        ((temp & RTC_TR_MNU) >> RTC_TR_MNU_Pos))
                       << RTC_OFFSET_MINUTE) |
                      ((((temp & RTC_TR_ST) >> RTC_TR_ST_Pos) << 4U) |
                       ((temp & RTC_TR_SU) >> RTC_TR_SU_Pos)));
}
 ...
 * * time_unit This conversion can be performed only if no shift operation is pending (ie. SHFP=0)
 * when PREDIV_S >= SS.
 ...
 * @note   This operation effectively subtracts from (delays) or advance the clock of a fraction of
 * a second.
 * @note   Bit is write-protected. @ref LL_RTC_DisableWriteProtection function should be called
 * before.
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_TIME_Synchronize(RTC_TypeDef* RTCx, uint32_t ShiftSecond,
                                             uint32_t Fraction) {
 ...
 * @note helper macro __LL_RTC_CONVERT_BIN2BCD is available to convert Year from binary to BCD
 * format
 ...
 * @note if shadow mode is disabled (BYPSHAD=0), need to check if RSF flag is set
 *       before reading this bit
 * @note helper macro __LL_RTC_CONVERT_BCD2BIN is available to convert Year from BCD to Binary
 * format
...
__STATIC_INLINE uint32_t LL_RTC_DATE_GetYear(RTC_TypeDef* RTCx) {
    ...
    return (uint32_t)((((temp & RTC_DR_YT) >> RTC_DR_YT_Pos) << 4U) |
                      ((temp & RTC_DR_YU) >> RTC_DR_YU_Pos));
}
 ...
 * @note helper macro __LL_RTC_CONVERT_BIN2BCD is available to convert Month from binary to BCD
 * format
 ...
 * @note if shadow mode is disabled (BYPSHAD=0), need to check if RSF flag is set
 *       before reading this bit
 * @note helper macro __LL_RTC_CONVERT_BCD2BIN is available to convert Month from BCD to Binary
 * format
...
__STATIC_INLINE uint32_t LL_RTC_DATE_GetMonth(RTC_TypeDef* RTCx) {
    ...
    return (uint32_t)((((temp & RTC_DR_MT) >> RTC_DR_MT_Pos) << 4U) |
                      ((temp & RTC_DR_MU) >> RTC_DR_MU_Pos));
}
...
__STATIC_INLINE uint32_t LL_RTC_DATE_GetDay(RTC_TypeDef* RTCx) {
    ...
    return (uint32_t)((((temp & RTC_DR_DT) >> RTC_DR_DT_Pos) << 4U) |
                      ((temp & RTC_DR_DU) >> RTC_DR_DU_Pos));
}
...
__STATIC_INLINE uint32_t LL_RTC_DATE_Get(RTC_TypeDef* RTCx) {
    ...
    temp = READ_BIT(RTCx->DR, (RTC_DR_WDU | RTC_DR_MT | RTC_DR_MU | RTC_DR_DT | RTC_DR_DU |
                               RTC_DR_YT | RTC_DR_YU));
    return (uint32_t)((((temp & RTC_DR_WDU) >> RTC_DR_WDU_Pos) << RTC_OFFSET_WEEKDAY) |
                      ...
                      (((((temp & RTC_DR_MT) >> RTC_DR_MT_Pos) << 4U) |
                        ((temp & RTC_DR_MU) >> RTC_DR_MU_Pos))
                       << RTC_OFFSET_MONTH) |
                      ((((temp & RTC_DR_YT) >> RTC_DR_YT_Pos) << 4U) |
                       ((temp & RTC_DR_YU) >> RTC_DR_YU_Pos)));
}
...
__STATIC_INLINE void LL_RTC_ALMA_SetMask(RTC_TypeDef* RTCx, uint32_t Mask) {
    MODIFY_REG(RTCx->ALRMAR, RTC_ALRMAR_MSK4 | RTC_ALRMAR_MSK3 | RTC_ALRMAR_MSK2 | RTC_ALRMAR_MSK1,
               Mask);
}
...
__STATIC_INLINE uint32_t LL_RTC_ALMA_GetMask(RTC_TypeDef* RTCx) {
    return (uint32_t)(READ_BIT(RTCx->ALRMAR, RTC_ALRMAR_MSK4 | RTC_ALRMAR_MSK3 | RTC_ALRMAR_MSK2 |
                                                 RTC_ALRMAR_MSK1));
}

/**
 * @brief  Enable AlarmA Week day selection (DU[3:0] represents the week day. DT[1:0] is do not
 * care)
...
__STATIC_INLINE void LL_RTC_ALMA_SetDay(RTC_TypeDef* RTCx, uint32_t Day) {
    MODIFY_REG(
        RTCx->ALRMAR, (RTC_ALRMAR_DT | RTC_ALRMAR_DU),
...
__STATIC_INLINE uint32_t LL_RTC_ALMA_GetDay(RTC_TypeDef* RTCx) {
    ...
    return (uint32_t)((((temp & RTC_ALRMAR_DT) >> RTC_ALRMAR_DT_Pos) << 4U) |
                      ((temp & RTC_ALRMAR_DU) >> RTC_ALRMAR_DU_Pos));
}
 ...
 * @note helper macro __LL_RTC_CONVERT_BIN2BCD is available to convert Hours from binary to BCD
 * format
...
__STATIC_INLINE void LL_RTC_ALMA_SetHour(RTC_TypeDef* RTCx, uint32_t Hours) {
    MODIFY_REG(
        RTCx->ALRMAR, (RTC_ALRMAR_HT | RTC_ALRMAR_HU),
        (((Hours & 0xF0U) << (RTC_ALRMAR_HT_Pos - 4U)) | ((Hours & 0x0FU) << RTC_ALRMAR_HU_Pos)));
}

/**
 * @brief  Get ALARM A Hours in BCD format
 * @note helper macro __LL_RTC_CONVERT_BCD2BIN is available to convert Hours from BCD to Binary
 * format
...
__STATIC_INLINE uint32_t LL_RTC_ALMA_GetHour(RTC_TypeDef* RTCx) {
    ...
    return (uint32_t)((((temp & RTC_ALRMAR_HT) >> RTC_ALRMAR_HT_Pos) << 4U) |
                      ((temp & RTC_ALRMAR_HU) >> RTC_ALRMAR_HU_Pos));
}
 ...
 * @note helper macro __LL_RTC_CONVERT_BCD2BIN is available to convert Minutes from BCD to Binary
 * format
...
__STATIC_INLINE uint32_t LL_RTC_ALMA_GetMinute(RTC_TypeDef* RTCx) {
    ...
    return (uint32_t)((((temp & RTC_ALRMAR_MNT) >> RTC_ALRMAR_MNT_Pos) << 4U) |
                      ((temp & RTC_ALRMAR_MNU) >> RTC_ALRMAR_MNU_Pos));
}
 ...
 * @note helper macro __LL_RTC_CONVERT_BCD2BIN is available to convert Seconds from BCD to Binary
 * format
...
__STATIC_INLINE uint32_t LL_RTC_ALMA_GetSecond(RTC_TypeDef* RTCx) {
    ...
    return (uint32_t)((((temp & RTC_ALRMAR_ST) >> RTC_ALRMAR_ST_Pos) << 4U) |
                      ((temp & RTC_ALRMAR_SU) >> RTC_ALRMAR_SU_Pos));
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_ALMA_ConfigTime(RTC_TypeDef* RTCx, uint32_t Format12_24, uint32_t Hours,
                                            uint32_t Minutes, uint32_t Seconds) {
    uint32_t temp;
    ...
    MODIFY_REG(RTCx->ALRMAR,
               RTC_ALRMAR_PM | RTC_ALRMAR_HT | RTC_ALRMAR_HU | RTC_ALRMAR_MNT | RTC_ALRMAR_MNU |
...
__STATIC_INLINE void LL_RTC_ALMB_SetMask(RTC_TypeDef* RTCx, uint32_t Mask) {
    MODIFY_REG(RTCx->ALRMBR, RTC_ALRMBR_MSK4 | RTC_ALRMBR_MSK3 | RTC_ALRMBR_MSK2 | RTC_ALRMBR_MSK1,
               Mask);
}
...
__STATIC_INLINE uint32_t LL_RTC_ALMB_GetMask(RTC_TypeDef* RTCx) {
    return (uint32_t)(READ_BIT(RTCx->ALRMBR, RTC_ALRMBR_MSK4 | RTC_ALRMBR_MSK3 | RTC_ALRMBR_MSK2 |
                                                 RTC_ALRMBR_MSK1));
}

/**
 * @brief  Enable AlarmB Week day selection (DU[3:0] represents the week day. DT[1:0] is do not
 * care)
...
__STATIC_INLINE void LL_RTC_ALMB_SetDay(RTC_TypeDef* RTCx, uint32_t Day) {
    MODIFY_REG(
        RTCx->ALRMBR, (RTC_ALRMBR_DT | RTC_ALRMBR_DU),
...
__STATIC_INLINE uint32_t LL_RTC_ALMB_GetDay(RTC_TypeDef* RTCx) {
    ...
    return (uint32_t)((((temp & RTC_ALRMBR_DT) >> RTC_ALRMBR_DT_Pos) << 4U) |
                      ((temp & RTC_ALRMBR_DU) >> RTC_ALRMBR_DU_Pos));
}
...
__STATIC_INLINE void LL_RTC_ALMB_SetHour(RTC_TypeDef* RTCx, uint32_t Hours) {
    MODIFY_REG(
        RTCx->ALRMBR, (RTC_ALRMBR_HT | RTC_ALRMBR_HU),
...
__STATIC_INLINE uint32_t LL_RTC_ALMB_GetHour(RTC_TypeDef* RTCx) {
    ...
    return (uint32_t)((((temp & RTC_ALRMBR_HT) >> RTC_ALRMBR_HT_Pos) << 4U) |
                      ((temp & RTC_ALRMBR_HU) >> RTC_ALRMBR_HU_Pos));
}
...
__STATIC_INLINE uint32_t LL_RTC_ALMB_GetMinute(RTC_TypeDef* RTCx) {
    ...
    return (uint32_t)((((temp & RTC_ALRMBR_MNT) >> RTC_ALRMBR_MNT_Pos) << 4U) |
                      ((temp & RTC_ALRMBR_MNU) >> RTC_ALRMBR_MNU_Pos));
}
...
__STATIC_INLINE uint32_t LL_RTC_ALMB_GetSecond(RTC_TypeDef* RTCx) {
    ...
    return (uint32_t)((((temp & RTC_ALRMBR_ST) >> RTC_ALRMBR_ST_Pos) << 4U) |
                      ((temp & RTC_ALRMBR_SU) >> RTC_ALRMBR_SU_Pos));
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_ALMB_ConfigTime(RTC_TypeDef* RTCx, uint32_t Format12_24, uint32_t Hours,
                                            uint32_t Minutes, uint32_t Seconds) {
    uint32_t temp;
    ...
    MODIFY_REG(RTCx->ALRMBR,
               RTC_ALRMBR_PM | RTC_ALRMBR_HT | RTC_ALRMBR_HU | RTC_ALRMBR_MNT | RTC_ALRMBR_MNU |
                   RTC_ALRMBR_ST | RTC_ALRMBR_SU,
               temp);
}
...
__STATIC_INLINE uint32_t LL_RTC_TS_GetTime(RTC_TypeDef* RTCx) {
    return (uint32_t)(READ_BIT(RTCx->TSTR, RTC_TSTR_HT | RTC_TSTR_HU | RTC_TSTR_MNT | RTC_TSTR_MNU |
...
__STATIC_INLINE uint32_t LL_RTC_TS_GetDate(RTC_TypeDef* RTCx) {
    return (uint32_t)(READ_BIT(RTCx->TSDR, RTC_TSDR_WDU | RTC_TSDR_MT | RTC_TSDR_MU | RTC_TSDR_DT |
                                               RTC_TSDR_DU));
}
 ...
 * @note Bits are write-protected. @ref LL_RTC_DisableWriteProtection function should be called
 * before.
...
/**
 * @brief  Check if one RTCCLK has been inserted or not every 2exp11 pulses (frequency increased by
 * 488.5 ppm)
...
__STATIC_INLINE void LL_RTC_ClearFlag_ITS(RTC_TypeDef* RTCx) {
    WRITE_REG(RTCx->ISR,
              (~((RTC_ISR_ITSF | RTC_ISR_INIT) & 0x0000FFFFU) | (RTCx->ISR & RTC_ISR_INIT)));
}
...
__STATIC_INLINE void LL_RTC_ClearFlag_TAMP3(RTC_TypeDef* RTCx) {
    WRITE_REG(RTCx->ISR,
              (~((RTC_ISR_TAMP3F | RTC_ISR_INIT) & 0x0000FFFFU) | (RTCx->ISR & RTC_ISR_INIT)));
}
#    endif /* RTC_TAMPER3_SUPPORT */
...
__STATIC_INLINE void LL_RTC_ClearFlag_TAMP2(RTC_TypeDef* RTCx) {
    WRITE_REG(RTCx->ISR,
              (~((RTC_ISR_TAMP2F | RTC_ISR_INIT) & 0x0000FFFFU) | (RTCx->ISR & RTC_ISR_INIT)));
}
#    endif /* RTC_TAMPER2_SUPPORT */
...
__STATIC_INLINE void LL_RTC_ClearFlag_TAMP1(RTC_TypeDef* RTCx) {
    WRITE_REG(RTCx->ISR,
              (~((RTC_ISR_TAMP1F | RTC_ISR_INIT) & 0x0000FFFFU) | (RTCx->ISR & RTC_ISR_INIT)));
}
#    endif /* RTC_TAMPER1_SUPPORT */
...
__STATIC_INLINE void LL_RTC_ClearFlag_TSOV(RTC_TypeDef* RTCx) {
    WRITE_REG(RTCx->ISR,
              (~((RTC_ISR_TSOVF | RTC_ISR_INIT) & 0x0000FFFFU) | (RTCx->ISR & RTC_ISR_INIT)));
}
...
__STATIC_INLINE void LL_RTC_ClearFlag_TS(RTC_TypeDef* RTCx) {
    WRITE_REG(RTCx->ISR,
              (~((RTC_ISR_TSF | RTC_ISR_INIT) & 0x0000FFFFU) | (RTCx->ISR & RTC_ISR_INIT)));
}
...
__STATIC_INLINE void LL_RTC_ClearFlag_WUT(RTC_TypeDef* RTCx) {
    WRITE_REG(RTCx->ISR,
              (~((RTC_ISR_WUTF | RTC_ISR_INIT) & 0x0000FFFFU) | (RTCx->ISR & RTC_ISR_INIT)));
}
#    endif /* RTC_WAKEUP_SUPPORT */
...
__STATIC_INLINE void LL_RTC_ClearFlag_ALRB(RTC_TypeDef* RTCx) {
    WRITE_REG(RTCx->ISR,
              (~((RTC_ISR_ALRBF | RTC_ISR_INIT) & 0x0000FFFFU) | (RTCx->ISR & RTC_ISR_INIT)));
}
...
__STATIC_INLINE void LL_RTC_ClearFlag_ALRA(RTC_TypeDef* RTCx) {
    WRITE_REG(RTCx->ISR,
              (~((RTC_ISR_ALRAF | RTC_ISR_INIT) & 0x0000FFFFU) | (RTCx->ISR & RTC_ISR_INIT)));
}
...
__STATIC_INLINE void LL_RTC_ClearFlag_RS(RTC_TypeDef* RTCx) {
    WRITE_REG(RTCx->ISR,
              (~((RTC_ISR_RSF | RTC_ISR_INIT) & 0x0000FFFFU) | (RTCx->ISR & RTC_ISR_INIT)));
}
