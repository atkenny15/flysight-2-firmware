...
#define SYSCFG_BOOT_SYSTEMFLASH \
...
#    define SYSCFG_VREFBUF_HIGH_IMPEDANCE_DISABLE                                                 \
        0x00000000U /*!< VREF_plus pin is internally connected to Voltage reference buffer output \
                     */
...
#    define HAL_SYSCFG_SECURE_ACCESS_AES1                                                     \
        LL_SYSCFG_SECURE_ACCESS_AES1 /*!< Enabling the security access of Advanced Encryption \
                                        Standard 1 KEY[7:0] */
#endif                               /* LL_SYSCFG_SECURE_ACCESS_AES1 */
#define HAL_SYSCFG_SECURE_ACCESS_AES2                                                              \
    LL_SYSCFG_SECURE_ACCESS_AES2 /*!< Enabling the security access of Advanced Encryption Standard \
                                    2          */
#define HAL_SYSCFG_SECURE_ACCESS_PKA \
    LL_SYSCFG_SECURE_ACCESS_PKA /*!< Enabling the security access of Public Key Accelerator */
#define HAL_SYSCFG_SECURE_ACCESS_RNG \
    LL_SYSCFG_SECURE_ACCESS_RNG /*!< Enabling the security access of Random Number Generator */
/**
 * @}
 */
...
#    define __HAL_DBGMCU_UNFREEZE_TIM2() \
        LL_DBGMCU_APB1_GRP1_UnFreezePeriph(LL_DBGMCU_APB1_GRP1_TIM2_STOP)
...
#    define __HAL_DBGMCU_UNFREEZE_RTC() \
        LL_DBGMCU_APB1_GRP1_UnFreezePeriph(LL_DBGMCU_APB1_GRP1_RTC_STOP)
...
#    define __HAL_DBGMCU_UNFREEZE_WWDG() \
        LL_DBGMCU_APB1_GRP1_UnFreezePeriph(LL_DBGMCU_APB1_GRP1_WWDG_STOP)
...
#    define __HAL_DBGMCU_FREEZE_I2C1_TIMEOUT() \
        LL_DBGMCU_APB1_GRP1_FreezePeriph(LL_DBGMCU_APB1_GRP1_I2C1_STOP)
#    define __HAL_DBGMCU_UNFREEZE_I2C1_TIMEOUT() \
        LL_DBGMCU_APB1_GRP1_UnFreezePeriph(LL_DBGMCU_APB1_GRP1_I2C1_STOP)
#endif /* LL_DBGMCU_APB1_GRP1_I2C1_STOP */

#if defined(LL_DBGMCU_APB1_GRP1_I2C3_STOP)
#    define __HAL_DBGMCU_FREEZE_I2C3_TIMEOUT() \
        LL_DBGMCU_APB1_GRP1_FreezePeriph(LL_DBGMCU_APB1_GRP1_I2C3_STOP)
#    define __HAL_DBGMCU_UNFREEZE_I2C3_TIMEOUT() \
        LL_DBGMCU_APB1_GRP1_UnFreezePeriph(LL_DBGMCU_APB1_GRP1_I2C3_STOP)
...
#    define __HAL_DBGMCU_UNFREEZE_LPTIM1() \
        LL_DBGMCU_APB1_GRP1_UnFreezePeriph(LL_DBGMCU_APB1_GRP1_LPTIM1_STOP)
#endif /* LL_DBGMCU_APB1_GRP1_LPTIM1_STOP */

#if defined(LL_DBGMCU_APB1_GRP2_LPTIM2_STOP)
#    define __HAL_DBGMCU_FREEZE_LPTIM2() \
        LL_DBGMCU_APB1_GRP2_FreezePeriph(LL_DBGMCU_APB1_GRP2_LPTIM2_STOP)
#    define __HAL_DBGMCU_UNFREEZE_LPTIM2() \
        LL_DBGMCU_APB1_GRP2_UnFreezePeriph(LL_DBGMCU_APB1_GRP2_LPTIM2_STOP)
...
#    define __HAL_DBGMCU_UNFREEZE_TIM1() \
        LL_DBGMCU_APB2_GRP1_UnFreezePeriph(LL_DBGMCU_APB2_GRP1_TIM1_STOP)
...
#    define __HAL_DBGMCU_UNFREEZE_TIM16() \
        LL_DBGMCU_APB2_GRP1_UnFreezePeriph(LL_DBGMCU_APB2_GRP1_TIM16_STOP)
#endif /* LL_DBGMCU_APB2_GRP1_TIM16_STOP */

#if defined(LL_DBGMCU_APB2_GRP1_TIM17_STOP)
#    define __HAL_DBGMCU_FREEZE_TIM17() \
        LL_DBGMCU_APB2_GRP1_FreezePeriph(LL_DBGMCU_APB2_GRP1_TIM17_STOP)
#    define __HAL_DBGMCU_UNFREEZE_TIM17() \
        LL_DBGMCU_APB2_GRP1_UnFreezePeriph(LL_DBGMCU_APB2_GRP1_TIM17_STOP)
...
#    define __HAL_C2_DBGMCU_UNFREEZE_TIM2() \
        LL_C2_DBGMCU_APB1_GRP1_UnFreezePeriph(LL_C2_DBGMCU_APB1_GRP1_TIM2_STOP)
#endif /* LL_C2_DBGMCU_APB1_GRP1_TIM2_STOP */

#if defined(LL_C2_DBGMCU_APB1_GRP1_RTC_STOP)
#    define __HAL_C2_DBGMCU_FREEZE_RTC() \
        LL_C2_DBGMCU_APB1_GRP1_FreezePeriph(LL_C2_DBGMCU_APB1_GRP1_RTC_STOP)
#    define __HAL_C2_DBGMCU_UNFREEZE_RTC() \
        LL_C2_DBGMCU_APB1_GRP1_UnFreezePeriph(LL_C2_DBGMCU_APB1_GRP1_RTC_STOP)
#endif /* LL_C2_DBGMCU_APB1_GRP1_RTC_STOP */

#if defined(LL_C2_DBGMCU_APB1_GRP1_IWDG_STOP)
#    define __HAL_C2_DBGMCU_FREEZE_IWDG() \
        LL_C2_DBGMCU_APB1_GRP1_FreezePeriph(LL_C2_DBGMCU_APB1_GRP1_IWDG_STOP)
#    define __HAL_C2_DBGMCU_UNFREEZE_IWDG() \
        LL_C2_DBGMCU_APB1_GRP1_UnFreezePeriph(LL_C2_DBGMCU_APB1_GRP1_IWDG_STOP)
#endif /* LL_C2_DBGMCU_APB1_GRP1_IWDG_STOP */

#if defined(LL_C2_DBGMCU_APB1_GRP1_I2C1_STOP)
#    define __HAL_C2_DBGMCU_FREEZE_I2C1_TIMEOUT() \
        LL_C2_DBGMCU_APB1_GRP1_FreezePeriph(LL_C2_DBGMCU_APB1_GRP1_I2C1_STOP)
#    define __HAL_C2_DBGMCU_UNFREEZE_I2C1_TIMEOUT() \
        LL_C2_DBGMCU_APB1_GRP1_UnFreezePeriph(LL_C2_DBGMCU_APB1_GRP1_I2C1_STOP)
#endif /* LL_C2_DBGMCU_APB1_GRP1_I2C1_STOP */

#if defined(LL_C2_DBGMCU_APB1_GRP1_I2C3_STOP)
#    define __HAL_C2_DBGMCU_FREEZE_I2C3_TIMEOUT() \
        LL_C2_DBGMCU_APB1_GRP1_FreezePeriph(LL_C2_DBGMCU_APB1_GRP1_I2C3_STOP)
#    define __HAL_C2_DBGMCU_UNFREEZE_I2C3_TIMEOUT() \
        LL_C2_DBGMCU_APB1_GRP1_UnFreezePeriph(LL_C2_DBGMCU_APB1_GRP1_I2C3_STOP)
#endif /* LL_C2_DBGMCU_APB1_GRP1_I2C3_STOP */

#if defined(LL_C2_DBGMCU_APB1_GRP1_LPTIM1_STOP)
#    define __HAL_C2_DBGMCU_FREEZE_LPTIM1() \
        LL_C2_DBGMCU_APB1_GRP1_FreezePeriph(LL_C2_DBGMCU_APB1_GRP1_LPTIM1_STOP)
#    define __HAL_C2_DBGMCU_UNFREEZE_LPTIM1() \
        LL_C2_DBGMCU_APB1_GRP1_UnFreezePeriph(LL_C2_DBGMCU_APB1_GRP1_LPTIM1_STOP)
#endif /* LL_C2_DBGMCU_APB1_GRP1_LPTIM1_STOP */

#if defined(LL_C2_DBGMCU_APB1_GRP2_LPTIM2_STOP)
#    define __HAL_C2_DBGMCU_FREEZE_LPTIM2() \
        LL_C2_DBGMCU_APB1_GRP2_FreezePeriph(LL_C2_DBGMCU_APB1_GRP2_LPTIM2_STOP)
#    define __HAL_C2_DBGMCU_UNFREEZE_LPTIM2() \
        LL_C2_DBGMCU_APB1_GRP2_UnFreezePeriph(LL_C2_DBGMCU_APB1_GRP2_LPTIM2_STOP)
#endif /* LL_C2_DBGMCU_APB1_GRP2_LPTIM2_STOP */

#if defined(LL_C2_DBGMCU_APB2_GRP1_TIM1_STOP)
#    define __HAL_C2_DBGMCU_FREEZE_TIM1() \
        LL_C2_DBGMCU_APB2_GRP1_FreezePeriph(LL_C2_DBGMCU_APB2_GRP1_TIM1_STOP)
#    define __HAL_C2_DBGMCU_UNFREEZE_TIM1() \
        LL_C2_DBGMCU_APB2_GRP1_UnFreezePeriph(LL_C2_DBGMCU_APB2_GRP1_TIM1_STOP)
#endif /* LL_C2_DBGMCU_APB2_GRP1_TIM1_STOP */

#if defined(LL_C2_DBGMCU_APB2_GRP1_TIM16_STOP)
#    define __HAL_C2_DBGMCU_FREEZE_TIM16() \
        LL_C2_DBGMCU_APB2_GRP1_FreezePeriph(LL_C2_DBGMCU_APB2_GRP1_TIM16_STOP)
#    define __HAL_C2_DBGMCU_UNFREEZE_TIM16() \
        LL_C2_DBGMCU_APB2_GRP1_UnFreezePeriph(LL_C2_DBGMCU_APB2_GRP1_TIM16_STOP)
#endif /* LL_C2_DBGMCU_APB2_GRP1_TIM16_STOP */

#if defined(LL_C2_DBGMCU_APB2_GRP1_TIM17_STOP)
#    define __HAL_C2_DBGMCU_FREEZE_TIM17() \
        LL_C2_DBGMCU_APB2_GRP1_FreezePeriph(LL_C2_DBGMCU_APB2_GRP1_TIM17_STOP)
#    define __HAL_C2_DBGMCU_UNFREEZE_TIM17() \
        LL_C2_DBGMCU_APB2_GRP1_UnFreezePeriph(LL_C2_DBGMCU_APB2_GRP1_TIM17_STOP)
 ...
 *         Enable and lock the connection of Cortex-M4 LOCKUP (Hardfault) output to TIM1/16/17 Break
 * input.
 * @note   The selected configuration is locked and can be unlocked only by system reset.
 */
 ...
 *         Enable and lock the PVD connection to Timer1/16/17 Break input, as well as the PVDE and
 * PLS[2:0] in the PWR_CR2 register.
 * @note   The selected configuration is locked and can be unlocked only by system reset.
 */
 ...
 */
#define __HAL_SYSCFG_BREAK_SRAM2PARITY_LOCK() \
    LL_SYSCFG_SetTIMBreakInputs(LL_SYSCFG_TIMBREAK_SRAM2_PARITY)
...
#define __HAL_SYSCFG_GET_FLAG(__FLAG__)                                                           \
    ((((((__FLAG__) == SYSCFG_SCSR_SRAM2BSY) ? SYSCFG->SCSR : SYSCFG->CFGR2) & (__FLAG__)) != 0U) \
         ? 1U                                                                                     \
         : 0U)
...
#if defined(LL_SYSCFG_SECURE_ACCESS_AES1)
#    define IS_SYSCFG_SECURITY_ACCESS(__VALUE__)                                           \
        ((((__VALUE__)&HAL_SYSCFG_SECURE_ACCESS_AES1) == HAL_SYSCFG_SECURE_ACCESS_AES1) || \
