...
typedef struct {
    uint32_t Prescaler; /*!< Specifies the prescaler value used to divide the TIM clock.
                             This parameter can be a number between Min_Data = 0x0000 and Max_Data =
                           0xFFFF */
...
typedef struct {
    ...
    uint32_t OCNPolarity; /*!< Specifies the complementary output polarity.
                               ...
                               @note This parameter is valid only for timer instances supporting
                             break feature. */
    ...
    uint32_t
        OCNIdleState; /*!< Specifies the TIM Output Compare pin state during Idle state.
                           This parameter can be a value of @ref TIM_Output_Compare_N_Idle_State
                           @note This parameter is valid only for timer instances supporting break
                         feature. */
} TIM_OC_InitTypeDef;
...
typedef struct {
    ...
    uint32_t
        IC1Filter; /*!< Specifies the input capture filter.
                        This parameter can be a number between Min_Data = 0x0 and Max_Data = 0xF */
    ...
    uint32_t
        IC2Filter; /*!< Specifies the input capture filter.
                        This parameter can be a number between Min_Data = 0x0 and Max_Data = 0xF */
...
typedef struct {
    ...
    uint32_t
        ClearInputPolarity;       /*!< TIM Clear Input polarity
                                       This parameter can be a value of @ref TIM_ClearInput_Polarity */
    uint32_t ClearInputPrescaler; /*!< TIM Clear Input prescaler
                                       This parameter must be 0: When OCRef clear feature is used
                                     with ETR source, ETR prescaler must be off */
...
typedef struct {
    uint32_t
        MasterOutputTrigger;       /*!< Trigger output (TRGO) selection
...
typedef struct {
    ...
    uint32_t OffStateIDLEMode; /*!< TIM off state in IDLE mode, This parameter can be a value of
                                  @ref TIM_OSSI_Off_State_Selection_for_Idle_mode_state */

    uint32_t LockLevel; /*!< TIM Lock level, This parameter can be a value of @ref TIM_Lock_level */

    uint32_t DeadTime; /*!< TIM dead Time, This parameter can be a number between Min_Data = 0x00
                          and Max_Data = 0xFF */

    uint32_t BreakState; /*!< TIM Break State, This parameter can be a value of @ref
                            TIM_Break_Input_enable_disable */

    uint32_t BreakPolarity; /*!< TIM Break input polarity, This parameter can be a value of @ref
                               TIM_Break_Polarity */

    uint32_t BreakFilter; /*!< Specifies the break input filter.This parameter can be a number
                             between Min_Data = 0x0 and Max_Data = 0xF */

    uint32_t BreakAFMode; /*!< Specifies the alternate function mode of the break input.This
                             parameter can be a value of @ref TIM_Break_Input_AF_Mode */

    uint32_t Break2State; /*!< TIM Break2 State, This parameter can be a value of @ref
                             TIM_Break2_Input_enable_disable */

    uint32_t Break2Polarity; /*!< TIM Break2 input polarity, This parameter can be a value of @ref
                                TIM_Break2_Polarity */

    uint32_t Break2Filter; /*!< TIM break2 input filter.This parameter can be a number between
                              Min_Data = 0x0 and Max_Data = 0xF */

    uint32_t Break2AFMode; /*!< Specifies the alternate function mode of the break2 input.This
                              parameter can be a value of @ref TIM_Break2_Input_AF_Mode */

    uint32_t AutomaticOutput; /*!< TIM Automatic Output Enable state, This parameter can be a value
                                 of @ref TIM_AOE_Bit_Set_Reset */
...
#define TIM_CLEARINPUTSOURCE_COMP1 \
    TIM1_AF1_ETRSEL_0 /*!< OCREF_CLR_INT is connected to COMP1 output */
#define TIM_CLEARINPUTSOURCE_COMP2 \
    TIM1_AF1_ETRSEL_1 /*!< OCREF_CLR_INT is connected to COMP2 output */
/**
 * @}
 */
...
#define TIM_ICSELECTION_DIRECTTI                                                                 \
    TIM_CCMR1_CC1S_0 /*!< TIM Input 1, 2, 3 or 4 is selected to be connected to IC1, IC2, IC3 or \
                        IC4, respectively */
#define TIM_ICSELECTION_INDIRECTTI                                                               \
    TIM_CCMR1_CC1S_1 /*!< TIM Input 1, 2, 3 or 4 is selected to be connected to IC2, IC1, IC4 or \
                        IC3, respectively */
...
#define TIM_DMA_CC2 \
    TIM_DIER_CC2DE /*!< DMA request is triggered by the capture/compare macth 2 event event */
#define TIM_DMA_CC3 \
    TIM_DIER_CC3DE /*!< DMA request is triggered by the capture/compare macth 3 event event */
#define TIM_DMA_CC4 \
    TIM_DIER_CC4DE /*!< DMA request is triggered by the capture/compare macth 4 event event */
...
/** @defgroup TIM_OSSR_Off_State_Selection_for_Run_mode_state TIM OSSR OffState Selection for Run
 * mode state
 * @{
 */
...
/** @defgroup TIM_OSSI_Off_State_Selection_for_Idle_mode_state TIM OSSI OffState Selection for Idle
 * mode state
 * @{
 */
...
#define TIM_AUTOMATICOUTPUT_ENABLE                                                             \
    TIM_BDTR_AOE /*!< MOE can be set by software or automatically at the next update event (if \
...
#define TIM_TRGO_OC1 \
    (TIM_CR2_MMS_1 | \
     TIM_CR2_MMS_0) /*!< Capture or a compare match 1 is used as trigger output (TRGO) */
...
#define TIM_TRGO2_OC1 \
    (TIM_CR2_MMS2_1 | \
     TIM_CR2_MMS2_0) /*!< Capture or a compare match 1 is used as trigger output (TRGO2) */
#define TIM_TRGO2_OC1REF \
    TIM_CR2_MMS2_2 /*!< OC1REF signal is used as trigger output (TRGO2)                */
#define TIM_TRGO2_OC2REF \
    (TIM_CR2_MMS2_2 | TIM_CR2_MMS2_0) /*!< OC2REF signal is used as trigger output (TRGO2) */
#define TIM_TRGO2_OC3REF \
    (TIM_CR2_MMS2_2 | TIM_CR2_MMS2_1) /*!< OC3REF signal is used as trigger output (TRGO2) */
...
#define TIM_TRGO2_OC6REF \
    (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_0) /*!< OC6REF signal is used as trigger output (TRGO2) */
#define TIM_TRGO2_OC4REF_RISINGFALLING \
    (TIM_CR2_MMS2_3 |                  \
     TIM_CR2_MMS2_1) /*!< OC4REF rising or falling edges generate pulses on TRGO2        */
#define TIM_TRGO2_OC6REF_RISINGFALLING \
    (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_1 | \
     TIM_CR2_MMS2_0) /*!< OC6REF rising or falling edges generate pulses on TRGO2        */
#define TIM_TRGO2_OC4REF_RISING_OC6REF_RISING \
    (TIM_CR2_MMS2_3 |                         \
     TIM_CR2_MMS2_2) /*!< OC4REF or OC6REF rising edges generate pulses on TRGO2         */
#define TIM_TRGO2_OC4REF_RISING_OC6REF_FALLING \
    (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_2 |         \
     TIM_CR2_MMS2_0) /*!< OC4REF rising or OC6REF falling edges generate pulses on TRGO2 */
...
#define TIM_DMA_ID_CC1 \
    ((uint16_t)0x0001) /*!< Index of the DMA handle used for Capture/Compare 1 DMA requests */
#define TIM_DMA_ID_CC2 \
    ((uint16_t)0x0002) /*!< Index of the DMA handle used for Capture/Compare 2 DMA requests */
#define TIM_DMA_ID_CC3 \
    ((uint16_t)0x0003) /*!< Index of the DMA handle used for Capture/Compare 3 DMA requests */
#define TIM_DMA_ID_CC4 \
    ((uint16_t)0x0004) /*!< Index of the DMA handle used for Capture/Compare 4 DMA requests */
...
#define TIM_BREAK_SYSTEM_ECC                                                          \
    SYSCFG_CFGR2_ECCL /*!< Enables and locks the ECC error signal with Break Input of \
                         TIM1/8/15/16/17 */
#define TIM_BREAK_SYSTEM_PVD                                                                     \
    SYSCFG_CFGR2_PVDL /*!< Enables and locks the PVD connection with TIM1/8/15/16/17 Break Input \
                         and also the PVDE and PLS bits of the Power Control Interface */
#define TIM_BREAK_SYSTEM_SRAM2_PARITY_ERROR                                                   \
    SYSCFG_CFGR2_SPL /*!< Enables and locks the SRAM2_PARITY error signal with Break Input of \
                        TIM1/8/15/16/17 */
#define TIM_BREAK_SYSTEM_LOCKUP                                                               \
    SYSCFG_CFGR2_CLL /*!< Enables and locks the LOCKUP output of CortexM4 with Break Input of \
                        TIM1/8/15/16/17 */
/**
 * @}
 */
 ...
 * @param  __HANDLE__ TIM handle
 * @retval None
 * @note The Main Output Enable of a timer instance is disabled only if all the CCx and CCxN
 ...
 * @note This macro is particularly useful to get the counting mode when the timer operates in
 ...
 * Note Please check if the bit 31 of CNT register is used as UIF copy or not, this may affect the
 * counter range in case of 32 bits counter TIM instance. Bit 31 of CNT can be enabled/disabled
 * using __HAL_TIM_UIFREMAP_ENABLE()/__HAL_TIM_UIFREMAP_DISABLE() macros.
 * @param  __HANDLE__ TIM handle.
...
/**
 * @brief  Set the TIM Autoreload Register value on runtime without calling another time any Init
 * function.
 * @param  __HANDLE__ TIM handle.
...
/**
 * @brief  Set the TIM Clock Division value on runtime without calling another time any Init
 * function.
 * @param  __HANDLE__ TIM handle.
...
/**
 * @brief  Set the TIM Capture Compare Register value on runtime without calling another time
...
#define IS_TIM_DMA_BASE(__BASE__)                                              \
    (((__BASE__) == TIM_DMABASE_CR1) || ((__BASE__) == TIM_DMABASE_CR2) ||     \
     ...
     ((__BASE__) == TIM_DMABASE_OR) || ((__BASE__) == TIM_DMABASE_CCMR3) ||    \
     ((__BASE__) == TIM_DMABASE_CCR5) || ((__BASE__) == TIM_DMABASE_CCR6) ||   \
     ((__BASE__) == TIM_DMABASE_AF1) || ((__BASE__) == TIM_DMABASE_AF2))
...
#define IS_TIM_PWM_MODE(__MODE__)                                                            \
    (((__MODE__) == TIM_OCMODE_PWM1) || ((__MODE__) == TIM_OCMODE_PWM2) ||                   \
     ...
     ((__MODE__) == TIM_OCMODE_ASSYMETRIC_PWM1) || ((__MODE__) == TIM_OCMODE_ASSYMETRIC_PWM2))
...
/* Non-Blocking mode: DMA */
HAL_StatusTypeDef HAL_TIM_IC_Start_DMA(TIM_HandleTypeDef* htim, uint32_t Channel, uint32_t* pData,
                                       uint16_t Length);
