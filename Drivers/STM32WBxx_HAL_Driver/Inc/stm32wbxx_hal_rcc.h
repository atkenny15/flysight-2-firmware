...
#    define RCC_OSCILLATORTYPE_ALL                                                    \
        (RCC_OSCILLATORTYPE_HSE | RCC_OSCILLATORTYPE_HSI | RCC_OSCILLATORTYPE_HSI48 | \
         RCC_OSCILLATORTYPE_MSI | RCC_OSCILLATORTYPE_LSI1 | RCC_OSCILLATORTYPE_LSI2 | \
         RCC_OSCILLATORTYPE_LSE) /*!< All Oscillator to configure */
#else
#    define RCC_OSCILLATORTYPE_ALL                                                  \
        (RCC_OSCILLATORTYPE_HSE | RCC_OSCILLATORTYPE_HSI | RCC_OSCILLATORTYPE_MSI | \
...
#define RCC_RESET_FLAG_ALL                                                              \
    (RCC_RESET_FLAG_OBL | RCC_RESET_FLAG_PIN | RCC_RESET_FLAG_PWR | RCC_RESET_FLAG_SW | \
...
#define IS_RCC_PLLSOURCE(__SOURCE__)                                               \
    (((__SOURCE__) == RCC_PLLSOURCE_MSI) || ((__SOURCE__) == RCC_PLLSOURCE_HSI) || \
...
#define IS_RCC_PLLP_VALUE(__VALUE__) \
    ((RCC_PLLP_DIV2 <= (__VALUE__)) && ((__VALUE__) <= RCC_PLLP_DIV32))

#define IS_RCC_PLLQ_VALUE(__VALUE__) \
    ((RCC_PLLQ_DIV2 <= (__VALUE__)) && ((__VALUE__) <= RCC_PLLQ_DIV8))

#define IS_RCC_PLLR_VALUE(__VALUE__) \
    ((RCC_PLLR_DIV2 <= (__VALUE__)) && ((__VALUE__) <= RCC_PLLR_DIV8))

#if defined(SAI1)
#    define IS_RCC_PLLSAI1CLOCKOUT_VALUE(__VALUE__)                     \
        (((((__VALUE__)&RCC_PLLSAI1_ADCCLK) == RCC_PLLSAI1_ADCCLK) ||   \
...
#define IS_RCC_CLOCKTYPE(__CLK__)                                                     \
    ((1U <= (__CLK__)) &&                                                             \
     ((__CLK__) <= (RCC_CLOCKTYPE_SYSCLK | RCC_CLOCKTYPE_HCLK | RCC_CLOCKTYPE_PCLK1 | \
                    RCC_CLOCKTYPE_PCLK2 | RCC_CLOCKTYPE_HCLK2 | RCC_CLOCKTYPE_HCLK4)))

#define IS_RCC_SYSCLKSOURCE(__SOURCE__)                                                  \
    (((__SOURCE__) == RCC_SYSCLKSOURCE_MSI) || ((__SOURCE__) == RCC_SYSCLKSOURCE_HSI) || \
     ((__SOURCE__) == RCC_SYSCLKSOURCE_HSE) || ((__SOURCE__) == RCC_SYSCLKSOURCE_PLLCLK))

#define IS_RCC_HCLKx(__HCLK__)                                                \
...
#    define IS_RCC_MCO(__MCOX__)                                         \
        (((__MCOX__) == RCC_MCO1_PA8) || ((__MCOX__) == RCC_MCO2_PB6) || \
         ((__MCOX__) == RCC_MCO3_PA15))
#else
#    define IS_RCC_MCO(__MCOX__) (((__MCOX__) == RCC_MCO1_PA8) || ((__MCOX__) == RCC_MCO2_PB6))
...
#    define IS_RCC_MCO1SOURCE(__SOURCE__)                                                       \
        (((__SOURCE__) == RCC_MCO1SOURCE_NOCLOCK) || ((__SOURCE__) == RCC_MCO1SOURCE_SYSCLK) || \
         ...
         ((__SOURCE__) == RCC_MCO1SOURCE_LSI1) || ((__SOURCE__) == RCC_MCO1SOURCE_LSI2) ||      \
         ((__SOURCE__) == RCC_MCO1SOURCE_LSE) || ((__SOURCE__) == RCC_MCO1SOURCE_HSI48))
#else
#    define IS_RCC_MCO1SOURCE(__SOURCE__)                                                       \
        (((__SOURCE__) == RCC_MCO1SOURCE_NOCLOCK) || ((__SOURCE__) == RCC_MCO1SOURCE_SYSCLK) || \
         ((__SOURCE__) == RCC_MCO1SOURCE_MSI) || ((__SOURCE__) == RCC_MCO1SOURCE_HSI) ||        \
...
#define IS_RCC_MCODIV(__DIV__)                                                                    \
    (((__DIV__) == RCC_MCODIV_1) || ((__DIV__) == RCC_MCODIV_2) || ((__DIV__) == RCC_MCODIV_4) || \
     ((__DIV__) == RCC_MCODIV_8) || ((__DIV__) == RCC_MCODIV_16))
...
typedef struct {
    ...
    uint32_t PLLR; /*!< PLLR: Division for the main system clock.
                        User have to set the PLLR parameter correctly to not exceed max frequency
                      64MHZ. This parameter must be a value of @ref RCC_PLLR_Clock_Divider */

} RCC_PLLInitTypeDef;

/**
 * @brief  RCC Internal/External Oscillator (HSE, HSI, HSI48, MSI, LSE and LSI) configuration
...
typedef struct {
    ...
    uint32_t HSICalibrationValue; /*!< The calibration trimming value (default is @ref
    ...
    uint32_t LSI2CalibrationValue; /*!< The LSI2 calibration trimming value .
                                     This parameter must be a number between Min_Data = 0x0 and
                                     Max_Data = 0xF     */

    uint32_t MSIState; /*!< The new state of the MSI.
                            This parameter can be a value of @ref RCC_MSI_Config */

    uint32_t MSICalibrationValue; /*!< The calibration trimming value (default is @ref
                                     RCC_MSICALIBRATION_DEFAULT). This parameter must be a number
...
typedef struct {
    ...
    uint32_t AHBCLKDivider; /*!< The AHBx clock (HCLK1) divider. This clock is derived from the
                               system clock (SYSCLK). This parameter can be a value of @ref
                               RCC_AHBx_Clock_Source       */

    uint32_t APB1CLKDivider; /*!< The APB1 clock (PCLK1) divider. This clock is derived from the AHB
                                clock (HCLK). This parameter can be a value of @ref
                                RCC_APBx_Clock_Source      */

    uint32_t APB2CLKDivider; /*!< The APB2 clock (PCLK2) divider. This clock is derived from the AHB
                                clock (HCLK). This parameter can be a value of @ref
                                RCC_APBx_Clock_Source      */

    uint32_t AHBCLK2Divider; /*!< The AHB clock (HCLK2) divider. This clock is derived from the
                                system clock (SYSCLK). This parameter can be a value of @ref
                                RCC_AHBx_Clock_Source      */

    uint32_t AHBCLK4Divider; /*!< The AHB shared clock (HCLK4) divider. This clock is derived from
                                the system clock (SYSCLK). This parameter can be a value of @ref
                                RCC_AHBx_Clock_Source       */
...
#define RCC_LSE_BYPASS \
    ((uint32_t)(RCC_BDCR_LSEBYP | RCC_BDCR_LSEON)) /*!< External clock source for LSE clock */
/**
 * @}
 */
...
#define RCC_PLLSOURCE_NONE \
    LL_RCC_PLLSOURCE_NONE                      /*!< No clock selected as PLL entry clock source  */
...
#define RCC_MCO2_PB6                                         \
    (RCC_MCO2_INDEX | (GPIO_AF0_MCO << RCC_MCO_GPIOAF_POS) | \
     (GPIO_GET_INDEX(GPIOB) << RCC_MCO_GPIOPORT_POS) | GPIO_PIN_6)
...
#    define RCC_MCO3_PA15                                        \
        (RCC_MCO3_INDEX | (GPIO_AF6_MCO << RCC_MCO_GPIOAF_POS) | \
...
#define RCC_MCO1SOURCE_NOCLOCK \
    LL_RCC_MCO1SOURCE_NOCLOCK /*!< MCO1 output disabled, no clock on MCO1 */
...
#define RCC_MCO1SOURCE_HSE \
    LL_RCC_MCO1SOURCE_HSE /*!< HSE after stabilization selection as MCO1 source */
...
#endif                                                   /* RCC_HSI48_SUPPORT */
#define RCC_MCO1SOURCE_HSE_BEFORE_STAB \
    LL_RCC_MCO1SOURCE_HSE_BEFORE_STAB /*!< HSE before stabilization selection as MCO1 source */
...
#    define RCC_FLAG_PLLSAI1RDY \
        ((CR_REG_INDEX << 5U) | RCC_CR_PLLSAI1RDY_Pos) /*!< PLLSAI1 Ready flag */
#endif                                                 /* SAI1 */
...
#define RCC_FLAG_LSECSSD      \
    ((BDCR_REG_INDEX << 5U) | \
     RCC_BDCR_LSECSSD_Pos) /*!< LSE Clock Security System failure detection flag */
...
#define RCC_FLAG_OBLRST \
    ((CSR_REG_INDEX << 5U) | RCC_CSR_OBLRSTF_Pos) /*!< Option Byte Loader reset flag */
#define RCC_FLAG_PINRST \
    ((CSR_REG_INDEX << 5U) | RCC_CSR_PINRSTF_Pos) /*!< Pin reset flag (NRST pin) */
...
/** @defgroup RCC_AHB1_Peripheral_Clock_Enable_Disable_Status AHB1 Peripheral Clock Enabled or
 * Disabled Status
...
#    define __HAL_RCC_DMA2_IS_CLK_DISABLED() \
        !(LL_AHB1_GRP1_IsEnabledClock(LL_AHB1_GRP1_PERIPH_DMA2))
#endif /* DMA2 */
#define __HAL_RCC_DMAMUX1_IS_CLK_DISABLED() \
    !(LL_AHB1_GRP1_IsEnabledClock(LL_AHB1_GRP1_PERIPH_DMAMUX1))
...
#endif /* ADC_SUPPORT_5_MSPS */
#if defined(AES1)
#    define __HAL_RCC_AES1_IS_CLK_DISABLED() \
        !(LL_AHB2_GRP1_IsEnabledClock(LL_AHB2_GRP1_PERIPH_AES1))
#endif /* AES1 */
...
#if defined(QUADSPI)
#    define __HAL_RCC_QUADSPI_IS_CLK_ENABLED() \
        LL_AHB3_GRP1_IsEnabledClock(LL_AHB3_GRP1_PERIPH_QUADSPI)
#endif /* QUADSPI */
...
#if defined(QUADSPI)
#    define __HAL_RCC_QUADSPI_IS_CLK_DISABLED() \
        !(LL_AHB3_GRP1_IsEnabledClock(LL_AHB3_GRP1_PERIPH_QUADSPI))
#endif /* QUADSPI */
...
#    define __HAL_RCC_LPUART1_IS_CLK_ENABLED() \
        LL_APB1_GRP2_IsEnabledClock(LL_APB1_GRP2_PERIPH_LPUART1)
#endif /* LPUART1 */

#define __HAL_RCC_RTCAPB_IS_CLK_DISABLED() \
    !(LL_APB1_GRP1_IsEnabledClock(LL_APB1_GRP1_PERIPH_RTCAPB))
...
#    define __HAL_RCC_SPI2_IS_CLK_DISABLED() \
        !(LL_APB1_GRP1_IsEnabledClock(LL_APB1_GRP1_PERIPH_SPI2))
#endif /* SPI2 */
...
#    define __HAL_RCC_I2C3_IS_CLK_DISABLED() \
        !(LL_APB1_GRP1_IsEnabledClock(LL_APB1_GRP1_PERIPH_I2C3))
#endif /* I2C3 */
#if defined(CRS)
...
#define __HAL_RCC_LPTIM1_IS_CLK_DISABLED() \
    !(LL_APB1_GRP1_IsEnabledClock(LL_APB1_GRP1_PERIPH_LPTIM1))

#define __HAL_RCC_LPTIM2_IS_CLK_DISABLED() \
    !(LL_APB1_GRP2_IsEnabledClock(LL_APB1_GRP2_PERIPH_LPTIM2))
#if defined(LPUART1)
...
#define __HAL_RCC_USART1_IS_CLK_DISABLED() \
    !(LL_APB2_GRP1_IsEnabledClock(LL_APB2_GRP1_PERIPH_USART1))
...
#    define __HAL_RCC_SAI1_IS_CLK_DISABLED() \
        !(LL_APB2_GRP1_IsEnabledClock(LL_APB2_GRP1_PERIPH_SAI1))
#endif /* SAI1 */
...
#endif /* DMA2 */
#define __HAL_RCC_C2DMAMUX1_CLK_DISABLE() \
    LL_C2_AHB1_GRP1_DisableClock(LL_C2_AHB1_GRP1_PERIPH_DMAMUX1)
...
#if defined(GPIOD)
#    define __HAL_RCC_C2GPIOD_CLK_DISABLE() \
        LL_C2_AHB2_GRP1_DisableClock(LL_C2_AHB2_GRP1_PERIPH_GPIOD)
#endif /* GPIOD */
...
#if defined(LPUART1)
#    define __HAL_RCC_C2LPUART1_CLK_ENABLE() \
...
#if defined(LPUART1)
#    define __HAL_RCC_C2LPUART1_CLK_DISABLE() \
        LL_C2_APB1_GRP2_DisableClock(LL_C2_APB1_GRP2_PERIPH_LPUART1)
#endif /* LPUART1 */
...
#define __HAL_RCC_C2DMA1_IS_CLK_ENABLED() \
    LL_C2_AHB1_GRP1_IsEnabledClock(LL_C2_AHB1_GRP1_PERIPH_DMA1)
#if defined(DMA2)
#    define __HAL_RCC_C2DMA2_IS_CLK_ENABLED() \
        LL_C2_AHB1_GRP1_IsEnabledClock(LL_C2_AHB1_GRP1_PERIPH_DMA2)
#endif /* DMA2 */
#define __HAL_RCC_C2DMAMUX1_IS_CLK_ENABLED() \
    LL_C2_AHB1_GRP1_IsEnabledClock(LL_C2_AHB1_GRP1_PERIPH_DMAMUX1)
#define __HAL_RCC_C2SRAM1_IS_CLK_ENABLED() \
    LL_C2_AHB1_GRP1_IsEnabledClock(LL_C2_AHB1_GRP1_PERIPH_SRAM1)
#define __HAL_RCC_C2CRC_IS_CLK_ENABLED() LL_C2_AHB1_GRP1_IsEnabledClock(LL_C2_AHB1_GRP1_PERIPH_CRC)
#if defined(TSC)
#    define __HAL_RCC_C2TSC_IS_CLK_ENABLED() \
        LL_C2_AHB1_GRP1_IsEnabledClock(LL_C2_AHB1_GRP1_PERIPH_TSC)
#endif /* TSC */

#define __HAL_RCC_C2DMA1_IS_CLK_DISABLED() \
    !(LL_C2_AHB1_GRP1_IsEnabledClock(LL_C2_AHB1_GRP1_PERIPH_DMA1))
#if defined(DMA2)
#    define __HAL_RCC_C2DMA2_IS_CLK_DISABLED() \
        !(LL_C2_AHB1_GRP1_IsEnabledClock(LL_C2_AHB1_GRP1_PERIPH_DMA2))
#endif /* DMA2 */
#define __HAL_RCC_C2DMAMUX1_IS_CLK_DISABLED() \
    !(LL_C2_AHB1_GRP1_IsEnabledClock(LL_C2_AHB1_GRP1_PERIPH_DMAMUX1))
#define __HAL_RCC_C2SRAM1_IS_CLK_DISABLED() \
    !(LL_C2_AHB1_GRP1_IsEnabledClock(LL_C2_AHB1_GRP1_PERIPH_SRAM1))
#define __HAL_RCC_C2CRC_IS_CLK_DISABLED() \
    !(LL_C2_AHB1_GRP1_IsEnabledClock(LL_C2_AHB1_GRP1_PERIPH_CRC))
#if defined(TSC)
#    define __HAL_RCC_C2TSC_IS_CLK_DISABLED() \
        !(LL_C2_AHB1_GRP1_IsEnabledClock(LL_C2_AHB1_GRP1_PERIPH_TSC))
#endif /* TSC */
...
#define __HAL_RCC_C2GPIOA_IS_CLK_ENABLED() \
    LL_C2_AHB2_GRP1_IsEnabledClock(LL_C2_AHB2_GRP1_PERIPH_GPIOA)
#define __HAL_RCC_C2GPIOB_IS_CLK_ENABLED() \
    LL_C2_AHB2_GRP1_IsEnabledClock(LL_C2_AHB2_GRP1_PERIPH_GPIOB)
#define __HAL_RCC_C2GPIOC_IS_CLK_ENABLED() \
    LL_C2_AHB2_GRP1_IsEnabledClock(LL_C2_AHB2_GRP1_PERIPH_GPIOC)
#if defined(GPIOD)
#    define __HAL_RCC_C2GPIOD_IS_CLK_ENABLED() \
        LL_C2_AHB2_GRP1_IsEnabledClock(LL_C2_AHB2_GRP1_PERIPH_GPIOD)
#endif /* GPIOD */
#define __HAL_RCC_C2GPIOE_IS_CLK_ENABLED() \
    LL_C2_AHB2_GRP1_IsEnabledClock(LL_C2_AHB2_GRP1_PERIPH_GPIOE)
#define __HAL_RCC_C2GPIOH_IS_CLK_ENABLED() \
    LL_C2_AHB2_GRP1_IsEnabledClock(LL_C2_AHB2_GRP1_PERIPH_GPIOH)
#if defined(ADC_SUPPORT_5_MSPS)
#    define __HAL_RCC_C2ADC_IS_CLK_ENABLED() \
        LL_C2_AHB2_GRP1_IsEnabledClock(LL_C2_AHB2_GRP1_PERIPH_ADC)
#endif /* ADC_SUPPORT_5_MSPS */
#if defined(AES1)
#    define __HAL_RCC_C2AES1_IS_CLK_ENABLED() \
        LL_C2_AHB2_GRP1_IsEnabledClock(LL_C2_AHB2_GRP1_PERIPH_AES1)
#endif /* AES1 */

#define __HAL_RCC_C2GPIOA_IS_CLK_DISABLED() \
    !(LL_C2_AHB2_GRP1_IsEnabledClock(LL_C2_AHB2_GRP1_PERIPH_GPIOA))
#define __HAL_RCC_C2GPIOB_IS_CLK_DISABLED() \
    !(LL_C2_AHB2_GRP1_IsEnabledClock(LL_C2_AHB2_GRP1_PERIPH_GPIOB))
#define __HAL_RCC_C2GPIOC_IS_CLK_DISABLED() \
    !(LL_C2_AHB2_GRP1_IsEnabledClock(LL_C2_AHB2_GRP1_PERIPH_GPIOC))
#if defined(GPIOD)
#    define __HAL_RCC_C2GPIOD_IS_CLK_DISABLED() \
        !(LL_C2_AHB2_GRP1_IsEnabledClock(LL_C2_AHB2_GRP1_PERIPH_GPIOD))
#endif /* GPIOD */
#define __HAL_RCC_C2GPIOE_IS_CLK_DISABLED() \
    !(LL_C2_AHB2_GRP1_IsEnabledClock(LL_C2_AHB2_GRP1_PERIPH_GPIOE))
#define __HAL_RCC_C2GPIOH_IS_CLK_DISABLED() \
    !(LL_C2_AHB2_GRP1_IsEnabledClock(LL_C2_AHB2_GRP1_PERIPH_GPIOH))
#if defined(ADC_SUPPORT_5_MSPS)
#    define __HAL_RCC_C2ADC_IS_CLK_DISABLED() \
        !(LL_C2_AHB2_GRP1_IsEnabledClock(LL_C2_AHB2_GRP1_PERIPH_ADC))
#endif /* ADC_SUPPORT_5_MSPS */
#if defined(AES1)
#    define __HAL_RCC_C2AES1_IS_CLK_DISABLED() \
        !(LL_C2_AHB2_GRP1_IsEnabledClock(LL_C2_AHB2_GRP1_PERIPH_AES1))
#endif /* AES1 */
...
#define __HAL_RCC_C2AES2_IS_CLK_ENABLED() \
    LL_C2_AHB3_GRP1_IsEnabledClock(LL_C2_AHB3_GRP1_PERIPH_AES2)
...
#define __HAL_RCC_C2HSEM_IS_CLK_ENABLED() \
    LL_C2_AHB3_GRP1_IsEnabledClock(LL_C2_AHB3_GRP1_PERIPH_HSEM)
#define __HAL_RCC_C2IPCC_IS_CLK_ENABLED() \
    LL_C2_AHB3_GRP1_IsEnabledClock(LL_C2_AHB3_GRP1_PERIPH_IPCC)
#define __HAL_RCC_C2FLASH_IS_CLK_ENABLED() \
    LL_C2_AHB3_GRP1_IsEnabledClock(LL_C2_AHB3_GRP1_PERIPH_FLASH)

#define __HAL_RCC_C2PKA_IS_CLK_DISABLED() \
    !(LL_C2_AHB3_GRP1_IsEnabledClock(LL_C2_AHB3_GRP1_PERIPH_PKA))
#define __HAL_RCC_C2AES2_IS_CLK_DISABLED() \
    !(LL_C2_AHB3_GRP1_IsEnabledClock(LL_C2_AHB3_GRP1_PERIPH_AES2))
#define __HAL_RCC_C2RNG_IS_CLK_DISABLED() \
    !(LL_C2_AHB3_GRP1_IsEnabledClock(LL_C2_AHB3_GRP1_PERIPH_RNG))
#define __HAL_RCC_C2HSEM_IS_CLK_DISABLED() \
    !(LL_C2_AHB3_GRP1_IsEnabledClock(LL_C2_AHB3_GRP1_PERIPH_HSEM))
#define __HAL_RCC_C2IPCC_IS_CLK_DISABLED() \
    !(LL_C2_AHB3_GRP1_IsEnabledClock(LL_C2_AHB3_GRP1_PERIPH_IPCC))
#define __HAL_RCC_C2FLASH_IS_CLK_DISABLED() \
    !(LL_C2_AHB3_GRP1_IsEnabledClock(LL_C2_AHB3_GRP1_PERIPH_FLASH))
...
#define __HAL_RCC_C2RTCAPB_IS_CLK_ENABLED() \
    LL_C2_APB1_GRP1_IsEnabledClock(LL_C2_APB1_GRP1_PERIPH_RTCAPB)
#define __HAL_RCC_C2TIM2_IS_CLK_ENABLED() \
    LL_C2_APB1_GRP1_IsEnabledClock(LL_C2_APB1_GRP1_PERIPH_TIM2)
#if defined(LCD)
#    define __HAL_RCC_C2LCD_IS_CLK_ENABLED() \
        LL_C2_APB1_GRP1_IsEnabledClock(LL_C2_APB1_GRP1_PERIPH_LCD)
#endif /* LCD */
#if defined(SPI2)
#    define __HAL_RCC_C2SPI2_IS_CLK_ENABLED() \
        LL_C2_APB1_GRP1_IsEnabledClock(LL_C2_APB1_GRP1_PERIPH_SPI2)
#endif /* SPI2 */
#define __HAL_RCC_C2I2C1_IS_CLK_ENABLED() \
    LL_C2_APB1_GRP1_IsEnabledClock(LL_C2_APB1_GRP1_PERIPH_I2C1)
#if defined(I2C3)
#    define __HAL_RCC_C2I2C3_IS_CLK_ENABLED() \
        LL_C2_APB1_GRP1_IsEnabledClock(LL_C2_APB1_GRP1_PERIPH_I2C3)
#endif /* I2C3 */
#if defined(CRS)
#    define __HAL_RCC_C2CRS_IS_CLK_ENABLED() \
        LL_C2_APB1_GRP1_IsEnabledClock(LL_C2_APB1_GRP1_PERIPH_CRS)
#endif /* CRS */
#if defined(USB)
#    define __HAL_RCC_C2USB_IS_CLK_ENABLED() \
        LL_C2_APB1_GRP1_IsEnabledClock(LL_C2_APB1_GRP1_PERIPH_USB)
#endif /* USB */
#define __HAL_RCC_C2LPTIM1_IS_CLK_ENABLED() \
    LL_C2_APB1_GRP1_IsEnabledClock(LL_C2_APB1_GRP1_PERIPH_LPTIM1)

#define __HAL_RCC_C2LPTIM2_IS_CLK_ENABLED() \
    LL_C2_APB1_GRP2_IsEnabledClock(LL_C2_APB1_GRP2_PERIPH_LPTIM2)
#if defined(LPUART1)
#    define __HAL_RCC_C2LPUART1_IS_CLK_ENABLED() \
        LL_C2_APB1_GRP2_IsEnabledClock(LL_C2_APB1_GRP2_PERIPH_LPUART1)
#endif /* LPUART1 */

#define __HAL_RCC_C2RTCAPB_IS_CLK_DISABLED() \
    !(LL_C2_APB1_GRP1_IsEnabledClock(LL_C2_APB1_GRP1_PERIPH_RTCAPB))
#define __HAL_RCC_C2TIM2_IS_CLK_DISABLED() \
    !(LL_C2_APB1_GRP1_IsEnabledClock(LL_C2_APB1_GRP1_PERIPH_TIM2))
#if defined(LCD)
#    define __HAL_RCC_C2LCD_IS_CLK_DISABLED() \
        !(LL_C2_APB1_GRP1_IsEnabledClock(LL_C2_APB1_GRP1_PERIPH_LCD))
#endif /* LCD */
#if defined(SPI2)
#    define __HAL_RCC_C2SPI2_IS_CLK_DISABLED() \
        !(LL_C2_APB1_GRP1_IsEnabledClock(LL_C2_APB1_GRP1_PERIPH_SPI2))
#endif /* SPI2 */
#define __HAL_RCC_C2I2C1_IS_CLK_DISABLED() \
    !(LL_C2_APB1_GRP1_IsEnabledClock(LL_C2_APB1_GRP1_PERIPH_I2C1))
#if defined(I2C3)
#    define __HAL_RCC_C2I2C3_IS_CLK_DISABLED() \
        !(LL_C2_APB1_GRP1_IsEnabledClock(LL_C2_APB1_GRP1_PERIPH_I2C3))
#endif /* I2C3 */
#if defined(CRS)
#    define __HAL_RCC_C2CRS_IS_CLK_DISABLED() \
        !(LL_C2_APB1_GRP1_IsEnabledClock(LL_C2_APB1_GRP1_PERIPH_CRS))
#endif /* CRS */
#if defined(USB)
#    define __HAL_RCC_C2USB_IS_CLK_DISABLED() \
        !(LL_C2_APB1_GRP1_IsEnabledClock(LL_C2_APB1_GRP1_PERIPH_USB))
#endif /* USB */
#define __HAL_RCC_C2LPTIM1_IS_CLK_DISABLED() \
    !(LL_C2_APB1_GRP1_IsEnabledClock(LL_C2_APB1_GRP1_PERIPH_LPTIM1))

#define __HAL_RCC_C2LPTIM2_IS_CLK_DISABLED() \
    !(LL_C2_APB1_GRP2_IsEnabledClock(LL_C2_APB1_GRP2_PERIPH_LPTIM2))
#if defined(LPUART1)
#    define __HAL_RCC_C2LPUART1_IS_CLK_DISABLED() \
        !(LL_C2_APB1_GRP2_IsEnabledClock(LL_C2_APB1_GRP1_PERIPH_LPTIM1))
#endif /* LPUART1*/
...
#if defined(ADC_SUPPORT_2_5_MSPS)
#    define __HAL_RCC_C2ADC_IS_CLK_ENABLED() \
        LL_C2_APB2_GRP1_IsEnabledClock(LL_C2_APB2_GRP1_PERIPH_ADC)
#endif /* ADC_SUPPORT_2_5_MSPS */
#define __HAL_RCC_C2TIM1_IS_CLK_ENABLED() \
    LL_C2_APB2_GRP1_IsEnabledClock(LL_C2_APB2_GRP1_PERIPH_TIM1)
#define __HAL_RCC_C2SPI1_IS_CLK_ENABLED() \
    LL_C2_APB2_GRP1_IsEnabledClock(LL_C2_APB2_GRP1_PERIPH_SPI1)
#define __HAL_RCC_C2USART1_IS_CLK_ENABLED() \
    LL_C2_APB2_GRP1_IsEnabledClock(LL_C2_APB2_GRP1_PERIPH_USART1)
#define __HAL_RCC_C2TIM16_IS_CLK_ENABLED() \
    LL_C2_APB2_GRP1_IsEnabledClock(LL_C2_APB2_GRP1_PERIPH_TIM16)
#define __HAL_RCC_C2TIM17_IS_CLK_ENABLED() \
    LL_C2_APB2_GRP1_IsEnabledClock(LL_C2_APB2_GRP1_PERIPH_TIM17)
#if defined(SAI1)
#    define __HAL_RCC_C2SAI1_IS_CLK_ENABLED() \
        LL_C2_APB2_GRP1_IsEnabledClock(LL_C2_APB2_GRP1_PERIPH_SAI1)
#endif /* SAI1 */
...
#    define __HAL_RCC_C2ADC_IS_CLK_DISABLED() \
        !(LL_C2_APB2_GRP1_IsEnabledClock(LL_C2_APB2_GRP1_PERIPH_ADC))
#endif /* ADC_SUPPORT_2_5_MSPS */
#define __HAL_RCC_C2TIM1_IS_CLK_DISABLED() \
    !(LL_C2_APB2_GRP1_IsEnabledClock(LL_C2_APB2_GRP1_PERIPH_TIM1))
#define __HAL_RCC_C2SPI1_IS_CLK_DISABLED() \
    !(LL_C2_APB2_GRP1_IsEnabledClock(LL_C2_APB2_GRP1_PERIPH_SPI1))
#define __HAL_RCC_C2USART1_IS_CLK_DISABLED() \
    !(LL_C2_APB2_GRP1_IsEnabledClock(LL_C2_APB2_GRP1_PERIPH_USART1))
#define __HAL_RCC_C2TIM16_IS_CLK_DISABLED() \
    !(LL_C2_APB2_GRP1_IsEnabledClock(LL_C2_APB2_GRP1_PERIPH_TIM16))
#define __HAL_RCC_C2TIM17_IS_CLK_DISABLED() \
    !(LL_C2_APB2_GRP1_IsEnabledClock(LL_C2_APB2_GRP1_PERIPH_TIM17))
#if defined(SAI1)
#    define __HAL_RCC_C2SAI1_IS_CLK_DISABLED() \
        !(LL_C2_APB2_GRP1_IsEnabledClock(LL_C2_APB2_GRP1_PERIPH_SAI1))
#endif /* SAI1 */
...
#if defined(RCC_802_SUPPORT)
#    define __HAL_RCC_C2802_IS_CLK_ENABLED() \
        LL_C2_APB3_GRP1_IsEnabledClock(LL_C2_APB3_GRP1_PERIPH_802)
#endif /* RCC_802_SUPPORT */
...
#    define __HAL_RCC_DMA2_CLK_SLEEP_ENABLE() \
        LL_AHB1_GRP1_EnableClockSleep(LL_AHB1_GRP1_PERIPH_DMA2)
#endif /* DMA2 */
#define __HAL_RCC_DMAMUX1_CLK_SLEEP_ENABLE() \
    LL_AHB1_GRP1_EnableClockSleep(LL_AHB1_GRP1_PERIPH_DMAMUX1)
...
#    define __HAL_RCC_DMA2_CLK_SLEEP_DISABLE() \
        LL_AHB1_GRP1_DisableClockSleep(LL_AHB1_GRP1_PERIPH_DMA2)
#endif /* DMA2 */
#define __HAL_RCC_DMAMUX1_CLK_SLEEP_DISABLE() \
    LL_AHB1_GRP1_DisableClockSleep(LL_AHB1_GRP1_PERIPH_DMAMUX1)
#define __HAL_RCC_SRAM1_CLK_SLEEP_DISABLE() \
    LL_AHB1_GRP1_DisableClockSleep(LL_AHB1_GRP1_PERIPH_SRAM1)
...
#    define __HAL_RCC_TSC_CLK_SLEEP_DISABLE() \
        LL_AHB1_GRP1_DisableClockSleep(LL_AHB1_GRP1_PERIPH_TSC)
#endif /* TSC */

#define __HAL_RCC_C2DMA1_CLK_SLEEP_ENABLE() \
    LL_C2_AHB1_GRP1_EnableClockSleep(LL_C2_AHB1_GRP1_PERIPH_DMA1)
#if defined(DMA2)
#    define __HAL_RCC_C2DMA2_CLK_SLEEP_ENABLE() \
        LL_C2_AHB1_GRP1_EnableClockSleep(LL_C2_AHB1_GRP1_PERIPH_DMA2)
#endif /* DMA2 */
#define __HAL_RCC_C2DMAMUX1_CLK_SLEEP_ENABLE() \
    LL_C2_AHB1_GRP1_EnableClockSleep(LL_C2_AHB1_GRP1_PERIPH_DMAMUX1)
#define __HAL_RCC_C2SRAM1_CLK_SLEEP_ENABLE() \
    LL_C2_AHB1_GRP1_EnableClockSleep(LL_C2_AHB1_GRP1_PERIPH_SRAM1)
#define __HAL_RCC_C2CRC_CLK_SLEEP_ENABLE() \
    LL_C2_AHB1_GRP1_EnableClockSleep(LL_C2_AHB1_GRP1_PERIPH_CRC)
#if defined(TSC)
#    define __HAL_RCC_C2TSC_CLK_SLEEP_ENABLE() \
        LL_C2_AHB1_GRP1_EnableClockSleep(LL_C2_AHB1_GRP1_PERIPH_TSC)
#endif /* TSC */

#define __HAL_RCC_C2DMA1_CLK_SLEEP_DISABLE() \
    LL_C2_AHB1_GRP1_DisableClockSleep(LL_C2_AHB1_GRP1_PERIPH_DMA1)
#if defined(DMA2)
#    define __HAL_RCC_C2DMA2_CLK_SLEEP_DISABLE() \
        LL_C2_AHB1_GRP1_DisableClockSleep(LL_C2_AHB1_GRP1_PERIPH_DMA2)
#endif /* DMA2 */
#define __HAL_RCC_C2DMAMUX1_CLK_SLEEP_DISABLE() \
    LL_C2_AHB1_GRP1_DisableClockSleep(LL_C2_AHB1_GRP1_PERIPH_DMAMUX1)
#define __HAL_RCC_C2SRAM1_CLK_SLEEP_DISABLE() \
    LL_C2_AHB1_GRP1_DisableClockSleep(LL_C2_AHB1_GRP1_PERIPH_SRAM1)

#define __HAL_RCC_C2CRC_CLK_SLEEP_DISABLE() \
    LL_C2_AHB1_GRP1_DisableClockSleep(LL_C2_AHB1_GRP1_PERIPH_CRC)
#if defined(TSC)
#    define __HAL_RCC_C2TSC_CLK_SLEEP_DISABLE() \
        LL_C2_AHB1_GRP1_DisableClockSleep(LL_C2_AHB1_GRP1_PERIPH_TSC)
#endif /* TSC */
...
#    define __HAL_RCC_GPIOD_CLK_SLEEP_ENABLE() \
        LL_AHB2_GRP1_EnableClockSleep(LL_AHB2_GRP1_PERIPH_GPIOD)
#endif /* GPIOD */
...
#endif /* ADC_SUPPORT_5_MSPS */
#if defined(AES1)
#    define __HAL_RCC_AES1_CLK_SLEEP_ENABLE() \
        LL_AHB2_GRP1_EnableClockSleep(LL_AHB2_GRP1_PERIPH_AES1)
#endif /* AES1 */

#define __HAL_RCC_GPIOA_CLK_SLEEP_DISABLE() \
    LL_AHB2_GRP1_DisableClockSleep(LL_AHB2_GRP1_PERIPH_GPIOA)
#define __HAL_RCC_GPIOB_CLK_SLEEP_DISABLE() \
    LL_AHB2_GRP1_DisableClockSleep(LL_AHB2_GRP1_PERIPH_GPIOB)
#define __HAL_RCC_GPIOC_CLK_SLEEP_DISABLE() \
    LL_AHB2_GRP1_DisableClockSleep(LL_AHB2_GRP1_PERIPH_GPIOC)
#if defined(GPIOD)
#    define __HAL_RCC_GPIOD_CLK_SLEEP_DISABLE() \
        LL_AHB2_GRP1_DisableClockSleep(LL_AHB2_GRP1_PERIPH_GPIOD)
#endif /* GPIOD */
#define __HAL_RCC_GPIOE_CLK_SLEEP_DISABLE() \
    LL_AHB2_GRP1_DisableClockSleep(LL_AHB2_GRP1_PERIPH_GPIOE)
#define __HAL_RCC_GPIOH_CLK_SLEEP_DISABLE() \
    LL_AHB2_GRP1_DisableClockSleep(LL_AHB2_GRP1_PERIPH_GPIOH)
#if defined(ADC_SUPPORT_5_MSPS)
#    define __HAL_RCC_ADC_CLK_SLEEP_DISABLE() \
        LL_AHB2_GRP1_DisableClockSleep(LL_AHB2_GRP1_PERIPH_ADC)
#endif /* ADC_SUPPORT_5_MSPS */
#if defined(AES1)
#    define __HAL_RCC_AES1_CLK_SLEEP_DISABLE() \
        LL_AHB2_GRP1_DisableClockSleep(LL_AHB2_GRP1_PERIPH_AES1)
#endif /* AES1 */

#define __HAL_RCC_C2GPIOA_CLK_SLEEP_ENABLE() \
    LL_C2_AHB2_GRP1_EnableClockSleep(LL_C2_AHB2_GRP1_PERIPH_GPIOA)
#define __HAL_RCC_C2GPIOB_CLK_SLEEP_ENABLE() \
    LL_C2_AHB2_GRP1_EnableClockSleep(LL_C2_AHB2_GRP1_PERIPH_GPIOB)
#define __HAL_RCC_C2GPIOC_CLK_SLEEP_ENABLE() \
    LL_C2_AHB2_GRP1_EnableClockSleep(LL_C2_AHB2_GRP1_PERIPH_GPIOC)
#if defined(GPIOD)
#    define __HAL_RCC_C2GPIOD_CLK_SLEEP_ENABLE() \
        LL_C2_AHB2_GRP1_EnableClockSleep(LL_C2_AHB2_GRP1_PERIPH_GPIOD)
#endif /* GPIOD */
#define __HAL_RCC_C2GPIOE_CLK_SLEEP_ENABLE() \
    LL_C2_AHB2_GRP1_EnableClockSleep(LL_C2_AHB2_GRP1_PERIPH_GPIOE)
#define __HAL_RCC_C2GPIOH_CLK_SLEEP_ENABLE() \
    LL_C2_AHB2_GRP1_EnableClockSleep(LL_C2_AHB2_GRP1_PERIPH_GPIOH)
#if defined(ADC_SUPPORT_5_MSPS)
#    define __HAL_RCC_C2ADC_CLK_SLEEP_ENABLE() \
        LL_C2_AHB2_GRP1_EnableClockSleep(LL_C2_AHB2_GRP1_PERIPH_ADC)
#endif /* ADC_SUPPORT_5_MSPS */
#if defined(AES1)
#    define __HAL_RCC_C2AES1_CLK_SLEEP_ENABLE() \
        LL_C2_AHB2_GRP1_EnableClockSleep(LL_C2_AHB2_GRP1_PERIPH_AES1)
#endif /* AES1 */

#define __HAL_RCC_C2GPIOA_CLK_SLEEP_DISABLE() \
    LL_C2_AHB2_GRP1_DisableClockSleep(LL_C2_AHB2_GRP1_PERIPH_GPIOA)
#define __HAL_RCC_C2GPIOB_CLK_SLEEP_DISABLE() \
    LL_C2_AHB2_GRP1_DisableClockSleep(LL_C2_AHB2_GRP1_PERIPH_GPIOB)
#define __HAL_RCC_C2GPIOC_CLK_SLEEP_DISABLE() \
    LL_C2_AHB2_GRP1_DisableClockSleep(LL_C2_AHB2_GRP1_PERIPH_GPIOC)
#if defined(GPIOD)
#    define __HAL_RCC_C2GPIOD_CLK_SLEEP_DISABLE() \
        LL_C2_AHB2_GRP1_DisableClockSleep(LL_C2_AHB2_GRP1_PERIPH_GPIOD)
#endif /* GPIOD */
#define __HAL_RCC_C2GPIOE_CLK_SLEEP_DISABLE() \
    LL_C2_AHB2_GRP1_DisableClockSleep(LL_C2_AHB2_GRP1_PERIPH_GPIOE)
#define __HAL_RCC_C2GPIOH_CLK_SLEEP_DISABLE() \
    LL_C2_AHB2_GRP1_DisableClockSleep(LL_C2_AHB2_GRP1_PERIPH_GPIOH)
#if defined(ADC_SUPPORT_5_MSPS)
#    define __HAL_RCC_C2ADC_CLK_SLEEP_DISABLE() \
        LL_C2_AHB2_GRP1_DisableClockSleep(LL_C2_AHB2_GRP1_PERIPH_ADC)
#endif /* ADC_SUPPORT_5_MSPS */
#if defined(AES1)
#    define __HAL_RCC_C2AES1_CLK_SLEEP_DISABLE() \
        LL_C2_AHB2_GRP1_DisableClockSleep(LL_C2_AHB2_GRP1_PERIPH_AES1)
#endif /* AES1 */
 ...
 */
#if defined(QUADSPI)
#    define __HAL_RCC_QUADSPI_CLK_SLEEP_ENABLE() \
        LL_AHB3_GRP1_EnableClockSleep(LL_AHB3_GRP1_PERIPH_QUADSPI)
#endif /* QUADSPI */
...
#if defined(QUADSPI)
#    define __HAL_RCC_QUADSPI_CLK_SLEEP_DISABLE() \
        LL_AHB3_GRP1_DisableClockSleep(LL_AHB3_GRP1_PERIPH_QUADSPI)
#endif /* QUADSPI */
...
#define __HAL_RCC_SRAM2_CLK_SLEEP_DISABLE() \
    LL_AHB3_GRP1_DisableClockSleep(LL_AHB3_GRP1_PERIPH_SRAM2)
#define __HAL_RCC_FLASH_CLK_SLEEP_DISABLE() \
    LL_AHB3_GRP1_DisableClockSleep(LL_AHB3_GRP1_PERIPH_FLASH)

#define __HAL_RCC_C2PKA_CLK_SLEEP_ENABLE() \
    LL_C2_AHB3_GRP1_EnableClockSleep(LL_C2_AHB3_GRP1_PERIPH_PKA)
#define __HAL_RCC_C2AES2_CLK_SLEEP_ENABLE() \
    LL_C2_AHB3_GRP1_EnableClockSleep(LL_C2_AHB3_GRP1_PERIPH_AES2)
#define __HAL_RCC_C2RNG_CLK_SLEEP_ENABLE() \
    LL_C2_AHB3_GRP1_EnableClockSleep(LL_C2_AHB3_GRP1_PERIPH_RNG)
#define __HAL_RCC_C2SRAM2_CLK_SLEEP_ENABLE() \
    LL_C2_AHB3_GRP1_EnableClockSleep(LL_C2_AHB3_GRP1_PERIPH_SRAM2)
#define __HAL_RCC_C2FLASH_CLK_SLEEP_ENABLE() \
    LL_C2_AHB3_GRP1_EnableClockSleep(LL_C2_AHB3_GRP1_PERIPH_FLASH)

#define __HAL_RCC_C2PKA_CLK_SLEEP_DISABLE() \
    LL_C2_AHB3_GRP1_DisableClockSleep(LL_C2_AHB3_GRP1_PERIPH_PKA)
#define __HAL_RCC_C2AES2_CLK_SLEEP_DISABLE() \
    LL_C2_AHB3_GRP1_DisableClockSleep(LL_C2_AHB3_GRP1_PERIPH_AES2)
#define __HAL_RCC_C2RNG_CLK_SLEEP_DISABLE() \
    LL_C2_AHB3_GRP1_DisableClockSleep(LL_C2_AHB3_GRP1_PERIPH_RNG)
#define __HAL_RCC_C2SRAM2_CLK_SLEEP_DISABLE() \
    LL_C2_AHB3_GRP1_DisableClockSleep(LL_C2_AHB3_GRP1_PERIPH_SRAM2)
#define __HAL_RCC_C2FLASH_CLK_SLEEP_DISABLE() \
    LL_C2_AHB3_GRP1_DisableClockSleep(LL_C2_AHB3_GRP1_PERIPH_FLASH)
...
#define __HAL_RCC_RTCAPB_CLK_SLEEP_ENABLE() \
    LL_APB1_GRP1_EnableClockSleep(LL_APB1_GRP1_PERIPH_RTCAPB)
...
#    define __HAL_RCC_SPI2_CLK_SLEEP_ENABLE() \
        LL_APB1_GRP1_EnableClockSleep(LL_APB1_GRP1_PERIPH_SPI2)
#endif /* SPI2 */
...
#    define __HAL_RCC_I2C3_CLK_SLEEP_ENABLE() \
        LL_APB1_GRP1_EnableClockSleep(LL_APB1_GRP1_PERIPH_I2C3)
#endif /* I2C3 */
#if defined(CRS)
...
#    define __HAL_RCC_LCD_CLK_SLEEP_DISABLE() \
        LL_APB1_GRP1_DisableClockSleep(LL_APB1_GRP1_PERIPH_LCD)
#endif /* LCD */
#define __HAL_RCC_RTCAPB_CLK_SLEEP_DISABLE() \
    LL_APB1_GRP1_DisableClockSleep(LL_APB1_GRP1_PERIPH_RTCAPB)
...
#    define __HAL_RCC_SPI2_CLK_SLEEP_DISABLE() \
        LL_APB1_GRP1_DisableClockSleep(LL_APB1_GRP1_PERIPH_SPI2)
#endif /* SPI2 */
...
#    define __HAL_RCC_I2C3_CLK_SLEEP_DISABLE() \
        LL_APB1_GRP1_DisableClockSleep(LL_APB1_GRP1_PERIPH_I2C3)
#endif /* I2C3 */
#if defined(CRS)
#    define __HAL_RCC_CRS_CLK_SLEEP_DISABLE() \
        LL_APB1_GRP1_DisableClockSleep(LL_APB1_GRP1_PERIPH_CRS)
#endif /* CRS */
#if defined(USB)
...
#define __HAL_RCC_LPTIM1_CLK_SLEEP_DISABLE() \
    LL_APB1_GRP1_DisableClockSleep(LL_APB1_GRP1_PERIPH_LPTIM1)
#if defined(LPUART1)
#    define __HAL_RCC_LPUART1_CLK_SLEEP_DISABLE() \
        LL_APB1_GRP2_DisableClockSleep(LL_APB1_GRP2_PERIPH_LPUART1)
#endif /* LPUART1 */
#define __HAL_RCC_LPTIM2_CLK_SLEEP_DISABLE() \
    LL_APB1_GRP2_DisableClockSleep(LL_APB1_GRP2_PERIPH_LPTIM2)

#define __HAL_RCC_C2TIM2_CLK_SLEEP_ENABLE() \
    LL_C2_APB1_GRP1_EnableClockSleep(LL_C2_APB1_GRP1_PERIPH_TIM2)
#if defined(LCD)
#    define __HAL_RCC_C2LCD_CLK_SLEEP_ENABLE() \
        LL_C2_APB1_GRP1_EnableClockSleep(LL_C2_APB1_GRP1_PERIPH_LCD)
#endif /* LCD */
#define __HAL_RCC_C2RTCAPB_CLK_SLEEP_ENABLE() \
    LL_C2_APB1_GRP1_EnableClockSleep(LL_C2_APB1_GRP1_PERIPH_RTCAPB)
#if defined(SPI2)
#    define __HAL_RCC_C2SPI2_CLK_SLEEP_ENABLE() \
        LL_C2_APB1_GRP1_EnableClockSleep(LL_C2_APB1_GRP1_PERIPH_SPI2)
#endif /* SPI2 */
#define __HAL_RCC_C2I2C1_CLK_SLEEP_ENABLE() \
    LL_C2_APB1_GRP1_EnableClockSleep(LL_C2_APB1_GRP1_PERIPH_I2C1)
#if defined(I2C3)
#    define __HAL_RCC_C2I2C3_CLK_SLEEP_ENABLE() \
        LL_C2_APB1_GRP1_EnableClockSleep(LL_C2_APB1_GRP1_PERIPH_I2C3)
#endif /* I2C3 */
#if defined(CRS)
#    define __HAL_RCC_C2CRS_CLK_SLEEP_ENABLE() \
        LL_C2_APB1_GRP1_EnableClockSleep(LL_C2_APB1_GRP1_PERIPH_CRS)
#endif /* CRS */
#if defined(USB)
#    define __HAL_RCC_C2USB_CLK_SLEEP_ENABLE() \
        LL_C2_APB1_GRP1_EnableClockSleep(LL_C2_APB1_GRP1_PERIPH_USB)
#endif /* USB */
#define __HAL_RCC_C2LPTIM1_CLK_SLEEP_ENABLE() \
    LL_C2_APB1_GRP1_EnableClockSleep(LL_C2_APB1_GRP1_PERIPH_LPTIM1)
#if defined(LPUART1)
#    define __HAL_RCC_C2LPUART1_CLK_SLEEP_ENABLE() \
        LL_C2_APB1_GRP2_EnableClockSleep(LL_C2_APB1_GRP2_PERIPH_LPUART1)
#endif /* LPUART1 */
#define __HAL_RCC_C2LPTIM2_CLK_SLEEP_ENABLE() \
    LL_C2_APB1_GRP2_EnableClockSleep(LL_C2_APB1_GRP2_PERIPH_LPTIM2)

#define __HAL_RCC_C2TIM2_CLK_SLEEP_DISABLE() \
    LL_C2_APB1_GRP1_DisableClockSleep(LL_C2_APB1_GRP1_PERIPH_TIM2)
#if defined(LCD)
#    define __HAL_RCC_C2LCD_CLK_SLEEP_DISABLE() \
        LL_C2_APB1_GRP1_DisableClockSleep(LL_C2_APB1_GRP1_PERIPH_LCD)
#endif /* LCD */
#define __HAL_RCC_C2RTCAPB_CLK_SLEEP_DISABLE() \
    LL_C2_APB1_GRP1_DisableClockSleep(LL_C2_APB1_GRP1_PERIPH_RTCAPB)
#if defined(SPI2)
#    define __HAL_RCC_C2SPI2_CLK_SLEEP_DISABLE() \
        LL_C2_APB1_GRP1_DisableClockSleep(LL_C2_APB1_GRP1_PERIPH_SPI2)
#endif /* SPI2 */
#define __HAL_RCC_C2I2C1_CLK_SLEEP_DISABLE() \
    LL_C2_APB1_GRP1_DisableClockSleep(LL_C2_APB1_GRP1_PERIPH_I2C1)
#if defined(I2C3)
#    define __HAL_RCC_C2I2C3_CLK_SLEEP_DISABLE() \
        LL_C2_APB1_GRP1_DisableClockSleep(LL_C2_APB1_GRP1_PERIPH_I2C3)
#endif /* I2C3 */
#if defined(CRS)
#    define __HAL_RCC_C2CRS_CLK_SLEEP_DISABLE() \
        LL_C2_APB1_GRP1_DisableClockSleep(LL_C2_APB1_GRP1_PERIPH_CRS)
#endif /* CRS */
#if defined(USB)
#    define __HAL_RCC_C2USB_CLK_SLEEP_DISABLE() \
        LL_C2_APB1_GRP1_DisableClockSleep(LL_C2_APB1_GRP1_PERIPH_USB)
#endif /* USB */
#define __HAL_RCC_C2LPTIM1_CLK_SLEEP_DISABLE() \
    LL_C2_APB1_GRP1_DisableClockSleep(LL_C2_APB1_GRP1_PERIPH_LPTIM1)
#if defined(LPUART1)
#    define __HAL_RCC_C2LPUART1_CLK_SLEEP_DISABLE() \
        LL_C2_APB1_GRP2_DisableClockSleep(LL_C2_APB1_GRP2_PERIPH_LPUART1)
#endif /* LPUART1 */
#define __HAL_RCC_C2LPTIM2_CLK_SLEEP_DISABLE() \
    LL_C2_APB1_GRP2_DisableClockSleep(LL_C2_APB1_GRP2_PERIPH_LPTIM2)
...
#define __HAL_RCC_USART1_CLK_SLEEP_ENABLE() \
    LL_APB2_GRP1_EnableClockSleep(LL_APB2_GRP1_PERIPH_USART1)
...
#    define __HAL_RCC_SAI1_CLK_SLEEP_ENABLE() \
        LL_APB2_GRP1_EnableClockSleep(LL_APB2_GRP1_PERIPH_SAI1)
#endif /* SAI1 */
...
#define __HAL_RCC_USART1_CLK_SLEEP_DISABLE() \
    LL_APB2_GRP1_DisableClockSleep(LL_APB2_GRP1_PERIPH_USART1)
#define __HAL_RCC_TIM16_CLK_SLEEP_DISABLE() \
    LL_APB2_GRP1_DisableClockSleep(LL_APB2_GRP1_PERIPH_TIM16)
#define __HAL_RCC_TIM17_CLK_SLEEP_DISABLE() \
    LL_APB2_GRP1_DisableClockSleep(LL_APB2_GRP1_PERIPH_TIM17)
#if defined(SAI1)
#    define __HAL_RCC_SAI1_CLK_SLEEP_DISABLE() \
        LL_APB2_GRP1_DisableClockSleep(LL_APB2_GRP1_PERIPH_SAI1)
#endif /* SAI1 */

#if defined(ADC_SUPPORT_2_5_MSPS)
#    define __HAL_RCC_C2ADC_CLK_SLEEP_ENABLE() \
        LL_C2_APB2_GRP1_EnableClockSleep(LL_C2_APB2_GRP1_PERIPH_ADC)
#endif /* ADC_SUPPORT_2_5_MSPS */
#define __HAL_RCC_C2TIM1_CLK_SLEEP_ENABLE() \
    LL_C2_APB2_GRP1_EnableClockSleep(LL_C2_APB2_GRP1_PERIPH_TIM1)
#define __HAL_RCC_C2SPI1_CLK_SLEEP_ENABLE() \
    LL_C2_APB2_GRP1_EnableClockSleep(LL_C2_APB2_GRP1_PERIPH_SPI1)
#define __HAL_RCC_C2USART1_CLK_SLEEP_ENABLE() \
    LL_C2_APB2_GRP1_EnableClockSleep(LL_C2_APB2_GRP1_PERIPH_USART1)
#define __HAL_RCC_C2TIM16_CLK_SLEEP_ENABLE() \
    LL_C2_APB2_GRP1_EnableClockSleep(LL_C2_APB2_GRP1_PERIPH_TIM16)
#define __HAL_RCC_C2TIM17_CLK_SLEEP_ENABLE() \
    LL_C2_APB2_GRP1_EnableClockSleep(LL_C2_APB2_GRP1_PERIPH_TIM17)
#if defined(SAI1)
#    define __HAL_RCC_C2SAI1_CLK_SLEEP_ENABLE() \
        LL_C2_APB2_GRP1_EnableClockSleep(LL_C2_APB2_GRP1_PERIPH_SAI1)
#endif /* SAI1 */

#if defined(ADC_SUPPORT_2_5_MSPS)
#    define __HAL_RCC_C2ADC_CLK_SLEEP_DISABLE() \
        LL_C2_APB2_GRP1_DisableClockSleep(LL_C2_APB2_GRP1_PERIPH_ADC)
#endif /* ADC_SUPPORT_2_5_MSPS */
#define __HAL_RCC_C2TIM1_CLK_SLEEP_DISABLE() \
    LL_C2_APB2_GRP1_DisableClockSleep(LL_C2_APB2_GRP1_PERIPH_TIM1)
#define __HAL_RCC_C2SPI1_CLK_SLEEP_DISABLE() \
    LL_C2_APB2_GRP1_DisableClockSleep(LL_C2_APB2_GRP1_PERIPH_SPI1)
#define __HAL_RCC_C2USART1_CLK_SLEEP_DISABLE() \
    LL_C2_APB2_GRP1_DisableClockSleep(LL_C2_APB2_GRP1_PERIPH_USART1)
#define __HAL_RCC_C2TIM16_CLK_SLEEP_DISABLE() \
    LL_C2_APB2_GRP1_DisableClockSleep(LL_C2_APB2_GRP1_PERIPH_TIM16)
#define __HAL_RCC_C2TIM17_CLK_SLEEP_DISABLE() \
    LL_C2_APB2_GRP1_DisableClockSleep(LL_C2_APB2_GRP1_PERIPH_TIM17)
#if defined(SAI1)
#    define __HAL_RCC_C2SAI1_CLK_SLEEP_DISABLE() \
        LL_C2_APB2_GRP1_DisableClockSleep(LL_C2_APB2_GRP1_PERIPH_SAI1)
#endif /* SAI1 */
/**
 * @}
 */

/** @defgroup RCC_AHB1_Clock_Sleep_Enable_Disable_Status AHB1 Peripheral Clock Sleep Enabled or
 * Disabled Status
...
#define __HAL_RCC_DMA1_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->AHB1SMENR, RCC_AHB1SMENR_DMA1SMEN) != RESET)
#if defined(DMA2)
#    define __HAL_RCC_DMA2_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->AHB1SMENR, RCC_AHB1SMENR_DMA2SMEN) != RESET)
#endif /* DMA2 */
#define __HAL_RCC_DMAMUX1_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->AHB1SMENR, RCC_AHB1SMENR_DMAMUX1SMEN) != RESET)
#define __HAL_RCC_SRAM1_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->AHB1SMENR, RCC_AHB1SMENR_SRAM1SMEN) != RESET)
#define __HAL_RCC_CRC_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->AHB1SMENR, RCC_AHB1SMENR_CRCSMEN) != RESET)
#if defined(TSC)
#    define __HAL_RCC_TSC_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->AHB1SMENR, RCC_AHB1SMENR_TSCSMEN) != RESET)
#endif /* TSC */
...
#define __HAL_RCC_C2DMA1_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2AHB1SMENR, RCC_C2AHB1SMENR_DMA1SMEN) != RESET)
#if defined(DMA2)
#    define __HAL_RCC_C2DMA2_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->C2AHB1SMENR, RCC_C2AHB1SMENR_DMA2SMEN) != RESET)
#endif /* DMA2 */
#define __HAL_RCC_C2DMAMUX1_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2AHB1SMENR, RCC_C2AHB1SMENR_DMAMUX1SMEN) != RESET)
#define __HAL_RCC_C2SRAM1_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2AHB1SMENR, RCC_C2AHB1SMENR_SRAM1SMEN) != RESET)
#define __HAL_RCC_C2CRC_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2AHB1SMENR, RCC_C2AHB1SMENR_CRCSMEN) != RESET)
#if defined(TSC)
#    define __HAL_RCC_C2TSC_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->C2AHB1SMENR, RCC_C2AHB1SMENR_TSCSMEN) != RESET)
#endif /* TSC */

#define __HAL_RCC_C2DMA1_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2AHB1SMENR, RCC_C2AHB1SMENR_DMA1SMEN) == RESET)
#if defined(DMA2)
#    define __HAL_RCC_C2DMA2_IS_CLK_SLEEP_DISABLED() \
        (READ_BIT(RCC->C2AHB1SMENR, RCC_C2AHB1SMENR_DMA2SMEN) == RESET)
#endif /* DMA2 */
#define __HAL_RCC_C2DMAMUX1_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2AHB1SMENR, RCC_C2AHB1SMENR_DMAMUX1SMEN) == RESET)
#define __HAL_RCC_C2SRAM1_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2AHB1SMENR, RCC_C2AHB1SMENR_SRAM1SMEN) == RESET)
#define __HAL_RCC_C2CRC_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2AHB1SMENR, RCC_C2AHB1SMENR_CRCSMEN) == RESET)
#if defined(TSC)
#    define __HAL_RCC_C2TSC_IS_CLK_SLEEP_DISABLED() \
        (READ_BIT(RCC->C2AHB1SMENR, RCC_C2AHB1SMENR_TSCSMEN) == RESET)
#endif /* TSC */
/**
 * @}
...
/** @defgroup RCC_AHB2_Clock_Sleep_Enable_Disable_Status AHB2 Peripheral Clock Sleep Enabled or
 * Disabled Status
...
#define __HAL_RCC_GPIOA_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->AHB2SMENR, RCC_AHB2SMENR_GPIOASMEN) != RESET)
#define __HAL_RCC_GPIOB_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->AHB2SMENR, RCC_AHB2SMENR_GPIOBSMEN) != RESET)
#define __HAL_RCC_GPIOC_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->AHB2SMENR, RCC_AHB2SMENR_GPIOCSMEN) != RESET)
#if defined(GPIOD)
#    define __HAL_RCC_GPIOD_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->AHB2SMENR, RCC_AHB2SMENR_GPIODSMEN) != RESET)
#endif /* GPIOD */
#define __HAL_RCC_GPIOE_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->AHB2SMENR, RCC_AHB2SMENR_GPIOESMEN) != RESET)
#define __HAL_RCC_GPIOH_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->AHB2SMENR, RCC_AHB2SMENR_GPIOHSMEN) != RESET)
#if defined(ADC_SUPPORT_5_MSPS)
#    define __HAL_RCC_ADC_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->AHB2SMENR, RCC_AHB2SMENR_ADCSMEN) != RESET)
#endif /* ADC_SUPPORT_5_MSPS */
#if defined(AES1)
#    define __HAL_RCC_AES1_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->AHB2SMENR, RCC_AHB2SMENR_AES1SMEN) != RESET)
#endif /* AES1 */
...
#endif /* ADC_SUPPORT_5_MSPS */
#if defined(AES1)
#    define __HAL_RCC_AES1_IS_CLK_SLEEP_DISABLED() \
        (READ_BIT(RCC->AHB2SMENR, RCC_AHB2SMENR_AES1SMEN) == RESET)
#endif /* AES1 */

#define __HAL_RCC_C2GPIOA_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2AHB2SMENR, RCC_C2AHB2SMENR_GPIOASMEN) != RESET)
#define __HAL_RCC_C2GPIOB_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2AHB2SMENR, RCC_C2AHB2SMENR_GPIOBSMEN) != RESET)
#define __HAL_RCC_C2GPIOC_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2AHB2SMENR, RCC_C2AHB2SMENR_GPIOCSMEN) != RESET)
#if defined(GPIOD)
#    define __HAL_RCC_C2GPIOD_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->C2AHB2SMENR, RCC_C2AHB2SMENR_GPIODSMEN) != RESET)
#endif /* GPIOD */
#define __HAL_RCC_C2GPIOE_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2AHB2SMENR, RCC_C2AHB2SMENR_GPIOESMEN) != RESET)
#define __HAL_RCC_C2GPIOH_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2AHB2SMENR, RCC_C2AHB2SMENR_GPIOHSMEN) != RESET)
#if defined(ADC_SUPPORT_5_MSPS)
#    define __HAL_RCC_C2ADC_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->C2AHB2SMENR, RCC_C2AHB2SMENR_ADCSMEN) != RESET)
#endif /* ADC_SUPPORT_5_MSPS */
#if defined(AES1)
#    define __HAL_RCC_C2AES1_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->C2AHB2SMENR, RCC_C2AHB2SMENR_AES1SMEN) != RESET)
#endif /* AES1 */

#define __HAL_RCC_C2GPIOA_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2AHB2SMENR, RCC_C2AHB2SMENR_GPIOASMEN) == RESET)
#define __HAL_RCC_C2GPIOB_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2AHB2SMENR, RCC_C2AHB2SMENR_GPIOBSMEN) == RESET)
#define __HAL_RCC_C2GPIOC_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2AHB2SMENR, RCC_C2AHB2SMENR_GPIOCSMEN) == RESET)
#if defined(GPIOD)
#    define __HAL_RCC_C2GPIOD_IS_CLK_SLEEP_DISABLED() \
        (READ_BIT(RCC->C2AHB2SMENR, RCC_C2AHB2SMENR_GPIODSMEN) == RESET)
#endif /* GPIOD */
#define __HAL_RCC_C2GPIOE_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2AHB2SMENR, RCC_C2AHB2SMENR_GPIOESMEN) == RESET)
#define __HAL_RCC_C2GPIOH_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2AHB2SMENR, RCC_C2AHB2SMENR_GPIOHSMEN) == RESET)
#if defined(ADC_SUPPORT_5_MSPS)
#    define __HAL_RCC_C2ADC_IS_CLK_SLEEP_DISABLED() \
        (READ_BIT(RCC->C2AHB2SMENR, RCC_C2AHB2SMENR_ADCSMEN) == RESET)
#endif /* ADC_SUPPORT_5_MSPS */
#if defined(AES1)
#    define __HAL_RCC_C2AES1_IS_CLK_SLEEP_DISABLED() \
        (READ_BIT(RCC->C2AHB2SMENR, RCC_C2AHB2SMENR_AES1SMEN) == RESET)
#endif /* AES1 */
...
/** @defgroup RCC_AHB3_Clock_Sleep_Enable_Disable_Status AHB3 Peripheral Clock Sleep Enabled or
 * Disabled Status
 ...
 */
#if defined(QUADSPI)
#    define __HAL_RCC_QUADSPI_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->AHB3SMENR, RCC_AHB3SMENR_QUADSPISMEN) != RESET)
#endif /* QUADSPI */
#define __HAL_RCC_PKA_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->AHB3SMENR, RCC_AHB3SMENR_PKASMEN) != RESET)
#define __HAL_RCC_AES2_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->AHB3SMENR, RCC_AHB3SMENR_AES2SMEN) != RESET)
#define __HAL_RCC_RNG_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->AHB3SMENR, RCC_AHB3SMENR_RNGSMEN) != RESET)
#define __HAL_RCC_SRAM2_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->AHB3SMENR, RCC_AHB3SMENR_SRAM2SMEN) != RESET)
#define __HAL_RCC_FLASH_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->AHB3SMENR, RCC_AHB3SMENR_FLASHSMEN) != RESET)

#if defined(QUADSPI)
#    define __HAL_RCC_QUADSPI_IS_CLK_SLEEP_DISABLED() \
        (READ_BIT(RCC->AHB3SMENR, RCC_AHB3SMENR_QUADSPISMEN) == RESET)
#endif /* QUADSPI */
#define __HAL_RCC_PKA_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->AHB3SMENR, RCC_AHB3SMENR_PKASMEN) == RESET)
#define __HAL_RCC_AES2_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->AHB3SMENR, RCC_AHB3SMENR_AES2SMEN) == RESET)
...
#define __HAL_RCC_C2PKA_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2AHB3SMENR, RCC_C2AHB3SMENR_PKASMEN) != RESET)
#define __HAL_RCC_C2AES2_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2AHB3SMENR, RCC_C2AHB3SMENR_AES2SMEN) != RESET)
#define __HAL_RCC_C2RNG_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2AHB3SMENR, RCC_C2AHB3SMENR_RNGSMEN) != RESET)
#define __HAL_RCC_C2SRAM2_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2AHB3SMENR, RCC_C2AHB3SMENR_SRAM2SMEN) != RESET)
#define __HAL_RCC_C2FLASH_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2AHB3SMENR, RCC_C2AHB3SMENR_FLASHSMEN) != RESET)

#define __HAL_RCC_C2PKA_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2AHB3SMENR, RCC_C2AHB3SMENR_PKASMEN) == RESET)
#define __HAL_RCC_C2AES2_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2AHB3SMENR, RCC_C2AHB3SMENR_AES2SMEN) == RESET)
#define __HAL_RCC_C2RNG_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2AHB3SMENR, RCC_C2AHB3SMENR_RNGSMEN) == RESET)
#define __HAL_RCC_C2SRAM2_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2AHB3SMENR, RCC_C2AHB3SMENR_SRAM2SMEN) == RESET)
#define __HAL_RCC_C2FLASH_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2AHB3SMENR, RCC_C2AHB3SMENR_FLASHSMEN) == RESET)
...
/** @defgroup RCC_APB1_Clock_Sleep_Enable_Disable_Status APB1 Peripheral Clock Sleep Enabled or
 * Disabled Status
...
#define __HAL_RCC_TIM2_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->APB1SMENR1, RCC_APB1SMENR1_TIM2SMEN) != RESET)
#if defined(LCD)
#    define __HAL_RCC_LCD_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->APB1SMENR1, RCC_APB1SMENR1_LCDSMEN) != RESET)
#endif /* LCD */
#define __HAL_RCC_RTCAPB_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->APB1SMENR1, RCC_APB1SMENR1_RTCAPBSMEN) != RESET)
#define __HAL_RCC_WWDG_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->APB1SMENR1, RCC_APB1SMENR1_WWDGSMEN) != RESET)
#if defined(SPI2)
...
#define __HAL_RCC_I2C1_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->APB1SMENR1, RCC_APB1SMENR1_I2C1SMEN) != RESET)
#if defined(I2C3)
#    define __HAL_RCC_I2C3_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->APB1SMENR1, RCC_APB1SMENR1_I2C3SMEN) != RESET)
#endif /* I2C3 */
#if defined(CRS)
#    define __HAL_RCC_CRS_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->APB1SMENR1, RCC_APB1SMENR1_CRSSMEN) != RESET)
#endif /* CRS */
#if defined(USB)
#    define __HAL_RCC_USB_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->APB1SMENR1, RCC_APB1SMENR1_USBSMEN) != RESET)
#endif /* USB */
#define __HAL_RCC_LPTIM1_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->APB1SMENR1, RCC_APB1SMENR1_LPTIM1SMEN) != RESET)
#if defined(LPUART1)
#    define __HAL_RCC_LPUART1_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->APB1SMENR2, RCC_APB1SMENR2_LPUART1SMEN) != RESET)
#endif /* LPUART1 */
#define __HAL_RCC_LPTIM2_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->APB1SMENR2, RCC_APB1SMENR2_LPTIM2SMEN) != RESET)
...
#define __HAL_RCC_C2TIM2_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2APB1SMENR1, RCC_C2APB1SMENR1_TIM2SMEN) != RESET)
#if defined(LCD)
#    define __HAL_RCC_C2LCD_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->C2APB1SMENR1, RCC_C2APB1SMENR1_LCDSMEN) != RESET)
#endif /* LCD */
#define __HAL_RCC_C2RTCAPB_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2APB1SMENR1, RCC_C2APB1SMENR1_RTCAPBSMEN) != RESET)
#if defined(SPI2)
#    define __HAL_RCC_C2SPI2_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->C2APB1SMENR1, RCC_C2APB1SMENR1_SPI2SMEN) != RESET)
#endif /* SPI2 */
#define __HAL_RCC_C2I2C1_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2APB1SMENR1, RCC_C2APB1SMENR1_I2C1SMEN) != RESET)
#if defined(I2C3)
#    define __HAL_RCC_C2I2C3_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->C2APB1SMENR1, RCC_C2APB1SMENR1_I2C3SMEN) != RESET)
#endif /* I2C3 */
#if defined(CRS)
#    define __HAL_RCC_C2CRS_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->C2APB1SMENR1, RCC_C2APB1SMENR1_CRSSMEN) != RESET)
#endif /* CRS */
#if defined(USB)
#    define __HAL_RCC_C2USB_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->C2APB1SMENR1, RCC_C2APB1SMENR1_USBSMEN) != RESET)
#endif /* USB */
#define __HAL_RCC_C2LPTIM1_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2APB1SMENR1, RCC_C2APB1SMENR1_LPTIM1SMEN) != RESET)
#if defined(LPUART1)
#    define __HAL_RCC_C2LPUART1_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->C2APB1SMENR2, RCC_C2APB1SMENR2_LPUART1SMEN) != RESET)
#endif /* LPUART1 */
#define __HAL_RCC_C2LPTIM2_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2APB1SMENR2, RCC_C2APB1SMENR2_LPTIM2SMEN) != RESET)

#define __HAL_RCC_C2TIM2_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2APB1SMENR1, RCC_C2APB1SMENR1_TIM2SMEN) == RESET)
#if defined(LCD)
#    define __HAL_RCC_C2LCD_IS_CLK_SLEEP_DISABLED() \
        (READ_BIT(RCC->C2APB1SMENR1, RCC_C2APB1SMENR1_LCDSMEN) == RESET)
#endif /* LCD */
#define __HAL_RCC_C2RTCAPB_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2APB1SMENR1, RCC_C2APB1SMENR1_RTCAPBSMEN) == RESET)
#if defined(SPI2)
#    define __HAL_RCC_C2SPI2_IS_CLK_SLEEP_DISABLED() \
        (READ_BIT(RCC->C2APB1SMENR1, RCC_C2APB1SMENR1_SPI2SMEN) == RESET)
#endif /* SPI2 */
#define __HAL_RCC_C2I2C1_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2APB1SMENR1, RCC_C2APB1SMENR1_I2C1SMEN) == RESET)
#if defined(I2C3)
#    define __HAL_RCC_C2I2C3_IS_CLK_SLEEP_DISABLED() \
        (READ_BIT(RCC->C2APB1SMENR1, RCC_C2APB1SMENR1_I2C3SMEN) == RESET)
#endif /* I2C3 */
#if defined(CRS)
#    define __HAL_RCC_C2CRS_IS_CLK_SLEEP_DISABLED() \
        (READ_BIT(RCC->C2APB1SMENR1, RCC_C2APB1SMENR1_CRSSMEN) == RESET)
#endif /* CRS */
#if defined(USB)
#    define __HAL_RCC_C2USB_IS_CLK_SLEEP_DISABLED() \
        (READ_BIT(RCC->C2APB1SMENR1, RCC_C2APB1SMENR1_USBSMEN) == RESET)
#endif /* USB */
#define __HAL_RCC_C2LPTIM1_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2APB1SMENR1, RCC_C2APB1SMENR1_LPTIM1SMEN) == RESET)
#if defined(LPUART1)
#    define __HAL_RCC_C2LPUART1_IS_CLK_SLEEP_DISABLED() \
        (READ_BIT(RCC->C2APB1SMENR2, RCC_C2APB1SMENR2_LPUART1SMEN) == RESET)
#endif /* LPUART1 */
#define __HAL_RCC_C2LPTIM2_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2APB1SMENR2, RCC_C2APB1SMENR2_LPTIM2SMEN) == RESET)
...
/** @defgroup RCC_APB2_Clock_Sleep_Enable_Disable_Status APB2 Peripheral Clock Sleep Enabled or
 * Disabled Status
...
#if defined(ADC_SUPPORT_2_5_MSPS)
#    define __HAL_RCC_ADC_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->APB2SMENR, RCC_APB2SMENR_ADCSMEN) != RESET)
#endif /* ADC_SUPPORT_2_5_MSPS */
#define __HAL_RCC_TIM1_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->APB2SMENR, RCC_APB2SMENR_TIM1SMEN) != RESET)
#define __HAL_RCC_SPI1_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->APB2SMENR, RCC_APB2SMENR_SPI1SMEN) != RESET)
#define __HAL_RCC_USART1_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->APB2SMENR, RCC_APB2SMENR_USART1SMEN) != RESET)
#define __HAL_RCC_TIM16_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->APB2SMENR, RCC_APB2SMENR_TIM16SMEN) != RESET)
#define __HAL_RCC_TIM17_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->APB2SMENR, RCC_APB2SMENR_TIM17SMEN) != RESET)
#if defined(SAI1)
#    define __HAL_RCC_SAI1_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->APB2SMENR, RCC_APB2SMENR_SAI1SMEN) != RESET)
#endif /* SAI1 */
...
#if defined(ADC_SUPPORT_2_5_MSPS)
#    define __HAL_RCC_C2ADC_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->C2APB2SMENR, RCC_C2APB2SMENR_ADCSMEN) != RESET)
#endif /* ADC_SUPPORT_2_5_MSPS */
#define __HAL_RCC_C2TIM1_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2APB2SMENR, RCC_C2APB2SMENR_TIM1SMEN) != RESET)
#define __HAL_RCC_C2SPI1_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2APB2SMENR, RCC_C2APB2SMENR_SPI1SMEN) != RESET)
#define __HAL_RCC_C2USART1_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2APB2SMENR, RCC_C2APB2SMENR_USART1SMEN) != RESET)
#define __HAL_RCC_C2TIM16_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2APB2SMENR, RCC_C2APB2SMENR_TIM16SMEN) != RESET)
#define __HAL_RCC_C2TIM17_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2APB2SMENR, RCC_C2APB2SMENR_TIM17SMEN) != RESET)
#if defined(SAI1)
#    define __HAL_RCC_C2SAI1_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->C2APB2SMENR, RCC_C2APB2SMENR_SAI1SMEN) != RESET)
#endif /* SAI1 */
...
#    define __HAL_RCC_C2ADC_IS_CLK_SLEEP_DISABLED() \
        (READ_BIT(RCC->C2APB2SMENR, RCC_C2APB2SMENR_ADCSMEN) == RESET)
#endif /* ADC_SUPPORT_2_5_MSPS */
#define __HAL_RCC_C2TIM1_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2APB2SMENR, RCC_C2APB2SMENR_TIM1SMEN) == RESET)
#define __HAL_RCC_C2SPI1_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2APB2SMENR, RCC_C2APB2SMENR_SPI1SMEN) == RESET)
#define __HAL_RCC_C2USART1_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2APB2SMENR, RCC_C2APB2SMENR_USART1SMEN) == RESET)
#define __HAL_RCC_C2TIM16_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2APB2SMENR, RCC_C2APB2SMENR_TIM16SMEN) == RESET)
#define __HAL_RCC_C2TIM17_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2APB2SMENR, RCC_C2APB2SMENR_TIM17SMEN) == RESET)
#if defined(SAI1)
#    define __HAL_RCC_C2SAI1_IS_CLK_SLEEP_DISABLED() \
        (READ_BIT(RCC->C2APB2SMENR, RCC_C2APB2SMENR_SAI1SMEN) == RESET)
#endif /* SAI1 */
 ...
 * @{
 */
#define __HAL_RCC_C2BLE_CLK_SLEEP_ENABLE() \
    LL_C2_APB3_GRP1_EnableClockSleep(LL_C2_APB3_GRP1_PERIPH_BLE)
#if defined(RCC_802_SUPPORT)
#    define __HAL_RCC_C2802_CLK_SLEEP_ENABLE() \
        LL_C2_APB3_GRP1_EnableClockSleep(LL_C2_APB3_GRP1_PERIPH_802)
#endif /* RCC_802_SUPPORT */

#define __HAL_RCC_C2BLE_CLK_SLEEP_DISABLE() \
    LL_C2_APB3_GRP1_DisableClockSleep(LL_C2_APB3_GRP1_PERIPH_BLE)
#if defined(RCC_802_SUPPORT)
#    define __HAL_RCC_C2802_CLK_SLEEP_DISABLE() \
        LL_C2_APB3_GRP1_DisableClockSleep(LL_C2_APB3_GRP1_PERIPH_802)
#endif /* RCC_802_SUPPORT */
/**
 * @}
 */

/** @defgroup RCC_C2APB3_Clock_Sleep_Enable_Disable_Status APB3 Peripheral Clock Sleep Enabled or
 * Disabled Status
 ...
 * @{
 */
#define __HAL_RCC_C2BLE_IS_CLK_SLEEP_ENABLED() \
    (READ_BIT(RCC->C2APB3SMENR, RCC_C2APB3SMENR_BLESMEN) != RESET)
#if defined(RCC_802_SUPPORT)
#    define __HAL_RCC_C2802_IS_CLK_SLEEP_ENABLED() \
        (READ_BIT(RCC->C2APB3SMENR, RCC_C2APB3SMENR_802SMEN) != RESET)
#endif /* RCC_802_SUPPORT */

#define __HAL_RCC_C2BLE_IS_CLK_SLEEP_DISABLED() \
    (READ_BIT(RCC->C2APB3SMENR, RCC_C2APB3SMENR_BLESMEN) == RESET)
#if defined(RCC_802_SUPPORT)
#    define __HAL_RCC_C2802_IS_CLK_SLEEP_DISABLED() \
        (READ_BIT(RCC->C2APB3SMENR, RCC_C2APB3SMENR_802SMEN) == RESET)
#endif /* RCC_802_SUPPORT */
/**
 * @}
 ...
 * @retval None
 */
#define __HAL_RCC_LSI2_CALIBRATIONVALUE_ADJUST(__LSI2TRIMMINGVALUE__) \
    LL_RCC_LSI2_SetTrimming(__LSI2TRIMMINGVALUE__)
 ...
 * @retval None
 */
#define __HAL_RCC_HSE_CURRENTCONFIG(__HSE_CURRENTMAX__) \
    LL_RCC_HSE_SetCurrentControl(__HSE_CURRENTMAX__)
 ...
 * @retval None
 */
#define __HAL_RCC_HSE_CAPACITORTUNING(__HSE_LOAD_CAPACITANCE__) \
    LL_RCC_HSE_SetCapacitorTuning(__HSE_LOAD_CAPACITANCE__)
...
#define __HAL_RCC_PLL_CONFIG(__PLLSOURCE__, __PLLM__, __PLLN__, __PLLP__, __PLLQ__, __PLLR__) \
    MODIFY_REG(RCC->PLLCFGR,                                                                  \
               ...
               ((uint32_t)(__PLLSOURCE__) | (uint32_t)(__PLLM__) |                            \
                (uint32_t)((__PLLN__) << RCC_PLLCFGR_PLLN_Pos) | (uint32_t)(__PLLP__) |       \
                (uint32_t)(__PLLQ__) | (uint32_t)(__PLLR__)))
 ...
 * @note   Enabling/disabling clock outputs RCC_PLL_SAI1CLK and RCC_PLL_USBCLK can be done at
 * anytime without the need to stop the PLL in order to save power. But RCC_PLL_SYSCLK cannot be
 * stopped if used as System Clock.
 ...
 *            @arg @ref RCC_PLL_USBCLK  This Clock is used to generate the clock for the USB FS (48
 * MHz)
 *            @arg @ref RCC_PLL_RNGCLK  This clock is used to generate the clock for RNG
 *            @arg @ref RCC_PLL_SYSCLK  This Clock is used to generate the high speed system clock
 * (up to 64MHz)
 * @retval None
 */
 ...
 *          This parameter can be one of the following values:
 *            @arg @ref RCC_PLL_SAI1CLK  This clock is used to generate an accurate clock to achieve
...
#define __HAL_RCC_MCO1_CONFIG(__MCOCLKSOURCE__, __MCODIV__) \
    LL_RCC_ConfigMCO((__MCOCLKSOURCE__), (__MCODIV__))
