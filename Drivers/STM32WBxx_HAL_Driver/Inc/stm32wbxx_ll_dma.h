...
#        define __LL_DMA_INSTANCE_TO_CHANNEL(__DMA_INSTANCE__, __CHANNEL_INDEX__) \
            (((__DMA_INSTANCE__) == DMA1) ? (DMA1_Channel1 + (__CHANNEL_INDEX__)) \
...
#        define __LL_DMA_INSTANCE_TO_DMAMUX_CCR(__DMA_INSTANCE__, __CHANNEL_INDEX__) \
            (((__DMA_INSTANCE__) == DMA1) ? (DMAMUX1_Channel0 + (__CHANNEL_INDEX__)) \
                                          : (DMAMUX1_Channel7 + (__CHANNEL_INDEX__)))
#    else
#        define __LL_DMA_INSTANCE_TO_DMAMUX_CCR(__DMA_INSTANCE__, __CHANNEL_INDEX__) \
...
typedef struct {
    uint32_t PeriphOrM2MSrcAddress; /*!< Specifies the peripheral base address for DMA transfer
                                         or as Source base address in case of memory to memory
                                       transfer direction.
    ...
    uint32_t MemoryOrM2MDstAddress; /*!< Specifies the memory base address for DMA transfer
                                         or as Destination base address in case of memory to memory
                                       transfer direction.
    ...
    uint32_t
        PeriphOrM2MSrcIncMode; /*!< Specifies whether the Peripheral address or Source address in
                                  case of memory to memory transfer direction is incremented or not.
    ...
    uint32_t
        MemoryOrM2MDstIncMode; /*!< Specifies whether the Memory address or Destination address in
                                  case of memory to memory transfer direction is incremented or not.
    ...
    uint32_t PeriphOrM2MSrcDataSize; /*!< Specifies the Peripheral data size alignment or Source
                                        data size alignment (byte, half word, word) in case of
                                        memory to memory transfer direction. This parameter can be a
                                        value of @ref DMA_LL_EC_PDATAALIGN

                                          This feature can be modified afterwards using unitary
                                        function @ref LL_DMA_SetPeriphSize(). */

    uint32_t MemoryOrM2MDstDataSize; /*!< Specifies the Memory data size alignment or Destination
                                        data size alignment (byte, half word, word) in case of
                                        memory to memory transfer direction. This parameter can be a
                                        value of @ref DMA_LL_EC_MDATAALIGN

                                          This feature can be modified afterwards using unitary
                                        function @ref LL_DMA_SetMemorySize(). */
...
__STATIC_INLINE uint32_t LL_DMA_IsEnabledChannel(DMA_TypeDef* DMAx, uint32_t Channel) {
    return ((READ_BIT(__LL_DMA_INSTANCE_TO_CHANNEL(DMAx, Channel - 1U)->CCR, DMA_CCR_EN) ==
             (DMA_CCR_EN))
                ? 1UL
                : 0UL);
}
 ...
 *         @arg @ref LL_DMA_PRIORITY_LOW or @ref LL_DMA_PRIORITY_MEDIUM or @ref LL_DMA_PRIORITY_HIGH
 * or @ref LL_DMA_PRIORITY_VERYHIGH
 * @retval None
 */
__STATIC_INLINE void LL_DMA_ConfigTransfer(DMA_TypeDef* DMAx, uint32_t Channel,
    ...
    MODIFY_REG(__LL_DMA_INSTANCE_TO_CHANNEL(DMAx, Channel - 1U)->CCR,
               DMA_CCR_DIR | DMA_CCR_MEM2MEM | DMA_CCR_CIRC | DMA_CCR_PINC | DMA_CCR_MINC |
...
__STATIC_INLINE void LL_DMA_SetDataTransferDirection(DMA_TypeDef* DMAx, uint32_t Channel,
                                                     uint32_t Direction) {
    MODIFY_REG(__LL_DMA_INSTANCE_TO_CHANNEL(DMAx, Channel - 1U)->CCR, DMA_CCR_DIR | DMA_CCR_MEM2MEM,
               Direction);
}
...
__STATIC_INLINE void LL_DMA_SetMode(DMA_TypeDef* DMAx, uint32_t Channel, uint32_t Mode) {
    MODIFY_REG(__LL_DMA_INSTANCE_TO_CHANNEL(DMAx, Channel - 1U)->CCR, DMA_CCR_CIRC, Mode);
}
...
__STATIC_INLINE uint32_t LL_DMA_GetMode(DMA_TypeDef* DMAx, uint32_t Channel) {
    return (READ_BIT(__LL_DMA_INSTANCE_TO_CHANNEL(DMAx, Channel - 1U)->CCR, DMA_CCR_CIRC));
}
...
__STATIC_INLINE uint32_t LL_DMA_GetPeriphIncMode(DMA_TypeDef* DMAx, uint32_t Channel) {
    return (READ_BIT(__LL_DMA_INSTANCE_TO_CHANNEL(DMAx, Channel - 1U)->CCR, DMA_CCR_PINC));
}
...
__STATIC_INLINE uint32_t LL_DMA_GetMemoryIncMode(DMA_TypeDef* DMAx, uint32_t Channel) {
    return (READ_BIT(__LL_DMA_INSTANCE_TO_CHANNEL(DMAx, Channel - 1U)->CCR, DMA_CCR_MINC));
}
...
__STATIC_INLINE uint32_t LL_DMA_GetPeriphSize(DMA_TypeDef* DMAx, uint32_t Channel) {
    return (READ_BIT(__LL_DMA_INSTANCE_TO_CHANNEL(DMAx, Channel - 1U)->CCR, DMA_CCR_PSIZE));
}
...
__STATIC_INLINE uint32_t LL_DMA_GetMemorySize(DMA_TypeDef* DMAx, uint32_t Channel) {
    return (READ_BIT(__LL_DMA_INSTANCE_TO_CHANNEL(DMAx, Channel - 1U)->CCR, DMA_CCR_MSIZE));
}
...
__STATIC_INLINE void LL_DMA_SetChannelPriorityLevel(DMA_TypeDef* DMAx, uint32_t Channel,
                                                    uint32_t Priority) {
    MODIFY_REG(__LL_DMA_INSTANCE_TO_CHANNEL(DMAx, Channel - 1U)->CCR, DMA_CCR_PL, Priority);
}
...
__STATIC_INLINE uint32_t LL_DMA_GetChannelPriorityLevel(DMA_TypeDef* DMAx, uint32_t Channel) {
    return (READ_BIT(__LL_DMA_INSTANCE_TO_CHANNEL(DMAx, Channel - 1U)->CCR, DMA_CCR_PL));
}
...
__STATIC_INLINE void LL_DMA_SetDataLength(DMA_TypeDef* DMAx, uint32_t Channel, uint32_t NbData) {
    MODIFY_REG(__LL_DMA_INSTANCE_TO_CHANNEL(DMAx, Channel - 1U)->CNDTR, DMA_CNDTR_NDT, NbData);
}
...
__STATIC_INLINE uint32_t LL_DMA_GetDataLength(DMA_TypeDef* DMAx, uint32_t Channel) {
    return (READ_BIT(__LL_DMA_INSTANCE_TO_CHANNEL(DMAx, Channel - 1U)->CNDTR, DMA_CNDTR_NDT));
}

/**
 * @brief  Configure the Source and Destination addresses.
 * @note   This API must not be called when the DMA channel is enabled.
 * @note   Each peripheral using DMA provides an API to get directly the register address
...
__STATIC_INLINE void LL_DMA_SetPeriphRequest(DMA_TypeDef* DMAx, uint32_t Channel,
                                             uint32_t Request) {
    MODIFY_REG(__LL_DMA_INSTANCE_TO_DMAMUX_CCR(DMAx, Channel - 1U)->CCR, DMAMUX_CxCR_DMAREQ_ID,
               Request);
}
...
__STATIC_INLINE uint32_t LL_DMA_GetPeriphRequest(DMA_TypeDef* DMAx, uint32_t Channel) {
    return (
        READ_BIT(__LL_DMA_INSTANCE_TO_DMAMUX_CCR(DMAx, Channel - 1U)->CCR, DMAMUX_CxCR_DMAREQ_ID));
}
...
__STATIC_INLINE uint32_t LL_DMA_IsEnabledIT_TC(DMA_TypeDef* DMAx, uint32_t Channel) {
    return ((READ_BIT(__LL_DMA_INSTANCE_TO_CHANNEL(DMAx, Channel - 1U)->CCR, DMA_CCR_TCIE) ==
             (DMA_CCR_TCIE))
                ? 1UL
                : 0UL);
}
...
__STATIC_INLINE uint32_t LL_DMA_IsEnabledIT_HT(DMA_TypeDef* DMAx, uint32_t Channel) {
    return ((READ_BIT(__LL_DMA_INSTANCE_TO_CHANNEL(DMAx, Channel - 1U)->CCR, DMA_CCR_HTIE) ==
             (DMA_CCR_HTIE))
                ? 1UL
                : 0UL);
}
...
__STATIC_INLINE uint32_t LL_DMA_IsEnabledIT_TE(DMA_TypeDef* DMAx, uint32_t Channel) {
    return ((READ_BIT(__LL_DMA_INSTANCE_TO_CHANNEL(DMAx, Channel - 1U)->CCR, DMA_CCR_TEIE) ==
             (DMA_CCR_TEIE))
                ? 1UL
                : 0UL);
}
