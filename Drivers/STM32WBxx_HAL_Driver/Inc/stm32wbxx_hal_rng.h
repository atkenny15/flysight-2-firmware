 ...
 */
typedef void (*pRNG_CallbackTypeDef)(
    RNG_HandleTypeDef* hrng); /*!< pointer to a common RNG callback function */
typedef void (*pRNG_ReadyDataCallbackTypeDef)(
    RNG_HandleTypeDef* hrng,
    uint32_t random32bit); /*!< pointer to an RNG Data Ready specific callback function */
 ...
 * @{
 */
#    define IS_RNG_IT(IT) (((IT) == RNG_IT_CEI) || ((IT) == RNG_IT_SEI))

#    define IS_RNG_FLAG(FLAG) \
        (((FLAG) == RNG_FLAG_DRDY) || ((FLAG) == RNG_FLAG_CECS) || ((FLAG) == RNG_FLAG_SECS))
