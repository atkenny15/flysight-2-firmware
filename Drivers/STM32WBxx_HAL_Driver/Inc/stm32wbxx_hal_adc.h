...
typedef struct {
    ...
    uint32_t
        OversamplingStopReset; /*!< Selects the regular oversampling mode.
                                  ...
                                  injected sequence interruption. If oversampling is enabled on both
                                  regular and injected groups, this parameter is discarded and
                                  forced to setting "ADC_REGOVERSAMPLING_RESUMED_MODE" (the
 ...
 * modify some parameters, these parameters setting is bypassed without error reporting (as it can
 * be the expected behavior in case of intended action to update another parameter (which fulfills
...
typedef struct {
    uint32_t
        ClockPrescaler; /*!< Select ADC clock source (synchronous clock derived from APB clock or
                           ...
                           manual for list of clocks available)) and clock prescaler. This parameter
                           can be a value of @ref ADC_HAL_EC_COMMON_CLOCK_SOURCE. Note: The ADC
                           clock configuration is common to all ADC instances. Note: ADC clock
                           source and prescaler must be selected in function of system clock to not
                           exceed ADC maximum frequency, depending on devices. Example: STM32WB55xx
                           ADC maximum frequency is 64MHz (corresponding to 4.27Msmp/s maximum)
                                   Example: STM32WB50xx ADC maximum frequency is 32MHz
                           (corresponding to 2.13Msmp/s maximum) For ADC maximum frequency, refer to
                           datasheet of the selected device. Note: In case of usage of channels on
                           injected group, ADC frequency should be lower than AHB clock frequency /4
                           for resolution 12 or 10 bits, AHB clock frequency /3 for resolution 8
                           bits, AHB clock frequency /2 for resolution 6 bits. Note: In case of
                           synchronous clock mode based on HCLK/1, the configuration must be enabled
                           only if the system clock has a 50% duty clock cycle (APB prescaler
                           configured inside RCC must be bypassed and PCLK clock must have 50% duty
                           cycle). Refer to reference manual for details. Note: In case of usage of
                           asynchronous clock, the selected clock must be preliminarily enabled at
                           RCC top level. Note: This parameter can be modified only if all ADC
    ...
    uint32_t
        ScanConvMode; /*!< Configure the sequencer of ADC groups regular and injected.
                         ...
                         have main sequence subdivided in successive parts. If disabled: Conversion
                         is performed in single mode (one channel converted, the one defined in rank
                         1). Parameters 'NbrOfConversion' and 'InjectedNbrOfConversion' are
                         discarded (equivalent to set to 1). If enabled:  Conversions are performed
                         in sequence mode (multiple ranks defined by 'NbrOfConversion' or
                         'InjectedNbrOfConversion' and rank of each channel in sequencer). Scan
                         direction is upward: from rank 1 to rank 'n'. This parameter can be a value
    ...
    FunctionalState
        LowPowerAutoWait; /*!< Select the dynamic low power Auto Delay: new conversion start only
                             ...
                             sequence (for ADC group injected) has been retrieved by user software,
                             using function HAL_ADC_GetValue() or HAL_ADCEx_InjectedGetValue().
                             This feature automatically adapts the frequency of ADC conversions
                             triggers to the speed of the system that reads the data. Moreover, this
                             avoids risk of overrun for low frequency applications. This parameter
                             can be set to ENABLE or DISABLE. Note: It is not recommended to use
                             with interruption or DMA (HAL_ADC_Start_IT(), HAL_ADC_Start_DMA())
                             since these modes have to clear immediately the EOC flag (by CPU to
                             free the IRQ pending event or by DMA). Auto wait will work but fort a
                             very short time, discarding its intended benefit (except specific case
                             of high load of CPU or DMA transfers which can justify usage of auto
...
#if defined(ADC_SUPPORT_2_5_MSPS)
    FunctionalState
        LowPowerAutoPowerOff; /*!< Select the auto-off mode: the ADC automatically powers-off after
                             a conversion and automatically wakes-up when a new conversion is
                             triggered (with startup time between trigger and start of sampling).
                             This feature can be combined with automatic wait mode (parameter
                             'LowPowerAutoWait'). This parameter can be set to ENABLE or DISABLE.
                             Note: If enabled, this feature also turns off the ADC dedicated 14 MHz
                             RC oscillator (HSI14) */
    ...
    uint32_t
        NbrOfConversion; /*!< Specify the number of ranks that will be converted within the regular
                            group sequencer. To use the regular group sequencer and convert several
                            ranks, parameter 'ScanConvMode' must be enabled. This parameter must be
                            a number between Min_Data = 1 and Max_Data = 16. Note: This parameter
                            must be modified when no conversion is on going on regular group (ADC
                            disabled, or ADC enabled without continuous mode or external trigger
                            that could launch a conversion). */

    FunctionalState
        DiscontinuousConvMode; /*!< Specify whether the conversions sequence of ADC group regular is
                             performed in Complete-sequence/Discontinuous-sequence (main sequence
                             ...
                             disabled, this parameter is discarded. Discontinuous mode can be
                             enabled only if continuous mode is disabled. If continuous mode is
                             enabled, this parameter setting is discarded. This parameter can be set
                             to ENABLE or DISABLE. */

#if defined(ADC_SUPPORT_2_5_MSPS)
/* Feature "ADC group regular number of discontinuous conversions" not available on ADC peripheral
 * of this STM32WB device */
#else
    uint32_t
        NbrOfDiscConversion; /*!< Specifies the number of discontinuous conversions in which the
                                main sequence of ADC group regular (parameter NbrOfConversion) will
                                be subdivided. If parameter 'DiscontinuousConvMode' is disabled,
                                this parameter is discarded. This parameter must be a number between
    ...
    uint32_t
        ExternalTrigConv; /*!< Select the external event source used to trigger ADC group regular
                             ...
                             disabled and software trigger is used instead. This parameter can be a
                             value of @ref ADC_regular_external_trigger_source. Caution: external
                             trigger source is common to all ADC instances. */

    uint32_t
        ExternalTrigConvEdge; /*!< Select the external event edge used to trigger ADC group regular
                                 conversion start. If trigger source is set to ADC_SOFTWARE_START,
                                 this parameter is discarded. This parameter can be a value of @ref
                                 ADC_regular_external_trigger_edge */

    FunctionalState DMAContinuousRequests; /*!< Specify whether the DMA requests are performed in
                                         one shot mode (DMA transfer stops when number of
                                         conversions is reached) or in continuous mode (DMA transfer
                                         unlimited, whatever number of conversions). This parameter
                                         can be set to ENABLE or DISABLE. Note: In continuous mode,
                                         DMA must be configured in circular mode. Otherwise an
                                         overrun will be triggered when DMA buffer maximum pointer
                                         is reached. */

    uint32_t
        Overrun; /*!< Select the behavior in case of overrun: data overwritten or preserved
                    (default). This parameter applies to ADC group regular only. This parameter can
                    be a value of @ref ADC_HAL_EC_REG_OVR_DATA_BEHAVIOR. Note: In case of overrun
                    set to data preserved and usage with programming model with interruption
                    (HAL_Start_IT()): ADC IRQ handler has to clear end of conversion flags, this
                    induces the release of the preserved data. If needed, this data can be saved in
                    function HAL_ADC_ConvCpltCallback(), placed in user program code (called before
                    end of conversion flags clear). Note: Error reporting with respect to the
                    conversion mode:
                            - Usage with ADC conversion by polling for event or interruption: Error
                    is reported only if overrun is set to data preserved. If overrun is set to data
                              overwritten, user can willingly not read all the converted data, this
...
#if defined(ADC_SUPPORT_2_5_MSPS)
    uint32_t
        SamplingTimeCommon1; /*!< Set sampling time common to a group of channels.
                                  Unit: ADC clock cycles
                                  Conversion time is the addition of sampling time and processing
                                time (12.5 ADC clock cycles at ADC resolution 12 bits, 10.5 cycles
                                at 10 bits, 8.5 cycles at 8 bits, 6.5 cycles at 6 bits). Note: On
                                this STM32 family, two different sampling time settings are
                                available, each channel can use one of these two settings. On some
                                other STM32 devices, this parameter in channel wise and is located
                                into ADC channel initialization structure. This parameter can be a
                                value of @ref ADC_HAL_EC_CHANNEL_SAMPLINGTIME_INST_SCOPE Note: In
                                case of usage of internal measurement channels
                                ...
                                frequency and sampling time setting) Refer to device datasheet for
                                timings values, parameters TS_vrefint, TS_vbat, TS_temp (values
                                rough order: few tens of microseconds). */

    uint32_t
        SamplingTimeCommon2; /*!< Set sampling time common to a group of channels, second common
                                setting possible. Unit: ADC clock cycles Conversion time is the
                                addition of sampling time and processing time (12.5 ADC clock cycles
                                at ADC resolution 12 bits, 10.5 cycles at 10 bits, 8.5 cycles at 8
                                bits, 6.5 cycles at 6 bits). Note: On this STM32 family, two
                                different sampling time settings are available, each channel can use
                                one of these two settings. On some other STM32 devices, this
                                parameter in channel wise and is located into ADC channel
                                initialization structure. This parameter can be a value of @ref
                                ADC_HAL_EC_CHANNEL_SAMPLINGTIME_INST_SCOPE Note: In case of usage of
                                internal measurement channels (VrefInt/Vbat/TempSensor), sampling
                                time constraints must be respected (sampling time can be adjusted in
                                function of ADC clock frequency and sampling time setting) Refer to
                                device datasheet for timings values, parameters TS_vrefint, TS_vbat,
                                TS_temp (values rough order: few tens of microseconds). */
#endif                       /* ADC_SUPPORT_2_5_MSPS */

#if !defined(ADC_SUPPORT_2_5_MSPS)
    FunctionalState OversamplingMode; /*!< Specify whether the oversampling feature is enabled or
    ...
    uint32_t
        TriggerFrequencyMode; /*!< Set ADC trigger frequency mode.
                                 ...
                                 ADC_HAL_EC_REG_TRIGGER_FREQ. Note: ADC trigger frequency mode must
                                 be set to low frequency when a duration is exceeded before ADC
                                 conversion start trigger event (between ADC enable and ADC
                                 conversion start trigger event or between two ADC conversion start
                                 trigger event). Duration value: Refer to device datasheet,
                                 parameter "tIdle". Note: When ADC trigger frequency mode is set to
                                 low frequency, some rearm cycles are inserted before performing ADC
                                 conversion start, inducing a delay of 2 ADC clock cycles. */
#endif                        /* ADC_SUPPORT_2_5_MSPS */
 ...
 * @note   The setting of these parameters by function HAL_ADC_ConfigChannel() is conditioned to ADC
...
typedef struct {
    ...
    uint32_t
        SamplingTime; /*!< Sampling time value to be set for the selected channel.
                         ...
                         bits, 8.5 cycles at 8 bits, 6.5 cycles at 6 bits). This parameter can be a
                         value of @ref ADC_HAL_EC_CHANNEL_SAMPLINGTIME Caution: This parameter
    ...
    uint32_t
        SingleDiff; /*!< Select single-ended or differential input.
                       ...
                       selected channel 'i' (positive input) and channel 'i+1' (negative input).
                                               Only channel 'i' has to be configured, channel 'i+1'
                       is configured automatically. This parameter must be a value of @ref
    ...
    uint32_t
        Offset; /*!< Define the offset to be subtracted from the raw converted data.
                     ...
                     Depending of ADC resolution selected (12, 10, 8 or 6 bits), this parameter must
                   be a number between Min_Data = 0x000 and Max_Data = 0xFFF, 0x3FF, 0xFF or 0x3F
                   respectively. Note: This parameter must be modified when no conversion is on
                   going on both regular and injected groups (ADC disabled, or ADC enabled without
 ...
 * @note   The setting of these parameters by function HAL_ADC_AnalogWDGConfig() is conditioned to
 ...
 */
typedef struct {
    uint32_t WatchdogNumber; /*!< Select which ADC analog watchdog is monitoring the selected
                                channel. For Analog Watchdog 1: Only 1 channel can be monitored (or
                                overall group of channels by setting parameter 'WatchdogMode') For
                                Analog Watchdog 2 and 3: Several channels can be monitored (by
                                successive calls of 'HAL_ADC_AnalogWDGConfig()' for each channel).
                                Note: Analog Watchdog 2 and 3 are not available on devices:
                                STM32WB10xx, STM32WB15xx, , STM32WB1Mxx. This parameter can be a
                                value of @ref ADC_HAL_EC_AWD_NUMBER. */

    uint32_t
        WatchdogMode; /*!< Configure the ADC analog watchdog mode: single/all/none channels.
                           For Analog Watchdog 1: Configure the ADC analog watchdog mode: single
                         channel or all channels, ADC groups regular and-or injected. For Analog
                         Watchdog 2 and 3: Several channels can be monitored by applying
                         successively the AWD init structure. Channels on ADC group regular and
                         injected are not differentiated: Set value 'ADC_ANALOGWATCHDOG_SINGLE_xxx'
                         to monitor 1 channel, value 'ADC_ANALOGWATCHDOG_ALL_xxx' to monitor all
                         channels, 'ADC_ANALOGWATCHDOG_NONE' to monitor no channel. This parameter
    ...
    uint32_t
        Channel; /*!< Select which ADC channel to monitor by analog watchdog.
                    ...
                    each channel to be added (or removed with value 'ADC_ANALOGWATCHDOG_NONE'). This
                    parameter can be a value of @ref ADC_HAL_EC_CHANNEL. */

    FunctionalState ITMode; /*!< Specify whether the analog watchdog is configured in interrupt or
                               polling mode. This parameter can be set to ENABLE or DISABLE */

    uint32_t
        HighThreshold; /*!< Configure the ADC analog watchdog High threshold value.
                          ...
                          the comparison of analog watchdog thresholds is done on oversampling final
                          computation (after ratio and shift application): ADC data register
    ...
    uint32_t
        LowThreshold; /*!< Configures the ADC analog watchdog Low threshold value.
                           Depending of ADC resolution selected (12, 10, 8 or 6 bits), this
                         parameter must be a number between Min_Data = 0x000 and Max_Data = 0xFFF,
                         0x3FF, 0xFF or 0x3F respectively. Note: Analog watchdog 2 and 3 are limited
                         to a resolution of 8 bits: if ADC resolution is 12 bits the 4 LSB are
                         ignored, if ADC resolution is 10 bits the 2 LSB are ignored. Note: If ADC
                         oversampling is enabled, ADC analog watchdog thresholds are impacted: the
                         comparison of analog watchdog thresholds is done on oversampling final
                         computation (after ratio and shift application): ADC data register bitfield
...
#define HAL_ADC_STATE_REG_BUSY                                                               \
    (0x00000100UL) /*!< A conversion on ADC group regular is ongoing or can occur (either by \
                      continuous mode, external trigger, low power auto power-on (if feature                                       \
                      available), multimode ADC master control (if feature available)) */
#define HAL_ADC_STATE_REG_EOC (0x00000200UL) /*!< Conversion data available on group regular */
#define HAL_ADC_STATE_REG_OVR (0x00000400UL) /*!< Overrun occurrence */
#define HAL_ADC_STATE_REG_EOSMP \
    (0x00000800UL) /*!< Not available on this STM32 series: End Of Sampling flag raised  */

/* States of ADC group injected */
#define HAL_ADC_STATE_INJ_BUSY                                                                \
    (0x00001000UL) /*!< A conversion on ADC group injected is ongoing or can occur (either by \
                      auto-injection mode, external trigger, low power auto power-on (if feature                                        \
                      available), multimode ADC master control (if feature available)) */
...
#define HAL_ADC_STATE_MULTIMODE_SLAVE                                                     \
    (0x00100000UL) /*!< Not available on this STM32 series: ADC in multimode slave state, \
                      controlled by another ADC master (when feature available) */
...
#define ADC_CLOCK_SYNC_PCLK_DIV1                                                            \
    (LL_ADC_CLOCK_SYNC_PCLK_DIV1) /*!< ADC synchronous clock derived from AHB clock without \
                                     prescaler */
#define ADC_CLOCK_SYNC_PCLK_DIV2                                                                   \
    (LL_ADC_CLOCK_SYNC_PCLK_DIV2) /*!< ADC synchronous clock derived from AHB clock with prescaler \
                                     division by 2 */
#define ADC_CLOCK_SYNC_PCLK_DIV4                                                                   \
    (LL_ADC_CLOCK_SYNC_PCLK_DIV4) /*!< ADC synchronous clock derived from AHB clock with prescaler \
                                     division by 4 */
...
#define ADC_DATAALIGN_RIGHT                                                                        \
    (LL_ADC_DATA_ALIGN_RIGHT) /*!< ADC conversion data alignment: right aligned (alignment on data \
                                 register LSB bit 0)*/
#define ADC_DATAALIGN_LEFT                                                                       \
    (LL_ADC_DATA_ALIGN_LEFT) /*!< ADC conversion data alignment: left aligned (alignment on data \
                                register MSB bit 15)*/
/**
 * @}
 */
...
#    define ADC_SCAN_DISABLE                                                                    \
        (0x00000000UL) /*!< Sequencer set to fully configurable: only the rank 1 is enabled (no \
                          scan sequence on several ranks) */
#    define ADC_SCAN_ENABLE                                                                       \
        (ADC_CFGR1_CHSELRMOD) /*!< Sequencer set to fully configurable: sequencer length and each \
                                 rank affectation to a channel are configurable. */

#    define ADC_SCAN_SEQ_FIXED                                                                     \
        (ADC_SCAN_SEQ_FIXED_INT) /*!< Sequencer set to not fully configurable: sequencer length    \
                                    and each rank affectation to a channel are fixed by channel HW \
...
#    define ADC_SCAN_SEQ_FIXED_BACKWARD                                                          \
        (ADC_SCAN_SEQ_FIXED_INT |                                                                \
         ADC_CFGR1_SCANDIR) /*!< Sequencer set to not fully configurable: sequencer length and   \
                               each rank affectation to a channel are fixed by channel HW number \
                               (channel 0 fixed on rank 0, channel 1 fixed on rank1, ...). Scan  \
                               direction backward: from channel 18 to channel 0 */

#    define ADC_SCAN_DIRECTION_FORWARD \
        (ADC_SCAN_SEQ_FIXED) /* For compatibility with other STM32 devices */
#    define ADC_SCAN_DIRECTION_BACKWARD \
        (ADC_SCAN_SEQ_FIXED_BACKWARD) /* For compatibility with other STM32 devices */
...
#    define ADC_EXTERNALTRIG_T1_TRGO2                                                              \
        (LL_ADC_REG_TRIG_EXT_TIM1_TRGO2) /*!< ADC group regular conversion trigger from external   \
                                            peripheral: TIM1 TRGO. Trigger edge set to rising edge \
                                            (default setting). */
#    define ADC_EXTERNALTRIG_T1_CC4                                                                \
        (LL_ADC_REG_TRIG_EXT_TIM1_CH4) /*!< ADC group regular conversion trigger from external     \
...
#    define ADC_EXTERNALTRIG_T2_TRGO                                                              \
        (LL_ADC_REG_TRIG_EXT_TIM2_TRGO) /*!< ADC group regular conversion trigger from external   \
                                           peripheral: TIM2 TRGO. Trigger edge set to rising edge \
                                           (default setting). */
#    define ADC_EXTERNALTRIG_T2_CC4                                                                \
        (LL_ADC_REG_TRIG_EXT_TIM2_CH4) /*!< ADC group regular conversion trigger from external     \
                                          peripheral: TIM2 channel 4 event (capture compare: input \
                                          capture or output capture). Trigger edge set to rising   \
                                          edge (default setting). */
#    define ADC_EXTERNALTRIG_T2_CC3                                                                \
        (LL_ADC_REG_TRIG_EXT_TIM2_CH3) /*!< ADC group regular conversion trigger from external     \
                                          peripheral: TIM2 channel 3 event (capture compare: input \
                                          capture or output capture). Trigger edge set to rising   \
                                          edge (default setting). */
#    define ADC_EXTERNALTRIG_EXT_IT11                                                             \
        (LL_ADC_REG_TRIG_EXT_EXTI_LINE11) /*!< ADC group regular conversion trigger from external \
                                             peripheral: external interrupt line 11. Trigger edge \
                                             set to rising edge (default setting). */
#else
#    define ADC_EXTERNALTRIG_T1_TRGO                                                              \
        (LL_ADC_REG_TRIG_EXT_TIM1_TRGO) /*!< ADC group regular conversion trigger from external   \
                                           peripheral: TIM1 TRGO. Trigger edge set to rising edge \
                                           (default setting). */
#    define ADC_EXTERNALTRIG_T1_TRGO2                                                            \
        (LL_ADC_REG_TRIG_EXT_TIM1_TRGO2) /*!< ADC group regular conversion trigger from external \
                                            peripheral: TIM1 TRGO2. Trigger edge set to rising   \
                                            edge (default setting). */
#    define ADC_EXTERNALTRIG_T1_CC1                                                                \
        (LL_ADC_REG_TRIG_EXT_TIM1_CH1) /*!< ADC group regular conversion trigger from external     \
                                          peripheral: TIM1 channel 1 event (capture compare: input \
                                          capture or output capture). Trigger edge set to rising   \
                                          edge (default setting). */
#    define ADC_EXTERNALTRIG_T1_CC2                                                                \
        (LL_ADC_REG_TRIG_EXT_TIM1_CH2) /*!< ADC group regular conversion trigger from external     \
                                          peripheral: TIM1 channel 2 event (capture compare: input \
                                          capture or output capture). Trigger edge set to rising   \
                                          edge (default setting). */
#    define ADC_EXTERNALTRIG_T1_CC3                                                                \
        (LL_ADC_REG_TRIG_EXT_TIM1_CH3) /*!< ADC group regular conversion trigger from external     \
...
#    define ADC_EXTERNALTRIG_T2_CC2                                                                \
        (LL_ADC_REG_TRIG_EXT_TIM2_CH2) /*!< ADC group regular conversion trigger from external     \
...
/** @defgroup ADC_regular_external_trigger_edge ADC group regular trigger edge (when external
 * trigger is selected)
 * @{
 */
...
#define ADC_EXTERNALTRIGCONVEDGE_RISING                                                           \
    (LL_ADC_REG_TRIG_EXT_RISING) /*!< ADC group regular conversion trigger polarity set to rising \
                                    edge */
#define ADC_EXTERNALTRIGCONVEDGE_FALLING                                                    \
    (LL_ADC_REG_TRIG_EXT_FALLING) /*!< ADC group regular conversion trigger polarity set to \
                                     falling edge */
#define ADC_EXTERNALTRIGCONVEDGE_RISINGFALLING                                                    \
    (LL_ADC_REG_TRIG_EXT_RISINGFALLING) /*!< ADC group regular conversion trigger polarity set to \
...
/** @defgroup ADC_HAL_EC_REG_OVR_DATA_BEHAVIOR  ADC group regular - Overrun behavior on conversion
 * data
 * @{
 */
#define ADC_OVR_DATA_PRESERVED                                                               \
    (LL_ADC_REG_OVR_DATA_PRESERVED) /*!< ADC group regular behavior in case of overrun: data \
                                       preserved */
#define ADC_OVR_DATA_OVERWRITTEN                                                               \
    (LL_ADC_REG_OVR_DATA_OVERWRITTEN) /*!< ADC group regular behavior in case of overrun: data \
                                         overwritten */
/**
 * @}
 */
...
#    define ADC_RANK_CHANNEL_NUMBER                                                              \
        (0x00000001U) /*!< Setting relevant if parameter "ScanConvMode" is set to sequencer not  \
                         fully configurable: Enable the rank of the selected channels. Number of \
...
#    define ADC_RANK_NONE                                                                       \
        (0x00000002U) /*!< Setting relevant if parameter "ScanConvMode" is set to sequencer not \
                         fully configurable: Disable the selected rank (selected channel) from  \
                         sequencer */
...
#if defined(ADC_SUPPORT_2_5_MSPS)
/** @defgroup ADC_HAL_EC_CHANNEL_SAMPLINGTIME  ADC instance - Sampling time common to a group of
 * channels
 * @{
 */
#    define ADC_SAMPLINGTIME_COMMON_1                                                        \
        (LL_ADC_SAMPLINGTIME_COMMON_1) /*!< Set sampling time common to a group of channels: \
                                          sampling time nb 1 */
#    define ADC_SAMPLINGTIME_COMMON_2                                                        \
        (LL_ADC_SAMPLINGTIME_COMMON_2) /*!< Set sampling time common to a group of channels: \
                                          sampling time nb 2 */
/**
 * @}
 */

/** @defgroup ADC_HAL_EC_CHANNEL_SAMPLINGTIME_INST_SCOPE  Channel - Sampling time (ADC instance
 * scope for sampling time common 1 or 2, not channel wise)
 * @{
 */
...
#    define ADC_SAMPLETIME_3CYCLES_5 \
        (LL_ADC_SAMPLINGTIME_3CYCLES_5) /*!< Sampling time 3.5 ADC clock cycles */
...
#    define ADC_SAMPLETIME_19CYCLES_5 \
        (LL_ADC_SAMPLINGTIME_19CYCLES_5) /*!< Sampling time 19.5 ADC clock cycles */
#    define ADC_SAMPLETIME_39CYCLES_5 \
        (LL_ADC_SAMPLINGTIME_39CYCLES_5) /*!< Sampling time 39.5 ADC clock cycles */
#    define ADC_SAMPLETIME_79CYCLES_5 \
        (LL_ADC_SAMPLINGTIME_79CYCLES_5) /*!< Sampling time 79.5 ADC clock cycles */
#    define ADC_SAMPLETIME_160CYCLES_5 \
        (LL_ADC_SAMPLINGTIME_160CYCLES_5) /*!< Sampling time 160.5 ADC clock cycles */
/**
 * @}
 */
#else
...
#define ADC_CHANNEL_VREFINT                                                                   \
    (LL_ADC_CHANNEL_VREFINT) /*!< ADC internal channel connected to VrefInt: Internal voltage \
                                reference. */
...
#define ADC_CHANNEL_VBAT                                                                        \
    (LL_ADC_CHANNEL_VBAT) /*!< ADC internal channel connected to Vbat/3: Vbat voltage through a \
                             divider ladder of factor 1/3 to have Vbat always below Vdda. */
/**
 * @}
 */
...
#define ADC_ANALOGWATCHDOG_SINGLE_REG \
    (ADC_CFGR_AWD1SGL |               \
     ADC_CFGR_AWD1EN) /*!< Analog watchdog applied to a regular group single channel */
#define ADC_ANALOGWATCHDOG_SINGLE_INJEC \
    (ADC_CFGR_AWD1SGL |                 \
     ADC_CFGR_JAWD1EN) /*!< Analog watchdog applied to an injected group single channel */
#define ADC_ANALOGWATCHDOG_SINGLE_REGINJEC                                                  \
    (ADC_CFGR_AWD1SGL | ADC_CFGR_AWD1EN |                                                   \
     ADC_CFGR_JAWD1EN) /*!< Analog watchdog applied to a regular and injected groups single \
                          channel */
...
#define ADC_ANALOGWATCHDOG_ALL_REGINJEC \
    (ADC_CFGR_AWD1EN |                  \
     ADC_CFGR_JAWD1EN) /*!< Analog watchdog applied to regular and injected groups all channels */
/**
 * @}
 */
...
#    define ADC_OVERSAMPLING_RATIO_2                                                            \
        (LL_ADC_OVS_RATIO_2) /*!< ADC oversampling ratio of 2 (2 ADC conversions are performed, \
...
#    define ADC_OVERSAMPLING_RATIO_4                                                            \
        (LL_ADC_OVS_RATIO_4) /*!< ADC oversampling ratio of 4 (4 ADC conversions are performed, \
                                sum of these conversions data is computed to result as the ADC  \
                                oversampling conversion data (before potential shift) */
#    define ADC_OVERSAMPLING_RATIO_8                                                            \
        (LL_ADC_OVS_RATIO_8) /*!< ADC oversampling ratio of 8 (8 ADC conversions are performed, \
                                sum of these conversions data is computed to result as the ADC  \
                                oversampling conversion data (before potential shift) */
#    define ADC_OVERSAMPLING_RATIO_16                                                              \
        (LL_ADC_OVS_RATIO_16) /*!< ADC oversampling ratio of 16 (16 ADC conversions are performed, \
                                 sum of these conversions data is computed to result as the ADC    \
                                 oversampling conversion data (before potential shift) */
#    define ADC_OVERSAMPLING_RATIO_32                                                              \
        (LL_ADC_OVS_RATIO_32) /*!< ADC oversampling ratio of 32 (32 ADC conversions are performed, \
                                 sum of these conversions data is computed to result as the ADC    \
                                 oversampling conversion data (before potential shift) */
#    define ADC_OVERSAMPLING_RATIO_64                                                              \
        (LL_ADC_OVS_RATIO_64) /*!< ADC oversampling ratio of 64 (64 ADC conversions are performed, \
                                 sum of these conversions data is computed to result as the ADC    \
                                 oversampling conversion data (before potential shift) */
#    define ADC_OVERSAMPLING_RATIO_128                                                             \
        (LL_ADC_OVS_RATIO_128) /*!< ADC oversampling ratio of 128 (128 ADC conversions are         \
                                  performed, sum of these conversions data is computed to result   \
                                  as the ADC oversampling conversion data (before potential shift) \
                                */
#    define ADC_OVERSAMPLING_RATIO_256                                                             \
        (LL_ADC_OVS_RATIO_256) /*!< ADC oversampling ratio of 256 (256 ADC conversions are         \
                                  performed, sum of these conversions data is computed to result   \
                                  as the ADC oversampling conversion data (before potential shift) \
                                */
                         /**
...
#    define ADC_RIGHTBITSHIFT_NONE                                                                 \
        (LL_ADC_OVS_SHIFT_NONE) /*!< ADC oversampling no shift (sum of the ADC conversions data is \
                                   not divided to result as the ADC oversampling conversion data)  \
                                 */
#    define ADC_RIGHTBITSHIFT_1                                                                 \
        (LL_ADC_OVS_SHIFT_RIGHT_1) /*!< ADC oversampling shift of 1 (sum of the ADC conversions \
                                      data is divided by 2 to result as the ADC oversampling    \
                                      conversion data) */
#    define ADC_RIGHTBITSHIFT_2                                                                 \
        (LL_ADC_OVS_SHIFT_RIGHT_2) /*!< ADC oversampling shift of 2 (sum of the ADC conversions \
                                      data is divided by 4 to result as the ADC oversampling    \
                                      conversion data) */
#    define ADC_RIGHTBITSHIFT_3                                                                 \
        (LL_ADC_OVS_SHIFT_RIGHT_3) /*!< ADC oversampling shift of 3 (sum of the ADC conversions \
                                      data is divided by 8 to result as the ADC oversampling    \
                                      conversion data) */
#    define ADC_RIGHTBITSHIFT_4                                                                 \
        (LL_ADC_OVS_SHIFT_RIGHT_4) /*!< ADC oversampling shift of 4 (sum of the ADC conversions \
                                      data is divided by 16 to result as the ADC oversampling   \
                                      conversion data) */
#    define ADC_RIGHTBITSHIFT_5                                                                 \
        (LL_ADC_OVS_SHIFT_RIGHT_5) /*!< ADC oversampling shift of 5 (sum of the ADC conversions \
                                      data is divided by 32 to result as the ADC oversampling   \
                                      conversion data) */
#    define ADC_RIGHTBITSHIFT_6                                                                 \
        (LL_ADC_OVS_SHIFT_RIGHT_6) /*!< ADC oversampling shift of 6 (sum of the ADC conversions \
                                      data is divided by 64 to result as the ADC oversampling   \
                                      conversion data) */
#    define ADC_RIGHTBITSHIFT_7                                                                 \
        (LL_ADC_OVS_SHIFT_RIGHT_7) /*!< ADC oversampling shift of 7 (sum of the ADC conversions \
                                      data is divided by 128 to result as the ADC oversampling  \
                                      conversion data) */
#    define ADC_RIGHTBITSHIFT_8                                                                 \
        (LL_ADC_OVS_SHIFT_RIGHT_8) /*!< ADC oversampling shift of 8 (sum of the ADC conversions \
                                      data is divided by 256 to result as the ADC oversampling  \
                                      conversion data) */
/**
 * @}
 */
...
#define ADC_TRIGGEREDMODE_SINGLE_TRIGGER                                                 \
    (LL_ADC_OVS_REG_CONT) /*!< ADC oversampling discontinuous mode: continuous mode (all \
                             conversions of oversampling ratio are done from 1 trigger) */
#define ADC_TRIGGEREDMODE_MULTI_TRIGGER                                                         \
    (LL_ADC_OVS_REG_DISCONT) /*!< ADC oversampling discontinuous mode: discontinuous mode (each \
...
#    define ADC_TRIGGER_FREQ_HIGH                                                                  \
        (LL_ADC_TRIGGER_FREQ_HIGH) /*!< ADC trigger frequency mode set to high frequency. Note:    \
                                      ADC trigger frequency mode must be set to low frequency when \
                                      a duration is exceeded before ADC conversion start trigger   \
                                      event (between ADC enable and ADC conversion start trigger   \
                                      event or between two ADC conversion start trigger event).    \
                                      Duration value: Refer to device datasheet, parameter         \
                                      "tIdle". */
#    define ADC_TRIGGER_FREQ_LOW                                                                   \
        (LL_ADC_TRIGGER_FREQ_LOW) /*!< ADC trigger frequency mode set to low frequency. Note: ADC  \
                                     trigger frequency mode must be set to low frequency when a    \
                                     duration is exceeded before ADC conversion start trigger      \
                                     event (between ADC enable and ADC conversion start trigger    \
                                     event or between two ADC conversion start trigger event).     \
...
#define ADC_AWD1_EVENT                                                                           \
    (ADC_FLAG_AWD1) /*!< ADC Analog watchdog 1 event (main analog watchdog, present on all STM32 \
                       series) */
#define ADC_AWD2_EVENT                                                                           \
    (ADC_FLAG_AWD2) /*!< ADC Analog watchdog 2 event (additional analog watchdog, not present on \
                       all STM32 series) */
#define ADC_AWD3_EVENT                                                                           \
    (ADC_FLAG_AWD3) /*!< ADC Analog watchdog 3 event (additional analog watchdog, not present on \
                       all STM32 series) */
...
#define ADC_AWD_EVENT                                                                          \
    ADC_AWD1_EVENT /*!< ADC Analog watchdog 1 event: Naming for compatibility with other STM32 \
                      devices having only one analog watchdog */
...
#    define ADC_IT_JEOS \
        ADC_IER_JEOSIE /*!< ADC End of injected sequence of conversions interrupt source */
#    define ADC_IT_JQOVF \
        ADC_IER_JQOVFIE /*!< ADC Injected Context Queue Overflow interrupt source */
#endif                  /* ADC_SUPPORT_2_5_MSPS */
#define ADC_IT_AWD1 \
    ADC_IER_AWD1IE /*!< ADC Analog watchdog 1 interrupt source (main analog watchdog) */
#define ADC_IT_AWD2 \
    ADC_IER_AWD2IE /*!< ADC Analog watchdog 2 interrupt source (additional analog watchdog) */
#define ADC_IT_AWD3 \
    ADC_IER_AWD3IE /*!< ADC Analog watchdog 3 interrupt source (additional analog watchdog) */

#define ADC_IT_AWD                                                                               \
    ADC_IT_AWD1 /*!< ADC Analog watchdog 1 interrupt source: naming for compatibility with other \
                   STM32 devices having only one analog watchdog */
 ...
 * @retval SET (__ADC_VALUE__ in line with __RESOLUTION__) or RESET (__ADC_VALUE__ not in line with
 * __RESOLUTION__)
 */
 ...
 * @retval SET (__LENGTH__ is within the maximum number of possible programmable regular
 * conversions) or RESET (__LENGTH__ is null or too large)
 */
#if defined(ADC_SUPPORT_2_5_MSPS)
 ...
 * @retval SET (NUMBER is within the maximum number of regular conversions in discontinuous mode) or
 * RESET (NUMBER is null or too large)
 */
...
#    define IS_ADC_EXTTRIG(__HANDLE__, __REGTRIG__)      \
        (((__REGTRIG__) == ADC_EXTERNALTRIG_T1_TRGO2) || \
         ...
         ((__REGTRIG__) == ADC_EXTERNALTRIG_EXT_IT11) || ((__REGTRIG__) == ADC_SOFTWARE_START))
#else
#    define IS_ADC_EXTTRIG(__HANDLE__, __REGTRIG__)      \
        (((__REGTRIG__) == ADC_EXTERNALTRIG_T1_CC1) ||   \
         ...
         ((__REGTRIG__) == ADC_EXTERNALTRIG_T1_TRGO2) || \
         ((__REGTRIG__) == ADC_EXTERNALTRIG_T2_TRGO) || ((__REGTRIG__) == ADC_SOFTWARE_START))
#endif /* ADC_SUPPORT_2_5_MSPS */
...
#if defined(ADC_SUPPORT_2_5_MSPS)
#    define IS_ADC_SAMPLING_TIME_COMMON(SAMPLING_TIME_COMMON)     \
        (((SAMPLING_TIME_COMMON) == ADC_SAMPLINGTIME_COMMON_1) || \
...
#    define IS_ADC_SAMPLE_TIME(__TIME__)                                                           \
        (((__TIME__) == ADC_SAMPLETIME_1CYCLE_5) || ((__TIME__) == ADC_SAMPLETIME_3CYCLES_5) ||    \
         ((__TIME__) == ADC_SAMPLETIME_7CYCLES_5) || ((__TIME__) == ADC_SAMPLETIME_12CYCLES_5) ||  \
         ((__TIME__) == ADC_SAMPLETIME_19CYCLES_5) || ((__TIME__) == ADC_SAMPLETIME_39CYCLES_5) || \
         ((__TIME__) == ADC_SAMPLETIME_79CYCLES_5) || ((__TIME__) == ADC_SAMPLETIME_160CYCLES_5))
#else
#    define IS_ADC_SAMPLE_TIME(__TIME__)                                                           \
...
#if defined(ADC_SUPPORT_2_5_MSPS)
#    define IS_ADC_REGULAR_RANK_SEQ_FIXED(RANK) \
        (((RANK) == ADC_RANK_CHANNEL_NUMBER) || ((RANK) == ADC_RANK_NONE))
#endif /* ADC_SUPPORT_2_5_MSPS */
...
#    define IS_ADC_REGULAR_RANK(RANK)                                        \
        (((RANK) == ADC_REGULAR_RANK_1) || ((RANK) == ADC_REGULAR_RANK_2) || \
         ((RANK) == ADC_REGULAR_RANK_3) || ((RANK) == ADC_REGULAR_RANK_4) || \
         ((RANK) == ADC_REGULAR_RANK_5) || ((RANK) == ADC_REGULAR_RANK_6) || \
         ((RANK) == ADC_REGULAR_RANK_7) || ((RANK) == ADC_REGULAR_RANK_8))
#else
#    define IS_ADC_REGULAR_RANK(RANK)                                          \
        (((RANK) == ADC_REGULAR_RANK_1) || ((RANK) == ADC_REGULAR_RANK_2) ||   \
         ((RANK) == ADC_REGULAR_RANK_3) || ((RANK) == ADC_REGULAR_RANK_4) ||   \
         ((RANK) == ADC_REGULAR_RANK_5) || ((RANK) == ADC_REGULAR_RANK_6) ||   \
         ((RANK) == ADC_REGULAR_RANK_7) || ((RANK) == ADC_REGULAR_RANK_8) ||   \
         ((RANK) == ADC_REGULAR_RANK_9) || ((RANK) == ADC_REGULAR_RANK_10) ||  \
         ((RANK) == ADC_REGULAR_RANK_11) || ((RANK) == ADC_REGULAR_RANK_12) || \
         ((RANK) == ADC_REGULAR_RANK_13) || ((RANK) == ADC_REGULAR_RANK_14) || \
         ((RANK) == ADC_REGULAR_RANK_15) || ((RANK) == ADC_REGULAR_RANK_16))
#endif /* ADC_SUPPORT_2_5_MSPS */
...
#if defined(ADC_SUPPORT_2_5_MSPS)
#    define ADC_SCAN_SEQ_FIXED_INT                                                     \
        0x80000000U /* Internal definition to differentiate sequencer setting fixed or \
                       configurable */
#endif              /* ADC_SUPPORT_2_5_MSPS */
 ...
 *            @arg @ref ADC_IT_AWD2   ADC Analog watchdog 2 interrupt source (additional analog
 * watchdog)
 *            @arg @ref ADC_IT_AWD3   ADC Analog watchdog 3 interrupt source (additional analog
 * watchdog)
 *
 ...
 *
 *         (7) On STM32WB, fast channel (0.188 us for 12-bit resolution (ADC conversion rate up
 * to 5.33 Ms/s)). Other channels are slow channels (0.238 us for 12-bit resolution (ADC conversion
 ...
 *         (7) On STM32WB, fast channel (0.188 us for 12-bit resolution (ADC conversion rate up
 * to 5.33 Ms/s)). Other channels are slow channels (0.238 us for 12-bit resolution (ADC conversion
 * rate up to 4.21 Ms/s)).\n (4) For ADC channel read back from ADC register, comparison with
 ...
 */
#define __HAL_ADC_CONVERT_DATA_RESOLUTION(__DATA__, __ADC_RESOLUTION_CURRENT__, \
 ...
 */
#define __HAL_ADC_CALC_TEMPERATURE(__VREFANALOG_VOLTAGE__, __TEMPSENSOR_ADC_DATA__, \
                                   __ADC_RESOLUTION__)                              \
    __LL_ADC_CALC_TEMPERATURE((__VREFANALOG_VOLTAGE__), (__TEMPSENSOR_ADC_DATA__),  \
                              (__ADC_RESOLUTION__))
...
HAL_StatusTypeDef HAL_ADC_AnalogWDGConfig(ADC_HandleTypeDef* hadc,
                                          const ADC_AnalogWDGConfTypeDef* AnalogWDGConfig);
