 ...
 */
typedef struct {
    uint32_t CPU1CLKDivider; /*!< The CPU1 clock (HCLK1) divider. This clock is derived from the
    ...
    uint32_t CPU2CLKDivider; /*!< The CPU2 clock (HCLK2) divider. This clock is derived from the
                                system clock (SYSCLK). This parameter can be a value of @ref
                                RCC_LL_EC_SYSCLK_DIV.
    ...
    uint32_t AHB4CLKDivider; /*!< The AHBS clock (HCLK4) divider. This clock is derived from the
                                system clock (SYSCLK). This parameter can be a value of @ref
                                RCC_LL_EC_SYSCLK_DIV.
    ...
    uint32_t
        APB1CLKDivider; /*!< The APB1 clock (PCLK1) divider. This clock is derived from the AHB
                           clock (HCLK1). This parameter can be a value of @ref RCC_LL_EC_APB1_DIV.

                             This feature can be modified afterwards using unitary function
                             @ref LL_RCC_SetAPB1Prescaler(). */

    uint32_t
        APB2CLKDivider; /*!< The APB2 clock (PCLK2) divider. This clock is derived from the AHB
                           clock (HCLK1). This parameter can be a value of @ref RCC_LL_EC_APB2_DIV.
 ...
 * @param  HCLKFrequency HCLK frequency in Hz (can be calculated thanks to RCC helper macro or
 * function @ref LL_RCC_GetSystemClocksFreq (HCLK1_Frequency field))
