...
typedef struct {
    ...
    uint32_t Commutation_Delay; /*!< Specifies the pulse value to be loaded into the Capture Compare
                                   Register. This parameter can be a number between Min_Data =
...
typedef struct {
    ...
    uint32_t
        Polarity; /*!< Specifies the break input source polarity.
...
#    define TIM_TIM1_ETR_ADC1_AWD2 \
        TIM1_OR_ETR_ADC1_RMP_1 /*!< TIM1_ETR is connected to ADC1 AWD2    */
#    define TIM_TIM1_ETR_ADC1_AWD3 \
        (TIM1_OR_ETR_ADC1_RMP_0 |  \
         TIM1_OR_ETR_ADC1_RMP_1) /*!< TIM1_ETR is connected to ADC1 AWD3    */
#endif
#if defined(COMP1)
...
#if defined(USB)
#    define TIM_TIM2_ITR_USB \
        TIM2_OR_ITR1_RMP /*!< TIM2 Internal trigger ITR is connected to USBFS SOF */
#endif                   /* USB */
...
#    define TIM_TIM2_TI4_COMP1 \
        TIM2_OR_TI4_RMP_0 /*!< TIM2_TI4 is connected to COMP1 OUT           */
#endif                    /* COMP1 */
#if defined(COMP2)
#    define TIM_TIM2_TI4_COMP2 \
        TIM2_OR_TI4_RMP_1 /*!< TIM2_TI4 is connected to COMP1 OUT           */
#endif                    /* COMP2 */
#if defined(COMP1) && defined(COMP2)
#    define TIM_TIM2_TI4_COMP1_COMP2                                                              \
        (TIM2_OR_TI4_RMP_0 | TIM2_OR_TI4_RMP_1) /*!< TIM2_TI4 is connected to COMP1 and COMP2 OUT \
                                                 */
#endif                                          /* COMP1 && COMP2 */
...
#    define TIM_TIM16_TI1_RTC \
        (TIM16_OR_TI1_RMP_0 | TIM16_OR_TI1_RMP_1) /*!< TIM16_TI1 is connected to RTC       */
#endif                                            /* TIM16 */
...
#    define TIM_TIM17_TI1_MCO \
        (TIM17_OR_TI1_RMP_0 | TIM17_OR_TI1_RMP_1) /*!< TIM17_TI1 is connected to MCO       */
#endif                                            /* TIM17 */
/**
 * @}
 */
...
/** @addtogroup TIMEx_Exported_Functions_Group2 Extended Timer Complementary Output Compare
 * functions
