...
#    endif                     /* RCC_HSI48_SUPPORT */
#    if defined(SAI1)
#        define LL_RCC_CICR_PLLSAI1RDYC \
...
#    endif                     /* RCC_HSI48_SUPPORT */
#    if defined(SAI1)
#        define LL_RCC_CIFR_PLLSAI1RDYF \
...
#    define LL_RCC_HSE_CURRENTMAX_1 \
        RCC_HSECR_HSEGMC0 /*!< HSE current control max limit = 0.57 ma/V*/
#    define LL_RCC_HSE_CURRENTMAX_2 \
        RCC_HSECR_HSEGMC1 /*!< HSE current control max limit = 0.78 ma/V*/
#    define LL_RCC_HSE_CURRENTMAX_3 \
        (RCC_HSECR_HSEGMC1 | RCC_HSECR_HSEGMC0) /*!< HSE current control max limit = 1.13 ma/V*/
#    define LL_RCC_HSE_CURRENTMAX_4 \
        RCC_HSECR_HSEGMC2 /*!< HSE current control max limit = 0.61 ma/V*/
#    define LL_RCC_HSE_CURRENTMAX_5 \
        (RCC_HSECR_HSEGMC2 | RCC_HSECR_HSEGMC0) /*!< HSE current control max limit = 1.65 ma/V*/
#    define LL_RCC_HSE_CURRENTMAX_6 \
        (RCC_HSECR_HSEGMC2 | RCC_HSECR_HSEGMC1) /*!< HSE current control max limit = 2.12 ma/V*/
#    define LL_RCC_HSE_CURRENTMAX_7              \
        (RCC_HSECR_HSEGMC2 | RCC_HSECR_HSEGMC1 | \
         RCC_HSECR_HSEGMC0) /*!< HSE current control max limit = 2.84 ma/V*/
/**
 * @}
 */
 ...
 * @{
 */
#    define LL_RCC_HSEAMPTHRESHOLD_1_2 \
        (0x000000000U) /*!< HSE sense amplifier bias current factor = 1/2*/
#    define LL_RCC_HSEAMPTHRESHOLD_3_4 \
        RCC_HSECR_HSES /*!< HSE sense amplifier bias current factor = 3/4*/
/**
 * @}
 */
...
#    define LL_RCC_SYS_CLKSOURCE_PLL \
        (RCC_CFGR_SW_1 | RCC_CFGR_SW_0) /*!< PLL selection as system clock */
/**
 * @}
 */
...
#    define LL_RCC_SYS_CLKSOURCE_STATUS_PLL \
        (RCC_CFGR_SWS_1 | RCC_CFGR_SWS_0) /*!< PLL used as system clock */
/**
 * @}
 */
...
#    define LL_RCC_RF_CLKSOURCE_HSE_DIV2 \
        RCC_EXTCFGR_RFCSS /*!< HSE divided by 2 used as RF system clock */
/**
 * @}
 */
...
#    define LL_RCC_SYSCLK_DIV_16 \
        (RCC_CFGR_HPRE_3 | RCC_CFGR_HPRE_1 | RCC_CFGR_HPRE_0) /*!< SYSCLK divided by 16  */
#    define LL_RCC_SYSCLK_DIV_32 \
        (RCC_CFGR_HPRE_2 | RCC_CFGR_HPRE_1 | RCC_CFGR_HPRE_0)        /*!< SYSCLK divided by 32  */
#    define LL_RCC_SYSCLK_DIV_64 (RCC_CFGR_HPRE_3 | RCC_CFGR_HPRE_2) /*!< SYSCLK divided by 64  */
#    define LL_RCC_SYSCLK_DIV_128 \
        (RCC_CFGR_HPRE_3 | RCC_CFGR_HPRE_2 | RCC_CFGR_HPRE_0) /*!< SYSCLK divided by 128 */
#    define LL_RCC_SYSCLK_DIV_256 \
        (RCC_CFGR_HPRE_3 | RCC_CFGR_HPRE_2 | RCC_CFGR_HPRE_1) /*!< SYSCLK divided by 256 */
#    define LL_RCC_SYSCLK_DIV_512                              \
        (RCC_CFGR_HPRE_3 | RCC_CFGR_HPRE_2 | RCC_CFGR_HPRE_1 | \
         RCC_CFGR_HPRE_0) /*!< SYSCLK divided by 512 */
/**
 * @}
 */
...
#    define LL_RCC_APB1_DIV_16 \
        (RCC_CFGR_PPRE1_2 | RCC_CFGR_PPRE1_1 | RCC_CFGR_PPRE1_0) /*!< HCLK1 divided by 16 */
/**
 * @}
 */
...
#    define LL_RCC_APB2_DIV_16 \
        (RCC_CFGR_PPRE2_2 | RCC_CFGR_PPRE2_1 | RCC_CFGR_PPRE2_0) /*!< HCLK1 divided by 16 */
/**
 * @}
 */
...
#    define LL_RCC_STOP_WAKEUPCLOCK_HSI \
...
#    define LL_RCC_MCO1SOURCE_HSE \
        RCC_CFGR_MCOSEL_2 /*!< HSE after stabilization selection as MCO1 source  */
#    define LL_RCC_MCO1SOURCE_PLLCLK \
        (RCC_CFGR_MCOSEL_0 | RCC_CFGR_MCOSEL_2) /*!< Main PLL selection as MCO1 source */
#    define LL_RCC_MCO1SOURCE_LSI1 \
        (RCC_CFGR_MCOSEL_1 | RCC_CFGR_MCOSEL_2) /*!< LSI1 selection as MCO1 source */
#    define LL_RCC_MCO1SOURCE_LSI2               \
        (RCC_CFGR_MCOSEL_0 | RCC_CFGR_MCOSEL_1 | \
         RCC_CFGR_MCOSEL_2) /*!< LSI2 selection as MCO1 source           */
#    define LL_RCC_MCO1SOURCE_LSE \
        RCC_CFGR_MCOSEL_3 /*!< LSE selection as MCO1 source                      */
#    if defined(RCC_HSI48_SUPPORT)
#        define LL_RCC_MCO1SOURCE_HSI48 \
            (RCC_CFGR_MCOSEL_0 | RCC_CFGR_MCOSEL_3) /*!< HSI48 selection as MCO1 source */
#    endif                                          /* RCC_HSI48_SUPPORT */
#    define LL_RCC_MCO1SOURCE_HSE_BEFORE_STAB \
        (RCC_CFGR_MCOSEL_2 |                  \
         RCC_CFGR_MCOSEL_3) /*!< HSE before stabilization selection as MCO1 source */
/**
 * @}
 */
...
#        define LL_RCC_SMPS_CLKSOURCE_STATUS_MSI \
            RCC_SMPSCR_SMPSSWS_0 /*!< MSI used as SMPS clock      */
#        define LL_RCC_SMPS_CLKSOURCE_STATUS_HSE \
            RCC_SMPSCR_SMPSSWS_1 /*!< HSE used as SMPS clock      */
#        define LL_RCC_SMPS_CLKSOURCE_STATUS_NO_CLOCK \
            (RCC_SMPSCR_SMPSSWS_0 | RCC_SMPSCR_SMPSSWS_1) /*!< No Clock used as SMPS clock */
/**
 * @}
 */
...
#        define LL_RCC_SMPS_DIV_3 \
            (RCC_SMPSCR_SMPSDIV_0 | RCC_SMPSCR_SMPSDIV_1) /*!< SMPS clock division 3 */
/**
 * @}
 */
...
#    define LL_RCC_USART1_CLKSOURCE_SYSCLK \
        RCC_CCIPR_USART1SEL_0 /*!< SYSCLK selected as USART1 clock */
#    define LL_RCC_USART1_CLKSOURCE_HSI \
        RCC_CCIPR_USART1SEL_1                               /*!< HSI selected as USART1 clock    */
...
#        define LL_RCC_LPUART1_CLKSOURCE_SYSCLK \
            RCC_CCIPR_LPUART1SEL_0 /*!< SYCLK selected as LPUART1 clock */
#        define LL_RCC_LPUART1_CLKSOURCE_HSI \
            RCC_CCIPR_LPUART1SEL_1 /*!< HSI selected as LPUART1 clock   */
#        define LL_RCC_LPUART1_CLKSOURCE_LSE \
            RCC_CCIPR_LPUART1SEL /*!< LSE selected as LPUART1 clock   */
/**
 * @}
 */
#    endif /* LPUART1 */
...
#    define LL_RCC_I2C1_CLKSOURCE_PCLK1       \
        (uint32_t)((RCC_CCIPR_I2C1SEL << 4) | \
                   (0x00000000U >> 4)) /*!< PCLK1 selected as I2C1 clock  */
#    define LL_RCC_I2C1_CLKSOURCE_SYSCLK      \
        (uint32_t)((RCC_CCIPR_I2C1SEL << 4) | \
                   (RCC_CCIPR_I2C1SEL_0 >> 4)) /*!< SYSCLK selected as I2C1 clock */
#    define LL_RCC_I2C1_CLKSOURCE_HSI         \
        (uint32_t)((RCC_CCIPR_I2C1SEL << 4) | \
                   (RCC_CCIPR_I2C1SEL_1 >> 4)) /*!< HSI selected as I2C1 clock    */
#    if defined(I2C3)
#        define LL_RCC_I2C3_CLKSOURCE_PCLK1       \
            (uint32_t)((RCC_CCIPR_I2C3SEL << 4) | \
                       (0x00000000U >> 4)) /*!< PCLK1 selected as I2C3 clock  */
#        define LL_RCC_I2C3_CLKSOURCE_SYSCLK      \
            (uint32_t)((RCC_CCIPR_I2C3SEL << 4) | \
                       (RCC_CCIPR_I2C3SEL_0 >> 4)) /*!< SYSCLK selected as I2C3 clock */
#        define LL_RCC_I2C3_CLKSOURCE_HSI         \
            (uint32_t)((RCC_CCIPR_I2C3SEL << 4) | \
                       (RCC_CCIPR_I2C3SEL_1 >> 4)) /*!< HSI selected as I2C3 clock    */
#    endif                                         /* I2C3 */
/**
 * @}
 */
...
#    define LL_RCC_LPTIM1_CLKSOURCE_PCLK1                                                         \
        (uint32_t)(RCC_CCIPR_LPTIM1SEL | (0x00000000U >> 16)) /*!< PCLK1 selected as LPTIM1 clock \
                                                               */
#    define LL_RCC_LPTIM1_CLKSOURCE_LSI  \
        (uint32_t)(RCC_CCIPR_LPTIM1SEL | \
                   (RCC_CCIPR_LPTIM1SEL_0 >> 16)) /*!< LSI selected as LPTIM1 clock   */
#    define LL_RCC_LPTIM1_CLKSOURCE_HSI  \
        (uint32_t)(RCC_CCIPR_LPTIM1SEL | \
                   (RCC_CCIPR_LPTIM1SEL_1 >> 16)) /*!< HSI selected as LPTIM1 clock   */
#    define LL_RCC_LPTIM1_CLKSOURCE_LSE  \
        (uint32_t)(RCC_CCIPR_LPTIM1SEL | \
                   (RCC_CCIPR_LPTIM1SEL >> 16)) /*!< LSE selected as LPTIM1 clock   */
#    define LL_RCC_LPTIM2_CLKSOURCE_PCLK1                                                         \
        (uint32_t)(RCC_CCIPR_LPTIM2SEL | (0x00000000U >> 16)) /*!< PCLK1 selected as LPTIM2 clock \
                                                               */
#    define LL_RCC_LPTIM2_CLKSOURCE_LSI  \
        (uint32_t)(RCC_CCIPR_LPTIM2SEL | \
                   (RCC_CCIPR_LPTIM2SEL_0 >> 16)) /*!< LSI selected as LPTIM2 clock   */
#    define LL_RCC_LPTIM2_CLKSOURCE_HSI  \
        (uint32_t)(RCC_CCIPR_LPTIM2SEL | \
                   (RCC_CCIPR_LPTIM2SEL_1 >> 16)) /*!< HSI selected as LPTIM2 clock   */
#    define LL_RCC_LPTIM2_CLKSOURCE_LSE  \
        (uint32_t)(RCC_CCIPR_LPTIM2SEL | \
                   (RCC_CCIPR_LPTIM2SEL >> 16)) /*!< LSE selected as LPTIM2 clock   */
/**
 * @}
 */
 ...
 * @{
 */
#        define LL_RCC_SAI1_CLKSOURCE_PLLSAI1 \
            0x00000000U /*!< PLLSAI1 selected as SAI1 clock        */
#        define LL_RCC_SAI1_CLKSOURCE_PLL \
            RCC_CCIPR_SAI1SEL_0 /*!< PLL selected as SAI1 clock            */
#        define LL_RCC_SAI1_CLKSOURCE_HSI \
            RCC_CCIPR_SAI1SEL_1 /*!< HSI selected as SAI1 clock            */
#        define LL_RCC_SAI1_CLKSOURCE_PIN \
            RCC_CCIPR_SAI1SEL /*!< External input selected as SAI1 clock */
/**
 * @}
 */
#    endif /* SAI1 */
...
#    endif                                               /* RCC_HSI48_SUPPORT */
#    if defined(SAI1)
#        define LL_RCC_CLK48_CLKSOURCE_PLLSAI1 \
            RCC_CCIPR_CLK48SEL_0                            /*!< PLLSAI1 selected as CLK48 clock */
#    endif                                                  /* SAI1 */
...
#        define LL_RCC_USB_CLKSOURCE_HSI48 \
            LL_RCC_CLK48_CLKSOURCE_HSI48 /*!< HSI48 selected as USB clock   */
#    endif                               /* RCC_HSI48_SUPPORT */
#    if defined(SAI1)
#        define LL_RCC_USB_CLKSOURCE_PLLSAI1 \
            LL_RCC_CLK48_CLKSOURCE_PLLSAI1 /*!< PLLSAI1 selected as USB clock */
#    endif                                 /* SAI1 */
#    define LL_RCC_USB_CLKSOURCE_PLL \
        LL_RCC_CLK48_CLKSOURCE_PLL /*!< PLL selected as USB clock     */
#    define LL_RCC_USB_CLKSOURCE_MSI \
        LL_RCC_CLK48_CLKSOURCE_MSI /*!< MSI selected as USB clock     */
/**
 * @}
 */
...
#        define LL_RCC_ADC_CLKSOURCE_PLLSAI1 RCC_CCIPR_ADCSEL_0 /*!< PLLSAI1 selected as ADC \
                                                                   clock*/
...
#    define LL_RCC_RNG_CLKSOURCE_LSI \
        RCC_CCIPR_RNGSEL_0 /*!< LSI selected as ADC clock                */
#    define LL_RCC_RNG_CLKSOURCE_LSE \
        RCC_CCIPR_RNGSEL_1 /*!< LSE selected as ADC clock                */
/**
 * @}
 */
...
#        define LL_RCC_LPUART1_CLKSOURCE \
            RCC_CCIPR_LPUART1SEL /*!< LPUART1 clock source selection bits */
/**
 * @}
 */
#    endif /* LPUART1 */
 ...
 * @{
 */
#    define LL_RCC_RFWKP_CLKSOURCE_NONE \
        0x00000000U /*!< No clock used as RF Wakeup clock                             */
#    define LL_RCC_RFWKP_CLKSOURCE_LSE \
        RCC_CSR_RFWKPSEL_0 /*!< LSE oscillator clock used as RF Wakeup clock                 */
#    if defined(STM32WB15xx) || defined(STM32WB10xx)
#        define LL_RCC_RFWKP_CLKSOURCE_LSI \
            RCC_CSR_RFWKPSEL_1 /*!< LSI oscillator clock used as RF Wakeup clock */
#    endif                     /* STM32WB15xx || STM32WB10xx */
#    define LL_RCC_RFWKP_CLKSOURCE_HSE_DIV1024 \
        RCC_CSR_RFWKPSEL /*!< HSE oscillator clock divided by 1024 used as RF Wakeup clock */
...
#    define LL_RCC_PLLSOURCE_MSI \
        RCC_PLLCFGR_PLLSRC_0 /*!< MSI clock selected as PLL entry clock source */
#    define LL_RCC_PLLSOURCE_HSI \
        RCC_PLLCFGR_PLLSRC_1 /*!< HSI clock selected as PLL entry clock source */
#    define LL_RCC_PLLSOURCE_HSE \
        (RCC_PLLCFGR_PLLSRC_1 |  \
         RCC_PLLCFGR_PLLSRC_0) /*!< HSE clock selected as PLL entry clock source */
/**
 * @}
 */
...
#    define LL_RCC_PLLM_DIV_4 \
        ((RCC_PLLCFGR_PLLM_1 | RCC_PLLCFGR_PLLM_0)) /*!< PLL and PLLSAI1 division factor by 4 */
#    define LL_RCC_PLLM_DIV_5 (RCC_PLLCFGR_PLLM_2)  /*!< PLL and PLLSAI1 division factor by 5 */
#    define LL_RCC_PLLM_DIV_6 \
        ((RCC_PLLCFGR_PLLM_2 | RCC_PLLCFGR_PLLM_0)) /*!< PLL and PLLSAI1 division factor by 6 */
#    define LL_RCC_PLLM_DIV_7 \
        ((RCC_PLLCFGR_PLLM_2 | RCC_PLLCFGR_PLLM_1)) /*!< PLL and PLLSAI1 division factor by 7 */
...
#    define LL_RCC_PLLR_DIV_2 \
        (RCC_PLLCFGR_PLLR_0) /*!< Main PLL division factor for PLLCLK (system clock) by 2 */
#    define LL_RCC_PLLR_DIV_3 \
        (RCC_PLLCFGR_PLLR_1) /*!< Main PLL division factor for PLLCLK (system clock) by 3 */
#    define LL_RCC_PLLR_DIV_4 \
        (RCC_PLLCFGR_PLLR_1 | \
         RCC_PLLCFGR_PLLR_0) /*!< Main PLL division factor for PLLCLK (system clock) by 4 */
#    define LL_RCC_PLLR_DIV_5 \
        (RCC_PLLCFGR_PLLR_2) /*!< Main PLL division factor for PLLCLK (system clock) by 5 */
#    define LL_RCC_PLLR_DIV_6 \
        (RCC_PLLCFGR_PLLR_2 | \
         RCC_PLLCFGR_PLLR_0) /*!< Main PLL division factor for PLLCLK (system clock) by 6 */
#    define LL_RCC_PLLR_DIV_7 \
        (RCC_PLLCFGR_PLLR_2 | \
         RCC_PLLCFGR_PLLR_1) /*!< Main PLL division factor for PLLCLK (system clock) by 7 */
#    define LL_RCC_PLLR_DIV_8 \
        (RCC_PLLCFGR_PLLR) /*!< Main PLL division factor for PLLCLK (system clock) by 8 */
/**
 * @}
 */
...
#    define LL_RCC_PLLP_DIV_2 \
        (RCC_PLLCFGR_PLLP_0) /*!< Main PLL division factor for PLLP output by 2  */
#    define LL_RCC_PLLP_DIV_3 \
        (RCC_PLLCFGR_PLLP_1) /*!< Main PLL division factor for PLLP output by 3  */
#    define LL_RCC_PLLP_DIV_4 \
        (RCC_PLLCFGR_PLLP_0 | \
         RCC_PLLCFGR_PLLP_1) /*!< Main PLL division factor for PLLP output by 4  */
#    define LL_RCC_PLLP_DIV_5 \
        (RCC_PLLCFGR_PLLP_2) /*!< Main PLL division factor for PLLP output by 5  */
#    define LL_RCC_PLLP_DIV_6 \
        (RCC_PLLCFGR_PLLP_0 | \
         RCC_PLLCFGR_PLLP_2) /*!< Main PLL division factor for PLLP output by 6  */
#    define LL_RCC_PLLP_DIV_7 \
        (RCC_PLLCFGR_PLLP_1 | \
         RCC_PLLCFGR_PLLP_2) /*!< Main PLL division factor for PLLP output by 7  */
#    define LL_RCC_PLLP_DIV_8                      \
        (RCC_PLLCFGR_PLLP_0 | RCC_PLLCFGR_PLLP_1 | \
         RCC_PLLCFGR_PLLP_2) /*!< Main PLL division factor for PLLP output by 8  */
#    define LL_RCC_PLLP_DIV_9 \
        (RCC_PLLCFGR_PLLP_3) /*!< Main PLL division factor for PLLP output by 9  */
#    define LL_RCC_PLLP_DIV_10 \
        (RCC_PLLCFGR_PLLP_0 |  \
         RCC_PLLCFGR_PLLP_3) /*!< Main PLL division factor for PLLP output by 10 */
#    define LL_RCC_PLLP_DIV_11 \
        (RCC_PLLCFGR_PLLP_1 |  \
         RCC_PLLCFGR_PLLP_3) /*!< Main PLL division factor for PLLP output by 11 */
#    define LL_RCC_PLLP_DIV_12                     \
        (RCC_PLLCFGR_PLLP_0 | RCC_PLLCFGR_PLLP_1 | \
         RCC_PLLCFGR_PLLP_3) /*!< Main PLL division factor for PLLP output by 12 */
#    define LL_RCC_PLLP_DIV_13 \
        (RCC_PLLCFGR_PLLP_2 |  \
         RCC_PLLCFGR_PLLP_3) /*!< Main PLL division factor for PLLP output by 13 */
#    define LL_RCC_PLLP_DIV_14                     \
        (RCC_PLLCFGR_PLLP_0 | RCC_PLLCFGR_PLLP_2 | \
         RCC_PLLCFGR_PLLP_3) /*!< Main PLL division factor for PLLP output by 14 */
#    define LL_RCC_PLLP_DIV_15                     \
        (RCC_PLLCFGR_PLLP_1 | RCC_PLLCFGR_PLLP_2 | \
         RCC_PLLCFGR_PLLP_3) /*!< Main PLL division factor for PLLP output by 15 */
...
#    define LL_RCC_PLLP_DIV_18 \
        (RCC_PLLCFGR_PLLP_0 |  \
         RCC_PLLCFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 18 */
#    define LL_RCC_PLLP_DIV_19 \
        (RCC_PLLCFGR_PLLP_1 |  \
         RCC_PLLCFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 19 */
#    define LL_RCC_PLLP_DIV_20                     \
        (RCC_PLLCFGR_PLLP_0 | RCC_PLLCFGR_PLLP_1 | \
         RCC_PLLCFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 20 */
#    define LL_RCC_PLLP_DIV_21 \
        (RCC_PLLCFGR_PLLP_2 |  \
         RCC_PLLCFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 21 */
#    define LL_RCC_PLLP_DIV_22                     \
        (RCC_PLLCFGR_PLLP_0 | RCC_PLLCFGR_PLLP_2 | \
         RCC_PLLCFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 22 */
#    define LL_RCC_PLLP_DIV_23                     \
        (RCC_PLLCFGR_PLLP_1 | RCC_PLLCFGR_PLLP_2 | \
         RCC_PLLCFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 23 */
#    define LL_RCC_PLLP_DIV_24                                          \
        (RCC_PLLCFGR_PLLP_0 | RCC_PLLCFGR_PLLP_1 | RCC_PLLCFGR_PLLP_2 | \
         RCC_PLLCFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 24 */
#    define LL_RCC_PLLP_DIV_25 \
        (RCC_PLLCFGR_PLLP_3 |  \
         RCC_PLLCFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 25 */
#    define LL_RCC_PLLP_DIV_26                     \
        (RCC_PLLCFGR_PLLP_0 | RCC_PLLCFGR_PLLP_3 | \
         RCC_PLLCFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 26 */
#    define LL_RCC_PLLP_DIV_27                     \
        (RCC_PLLCFGR_PLLP_1 | RCC_PLLCFGR_PLLP_3 | \
         RCC_PLLCFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 27 */
...
#    define LL_RCC_PLLP_DIV_29                     \
        (RCC_PLLCFGR_PLLP_2 | RCC_PLLCFGR_PLLP_3 | \
         RCC_PLLCFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 29 */
...
#    define LL_RCC_PLLP_DIV_32                                                               \
        (RCC_PLLCFGR_PLLP_0 | RCC_PLLCFGR_PLLP_1 | RCC_PLLCFGR_PLLP_2 | RCC_PLLCFGR_PLLP_3 | \
         RCC_PLLCFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 32 */
/**
 * @}
 */
...
#    define LL_RCC_PLLQ_DIV_2 \
        (RCC_PLLCFGR_PLLQ_0) /*!< Main PLL division factor for PLLQ output by 2 */
#    define LL_RCC_PLLQ_DIV_3 \
        (RCC_PLLCFGR_PLLQ_1) /*!< Main PLL division factor for PLLQ output by 3 */
#    define LL_RCC_PLLQ_DIV_4 \
        (RCC_PLLCFGR_PLLQ_1 | \
         RCC_PLLCFGR_PLLQ_0) /*!< Main PLL division factor for PLLQ output by 4 */
#    define LL_RCC_PLLQ_DIV_5 \
        (RCC_PLLCFGR_PLLQ_2) /*!< Main PLL division factor for PLLQ output by 5 */
#    define LL_RCC_PLLQ_DIV_6 \
        (RCC_PLLCFGR_PLLQ_2 | \
         RCC_PLLCFGR_PLLQ_0) /*!< Main PLL division factor for PLLQ output by 6 */
#    define LL_RCC_PLLQ_DIV_7 \
        (RCC_PLLCFGR_PLLQ_2 | \
         RCC_PLLCFGR_PLLQ_1) /*!< Main PLL division factor for PLLQ output by 7 */
 ...
 * @{
 */
#        define LL_RCC_PLLSAI1Q_DIV_2 \
            (RCC_PLLSAI1CFGR_PLLQ_0) /*!< PLLSAI1 division factor for PLLSAI1Q output by 2 */
#        define LL_RCC_PLLSAI1Q_DIV_3 \
            (RCC_PLLSAI1CFGR_PLLQ_1) /*!< PLLSAI1 division factor for PLLSAI1Q output by 3 */
#        define LL_RCC_PLLSAI1Q_DIV_4 \
            (RCC_PLLSAI1CFGR_PLLQ_1 | \
             RCC_PLLSAI1CFGR_PLLQ_0) /*!< PLLSAI1 division factor for PLLSAI1Q output by 4 */
#        define LL_RCC_PLLSAI1Q_DIV_5 \
            (RCC_PLLSAI1CFGR_PLLQ_2) /*!< PLLSAI1 division factor for PLLSAI1Q output by 5 */
#        define LL_RCC_PLLSAI1Q_DIV_6 \
            (RCC_PLLSAI1CFGR_PLLQ_2 | \
             RCC_PLLSAI1CFGR_PLLQ_0) /*!< PLLSAI1 division factor for PLLSAI1Q output by 6 */
#        define LL_RCC_PLLSAI1Q_DIV_7 \
            (RCC_PLLSAI1CFGR_PLLQ_2 | \
             RCC_PLLSAI1CFGR_PLLQ_1) /*!< PLLSAI1 division factor for PLLSAI1Q output by 7 */
#        define LL_RCC_PLLSAI1Q_DIV_8                          \
            (RCC_PLLSAI1CFGR_PLLQ_2 | RCC_PLLSAI1CFGR_PLLQ_1 | \
             RCC_PLLSAI1CFGR_PLLQ_0) /*!< PLLSAI1 division factor for PLLSAI1Q output by 8 */
/**
 * @}
 */
 ...
 * @{
 */
#        define LL_RCC_PLLSAI1P_DIV_2 \
            (RCC_PLLSAI1CFGR_PLLP_0) /*!< Main PLL division factor for PLLP output by 2 */
#        define LL_RCC_PLLSAI1P_DIV_3 \
            (RCC_PLLSAI1CFGR_PLLP_1) /*!< Main PLL division factor for PLLP output by 3 */
#        define LL_RCC_PLLSAI1P_DIV_4 \
            (RCC_PLLSAI1CFGR_PLLP_0 | \
             RCC_PLLSAI1CFGR_PLLP_1) /*!< Main PLL division factor for PLLP output by 4 */
#        define LL_RCC_PLLSAI1P_DIV_5 \
            (RCC_PLLSAI1CFGR_PLLP_2) /*!< Main PLL division factor for PLLP output by 5 */
#        define LL_RCC_PLLSAI1P_DIV_6 \
            (RCC_PLLSAI1CFGR_PLLP_0 | \
             RCC_PLLSAI1CFGR_PLLP_2) /*!< Main PLL division factor for PLLP output by 6 */
#        define LL_RCC_PLLSAI1P_DIV_7 \
            (RCC_PLLSAI1CFGR_PLLP_1 | \
             RCC_PLLSAI1CFGR_PLLP_2) /*!< Main PLL division factor for PLLP output by 7 */
#        define LL_RCC_PLLSAI1P_DIV_8                          \
            (RCC_PLLSAI1CFGR_PLLP_0 | RCC_PLLSAI1CFGR_PLLP_1 | \
             RCC_PLLSAI1CFGR_PLLP_2) /*!< Main PLL division factor for PLLP output by 8 */
#        define LL_RCC_PLLSAI1P_DIV_9 \
            (RCC_PLLSAI1CFGR_PLLP_3) /*!< Main PLL division factor for PLLP output by 9 */
#        define LL_RCC_PLLSAI1P_DIV_10 \
            (RCC_PLLSAI1CFGR_PLLP_0 |  \
             RCC_PLLSAI1CFGR_PLLP_3) /*!< Main PLL division factor for PLLP output by 10 */
#        define LL_RCC_PLLSAI1P_DIV_11 \
            (RCC_PLLSAI1CFGR_PLLP_1 |  \
             RCC_PLLSAI1CFGR_PLLP_3) /*!< Main PLL division factor for PLLP output by 11 */
#        define LL_RCC_PLLSAI1P_DIV_12                         \
            (RCC_PLLSAI1CFGR_PLLP_0 | RCC_PLLSAI1CFGR_PLLP_1 | \
             RCC_PLLSAI1CFGR_PLLP_3) /*!< Main PLL division factor for PLLP output by 12 */
#        define LL_RCC_PLLSAI1P_DIV_13 \
            (RCC_PLLSAI1CFGR_PLLP_2 |  \
             RCC_PLLSAI1CFGR_PLLP_3) /*!< Main PLL division factor for PLLP output by 13 */
#        define LL_RCC_PLLSAI1P_DIV_14                         \
            (RCC_PLLSAI1CFGR_PLLP_0 | RCC_PLLSAI1CFGR_PLLP_2 | \
             RCC_PLLSAI1CFGR_PLLP_3) /*!< Main PLL division factor for PLLP output by 14 */
#        define LL_RCC_PLLSAI1P_DIV_15                         \
            (RCC_PLLSAI1CFGR_PLLP_1 | RCC_PLLSAI1CFGR_PLLP_2 | \
             RCC_PLLSAI1CFGR_PLLP_3) /*!< Main PLL division factor for PLLP output by 15 */
#        define LL_RCC_PLLSAI1P_DIV_16                                                  \
            (RCC_PLLSAI1CFGR_PLLP_0 | RCC_PLLSAI1CFGR_PLLP_1 | RCC_PLLSAI1CFGR_PLLP_2 | \
             RCC_PLLSAI1CFGR_PLLP_3) /*!< Main PLL division factor for PLLP output by 16 */
#        define LL_RCC_PLLSAI1P_DIV_17 \
            (RCC_PLLSAI1CFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 17 */
#        define LL_RCC_PLLSAI1P_DIV_18 \
            (RCC_PLLSAI1CFGR_PLLP_0 |  \
             RCC_PLLSAI1CFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 18 */
#        define LL_RCC_PLLSAI1P_DIV_19 \
            (RCC_PLLSAI1CFGR_PLLP_1 |  \
             RCC_PLLSAI1CFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 19 */
#        define LL_RCC_PLLSAI1P_DIV_20                         \
            (RCC_PLLSAI1CFGR_PLLP_0 | RCC_PLLSAI1CFGR_PLLP_1 | \
             RCC_PLLSAI1CFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 20 */
#        define LL_RCC_PLLSAI1P_DIV_21 \
            (RCC_PLLSAI1CFGR_PLLP_2 |  \
             RCC_PLLSAI1CFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 21 */
#        define LL_RCC_PLLSAI1P_DIV_22                         \
            (RCC_PLLSAI1CFGR_PLLP_0 | RCC_PLLSAI1CFGR_PLLP_2 | \
             RCC_PLLSAI1CFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 22 */
#        define LL_RCC_PLLSAI1P_DIV_23                         \
            (RCC_PLLSAI1CFGR_PLLP_1 | RCC_PLLSAI1CFGR_PLLP_2 | \
             RCC_PLLSAI1CFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 23 */
#        define LL_RCC_PLLSAI1P_DIV_24                                                  \
            (RCC_PLLSAI1CFGR_PLLP_0 | RCC_PLLSAI1CFGR_PLLP_1 | RCC_PLLSAI1CFGR_PLLP_2 | \
             RCC_PLLSAI1CFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 24 */
#        define LL_RCC_PLLSAI1P_DIV_25 \
            (RCC_PLLSAI1CFGR_PLLP_3 |  \
             RCC_PLLSAI1CFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 25 */
#        define LL_RCC_PLLSAI1P_DIV_26                         \
            (RCC_PLLSAI1CFGR_PLLP_0 | RCC_PLLSAI1CFGR_PLLP_3 | \
             RCC_PLLSAI1CFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 26 */
#        define LL_RCC_PLLSAI1P_DIV_27                         \
            (RCC_PLLSAI1CFGR_PLLP_1 | RCC_PLLSAI1CFGR_PLLP_3 | \
             RCC_PLLSAI1CFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 27*/
#        define LL_RCC_PLLSAI1P_DIV_28                                                  \
            (RCC_PLLSAI1CFGR_PLLP_0 | RCC_PLLSAI1CFGR_PLLP_1 | RCC_PLLSAI1CFGR_PLLP_3 | \
             RCC_PLLSAI1CFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 28 */
#        define LL_RCC_PLLSAI1P_DIV_29                         \
            (RCC_PLLSAI1CFGR_PLLP_2 | RCC_PLLSAI1CFGR_PLLP_3 | \
             RCC_PLLSAI1CFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 29 */
#        define LL_RCC_PLLSAI1P_DIV_30                                                  \
            (RCC_PLLSAI1CFGR_PLLP_0 | RCC_PLLSAI1CFGR_PLLP_2 | RCC_PLLSAI1CFGR_PLLP_3 | \
             RCC_PLLSAI1CFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 30 */
#        define LL_RCC_PLLSAI1P_DIV_31                                                  \
            (RCC_PLLSAI1CFGR_PLLP_1 | RCC_PLLSAI1CFGR_PLLP_2 | RCC_PLLSAI1CFGR_PLLP_3 | \
             RCC_PLLSAI1CFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 31 */
#        define LL_RCC_PLLSAI1P_DIV_32                                                  \
            (RCC_PLLSAI1CFGR_PLLP_0 | RCC_PLLSAI1CFGR_PLLP_1 | RCC_PLLSAI1CFGR_PLLP_2 | \
             RCC_PLLSAI1CFGR_PLLP_3 |                                                   \
             RCC_PLLSAI1CFGR_PLLP_4) /*!< Main PLL division factor for PLLP output by 32 */
/**
 * @}
 */
 ...
 * @{
 */
#        define LL_RCC_PLLSAI1R_DIV_2 \
            (RCC_PLLSAI1CFGR_PLLR_0) /*!< PLLSAI1 division factor for PLLSAI1R output by 2 */
#        define LL_RCC_PLLSAI1R_DIV_3 \
            (RCC_PLLSAI1CFGR_PLLR_1) /*!< PLLSAI1 division factor for PLLSAI1R output by 3 */
#        define LL_RCC_PLLSAI1R_DIV_4 \
            (RCC_PLLSAI1CFGR_PLLR_1 | \
             RCC_PLLSAI1CFGR_PLLR_0) /*!< PLLSAI1 division factor for PLLSAI1R output by 4 */
#        define LL_RCC_PLLSAI1R_DIV_5 \
            (RCC_PLLSAI1CFGR_PLLR_2) /*!< PLLSAI1 division factor for PLLSAI1R output by 5 */
#        define LL_RCC_PLLSAI1R_DIV_6 \
            (RCC_PLLSAI1CFGR_PLLR_2 | \
             RCC_PLLSAI1CFGR_PLLR_0) /*!< PLLSAI1 division factor for PLLSAI1R output by 6 */
#        define LL_RCC_PLLSAI1R_DIV_7 \
            (RCC_PLLSAI1CFGR_PLLR_2 | \
             RCC_PLLSAI1CFGR_PLLR_1) /*!< PLLSAI1 division factor for PLLSAI1R output by 7 */
#        define LL_RCC_PLLSAI1R_DIV_8                          \
            (RCC_PLLSAI1CFGR_PLLR_2 | RCC_PLLSAI1CFGR_PLLR_1 | \
             RCC_PLLSAI1CFGR_PLLR_0) /*!< PLLSAI1 division factor for PLLSAI1R output by 8 */
/**
 * @}
 */
#    endif /* SAI1 */
 ...
 */
#        define __LL_RCC_CALC_PLLSAI1_SAI_FREQ(__INPUTFREQ__, __PLLM__, __PLLSAI1N__,           \
                                               __PLLSAI1P__)                                    \
 ...
 * @retval PLLSAI1 clock frequency (in Hz)
 */
#        define __LL_RCC_CALC_PLLSAI1_48M_FREQ(__INPUTFREQ__, __PLLM__, __PLLSAI1N__,           \
                                               __PLLSAI1Q__)                                    \
            ((__INPUTFREQ__) * (__PLLSAI1N__) / ((((__PLLM__) >> RCC_PLLCFGR_PLLM_Pos) + 1U)) / \
 ...
 * @retval PLLSAI1 clock frequency (in Hz)
 */
#        define __LL_RCC_CALC_PLLSAI1_ADC_FREQ(__INPUTFREQ__, __PLLM__, __PLLSAI1N__,           \
                                               __PLLSAI1R__)                                    \
            ((__INPUTFREQ__) * (__PLLSAI1N__) / ((((__PLLM__) >> RCC_PLLCFGR_PLLM_Pos) + 1U)) / \
...
#    define __LL_RCC_CALC_HCLK2_FREQ(__SYSCLKFREQ__, __CPU2PRESCALER__) \
        ((__SYSCLKFREQ__) /                                             \
         AHBPrescTable[((__CPU2PRESCALER__)&RCC_EXTCFGR_C2HPRE) >> RCC_EXTCFGR_C2HPRE_Pos])
 ...
 */
#    define __LL_RCC_CALC_HCLK4_FREQ(__SYSCLKFREQ__, __AHB4PRESCALER__)                          \
        ((__SYSCLKFREQ__) / AHBPrescTable[(((__AHB4PRESCALER__) >> 4U) & RCC_EXTCFGR_SHDHPRE) >> \
                                          RCC_EXTCFGR_SHDHPRE_Pos])
...
#    define __LL_RCC_CALC_PCLK1_FREQ(__HCLKFREQ__, __APB1PRESCALER__) \
        ((__HCLKFREQ__) >>                                            \
         (APBPrescTable[(((__APB1PRESCALER__)&RCC_CFGR_PPRE1_Msk) >> RCC_CFGR_PPRE1_Pos)] & 31U))
...
#    define __LL_RCC_CALC_PCLK2_FREQ(__HCLKFREQ__, __APB2PRESCALER__) \
        ((__HCLKFREQ__) >>                                            \
         (APBPrescTable[(((__APB2PRESCALER__)&RCC_CFGR_PPRE2_Msk) >> RCC_CFGR_PPRE2_Pos)] & 31U))
 ...
 */
#    define __LL_RCC_CALC_MSI_FREQ(__MSIRANGE__) \
 ...
 * @note In case of CLK48 clock selected, it must be configured first thanks to
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RCC_PLL_ConfigDomain_SYS(uint32_t Source, uint32_t PLLM, uint32_t PLLN,
                                                 uint32_t PLLR) {
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RCC_PLL_ConfigDomain_SAI(uint32_t Source, uint32_t PLLM, uint32_t PLLN,
                                                 uint32_t PLLP) {
    MODIFY_REG(RCC->PLLCFGR,
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RCC_PLL_ConfigDomain_ADC(uint32_t Source, uint32_t PLLM, uint32_t PLLN,
                                                 uint32_t PLLP) {
    MODIFY_REG(RCC->PLLCFGR,
               RCC_PLLCFGR_PLLSRC | RCC_PLLCFGR_PLLM | RCC_PLLCFGR_PLLN | RCC_PLLCFGR_PLLP,
               Source | PLLM | (PLLN << RCC_PLLCFGR_PLLN_Pos) | PLLP);
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RCC_PLL_ConfigDomain_48M(uint32_t Source, uint32_t PLLM, uint32_t PLLN,
                                                 uint32_t PLLQ) {
    MODIFY_REG(RCC->PLLCFGR,
 ...
 * @rmtoll PLLCFGR      RCC_PLLCFGR_PLLREN
 * LL_RCC_PLL_LL_RCC_PLL_IsEnabledDomain_SYSIsEnabledDomain_SYS
 * @retval State of bit (1 or 0).
 */
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RCC_PLLSAI1_ConfigDomain_48M(uint32_t Source, uint32_t PLLM, uint32_t PLLN,
                                                     uint32_t PLLQ) {
    MODIFY_REG(RCC->PLLCFGR, RCC_PLLCFGR_PLLSRC | RCC_PLLCFGR_PLLM, Source | PLLM);
    MODIFY_REG(RCC->PLLSAI1CFGR, RCC_PLLSAI1CFGR_PLLN | RCC_PLLSAI1CFGR_PLLQ,
               (PLLN << RCC_PLLSAI1CFGR_PLLN_Pos) | PLLQ);
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RCC_PLLSAI1_ConfigDomain_SAI(uint32_t Source, uint32_t PLLM, uint32_t PLLN,
                                                     uint32_t PLLP) {
    MODIFY_REG(RCC->PLLCFGR, RCC_PLLCFGR_PLLSRC | RCC_PLLCFGR_PLLM, Source | PLLM);
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RCC_PLLSAI1_ConfigDomain_ADC(uint32_t Source, uint32_t PLLM, uint32_t PLLN,
                                                     uint32_t PLLR) {
    MODIFY_REG(RCC->PLLCFGR, RCC_PLLCFGR_PLLSRC | RCC_PLLCFGR_PLLM, Source | PLLM);
    MODIFY_REG(RCC->PLLSAI1CFGR, RCC_PLLSAI1CFGR_PLLN | RCC_PLLSAI1CFGR_PLLR,
               (PLLN << RCC_PLLSAI1CFGR_PLLN_Pos) | PLLR);
}
...
__STATIC_INLINE uint32_t LL_RCC_PLLSAI1_IsEnabledDomain_SAI(void) {
    return ((READ_BIT(RCC->PLLSAI1CFGR, RCC_PLLSAI1CFGR_PLLPEN) == (RCC_PLLSAI1CFGR_PLLPEN)) ? 1UL
                                                                                             : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RCC_PLLSAI1_IsEnabledDomain_48M(void) {
    return ((READ_BIT(RCC->PLLSAI1CFGR, RCC_PLLSAI1CFGR_PLLQEN) == (RCC_PLLSAI1CFGR_PLLQEN)) ? 1UL
                                                                                             : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RCC_PLLSAI1_IsEnabledDomain_ADC(void) {
    return ((READ_BIT(RCC->PLLSAI1CFGR, RCC_PLLSAI1CFGR_PLLREN) == (RCC_PLLSAI1CFGR_PLLREN)) ? 1UL
                                                                                             : 0UL);
}
#    endif /* SAI1 */
