...
#    define RCC_PERIPHCLOCK_ALL                                                                   \
        (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_LPUART1 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C3 | \
...
#    define RCC_PERIPHCLOCK_ALL                                                                \
        (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_LPUART1 | RCC_PERIPHCLK_I2C1 |                   \
         RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_RNG | RCC_PERIPHCLK_ADC | \
         RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_RFWAKEUP)
#else
#    define RCC_PERIPHCLOCK_ALL                                                                    \
        (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 | \
         RCC_PERIPHCLK_RNG | RCC_PERIPHCLK_ADC | RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_RFWAKEUP)
#endif /* LPUART1 */
...
#    define IS_RCC_LSCO(__LSCOX__) \
        (((__LSCOX__) == RCC_LSCO1) || ((__LSCOX__) == RCC_LSCO2) || ((__LSCOX__) == RCC_LSCO3))
#else
#    define IS_RCC_LSCO(__LSCOX__) (((__LSCOX__) == RCC_LSCO1) || ((__LSCOX__) == RCC_LSCO2))
...
#define IS_RCC_USART1CLKSOURCE(__SOURCE__)                                                        \
    (((__SOURCE__) == RCC_USART1CLKSOURCE_PCLK2) ||                                               \
     ((__SOURCE__) == RCC_USART1CLKSOURCE_SYSCLK) || ((__SOURCE__) == RCC_USART1CLKSOURCE_LSE) || \
...
#    define IS_RCC_I2C3CLKSOURCE(__SOURCE__)          \
        (((__SOURCE__) == RCC_I2C3CLKSOURCE_PCLK1) || \
         ((__SOURCE__) == RCC_I2C3CLKSOURCE_SYSCLK) || ((__SOURCE__) == RCC_I2C3CLKSOURCE_HSI))
#endif /* I2C3 */

#if defined(SAI1)
#    define IS_RCC_SAI1CLK(__SOURCE__)                                                             \
        (((__SOURCE__) == RCC_SAI1CLKSOURCE_PLLSAI1) || ((__SOURCE__) == RCC_SAI1CLKSOURCE_PLL) || \
         ((__SOURCE__) == RCC_SAI1CLKSOURCE_HSI) || ((__SOURCE__) == RCC_SAI1CLKSOURCE_PIN))
#endif /* SAI1 */
...
#        define IS_RCC_RNGCLKSOURCE(__SOURCE__)                                                    \
            (((__SOURCE__) == RCC_RNGCLKSOURCE_HSI48) || ((__SOURCE__) == RCC_RNGCLKSOURCE_PLL) || \
             ((__SOURCE__) == RCC_RNGCLKSOURCE_MSI) ||                                             \
             ((__SOURCE__) == RCC_RNGCLKSOURCE_PLLSAI1) ||                                         \
             ((__SOURCE__) == RCC_RNGCLKSOURCE_CLK48) || ((__SOURCE__) == RCC_RNGCLKSOURCE_LSI) || \
             ((__SOURCE__) == RCC_RNGCLKSOURCE_LSE))
#    else /* SAI1 */
#        define IS_RCC_RNGCLKSOURCE(__SOURCE__)                                                    \
            (((__SOURCE__) == RCC_RNGCLKSOURCE_HSI48) || ((__SOURCE__) == RCC_RNGCLKSOURCE_PLL) || \
             ((__SOURCE__) == RCC_RNGCLKSOURCE_MSI) || ((__SOURCE__) == RCC_RNGCLKSOURCE_CLK48) || \
             ((__SOURCE__) == RCC_RNGCLKSOURCE_LSI) || ((__SOURCE__) == RCC_RNGCLKSOURCE_LSE))
#    endif /* SAI1 */
#else      /* RCC_HSI48_SUPPORT */
#    define IS_RCC_RNGCLKSOURCE(__SOURCE__)                                                    \
        (((__SOURCE__) == RCC_RNGCLKSOURCE_PLL) || ((__SOURCE__) == RCC_RNGCLKSOURCE_MSI) ||   \
         ((__SOURCE__) == RCC_RNGCLKSOURCE_CLK48) || ((__SOURCE__) == RCC_RNGCLKSOURCE_LSI) || \
         ((__SOURCE__) == RCC_RNGCLKSOURCE_LSE))
...
#        define IS_RCC_USBCLKSOURCE(__SOURCE__)            \
            (((__SOURCE__) == RCC_USBCLKSOURCE_HSI48) ||   \
             ...
             ((__SOURCE__) == RCC_USBCLKSOURCE_PLL) || ((__SOURCE__) == RCC_USBCLKSOURCE_MSI))
#    else
#        define IS_RCC_USBCLKSOURCE(__SOURCE__)                                                    \
            (((__SOURCE__) == RCC_USBCLKSOURCE_HSI48) || ((__SOURCE__) == RCC_USBCLKSOURCE_PLL) || \
...
#    define IS_RCC_ADCCLKSOURCE(__SOURCE__)                                                   \
        (((__SOURCE__) == RCC_ADCCLKSOURCE_NONE) || ((__SOURCE__) == RCC_ADCCLKSOURCE_PLL) || \
         ((__SOURCE__) == RCC_ADCCLKSOURCE_PLLSAI1) || ((__SOURCE__) == RCC_ADCCLKSOURCE_SYSCLK))
#elif defined(STM32WB15xx) || defined(STM32WB1Mxx)
#    define IS_RCC_ADCCLKSOURCE(__SOURCE__)                                                   \
        (((__SOURCE__) == RCC_ADCCLKSOURCE_NONE) || ((__SOURCE__) == RCC_ADCCLKSOURCE_PLL) || \
         ((__SOURCE__) == RCC_ADCCLKSOURCE_HSI) || ((__SOURCE__) == RCC_ADCCLKSOURCE_SYSCLK))
#else
#    define IS_RCC_ADCCLKSOURCE(__SOURCE__)                                                   \
        (((__SOURCE__) == RCC_ADCCLKSOURCE_NONE) || ((__SOURCE__) == RCC_ADCCLKSOURCE_PLL) || \
...
#    define IS_RCC_SMPSCLKDIV(__DIV__)                                                   \
        (((__DIV__) == RCC_SMPSCLKDIV_RANGE0) || ((__DIV__) == RCC_SMPSCLKDIV_RANGE1) || \
         ((__DIV__) == RCC_SMPSCLKDIV_RANGE2) || ((__DIV__) == RCC_SMPSCLKDIV_RANGE3))

#    define IS_RCC_SMPSCLKSOURCE(__SOURCE__)                                                   \
        (((__SOURCE__) == RCC_SMPSCLKSOURCE_HSI) || ((__SOURCE__) == RCC_SMPSCLKSOURCE_MSI) || \
...
#    define IS_RCC_PLLSAI1P_VALUE(__VALUE__) \
...
#    define IS_RCC_CRS_SYNC_SOURCE(__SOURCE__)         \
        (((__SOURCE__) == RCC_CRS_SYNC_SOURCE_GPIO) || \
         ((__SOURCE__) == RCC_CRS_SYNC_SOURCE_LSE) || ((__SOURCE__) == RCC_CRS_SYNC_SOURCE_USB))
...
typedef struct {
    ...
    uint32_t
        PLLSAI1ClockOut; /*!< PLLSAI1ClockOut: specifies PLLSAI1 output clock to be enabled.
...
typedef struct {
    ...
    RCC_PLLSAI1InitTypeDef PLLSAI1; /*!< PLLSAI1 structure parameters.
                                         This parameter will be used only when PLLSAI1 is selected
                                       as Clock Source for SAI, USB/RNG or ADC */
#endif                              /* SAI1 */
    ...
    uint32_t
        I2c1ClockSelection; /*!< Specifies I2C1 clock source.
                                 This parameter can be a value of @ref RCCEx_I2C1_Clock_Source */

#if defined(I2C3)
    uint32_t
        I2c3ClockSelection; /*!< Specifies I2C3 clock source.
...
#if defined(SAI1)
    uint32_t
        Sai1ClockSelection; /*!< Specifies SAI1 clock source.
    ...
    uint32_t RFWakeUpClockSelection; /*!< Specifies RF Wake-up clock source.
                                          This parameter can be a value of @ref
                                        RCCEx_RFWKP_Clock_Source */

#if defined(RCC_SMPS_SUPPORT)
    uint32_t
        SmpsClockSelection; /*!< Specifies SMPS clock source.
                                 This parameter can be a value of @ref RCCEx_SMPS_Clock_Source */

    uint32_t
        SmpsDivSelection; /*!< Specifies SMPS clock division factor.
...
typedef struct {
    ...
    uint32_t ReloadValue; /*!< Specifies the value to be loaded in the frequency error counter with
                             each SYNC event. It can be calculated in using macro
                             __HAL_RCC_CRS_RELOADVALUE_CALCULATE(__FTARGET__, __FSYNC__) This
                             parameter must be a number between Min_Data=0 and Max_Data=0xFFFF or a
                             value of @ref RCCEx_CRS_ReloadValueDefault .*/

    uint32_t ErrorLimitValue; /*!< Specifies the value to be used to evaluate the captured frequency
                                 error value. This parameter must be a number between Min_Data=0 and
                                 Max_Data=0xFF or a value of @ref RCCEx_CRS_ErrorLimitDefault */

    uint32_t HSI48CalibrationValue; /*!< Specifies a user-programmable trimming value to the HSI48
                                       oscillator. This parameter must be a number between
                                       Min_Data=0 and Max_Data=0x3F or a value of @ref
...
typedef struct {
    ...
    uint32_t
        FreqErrorCapture; /*!< Specifies the value loaded in the .FECAP, the frequency error counter
                               value latched in the time of the last SYNC event.
                               This parameter must be a number between Min_Data=0 and
                             Max_Data=0xFFFF */

    uint32_t FreqErrorDirection; /*!< Specifies the value loaded in the .FEDIR, the counting
                                    direction of the frequency error counter latched in the time of
                                    the last SYNC event. It shows whether the actual frequency is
                                    below or above the target. This parameter must be a value of
...
#define RCC_LSCOSOURCE_LSI \
    LL_RCC_LSCO_CLKSOURCE_LSI /*!< LSI selection for low speed clock output */
#define RCC_LSCOSOURCE_LSE \
    LL_RCC_LSCO_CLKSOURCE_LSE /*!< LSE selection for low speed clock output */
/**
 * @}
 */
...
#define RCC_USART1CLKSOURCE_PCLK2 \
    LL_RCC_USART1_CLKSOURCE_PCLK2 /*!< APB2 clock selected as USART 1 clock*/
#define RCC_USART1CLKSOURCE_SYSCLK \
    LL_RCC_USART1_CLKSOURCE_SYSCLK /*!< SYSCLK clock selected as USART 1 clock*/
#define RCC_USART1CLKSOURCE_HSI \
    LL_RCC_USART1_CLKSOURCE_HSI /*!< HSI clock selected as USART 1 clock*/
#define RCC_USART1CLKSOURCE_LSE \
    LL_RCC_USART1_CLKSOURCE_LSE /*!< LSE clock selected as USART 1 clock*/
/**
 * @}
 */
 ...
 * @{
 */
#    define RCC_LPUART1CLKSOURCE_PCLK1 \
        LL_RCC_LPUART1_CLKSOURCE_PCLK1 /*!< APB1 clock selected as LPUART 1 clock*/
#    define RCC_LPUART1CLKSOURCE_SYSCLK \
        LL_RCC_LPUART1_CLKSOURCE_SYSCLK /*!< SYSCLK clock selected as LPUART 1 clock*/
#    define RCC_LPUART1CLKSOURCE_HSI \
        LL_RCC_LPUART1_CLKSOURCE_HSI /*!< HSI clock selected as LPUART 1 clock*/
#    define RCC_LPUART1CLKSOURCE_LSE \
        LL_RCC_LPUART1_CLKSOURCE_LSE /*!< LSE clock selected as LPUART 1 clock*/
/**
 * @}
 */
#endif /* LPUART1 */
...
#define RCC_I2C1CLKSOURCE_PCLK1 \
    LL_RCC_I2C1_CLKSOURCE_PCLK1 /*!< APB1 clock selected as I2C1 clock */
#define RCC_I2C1CLKSOURCE_SYSCLK \
    LL_RCC_I2C1_CLKSOURCE_SYSCLK                        /*!< SYSCLK clock selected as I2C1 clock */
...
#    define RCC_I2C3CLKSOURCE_PCLK1 \
        LL_RCC_I2C3_CLKSOURCE_PCLK1 /*!< APB1 clock selected as I2C3 clock */
#    define RCC_I2C3CLKSOURCE_SYSCLK \
        LL_RCC_I2C3_CLKSOURCE_SYSCLK /*!< SYSCLK clock selected as I2C3 clock */
 ...
 * @{
 */
#    define RCC_SAI1CLKSOURCE_PLLSAI1 \
        LL_RCC_SAI1_CLKSOURCE_PLLSAI1 /*!< PLLSAI "P" clock selected as SAI1 clock  */
#    define RCC_SAI1CLKSOURCE_PLL \
        LL_RCC_SAI1_CLKSOURCE_PLL /*!< PLL "P" clock selected as SAI1 clock     */
#    define RCC_SAI1CLKSOURCE_HSI \
        LL_RCC_SAI1_CLKSOURCE_HSI /*!< HSI clock selected as SAI1 clock         */
#    define RCC_SAI1CLKSOURCE_PIN \
        LL_RCC_SAI1_CLKSOURCE_PIN /*!< External PIN clock selected as SAI1 clock */
/**
 * @}
 */
#endif /* SAI1 */
...
#define RCC_LPTIM1CLKSOURCE_PCLK1 \
    LL_RCC_LPTIM1_CLKSOURCE_PCLK1 /*!< APB1 clock selected as LPTIM1 clock */
#define RCC_LPTIM1CLKSOURCE_LSI \
    LL_RCC_LPTIM1_CLKSOURCE_LSI /*!< LSI clock selected as LPTIM1 clock  */
#define RCC_LPTIM1CLKSOURCE_HSI \
    LL_RCC_LPTIM1_CLKSOURCE_HSI /*!< HSI clock selected as LPTIM1 clock  */
#define RCC_LPTIM1CLKSOURCE_LSE \
    LL_RCC_LPTIM1_CLKSOURCE_LSE /*!< LSE clock selected as LPTIM1 clock  */
/**
 * @}
 */
 ...
 * @{
 */
#define RCC_LPTIM2CLKSOURCE_PCLK1 \
    LL_RCC_LPTIM2_CLKSOURCE_PCLK1 /*!< APB1 clock selected as LPTIM2 clock */
#define RCC_LPTIM2CLKSOURCE_LSI \
    LL_RCC_LPTIM2_CLKSOURCE_LSI /*!< LSI clock selected as LPTIM2 clock  */
#define RCC_LPTIM2CLKSOURCE_HSI \
    LL_RCC_LPTIM2_CLKSOURCE_HSI /*!< HSI clock selected as LPTIM2 clock  */
#define RCC_LPTIM2CLKSOURCE_LSE \
    LL_RCC_LPTIM2_CLKSOURCE_LSE /*!< LSE clock selected as LPTIM2 clock  */
/**
 * @}
 */
...
#define RCC_RNGCLKSOURCE_HSI48 \
    (CLK48_MASK |              \
     LL_RCC_CLK48_CLKSOURCE_HSI48) /*!< HSI48 clock divided by 3 selected as RNG clock    */
#define RCC_RNGCLKSOURCE_PLL \
    (CLK48_MASK |            \
     LL_RCC_CLK48_CLKSOURCE_PLL) /*!< PLL "Q" clock divided by 3  selected as RNG clock */
#define RCC_RNGCLKSOURCE_MSI \
    (CLK48_MASK | LL_RCC_CLK48_CLKSOURCE_MSI) /*!< MSI clock divided by 3 selected as RNG clock */
#if defined(SAI1)
#    define RCC_RNGCLKSOURCE_PLLSAI1 \
        (CLK48_MASK |                \
         LL_RCC_CLK48_CLKSOURCE_PLLSAI1) /*!< PLLSAI1 "Q" clock selected as RNG clock           */
#endif                                   /* SAI1 */
#define RCC_RNGCLKSOURCE_CLK48 \
    LL_RCC_RNG_CLKSOURCE_CLK48 /*!< CLK48 divided by 3 selected as RNG Clock          */
#define RCC_RNGCLKSOURCE_LSI \
    LL_RCC_RNG_CLKSOURCE_LSI /*!< LSI clock selected as RNG clock                   */
#define RCC_RNGCLKSOURCE_LSE \
    LL_RCC_RNG_CLKSOURCE_LSE /*!< LSE clock selected as RNG clock                   */
/**
 * @}
 */
...
#    define RCC_USBCLKSOURCE_HSI48 \
        LL_RCC_USB_CLKSOURCE_HSI48 /*!< HSI48 clock selected as USB clock       */
#    if defined(SAI1)
#        define RCC_USBCLKSOURCE_PLLSAI1 \
            LL_RCC_USB_CLKSOURCE_PLLSAI1 /*!< PLLSAI1 "Q" clock selected as USB clock */
#    endif                               /* SAI1 */
#    define RCC_USBCLKSOURCE_PLL \
        LL_RCC_USB_CLKSOURCE_PLL /*!< PLL "Q" clock selected as USB clock     */
#    define RCC_USBCLKSOURCE_MSI \
        LL_RCC_USB_CLKSOURCE_MSI /*!< MSI clock selected as USB clock         */
/**
 * @}
 */
#endif /* USB */
...
#define RCC_ADCCLKSOURCE_NONE \
    LL_RCC_ADC_CLKSOURCE_NONE /*!< None clock selected as ADC clock        */
#if defined(STM32WB55xx) || defined(STM32WB5Mxx) || defined(STM32WB35xx)
#    define RCC_ADCCLKSOURCE_PLLSAI1 \
        LL_RCC_ADC_CLKSOURCE_PLLSAI1 /*!< PLLSAI1 "R" clock selected as ADC clock */
#elif defined(STM32WB15xx) || defined(STM32WB1Mxx)
#    define RCC_ADCCLKSOURCE_HSI LL_RCC_ADC_CLKSOURCE_HSI /*!< HSI clock selected as ADC clock */
#endif /* STM32WB55xx || STM32WB5Mxx || STM32WB35xx */
#define RCC_ADCCLKSOURCE_PLL \
    LL_RCC_ADC_CLKSOURCE_PLL /*!< PLL "P" clock selected as ADC clock     */
#define RCC_ADCCLKSOURCE_SYSCLK \
    LL_RCC_ADC_CLKSOURCE_SYSCLK /*!< SYSCLK clock selected as ADC clock      */
...
#define RCC_HCLK5SOURCE_HSI 0x00000001U /*!< HSI clock not divided selected as Radio Domain clock \
                                         */
#define RCC_HCLK5SOURCE_HSE \
    0x00000002U /*!< HSE clock divided by 2 selected as Radio Domain clock */
...
#define RCC_RFWKPCLKSOURCE_NONE \
    LL_RCC_RFWKP_CLKSOURCE_NONE /*!< None clock selected as RF system wakeup clock */
#define RCC_RFWKPCLKSOURCE_LSE \
    LL_RCC_RFWKP_CLKSOURCE_LSE /*!< LSE clock selected as RF system wakeup clock */
#if defined(STM32WB15xx) || defined(STM32WB10xx)
#    define RCC_RFWKPCLKSOURCE_LSI \
        LL_RCC_RFWKP_CLKSOURCE_LSI /*!< LSI clock selected as RF system wakeup clock */
#endif                             /* STM32WB15xx || STM32WB10xx */
#define RCC_RFWKPCLKSOURCE_HSE_DIV1024                                                             \
 ...
 * @{
 */
#    define RCC_SMPSCLKSOURCE_STATUS_HSI \
        LL_RCC_SMPS_CLKSOURCE_STATUS_HSI /*!< HSI selection as smps clock */
#    define RCC_SMPSCLKSOURCE_STATUS_MSI \
        LL_RCC_SMPS_CLKSOURCE_STATUS_MSI /*!< MSI selection as smps clock */
#    define RCC_SMPSCLKSOURCE_STATUS_HSE \
        LL_RCC_SMPS_CLKSOURCE_STATUS_HSE /*!< HSE selection as smps clock */
/**
 * @}
 */
...
#define RCC_EXTI_LINE_LSECSS \
    EXTI_IMR1_IM18 /*!< External interrupt line 18 connected to the LSE CSS EXTI Line */
...
#    define RCC_CRS_RELOADVALUE_DEFAULT                                                       \
        LL_CRS_RELOADVALUE_DEFAULT /*!< The reset value of the RELOAD field corresponds       \
...
#    define RCC_CRS_ERRORLIMIT_DEFAULT \
        LL_CRS_ERRORLIMIT_DEFAULT /*!< Default Frequency error limit */
/**
 * @}
 */
...
#    define RCC_CRS_HSI48CALIBRATION_DEFAULT                                                   \
        LL_CRS_HSI48CALIBRATION_DEFAULT /*!< The default value is 32, which corresponds to the \
                                           middle of the trimming interval. The trimming step is                                                                          \
                                           around 67 kHz between two consecutive TRIM steps. A \
                                           higher TRIM value corresponds to a higher output                                                                \
                                           frequency */
/**
 * @}
 */
...
#    define RCC_CRS_FREQERRORDIR_UP                                                           \
        LL_CRS_FREQ_ERROR_DIR_UP /*!< Upcounting direction, the actual frequency is above the \
                                    target */
#    define RCC_CRS_FREQERRORDIR_DOWN                                                             \
        LL_CRS_FREQ_ERROR_DIR_DOWN /*!< Downcounting direction, the actual frequency is below the \
                                      target */
/**
 * @}
 */
...
#    define __HAL_RCC_PLLSAI1_CONFIG(__PLLN__, __PLLP__, __PLLQ__, __PLLR__)             \
        MODIFY_REG(RCC->PLLSAI1CFGR,                                                     \
                   (RCC_PLLSAI1CFGR_PLLN | RCC_PLLSAI1CFGR_PLLP | RCC_PLLSAI1CFGR_PLLQ | \
                    RCC_PLLSAI1CFGR_PLLR),                                               \
...
/**
 * @brief  Macros to enable each clock output (RCC_PLLSAI1_SAI1CLK, RCC_PLLSAI1_USBCLK and
 * RCC_PLLSAI1_ADCCLK).
 ...
 *            @arg @ref RCC_PLLSAI1_SAI1CLK  This clock is used to generate an accurate clock to
 * achieve high-quality audio performance on SAI interface
 *            @arg @ref RCC_PLLSAI1_ADCCLK  Clock used to clock ADC peripheral
 *            @arg @ref RCC_PLLSAI1_USBCLK  This clock is used to generate the clock for the USB
 * Device (48 MHz)
 *
 * @retval None
 */
#    define __HAL_RCC_PLLSAI1CLKOUT_ENABLE(__PLLSAI1_CLOCKOUT__) \
        SET_BIT(RCC->PLLSAI1CFGR, (__PLLSAI1_CLOCKOUT__))

/**
 * @brief  Macros to disable each clock output (RCC_PLLSAI1_SAI1CLK, RCC_PLLSAI1_USBCLK and
 * RCC_PLLSAI1_ADCCLK).
 * @note   Enabling and disabling those clocks can be done without the need to stop the PLL.
 *         This is mainly used to save Power.
 * @param  __PLLSAI1_CLOCKOUT__ specifies the PLLSAI1 clock to be output.
 ...
 * @retval None
 */
#    define __HAL_RCC_PLLSAI1CLKOUT_DISABLE(__PLLSAI1_CLOCKOUT__) \
        CLEAR_BIT(RCC->PLLSAI1CFGR, (__PLLSAI1_CLOCKOUT__))

/**
 * @brief  Macro to get clock output enable status (RCC_PLLSAI1_SAI1CLK, RCC_PLLSAI1_USBCLK and
 * RCC_PLLSAI1_ADCCLK).
 * @param  __PLLSAI1_CLOCKOUT__ specifies the PLLSAI1 clock to be output.
 *         This parameter can be one or a combination of the following values:
 *            @arg @ref RCC_PLLSAI1_SAI1CLK  This clock is used to generate an accurate clock to
 ...
 * @retval SET / RESET
 */
#    define __HAL_RCC_GET_PLLSAI1CLKOUT_CONFIG(__PLLSAI1_CLOCKOUT__) \
        READ_BIT(RCC->PLLSAI1CFGR, (__PLLSAI1_CLOCKOUT__))
 ...
 * @retval None
 */
#    define __HAL_RCC_LPUART1_CONFIG(__LPUART_CLKSOURCE__) \
        LL_RCC_SetLPUARTClockSource(__LPUART_CLKSOURCE__)
 ...
 *         This parameter can be one of the following values:
 *            @arg @ref RCC_RNGCLKSOURCE_HSI48         HSI48 clock divided by 3  selected as RNG
 * clock
 *            @arg @ref RCC_RNGCLKSOURCE_PLL           PLL "Q" clock divided by 3  selected as RNG
 * clock
 ...
 *            @arg @ref RCC_USBCLKSOURCE_PLLSAI1  PLLSAI1 "Q" clock (PLL48M2CLK) selected as USB
 * clock
 ...
 * @retval None
 */
#define __HAL_RCC_RFWAKEUP_CONFIG(__RFWKP_CLKSOURCE__) \
    LL_RCC_SetRFWKPClockSource(__RFWKP_CLKSOURCE__)
...
#define __HAL_RCC_LSECSS_EXTI_ENABLE_FALLING_EDGE() \
    LL_EXTI_EnableFallingTrig_0_31(RCC_EXTI_LINE_LSECSS)
...
#define __HAL_RCC_LSECSS_EXTI_DISABLE_FALLING_EDGE() \
    LL_EXTI_DisableFallingTrig_0_31(RCC_EXTI_LINE_LSECSS)
...
#define __HAL_RCC_LSECSS_EXTI_ENABLE_RISING_EDGE() \
    LL_EXTI_EnableRisingTrig_0_31(RCC_EXTI_LINE_LSECSS)
...
#define __HAL_RCC_LSECSS_EXTI_DISABLE_RISING_EDGE() \
    LL_EXTI_DisableRisingTrig_0_31(RCC_EXTI_LINE_LSECSS)
...
/**
 * @brief  Macro to calculate reload value to be set in CRS register according to target and sync
 * frequencies
 * @note   The RELOAD value should be selected according to the ratio between the target frequency
 * and the frequency of the synchronization source after prescaling. It is then decreased by one in
 * order to reach the expected synchronization on the zero value. The formula is the following:
...
#    define __HAL_RCC_CRS_RELOADVALUE_CALCULATE(__FTARGET__, __FSYNC__) \
        __LL_CRS_CALC_CALCULATE_RELOADVALUE((__FTARGET__), (__FSYNC__))
