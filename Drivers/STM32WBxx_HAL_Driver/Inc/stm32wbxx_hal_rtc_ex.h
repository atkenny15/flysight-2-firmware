...
typedef struct {
    ...
    uint32_t
        Interrupt; /*!< Specifies the Tamper Interrupt.
    ...
    uint32_t
        NoErase; /*!< Specifies the Tamper no erase mode.
                      This parameter can be a value of @ref RTCEx_Tamper_EraseBackUp_Definitions */

    uint32_t
        MaskFlag; /*!< Specifies the Tamper Flag masking.
    ...
    uint32_t
        TamperPullUp; /*!< Specifies the Tamper PullUp .
...
#define RTC_TAMPERFILTER_2SAMPLE                          \
    RTC_TAMPCR_TAMPFLT_0 /*!< Tamper is activated after 2 \
                              consecutive samples at the active level */
#define RTC_TAMPERFILTER_4SAMPLE                          \
    RTC_TAMPCR_TAMPFLT_1 /*!< Tamper is activated after 4 \
                              consecutive samples at the active level */
#define RTC_TAMPERFILTER_8SAMPLE                        \
    RTC_TAMPCR_TAMPFLT /*!< Tamper is activated after 8 \
                            consecutive samples at the active level */
...
/** @defgroup RTCEx_Tamper_Sampling_Frequencies_Definitions RTCEx Tamper Sampling Frequencies
 * Definitions
 * @{
 */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV32768                         \
    ((uint32_t)0x00000000U) /*!< Each of the tamper inputs are sampled \
                                 with a frequency =  RTCCLK / 32768 */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV16384                       \
    RTC_TAMPCR_TAMPFREQ_0 /*!< Each of the tamper inputs are sampled \
                               with a frequency =  RTCCLK / 16384 */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV8192                        \
    RTC_TAMPCR_TAMPFREQ_1 /*!< Each of the tamper inputs are sampled \
                               with a frequency =  RTCCLK / 8192  */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV4096                                      \
    ((uint32_t)(RTC_TAMPCR_TAMPFREQ_0 |                                            \
                RTC_TAMPCR_TAMPFREQ_1)) /*!< Each of the tamper inputs are sampled \
...
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV512                                       \
    ((uint32_t)(RTC_TAMPCR_TAMPFREQ_1 |                                            \
                RTC_TAMPCR_TAMPFREQ_2)) /*!< Each of the tamper inputs are sampled \
                                             with a frequency =  RTCCLK / 512   */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV256                                       \
    ((uint32_t)(RTC_TAMPCR_TAMPFREQ_0 | RTC_TAMPCR_TAMPFREQ_1 |                    \
                RTC_TAMPCR_TAMPFREQ_2)) /*!< Each of the tamper inputs are sampled \
...
/** @defgroup RTCEx_Tamper_Pin_Precharge_Duration_Definitions RTCEx Tamper Pin Precharge Duration
 * Definitions
 * @{
 */
#define RTC_TAMPERPRECHARGEDURATION_1RTCCLK                         \
    ((uint32_t)0x00000000U) /*!< Tamper pins are pre-charged before \
                                sampling during 1 RTCCLK cycle  */
#define RTC_TAMPERPRECHARGEDURATION_2RTCCLK                       \
    RTC_TAMPCR_TAMPPRCH_0 /*!< Tamper pins are pre-charged before \
                               sampling during 2 RTCCLK cycles */
#define RTC_TAMPERPRECHARGEDURATION_4RTCCLK                       \
    RTC_TAMPCR_TAMPPRCH_1 /*!< Tamper pins are pre-charged before \
                               sampling during 4 RTCCLK cycles */
#define RTC_TAMPERPRECHARGEDURATION_8RTCCLK                                     \
    ((uint32_t)(RTC_TAMPCR_TAMPPRCH_0 |                                         \
                RTC_TAMPCR_TAMPPRCH_1)) /*!< Tamper pins are pre-charged before \
...
/** @defgroup RTCEx_Tamper_TimeStampOnTamperDetection_Definitions RTCEx Tamper
 * TimeStampOnTamperDetection Definitions
 * @{
 */
#define RTC_TIMESTAMPONTAMPERDETECTION_ENABLE \
    RTC_TAMPCR_TAMPTS /*!< TimeStamp on Tamper Detection event saved        */
#define RTC_TIMESTAMPONTAMPERDETECTION_DISABLE \
    ((uint32_t)0x00000000U) /*!< TimeStamp on Tamper Detection event is not saved */
...
#define RTC_TAMPER_PULLUP_ENABLE \
    ((uint32_t)0x00000000U) /*!< Tamper pins are pre-charged before sampling */
#define RTC_TAMPER_PULLUP_DISABLE \
    RTC_TAMPCR_TAMPPUDIS /*!< Tamper pins pre-charge is disabled          */
...
#define RTC_SMOOTHCALIB_PERIOD_32SEC                                     \
    ((uint32_t)0x00000000U) /*!< If RTCCLK = 32768 Hz, Smooth calibation \
                                 period is 32s,  else 2exp20 RTCCLK pulses */
#define RTC_SMOOTHCALIB_PERIOD_16SEC                             \
    RTC_CALR_CALW16 /*!< If RTCCLK = 32768 Hz, Smooth calibation \
                         period is 16s, else 2exp19 RTCCLK pulses */
#define RTC_SMOOTHCALIB_PERIOD_8SEC                             \
    RTC_CALR_CALW8 /*!< If RTCCLK = 32768 Hz, Smooth calibation \
...
#define RTC_SMOOTHCALIB_PLUSPULSES_SET                           \
    RTC_CALR_CALP /*!< The number of RTCCLK pulses added         \
                       during a X -second window = Y - CALM[8:0] \
                       with Y = 512, 256, 128 when X = 32, 16, 8 */
#define RTC_SMOOTHCALIB_PLUSPULSES_RESET                                \
    ((uint32_t)0x00000000U) /*!< The number of RTCCLK pulses subbstited \
...
#define __HAL_RTC_WAKEUPTIMER_CLEAR_FLAG(__HANDLE__, __FLAG__) \
    ((__HANDLE__)->Instance->ISR) =                            \
        (~((__FLAG__) | RTC_ISR_INIT) | ((__HANDLE__)->Instance->ISR & RTC_ISR_INIT))
 ...
 * @retval None
 */
#define __HAL_RTC_WAKEUPTIMER_EXTIC2_DISABLE_IT() \
    (EXTI->C2IMR1 &= ~(RTC_EXTI_LINE_WAKEUPTIMER_EVENT))
 ...
 * @retval None.
 */
#define __HAL_RTC_WAKEUPTIMER_EXTIC2_ENABLE_EVENT() \
    (EXTI->C2EMR1 |= RTC_EXTI_LINE_WAKEUPTIMER_EVENT)
...
#define __HAL_RTC_WAKEUPTIMER_EXTI_DISABLE_EVENT() \
    (EXTI->EMR1 &= ~(RTC_EXTI_LINE_WAKEUPTIMER_EVENT))

/**
 * @brief  Disable event on the RTC WakeUp Timer associated Exti line of core 2.
 * @retval None.
 */
#define __HAL_RTC_WAKEUPTIMER_EXTIC2_DISABLE_EVENT() \
    (EXTI->C2EMR1 &= ~(RTC_EXTI_LINE_WAKEUPTIMER_EVENT))
...
#define __HAL_RTC_WAKEUPTIMER_EXTI_ENABLE_FALLING_EDGE() \
    (EXTI->FTSR1 |= RTC_EXTI_LINE_WAKEUPTIMER_EVENT)
...
#define __HAL_RTC_WAKEUPTIMER_EXTI_ENABLE_RISING_EDGE() \
    (EXTI->RTSR1 |= RTC_EXTI_LINE_WAKEUPTIMER_EVENT)
...
/**
 * @brief Check whether the RTC WakeUp Timer associated Exti line interrupt flag is set or not of
 * core 1.
 * @retval Line Status.
 */
...
#    define __HAL_RTC_TAMPER1_ENABLE(__HANDLE__) \
        ((__HANDLE__)->Instance->TAMPCR |= (RTC_TAMPCR_TAMP1E))
...
#define __HAL_RTC_TAMPER2_DISABLE(__HANDLE__) \
    ((__HANDLE__)->Instance->TAMPCR &= ~(RTC_TAMPCR_TAMP2E))
 ...
 * @retval None
 */
#    define __HAL_RTC_TAMPER3_ENABLE(__HANDLE__) \
        ((__HANDLE__)->Instance->TAMPCR |= (RTC_TAMPCR_TAMP3E))
 ...
 * @retval None
 */
#    define __HAL_RTC_TAMPER3_DISABLE(__HANDLE__) \
        ((__HANDLE__)->Instance->TAMPCR &= ~(RTC_TAMPCR_TAMP3E))
#endif /* RTC_TAMPER3_SUPPORT */
...
#    define __HAL_RTC_INTERNAL_TIMESTAMP_ENABLE(__HANDLE__) \
        ((__HANDLE__)->Instance->CR |= (RTC_CR_ITSE))
 ...
 * @retval None
 */
#    define __HAL_RTC_INTERNAL_TIMESTAMP_GET_FLAG(__HANDLE__, __FLAG__) \
        (((((__HANDLE__)->Instance->ISR) & (__FLAG__)) != 0U) ? 1U : 0U)
 ...
 * @retval None
 */
#define __HAL_RTC_TAMPER_TIMESTAMP_EXTIC2_ENABLE_IT() \
    (EXTI->C2IMR1 |= RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT)
 ...
 * @retval None
 */
#define __HAL_RTC_TAMPER_TIMESTAMP_EXTIC2_DISABLE_IT() \
    (EXTI->C2IMR1 &= ~(RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT))
...
#define __HAL_RTC_TAMPER_TIMESTAMP_EXTI_ENABLE_EVENT() \
    (EXTI->EMR1 |= RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT)

/**
 * @brief  Enable event on the RTC Tamper and Timestamp associated Exti line of core 2.
 * @retval None.
 */
#define __HAL_RTC_TAMPER_TIMESTAMP_EXTIC2_ENABLE_EVENT() \
    (EXTI->C2EMR1 |= RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT)
 ...
 * @retval None.
 */
#define __HAL_RTC_TAMPER_TIMESTAMP_EXTIC2_DISABLE_EVENT() \
    (EXTI->C2EMR1 &= ~(RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT))
...
#define __HAL_RTC_TAMPER_TIMESTAMP_EXTI_ENABLE_FALLING_EDGE() \
    (EXTI->FTSR1 |= RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT)
...
#define __HAL_RTC_TAMPER_TIMESTAMP_EXTI_ENABLE_RISING_EDGE() \
    (EXTI->RTSR1 |= RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT)
...
/**
 * @brief  Enable rising & falling edge trigger on the RTC Tamper and Timestamp associated Exti
 * line.
 * @retval None.
 */
...
/**
 * @brief  Disable rising & falling edge trigger on the RTC Tamper and Timestamp associated Exti
 * line. This parameter can be:
 * @retval None.
 */
...
/**
 * @brief Check whether the RTC Tamper and Timestamp associated Exti line interrupt flag is set or
 * not of core 1.
 * @retval Line Status.
 */
#define __HAL_RTC_TAMPER_TIMESTAMP_EXTI_GET_FLAG() \
    (EXTI->PR1 & RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT)
 ...
 * @retval Line Status.
 */
#define __HAL_RTC_TAMPER_TIMESTAMP_EXTIC2_GET_FLAG() \
    (EXTI->PR1 & RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT)
 ...
 * @retval None.
 */
#define __HAL_RTC_TAMPER_TIMESTAMP_EXTIC2_CLEAR_FLAG() \
    (EXTI->PR1 = RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT)
...
#define __HAL_RTC_TAMPER_TIMESTAMP_EXTI_GENERATE_SWIT() \
    (EXTI->SWIER1 |= RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT)
...
HAL_StatusTypeDef HAL_RTCEx_SetWakeUpTimer(RTC_HandleTypeDef* hrtc, uint32_t WakeUpCounter,
                                           uint32_t WakeUpClock);
HAL_StatusTypeDef HAL_RTCEx_SetWakeUpTimer_IT(RTC_HandleTypeDef* hrtc, uint32_t WakeUpCounter,
                                              uint32_t WakeUpClock);
...
#    define RTC_FLAGS_MASK                                                                   \
        ((uint32_t)(RTC_FLAG_RECALPF | RTC_FLAG_TAMP3F | RTC_FLAG_TAMP2F | RTC_FLAG_TAMP1F | \
...
#    define RTC_TAMPCR_TAMPXE \
        ((uint32_t)(RTC_TAMPCR_TAMP3E | RTC_TAMPCR_TAMP2E | RTC_TAMPCR_TAMP1E))
#    define RTC_TAMPCR_TAMPXIE                                                              \
        ((uint32_t)(RTC_TAMPER1_INTERRUPT | RTC_TAMPER2_INTERRUPT | RTC_TAMPER3_INTERRUPT | \
                    RTC_ALL_TAMPER_INTERRUPT))

#else

#    define RTC_FLAGS_MASK                                                               \
        ((uint32_t)(RTC_FLAG_RECALPF | RTC_FLAG_TAMP2F | RTC_FLAG_TSOVF | RTC_FLAG_TSF | \
...
#define RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT                                                    \
    (EXTI_IMR1_IM18) /*!< External interrupt line 18 Connected to the RTC Tamper and Time Stamp \
                        events */
#define RTC_EXTI_LINE_WAKEUPTIMER_EVENT \
    (EXTI_IMR1_IM19) /*!< External interrupt line 19 Connected to the RTC Wakeup event */
...
#define IS_RTC_OUTPUT(OUTPUT)                                               \
    (((OUTPUT) == RTC_OUTPUT_DISABLE) || ((OUTPUT) == RTC_OUTPUT_ALARMA) || \
     ((OUTPUT) == RTC_OUTPUT_ALARMB) || ((OUTPUT) == RTC_OUTPUT_WAKEUP))

#define IS_RTC_BKP(BKP) ((BKP) < (uint32_t)RTC_BKP_NUMBER)

#define IS_TIMESTAMP_EDGE(EDGE) \
    (((EDGE) == RTC_TIMESTAMPEDGE_RISING) || ((EDGE) == RTC_TIMESTAMPEDGE_FALLING))

#define IS_RTC_TAMPER(TAMPER) \
    ((((TAMPER) & ((uint32_t)(0xFFFFFFFFU ^ RTC_TAMPCR_TAMPXE))) == 0x00U) && ((TAMPER) != 0U))

#define IS_RTC_TAMPER_INTERRUPT(INTERRUPT) \
    ((((INTERRUPT) & (uint32_t)(0xFFFFFFFFU ^ RTC_TAMPCR_TAMPXIE)) == 0x00U) && ((INTERRUPT) != 0U))

#define IS_RTC_TIMESTAMP_PIN(PIN) (((PIN) == RTC_TIMESTAMPPIN_DEFAULT))

#define IS_RTC_TAMPER_TRIGGER(TRIGGER)                                                            \
    (((TRIGGER) == RTC_TAMPERTRIGGER_RISINGEDGE) ||                                               \
     ((TRIGGER) == RTC_TAMPERTRIGGER_FALLINGEDGE) || ((TRIGGER) == RTC_TAMPERTRIGGER_LOWLEVEL) || \
     ((TRIGGER) == RTC_TAMPERTRIGGER_HIGHLEVEL))

#define IS_RTC_TAMPER_ERASE_MODE(MODE) \
    (((MODE) == RTC_TAMPER_ERASE_BACKUP_ENABLE) || ((MODE) == RTC_TAMPER_ERASE_BACKUP_DISABLE))

#define IS_RTC_TAMPER_MASKFLAG_STATE(STATE) \
    (((STATE) == RTC_TAMPERMASK_FLAG_ENABLE) || ((STATE) == RTC_TAMPERMASK_FLAG_DISABLE))

#define IS_RTC_TAMPER_FILTER(FILTER)                                                     \
    (((FILTER) == RTC_TAMPERFILTER_DISABLE) || ((FILTER) == RTC_TAMPERFILTER_2SAMPLE) || \
     ((FILTER) == RTC_TAMPERFILTER_4SAMPLE) || ((FILTER) == RTC_TAMPERFILTER_8SAMPLE))
...
#define IS_RTC_TAMPER_PULLUP_STATE(STATE) \
    (((STATE) == RTC_TAMPER_PULLUP_ENABLE) || ((STATE) == RTC_TAMPER_PULLUP_DISABLE))

#define IS_RTC_WAKEUP_CLOCK(CLOCK)                                                            \
    (((CLOCK) == RTC_WAKEUPCLOCK_RTCCLK_DIV16) || ((CLOCK) == RTC_WAKEUPCLOCK_RTCCLK_DIV8) || \
     ((CLOCK) == RTC_WAKEUPCLOCK_RTCCLK_DIV4) || ((CLOCK) == RTC_WAKEUPCLOCK_RTCCLK_DIV2) ||  \
     ((CLOCK) == RTC_WAKEUPCLOCK_CK_SPRE_16BITS) || ((CLOCK) == RTC_WAKEUPCLOCK_CK_SPRE_17BITS))

#define IS_RTC_WAKEUP_COUNTER(COUNTER) ((COUNTER) <= RTC_WUTR_WUT)

#define IS_RTC_SMOOTH_CALIB_PERIOD(PERIOD)                                                       \
    (((PERIOD) == RTC_SMOOTHCALIB_PERIOD_32SEC) || ((PERIOD) == RTC_SMOOTHCALIB_PERIOD_16SEC) || \
     ((PERIOD) == RTC_SMOOTHCALIB_PERIOD_8SEC))

#define IS_RTC_SMOOTH_CALIB_PLUS(PLUS) \
    (((PLUS) == RTC_SMOOTHCALIB_PLUSPULSES_SET) || ((PLUS) == RTC_SMOOTHCALIB_PLUSPULSES_RESET))

/** @defgroup RTCEx_Smooth_calib_Minus_pulses_Definitions RTCEx Smooth calib Minus pulses
 * Definitions
 * @{
 */
