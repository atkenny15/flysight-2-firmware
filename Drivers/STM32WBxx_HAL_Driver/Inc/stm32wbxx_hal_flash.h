...
typedef struct {
    ...
    uint32_t NbPages;   /*!< Number of pages to be erased.
                             This parameter must be a value between 1 and (FLASH_PAGE_NB - value of
                           initial page)*/
...
typedef struct {
    uint32_t
        OptionType;          /*!< Option byte to be configured.
    ...
    uint32_t WRPEndOffset;   /*!< Write protection end offset (used for OPTIONBYTE_WRP).
                                  This parameter must be a value between WRPStartOffset and (max
                                number of pages - 1) */
    ...
    uint32_t UserConfig;     /*!< Value of the user option byte (used for OPTIONBYTE_USER).
                                  This parameter can be a combination of the values of
                                      ...
                                      @ref FLASH_OB_USER_RESET_CONFIG(*), @ref
                                FLASH_OB_USER_INPUT_RESET_HOLDER(*)
    ...
    uint32_t PCROPConfig;    /*!< Configuration of the PCROP (used for OPTIONBYTE_PCROP).
                                  This parameter must be a combination of values of @ref
                                FLASH_OB_PCROP_ZONE    and @ref FLASH_OB_PCROP_RDP */
    uint32_t PCROP1AStartAddr;     /*!< PCROP Zone A Start address (used for OPTIONBYTE_PCROP). It
                                      represents first address of start block     to protect. Make sure this
                                      parameter is multiple of PCROP granularity */
    uint32_t PCROP1AEndAddr;       /*!< PCROP Zone A End address (used for OPTIONBYTE_PCROP). It
                                      represents first address of end block       to protect. Make sure this
                                      parameter is multiple of PCROP granularity */
    uint32_t PCROP1BStartAddr;     /*!< PCROP Zone B Start address (used for OPTIONBYTE_PCROP). It
                                      represents first address of start block     to protect. Make sure this
                                      parameter is multiple of PCROP granularity */
    uint32_t PCROP1BEndAddr;       /*!< PCROP Zone B End address (used for OPTIONBYTE_PCROP). It
                                      represents first address of end block       to protect. Make sure this
                                      parameter is multiple of PCROP granularity */
    uint32_t SecureFlashStartAddr; /*!< Secure Flash start address (used for
                                      OPTIONBYTE_SECURE_MODE). This parameter must be a value
                                      between begin and end of Flash bank
                                        => Contains the start address of the first 4kB page of the
                                      secure Flash area */
    uint32_t SecureRAM2aStartAddr; /*!< Secure Backup RAM2a start address (used for
                                      OPTIONBYTE_SECURE_MODE). This parameter can be a value of @ref
                                      FLASH_SRAM2A_ADDRESS_RANGE */
    uint32_t SecureRAM2bStartAddr; /*!< Secure non-Backup RAM2b start address (used for
                                      OPTIONBYTE_SECURE_MODE) This parameter can be a value of @ref
                                      FLASH_SRAM2B_ADDRESS_RANGE */
    ...
    uint32_t C2SecureBootVectAddr; /*!< CPU2 Secure Boot reset vector (used for
                                      OPTIONBYTE_C2_BOOT_VECT). This parameter contains the CPU2
                                      boot reset start address within the selected memory region.
                                      Make sure this parameter is word aligned. */
    uint32_t IPCCdataBufAddr;      /*!< IPCC mailbox data buffer base address (used for
                                      OPTIONBYTE_IPCC_BUF_ADDR).      This parameter contains the IPCC mailbox
                                      data buffer start address area in SRAM2.      Make sure this parameter
...
typedef struct {
    ...
    uint32_t ProcedureOnGoing; /* Internal variable to indicate which procedure is ongoing or not in
                                  IT context */
    ...
    uint32_t
        NbPagesToErase; /* Internal variable to save the remaining pages to erase in IT context */
...
#define FLASH_FLAG_SR_ERRORS                                                          \
    (FLASH_FLAG_OPERR | FLASH_FLAG_PROGERR | FLASH_FLAG_WRPERR | FLASH_FLAG_PGAERR |  \
     FLASH_FLAG_SIZERR | FLASH_FLAG_PGSERR | FLASH_FLAG_MISERR | FLASH_FLAG_FASTERR | \
     FLASH_FLAG_RDERR | FLASH_FLAG_OPTVERR) /*!< All SR error flags */
...
#define FLASH_IT_ECCC \
    (FLASH_ECCR_ECCCIE >> FLASH_ECCR_ECCCIE_Pos) /*!< ECC Correction Interrupt source */
/**
 * @}
 */
...
#define FLASH_TYPEPROGRAM_DOUBLEWORD \
    FLASH_CR_PG /*!< Program a double-word (64-bit) at a specified address.*/
#define FLASH_TYPEPROGRAM_FAST                                                             \
    FLASH_CR_FSTPG /*!< Fast program a 64 row double-word (64-bit) at a specified address. \
...
#define OPTIONBYTE_ALL                                                      \
    (OPTIONBYTE_WRP | OPTIONBYTE_RDP | OPTIONBYTE_USER | OPTIONBYTE_PCROP | \
     OPTIONBYTE_IPCC_BUF_ADDR | OPTIONBYTE_C2_BOOT_VECT |                   \
...
#    define OB_USER_ALL                                                                            \
        (OB_USER_BOR_LEV | OB_USER_nRST_STOP | OB_USER_nRST_STDBY | OB_USER_nRST_SHDW |            \
         OB_USER_IWDG_SW | OB_USER_IWDG_STOP | OB_USER_IWDG_STDBY | OB_USER_WWDG_SW |              \
         OB_USER_nBOOT1 | OB_USER_SRAM2PE | OB_USER_SRAM2RST | OB_USER_nSWBOOT0 | OB_USER_nBOOT0 | \
         OB_USER_AGC_TRIM | OB_USER_NRST_MODE |                                                    \
...
#    define OB_USER_ALL                                                                            \
        (OB_USER_BOR_LEV | OB_USER_nRST_STOP | OB_USER_nRST_STDBY | OB_USER_nRST_SHDW |            \
         OB_USER_IWDG_SW | OB_USER_IWDG_STOP | OB_USER_IWDG_STDBY | OB_USER_WWDG_SW |              \
         OB_USER_nBOOT1 | OB_USER_SRAM2PE | OB_USER_SRAM2RST | OB_USER_nSWBOOT0 | OB_USER_nBOOT0 | \
         OB_USER_AGC_TRIM) /*!< all option bits */
#endif                     /* FLASH_OPTR_IRHEN */
...
#define OB_AGC_TRIM_3                                                                            \
    (FLASH_OPTR_AGC_TRIM_1 | FLASH_OPTR_AGC_TRIM_0) /*!< Automatic Gain Control Trimming Value 3 \
                                                     */
#define OB_AGC_TRIM_4 FLASH_OPTR_AGC_TRIM_2         /*!< Automatic Gain Control Trimming Value 4 */
#define OB_AGC_TRIM_5                                                                            \
    (FLASH_OPTR_AGC_TRIM_2 | FLASH_OPTR_AGC_TRIM_0) /*!< Automatic Gain Control Trimming Value 5 \
                                                     */
#define OB_AGC_TRIM_6                                                                            \
    (FLASH_OPTR_AGC_TRIM_2 | FLASH_OPTR_AGC_TRIM_1) /*!< Automatic Gain Control Trimming Value 6 \
                                                     */
#define OB_AGC_TRIM_7                                \
    (FLASH_OPTR_AGC_TRIM_2 | FLASH_OPTR_AGC_TRIM_1 | \
     FLASH_OPTR_AGC_TRIM_0) /*!< Automatic Gain Control Trimming Value 7 */
/**
 * @}
 */
...
#define OB_BOR_LEVEL_3 \
    (FLASH_OPTR_BOR_LEV_0 | FLASH_OPTR_BOR_LEV_1) /*!< Reset level threshold is around 2.5V */
...
#define OB_IWDG_STDBY_RUN \
    FLASH_OPTR_IWDG_STDBY /*!< Independent watchdog counter is running in Standby mode */
/**
 * @}
 */
 ...
 * @{
 */
#    define OB_RESET_MODE_INPUT_ONLY \
...
#    define OB_RESET_MODE_INPUT_OUTPUT \
        (FLASH_OPTR_nRST_MODE_0 |      \
         FLASH_OPTR_nRST_MODE_1) /*!< Reset pin is in Reset input and output mode */
/**
 * @}
 */
#endif /* FLASH_OPTR_nRST_MODE */
...
#define SRAM2A_START_SECURE_ADDR_0                                                               \
    (SRAM2A_BASE + 0x0000U) /*  When in secure mode (SRAM2A_BASE + 0x0000) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_1                                                               \
    (SRAM2A_BASE + 0x0400U) /*  When in secure mode (SRAM2A_BASE + 0x0400) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_2                                                               \
    (SRAM2A_BASE + 0x0800U) /*  When in secure mode (SRAM2A_BASE + 0x0800) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_3                                                               \
    (SRAM2A_BASE + 0x0C00U) /*  When in secure mode (SRAM2A_BASE + 0x0C00) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_4                                                               \
    (SRAM2A_BASE + 0x1000U) /*  When in secure mode (SRAM2A_BASE + 0x1000) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_5                                                               \
    (SRAM2A_BASE + 0x1400U) /*  When in secure mode (SRAM2A_BASE + 0x1400) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_6                                                               \
    (SRAM2A_BASE + 0x1800U) /*  When in secure mode (SRAM2A_BASE + 0x1800) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_7                                                               \
    (SRAM2A_BASE + 0x1C00U) /*  When in secure mode (SRAM2A_BASE + 0x1C00) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_8                                                               \
    (SRAM2A_BASE + 0x2000U) /*  When in secure mode (SRAM2A_BASE + 0x2000) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_9                                                               \
    (SRAM2A_BASE + 0x2400U) /*  When in secure mode (SRAM2A_BASE + 0x2400) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_10                                                              \
    (SRAM2A_BASE + 0x2800U) /*  When in secure mode (SRAM2A_BASE + 0x2800) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_11                                                              \
    (SRAM2A_BASE + 0x2C00U) /*  When in secure mode (SRAM2A_BASE + 0x2C00) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_12                                                              \
    (SRAM2A_BASE + 0x3000U) /*  When in secure mode (SRAM2A_BASE + 0x3000) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_13                                                              \
    (SRAM2A_BASE + 0x3400U) /*  When in secure mode (SRAM2A_BASE + 0x3400) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_14                                                              \
    (SRAM2A_BASE + 0x3800U) /*  When in secure mode (SRAM2A_BASE + 0x3800) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_15                                                              \
    (SRAM2A_BASE + 0x3C00U) /*  When in secure mode (SRAM2A_BASE + 0x3C00) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_16                                                              \
    (SRAM2A_BASE + 0x4000U) /*  When in secure mode (SRAM2A_BASE + 0x4000) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_17                                                              \
    (SRAM2A_BASE + 0x4400U) /*  When in secure mode (SRAM2A_BASE + 0x4400) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_18                                                              \
    (SRAM2A_BASE + 0x4800U) /*  When in secure mode (SRAM2A_BASE + 0x4800) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_19                                                              \
    (SRAM2A_BASE + 0x4C00U) /*  When in secure mode (SRAM2A_BASE + 0x4C00) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_20                                                              \
    (SRAM2A_BASE + 0x5000U) /*  When in secure mode (SRAM2A_BASE + 0x5000) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_21                                                              \
    (SRAM2A_BASE + 0x5400U) /*  When in secure mode (SRAM2A_BASE + 0x5400) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_22                                                              \
    (SRAM2A_BASE + 0x5800U) /*  When in secure mode (SRAM2A_BASE + 0x5800) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_23                                                              \
    (SRAM2A_BASE + 0x5C00U) /*  When in secure mode (SRAM2A_BASE + 0x5C00) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_24                                                              \
    (SRAM2A_BASE + 0x6000U) /*  When in secure mode (SRAM2A_BASE + 0x6000) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_25                                                              \
    (SRAM2A_BASE + 0x6400U) /*  When in secure mode (SRAM2A_BASE + 0x6400) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_26                                                              \
    (SRAM2A_BASE + 0x6800U) /*  When in secure mode (SRAM2A_BASE + 0x6800) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_27                                                              \
    (SRAM2A_BASE + 0x6C00U) /*  When in secure mode (SRAM2A_BASE + 0x6C00) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_28                                                              \
    (SRAM2A_BASE + 0x7000U) /*  When in secure mode (SRAM2A_BASE + 0x7000) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_29                                                              \
    (SRAM2A_BASE + 0x7400U) /*  When in secure mode (SRAM2A_BASE + 0x7400) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_30                                                              \
    (SRAM2A_BASE + 0x7800U) /*  When in secure mode (SRAM2A_BASE + 0x7800) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_START_SECURE_ADDR_31                                                              \
    (SRAM2A_BASE + 0x7C00U) /*  When in secure mode (SRAM2A_BASE + 0x7C00) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2A_FULL_UNSECURE \
    (SRAM2A_BASE + 0x8000U) /*  The RAM2A is accessible to M0 Plus and M4 */
...
#define SRAM2B_START_SECURE_ADDR_0                                                               \
    (SRAM2B_BASE + 0x0000U) /*  When in secure mode (SRAM2B_BASE + 0x0000) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2B_START_SECURE_ADDR_1                                                               \
    (SRAM2B_BASE + 0x0400U) /*  When in secure mode (SRAM2B_BASE + 0x0400) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2B_START_SECURE_ADDR_2                                                               \
    (SRAM2B_BASE + 0x0800U) /*  When in secure mode (SRAM2B_BASE + 0x0800) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#define SRAM2B_START_SECURE_ADDR_3                                                               \
    (SRAM2B_BASE + 0x0C00U) /*  When in secure mode (SRAM2B_BASE + 0x0C00) -> SRAM2B_END_ADDR is \
                               accessible only by M0 Plus  */
#if !defined(STM32WB10xx) && !defined(STM32WB15xx) && !defined(STM32WB1Mxx)
#    define SRAM2B_START_SECURE_ADDR_4                                                            \
        (SRAM2B_BASE + 0x1000U) /*  When in secure mode (SRAM2B_BASE + 0x1000) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_5                                                            \
        (SRAM2B_BASE + 0x1400U) /*  When in secure mode (SRAM2B_BASE + 0x1400) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_6                                                            \
        (SRAM2B_BASE + 0x1800U) /*  When in secure mode (SRAM2B_BASE + 0x1800) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_7                                                            \
        (SRAM2B_BASE + 0x1C00U) /*  When in secure mode (SRAM2B_BASE + 0x1C00) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_8                                                            \
        (SRAM2B_BASE + 0x2000U) /*  When in secure mode (SRAM2B_BASE + 0x2000) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_9                                                            \
        (SRAM2B_BASE + 0x2400U) /*  When in secure mode (SRAM2B_BASE + 0x2400) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_10                                                           \
        (SRAM2B_BASE + 0x2800U) /*  When in secure mode (SRAM2B_BASE + 0x2800) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_11                                                           \
        (SRAM2B_BASE + 0x2C00U) /*  When in secure mode (SRAM2B_BASE + 0x2C00) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_12                                                           \
        (SRAM2B_BASE + 0x3000U) /*  When in secure mode (SRAM2B_BASE + 0x3000) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_13                                                           \
        (SRAM2B_BASE + 0x3400U) /*  When in secure mode (SRAM2B_BASE + 0x3400) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_14                                                           \
        (SRAM2B_BASE + 0x3800U) /*  When in secure mode (SRAM2B_BASE + 0x3800) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_15                                                           \
        (SRAM2B_BASE + 0x3C00U) /*  When in secure mode (SRAM2B_BASE + 0x3C00) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_16                                                           \
        (SRAM2B_BASE + 0x4000U) /*  When in secure mode (SRAM2B_BASE + 0x4000) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_17                                                           \
        (SRAM2B_BASE + 0x4400U) /*  When in secure mode (SRAM2B_BASE + 0x4400) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_18                                                           \
        (SRAM2B_BASE + 0x4800U) /*  When in secure mode (SRAM2B_BASE + 0x4800) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_19                                                           \
        (SRAM2B_BASE + 0x4C00U) /*  When in secure mode (SRAM2B_BASE + 0x4C00) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_20                                                           \
        (SRAM2B_BASE + 0x5000U) /*  When in secure mode (SRAM2B_BASE + 0x5000) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_21                                                           \
        (SRAM2B_BASE + 0x5400U) /*  When in secure mode (SRAM2B_BASE + 0x5400) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_22                                                           \
        (SRAM2B_BASE + 0x5800U) /*  When in secure mode (SRAM2B_BASE + 0x5800) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_23                                                           \
        (SRAM2B_BASE + 0x5C00U) /*  When in secure mode (SRAM2B_BASE + 0x5C00) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_24                                                           \
        (SRAM2B_BASE + 0x6000U) /*  When in secure mode (SRAM2B_BASE + 0x6000) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_25                                                           \
        (SRAM2B_BASE + 0x6400U) /*  When in secure mode (SRAM2B_BASE + 0x6400) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_26                                                           \
        (SRAM2B_BASE + 0x6800U) /*  When in secure mode (SRAM2B_BASE + 0x6800) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_27                                                           \
        (SRAM2B_BASE + 0x6C00U) /*  When in secure mode (SRAM2B_BASE + 0x6C00) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_28                                                           \
        (SRAM2B_BASE + 0x7000U) /*  When in secure mode (SRAM2B_BASE + 0x7000) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_29                                                           \
        (SRAM2B_BASE + 0x7400U) /*  When in secure mode (SRAM2B_BASE + 0x7400) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_30                                                           \
        (SRAM2B_BASE + 0x7800U) /*  When in secure mode (SRAM2B_BASE + 0x7800) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_START_SECURE_ADDR_31                                                           \
        (SRAM2B_BASE + 0x7C00U) /*  When in secure mode (SRAM2B_BASE + 0x7C00) -> SRAM2B_END_ADDR \
                                   is accessible only by M0 Plus  */
#    define SRAM2B_FULL_UNSECURE \
        (SRAM2B_BASE + 0x8000U) /*  The RAM2B is accessible to M0 Plus and M4 */
#else
#    define SRAM2B_FULL_UNSECURE \
        (SRAM2B_BASE + 0x1000U) /*  The RAM2B is accessible to M0 Plus and M4 */
...
#define __HAL_FLASH_ENABLE_IT(__INTERRUPT__)                          \
    do {                                                              \
        if (((__INTERRUPT__)&FLASH_IT_ECCC) != 0U) {                  \
            SET_BIT(FLASH->ECCR, FLASH_ECCR_ECCCIE);                  \
        }                                                             \
        if (((__INTERRUPT__) & (~FLASH_IT_ECCC)) != 0U) {             \
...
#define __HAL_FLASH_DISABLE_IT(__INTERRUPT__)                           \
    do {                                                                \
        if (((__INTERRUPT__)&FLASH_IT_ECCC) != 0U) {                    \
            CLEAR_BIT(FLASH->ECCR, FLASH_ECCR_ECCCIE);                  \
        }                                                               \
        if (((__INTERRUPT__) & (~FLASH_IT_ECCC)) != 0U) {               \
...
#    define FLASH_PCROP_GRANULARITY_OFFSET \
        10U /*!< FLASH Code Readout Protection granularity offset */
#    define FLASH_PCROP_GRANULARITY                                                               \
        (1UL << FLASH_PCROP_GRANULARITY_OFFSET) /*!< FLASH Code Readout Protection granularity, 1 \
                                                   KBytes */
#else
#    define FLASH_PCROP_GRANULARITY_OFFSET \
        11U /*!< FLASH Code Readout Protection granularity offset */
#    define FLASH_PCROP_GRANULARITY                                                               \
        (1UL << FLASH_PCROP_GRANULARITY_OFFSET) /*!< FLASH Code Readout Protection granularity, 2 \
                                                   KBytes */
#endif                                          /* STM32WB10xx || STM32WB15xx || STM32WB1Mxx */
 ...
 * @{
 */
#define SRAM_SECURE_PAGE_GRANULARITY_OFFSET \
    10U /*!< Secure SRAM2A and SRAM2B Protection granularity offset */
#define SRAM_SECURE_PAGE_GRANULARITY                                                      \
    (1UL << SRAM_SECURE_PAGE_GRANULARITY_OFFSET) /*!< Secure SRAM2A and SRAM2B Protection \
                                                    granularity, 1KBytes */
/**
 * @}
 */
 ...
 *  @{
 */
#define IS_FLASH_MAIN_MEM_ADDRESS(__VALUE__) \
    (((__VALUE__) >= FLASH_BASE) && ((__VALUE__) <= (FLASH_BASE + FLASH_SIZE - 1UL)))

#define IS_FLASH_FAST_PROGRAM_ADDRESS(__VALUE__)                                          \
    (((__VALUE__) >= FLASH_BASE) && ((__VALUE__) <= (FLASH_BASE + FLASH_SIZE - 256UL)) && \
     (((__VALUE__) % 256UL) == 0UL))
...
#define IS_FLASH_PROGRAM_OTP_ADDRESS(__VALUE__)                                            \
    (((__VALUE__) >= OTP_AREA_BASE) && ((__VALUE__) <= (OTP_AREA_END_ADDR + 1UL - 8UL)) && \
     (((__VALUE__) % 8UL) == 0UL))

#define IS_FLASH_PROGRAM_ADDRESS(__VALUE__) \
    (IS_FLASH_PROGRAM_MAIN_MEM_ADDRESS(__VALUE__) || IS_FLASH_PROGRAM_OTP_ADDRESS(__VALUE__))
...
#define IS_OB_SFSA_START_ADDR(__VALUE__)                               \
    (((__VALUE__) >= FLASH_BASE) && ((__VALUE__) <= FLASH_END_ADDR) && \
     (((__VALUE__) & ~(uint32_t)(FLASH_PAGE_SIZE - 1U)) == (__VALUE__)))
#define IS_OB_SBRSA_START_ADDR(__VALUE__)                                                 \
    (((__VALUE__) >= SRAM2A_BASE) && ((__VALUE__) <= (SRAM2A_BASE + SRAM2A_SIZE - 1U)) && \
     (((__VALUE__) & ~0x3FFU) == (__VALUE__)))
#define IS_OB_SNBRSA_START_ADDR(__VALUE__)                                                \
    (((__VALUE__) >= SRAM2B_BASE) && ((__VALUE__) <= (SRAM2B_BASE + SRAM2B_SIZE - 1U)) && \
     (((__VALUE__) & ~0x3FFU) == (__VALUE__)))
#define IS_OB_SECURE_MODE(__VALUE__) \
    (((__VALUE__) == SYSTEM_IN_SECURE_MODE) || ((__VALUE__) == SYSTEM_NOT_IN_SECURE_MODE))
...
#define IS_OB_WRPAREA(__VALUE__) \
    (((__VALUE__) == OB_WRPAREA_BANK1_AREAA) || ((__VALUE__) == OB_WRPAREA_BANK1_AREAB))

#define IS_OB_RDP_LEVEL(__VALUE__)                                         \
    (((__VALUE__) == OB_RDP_LEVEL_0) || ((__VALUE__) == OB_RDP_LEVEL_1) || \
     ((__VALUE__) == OB_RDP_LEVEL_2))

#define IS_OB_USER_TYPE(__VALUE__) \
    ((((__VALUE__)&OB_USER_ALL) != 0U) && (((__VALUE__) & ~OB_USER_ALL) == 0U))

#define IS_OB_USER_CONFIG(__TYPE__, __VALUE__)                                              \
    ((((__TYPE__)&OB_USER_BOR_LEV) == OB_USER_BOR_LEV)                                      \
...
#define IS_OB_USER_AGC_TRIMMING(__VALUE__)                               \
    (((__VALUE__) == OB_AGC_TRIM_0) || ((__VALUE__) == OB_AGC_TRIM_1) || \
...
#define IS_OB_USER_BOR_LEVEL(__VALUE__)                                    \
    (((__VALUE__) == OB_BOR_LEVEL_0) || ((__VALUE__) == OB_BOR_LEVEL_1) || \
     ((__VALUE__) == OB_BOR_LEVEL_2) || ((__VALUE__) == OB_BOR_LEVEL_3) || \
     ((__VALUE__) == OB_BOR_LEVEL_4))

#define IS_OB_PCROP_CONFIG(__VALUE__) \
    (((__VALUE__) & ~(OB_PCROP_ZONE_A | OB_PCROP_ZONE_B | OB_PCROP_RDP_ERASE)) == 0U)

#define IS_OB_IPCC_BUF_ADDR(__VALUE__) \
    (IS_OB_SBRSA_START_ADDR(__VALUE__) || IS_OB_SNBRSA_START_ADDR(__VALUE__))

#define IS_OB_BOOT_VECTOR_ADDR(__VALUE__)                                                   \
    ((((__VALUE__) >= FLASH_BASE) && ((__VALUE__) <= (FLASH_BASE + FLASH_SIZE - 1U))) ||    \
     (((__VALUE__) >= SRAM1_BASE) && ((__VALUE__) <= (SRAM1_BASE + SRAM1_SIZE - 1U))) ||    \
     (((__VALUE__) >= SRAM2A_BASE) && ((__VALUE__) <= (SRAM2A_BASE + SRAM2A_SIZE - 1U))) || \
     (((__VALUE__) >= SRAM2B_BASE) && ((__VALUE__) <= (SRAM2B_BASE + SRAM2B_SIZE - 1U))))

#define IS_OB_BOOT_REGION(__VALUE__) \
    (((__VALUE__) == OB_C2_BOOT_FROM_FLASH) || ((__VALUE__) == OB_C2_BOOT_FROM_SRAM))

#define IS_OB_SECURE_CONFIG(__VALUE__) \
    (((__VALUE__) & ~(OB_SECURE_CONFIG_MEMORY | OB_SECURE_CONFIG_BOOT_RESET)) == 0U)

#define IS_FLASH_LATENCY(__VALUE__)                                          \
    (((__VALUE__) == FLASH_LATENCY_0) || ((__VALUE__) == FLASH_LATENCY_1) || \
     ((__VALUE__) == FLASH_LATENCY_2) || ((__VALUE__) == FLASH_LATENCY_3))
/**
 * @}
 */
