...
#        define ADC_REG_SQRX_REGOFFSET_MASK \
            (ADC_SQR1_REGOFFSET | ADC_SQR2_REGOFFSET | ADC_SQR3_REGOFFSET | ADC_SQR4_REGOFFSET)
...
#        define ADC_REG_RANK_1_SQRX_BITOFFSET_POS \
            (0UL) /* Value equivalent to bitfield "ADC_CHSELR_SQ1" position in register */
#        define ADC_REG_RANK_2_SQRX_BITOFFSET_POS \
            (4UL) /* Value equivalent to bitfield "ADC_CHSELR_SQ2" position in register */
#        define ADC_REG_RANK_3_SQRX_BITOFFSET_POS \
            (8UL) /* Value equivalent to bitfield "ADC_CHSELR_SQ3" position in register */
#        define ADC_REG_RANK_4_SQRX_BITOFFSET_POS \
            (12UL) /* Value equivalent to bitfield "ADC_CHSELR_SQ4" position in register */
#        define ADC_REG_RANK_5_SQRX_BITOFFSET_POS \
            (16UL) /* Value equivalent to bitfield "ADC_CHSELR_SQ5" position in register */
#        define ADC_REG_RANK_6_SQRX_BITOFFSET_POS \
            (20UL) /* Value equivalent to bitfield "ADC_CHSELR_SQ6" position in register */
#        define ADC_REG_RANK_7_SQRX_BITOFFSET_POS \
            (24UL) /* Value equivalent to bitfield "ADC_CHSELR_SQ7" position in register */
#        define ADC_REG_RANK_8_SQRX_BITOFFSET_POS \
            (28UL) /* Value equivalent to bitfield "ADC_CHSELR_SQ8" position in register */
#    else
#        define ADC_REG_RANK_1_SQRX_BITOFFSET_POS \
            (6UL) /* Value equivalent to bitfield "ADC_SQR1_SQ1" position in register */
#        define ADC_REG_RANK_2_SQRX_BITOFFSET_POS \
...
#        define ADC_REG_RANK_5_SQRX_BITOFFSET_POS \
            (0UL) /* Value equivalent to bitfield "ADC_SQR2_SQ5" position in register */
#        define ADC_REG_RANK_6_SQRX_BITOFFSET_POS \
            (6UL) /* Value equivalent to bitfield "ADC_SQR2_SQ6" position in register */
#        define ADC_REG_RANK_7_SQRX_BITOFFSET_POS \
...
#    define ADC_INJ_JDRX_REGOFFSET_MASK \
        (ADC_JDR1_REGOFFSET | ADC_JDR2_REGOFFSET | ADC_JDR3_REGOFFSET | ADC_JDR4_REGOFFSET)
...
#    define ADC_REG_TRIG_EXT_EDGE_DEFAULT                                                         \
        (ADC_CFGR_EXTEN_0) /* Trigger edge set to rising edge (default setting for compatibility  \
...
#    define ADC_INJ_TRIG_EXT_EDGE_DEFAULT                                                          \
        (ADC_JSQR_JEXTEN_0) /* Trigger edge set to rising edge (default setting for compatibility  \
                               with some ADC on other STM32 families having this setting set by HW \
                               default value) */
...
#    define ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS                                                  \
        (26UL) /* Value equivalent to bitfield "ADC_CHANNEL_ID_NUMBER_MASK" position in register \
                */
#    if defined(ADC_SUPPORT_2_5_MSPS)
#        define ADC_CHANNEL_ID_NUMBER_MASK_SEQ                                                     \
            (ADC_CHSELR_SQ1                                                                        \
             << ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS) /* Value equivalent to                        \
                                                        ADC_CHANNEL_ID_NUMBER_MASK with reduced    \
                                                        range: on this STM32 series, ADC group     \
                                                        regular sequencer, if set to mode "fully   \
                                                        configurable", can contain channels with a \
                                                        restricted channel number. Refer to        \
                                                        function @ref                              \
...
#    define ADC_CHANNEL_ID_NUMBER_MASK_POSBIT0                                                   \
        (0x0000001FUL) /* Equivalent to shift: (ADC_CHANNEL_NUMBER_MASK >> [Position of bitfield \
                          "ADC_CHANNEL_NUMBER_MASK" in register]) */

/* Channel differentiation between external and internal channels */
#    define ADC_CHANNEL_ID_INTERNAL_CH (0x80000000UL) /* Marker of internal channel */
#    define ADC_CHANNEL_ID_INTERNAL_CH_2                                                           \
        (0x00080000UL) /* Marker of internal channel for other ADC instances, in case of different \
                          ADC internal channels mapped on same channel number on different ADC     \
                          instances */
...
#    define ADC_SMPRX_REGOFFSET_POS \
        (25UL) /* Position of bits ADC_SMPRx_REGOFFSET in ADC_CHANNEL_SMPRX_REGOFFSET_MASK */

#    define ADC_CHANNEL_SMPx_BITOFFSET_MASK (0x01F00000UL)
#    define ADC_CHANNEL_SMPx_BITOFFSET_POS                                                   \
        (20UL) /* Value equivalent to bitfield "ADC_CHANNEL_SMPx_BITOFFSET_MASK" position in \
                  register */
...
#    define ADC_CHANNEL_15_NUMBER \
        (ADC_CFGR_AWD1CH_3 | ADC_CFGR_AWD1CH_2 | ADC_CFGR_AWD1CH_1 | ADC_CFGR_AWD1CH_0)
...
#    define ADC_CHANNEL_0_SMP                                                                  \
        (ADC_SMPR1_REGOFFSET |                                                                 \
         ((0UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield \
                                                       "ADC_SMPR1_SMP0" position in register */
#    define ADC_CHANNEL_1_SMP                                                                  \
        (ADC_SMPR1_REGOFFSET |                                                                 \
         ((3UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield \
                                                       "ADC_SMPR1_SMP1" position in register */
#    define ADC_CHANNEL_2_SMP                                                                  \
        (ADC_SMPR1_REGOFFSET |                                                                 \
         ((6UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield \
                                                       "ADC_SMPR1_SMP2" position in register */
#    define ADC_CHANNEL_3_SMP                                                                  \
        (ADC_SMPR1_REGOFFSET |                                                                 \
         ((9UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield \
                                                       "ADC_SMPR1_SMP3" position in register */
#    define ADC_CHANNEL_4_SMP                                                                   \
        (ADC_SMPR1_REGOFFSET |                                                                  \
         ((12UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield \
                                                        "ADC_SMPR1_SMP4" position in register */
#    define ADC_CHANNEL_5_SMP                                                                   \
        (ADC_SMPR1_REGOFFSET |                                                                  \
         ((15UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield \
                                                        "ADC_SMPR1_SMP5" position in register */
#    define ADC_CHANNEL_6_SMP                                                                   \
        (ADC_SMPR1_REGOFFSET |                                                                  \
         ((18UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield \
                                                        "ADC_SMPR1_SMP6" position in register */
#    define ADC_CHANNEL_7_SMP                                                                   \
        (ADC_SMPR1_REGOFFSET |                                                                  \
         ((21UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield \
                                                        "ADC_SMPR1_SMP7" position in register */
#    define ADC_CHANNEL_8_SMP                                                                   \
        (ADC_SMPR1_REGOFFSET |                                                                  \
         ((24UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield \
                                                        "ADC_SMPR1_SMP8" position in register */
#    define ADC_CHANNEL_9_SMP                                                                   \
        (ADC_SMPR1_REGOFFSET |                                                                  \
         ((27UL) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to bitfield \
...
#        define ADC_SAMPLING_TIME_CH_MASK \
            (ADC_CHANNEL_ID_BITFIELD_MASK << ADC_SMPR_SMPSEL0_BITOFFSET_POS)
#        define ADC_SAMPLING_TIME_SMP_MASK (ADC_SMPR_SMP2 | ADC_SMPR_SMP1)
#        define ADC_SAMPLING_TIME_SMP_SHIFT_MASK \
            (ADC_SMPR_SMP2_BITOFFSET_POS | ADC_SMPR_SMP1_BITOFFSET_POS)
...
#    define ADC_SINGLEDIFF_CHANNEL_SHIFT_MASK                                                      \
        (ADC_CALFACT_CALFACT_S_4 |                                                                 \
         ADC_CALFACT_CALFACT_S_3) /* Bits chosen to perform of shift when single mode is selected, \
...
#    define ADC_SINGLEDIFF_CALIB_F_BIT_D_SHIFT4                                                  \
        (ADC_SINGLEDIFF_CALIB_F_BIT_D_POS - 4UL) /* Shift of bit ADC_SINGLEDIFF_CALIB_F_BIT_D to \
...
#    define ADC_AWD_CRX_REGOFFSET_POS \
        (20UL) /* Position of bits ADC_AWD_CRx_REGOFFSET in ADC_AWD_CRX_REGOFFSET_MASK */
...
#    define ADC_AWD_TRX_BIT_HIGH_MASK \
        (0x00010000UL) /* Selection of 1 bit to discriminate threshold high: mask of bit */
...
#    define ADC_AWD_TRX_BIT_HIGH_SHIFT4 \
        (ADC_AWD_TRX_BIT_HIGH_POS -     \
         4UL) /* Shift of bit ADC_AWD_TRX_BIT_HIGH to position to perform a shift of 4 ranks */
...
#    define ADC_OFRx_REGOFFSET_MASK \
        (ADC_OFR1_REGOFFSET | ADC_OFR2_REGOFFSET | ADC_OFR3_REGOFFSET | ADC_OFR4_REGOFFSET)

/* ADC registers bits positions */
#    if defined(ADC_SUPPORT_2_5_MSPS)
#        define ADC_CFGR1_RES_BITOFFSET_POS \
            (3UL) /* Value equivalent to bitfield "ADC_CFGR1_RES" position in register */
#        define ADC_CFGR1_AWDSGL_BITOFFSET_POS \
            (22UL) /* Value equivalent to bitfield "ADC_CFGR1_AWDSGL" position in register */
#        define ADC_TR_HT_BITOFFSET_POS \
            (16UL) /* Value equivalent to bitfield "ADC_TR_HT" position in register */
#        define ADC_CHSELR_CHSEL0_BITOFFSET_POS \
            (0UL) /* Value equivalent to bitfield "ADC_CHSELR_CHSEL0" position in register */
#        define ADC_CHSELR_CHSEL1_BITOFFSET_POS \
            (1UL) /* Value equivalent to bitfield "ADC_CHSELR_CHSEL1" position in register */
#        define ADC_CHSELR_CHSEL2_BITOFFSET_POS \
            (2UL) /* Value equivalent to bitfield "ADC_CHSELR_CHSEL2" position in register */
#        define ADC_CHSELR_CHSEL3_BITOFFSET_POS \
            (3UL) /* Value equivalent to bitfield "ADC_CHSELR_CHSEL3" position in register */
#        define ADC_CHSELR_CHSEL4_BITOFFSET_POS \
            (4UL) /* Value equivalent to bitfield "ADC_CHSELR_CHSEL4" position in register */
#        define ADC_CHSELR_CHSEL5_BITOFFSET_POS \
            (5UL) /* Value equivalent to bitfield "ADC_CHSELR_CHSEL5" position in register */
#        define ADC_CHSELR_CHSEL6_BITOFFSET_POS \
            (6UL) /* Value equivalent to bitfield "ADC_CHSELR_CHSEL6" position in register */
#        define ADC_CHSELR_CHSEL7_BITOFFSET_POS \
            (7UL) /* Value equivalent to bitfield "ADC_CHSELR_CHSEL7" position in register */
#        define ADC_CHSELR_CHSEL8_BITOFFSET_POS \
            (8UL) /* Value equivalent to bitfield "ADC_CHSELR_CHSEL8" position in register */
#        define ADC_CHSELR_CHSEL9_BITOFFSET_POS \
            (9UL) /* Value equivalent to bitfield "ADC_CHSELR_CHSEL9" position in register */
#        define ADC_CHSELR_CHSEL10_BITOFFSET_POS \
            (10UL) /* Value equivalent to bitfield "ADC_CHSELR_CHSEL10" position in register */
#        define ADC_CHSELR_CHSEL11_BITOFFSET_POS \
            (11UL) /* Value equivalent to bitfield "ADC_CHSELR_CHSEL11" position in register */
#        define ADC_CHSELR_CHSEL12_BITOFFSET_POS \
            (12UL) /* Value equivalent to bitfield "ADC_CHSELR_CHSEL12" position in register */
#        define ADC_CHSELR_CHSEL13_BITOFFSET_POS \
            (13UL) /* Value equivalent to bitfield "ADC_CHSELR_CHSEL13" position in register */
#        define ADC_CHSELR_CHSEL14_BITOFFSET_POS \
            (14UL) /* Value equivalent to bitfield "ADC_CHSELR_CHSEL14" position in register */
#        define ADC_CHSELR_CHSEL15_BITOFFSET_POS \
            (15UL) /* Value equivalent to bitfield "ADC_CHSELR_CHSEL15" position in register */
#        define ADC_CHSELR_CHSEL16_BITOFFSET_POS \
            (16UL) /* Value equivalent to bitfield "ADC_CHSELR_CHSEL16" position in register */
#        define ADC_CHSELR_CHSEL17_BITOFFSET_POS \
            (17UL) /* Value equivalent to bitfield "ADC_CHSELR_CHSEL17" position in register */
#        define ADC_CHSELR_CHSEL18_BITOFFSET_POS \
            (18UL) /* Value equivalent to bitfield "ADC_CHSELR_CHSEL18" position in register */
#        define ADC_SMPR_SMP1_BITOFFSET_POS \
            (0UL) /* Value equivalent to bitfield "ADC_SMPR_SMP1" position in register */
#        define ADC_SMPR_SMP2_BITOFFSET_POS \
            (4UL) /* Value equivalent to bitfield "ADC_SMPR_SMP2" position in register */
#        define ADC_SMPR_SMPSEL0_BITOFFSET_POS \
            (8UL) /* Value equivalent to bitfield "ADC_SMPR_SMPSEL0" position in register */
...
#    else
#        define ADC_CFGR_RES_BITOFFSET_POS \
            (3UL) /* Value equivalent to bitfield "ADC_CFGR_RES" position in register */
#        define ADC_CFGR_AWD1SGL_BITOFFSET_POS \
            (22UL) /* Value equivalent to bitfield "ADC_CFGR_AWD1SGL" position in register */
#        define ADC_CFGR_AWD1EN_BITOFFSET_POS \
            (23UL) /* Value equivalent to bitfield "ADC_CFGR_AWD1EN" position in register */
...
#        define ADC_TR1_HT1_BITOFFSET_POS \
            (16UL) /* Value equivalent to bitfield "ADC_TR1_HT1" position in register */
#    endif         /* ADC_SUPPORT_2_5_MSPS */
...
#        define ADC_CR_BITS_PROPERTY_RS                                                            \
            (ADC_CR_ADCAL | ADC_CR_ADSTP | ADC_CR_ADSTART | ADC_CR_ADDIS |                         \
             ADC_CR_ADEN) /* ADC register CR bits with HW property "rs": Software can read as well \
                             as set this bit. Writing '0' has no effect on the bit value. */
#    else
#        define ADC_CR_BITS_PROPERTY_RS                                                            \
...
#    define VREFINT_CAL_ADDR                                                                      \
        ((uint16_t*)(0x1FFF75AAUL)) /* Internal voltage reference, address of parameter VREFINT:  \
                                       VrefInt ADC raw data acquired at temperature 30 DegC       \
                                       (tolerance: +-5 DegC), Vref+ = 3.6 V (tolerance: +-10 mV). \
                                     */
#    define VREFINT_CAL_VREF                                                                      \
        (3600UL) /* Analog voltage reference (Vref+) value with which temperature sensor has been \
                    calibrated in production (tolerance: +-10 mV) (unit: mV). */
/* Temperature sensor */
#    define TEMPSENSOR_CAL1_ADDR                                                                  \
        ((uint16_t*)(0x1FFF75A8UL)) /* Internal temperature sensor, address of parameter TS_CAL1: \
                                       On STM32WB, temperature sensor ADC raw data acquired at    \
                                       temperature  30 DegC (tolerance: +-5 DegC), Vref+ = 3.0 V  \
                                       (tolerance: +-10 mV). */
#    define TEMPSENSOR_CAL2_ADDR                                                                  \
        ((uint16_t*)(0x1FFF75CAUL)) /* Internal temperature sensor, address of parameter TS_CAL2: \
                                       On STM32WB, temperature sensor ADC raw data acquired at    \
                                       temperature 130 DegC (tolerance: +-5 DegC), Vref+ = 3.0 V  \
                                       (tolerance: +-10 mV). */
#    define TEMPSENSOR_CAL1_TEMP                                                                   \
        (30L) /* Internal temperature sensor, temperature at which temperature sensor has been     \
                 calibrated in production for data into TEMPSENSOR_CAL1_ADDR (tolerance: +-5 DegC) \
                 (unit: DegC). */
#    define TEMPSENSOR_CAL2_TEMP                                                                \
        (130L) /* Internal temperature sensor, temperature at which temperature sensor has been \
                  calibrated in production for data into TEMPSENSOR_CAL2_ADDR (tolerance: +-5   \
                  DegC) (unit: DegC). */
#    define TEMPSENSOR_CAL_VREFANALOG                                                          \
        (3000UL) /* Analog voltage reference (Vref+) voltage with which temperature sensor has \
                    been calibrated in production (+-10 mV) (unit: mV). */
...
#        if defined(ADC_SUPPORT_2_5_MSPS)
    uint32_t
        Clock; /*!< Set ADC instance clock source and prescaler.
                    ...
                    @note On this STM32 series, this parameter has some clock ratio constraints:
                          ADC clock synchronous (from PCLK) with prescaler 1 must be enabled only if
                  PCLK has a 50% duty clock cycle (APB prescaler configured inside the RCC must be
                  bypassed and the system clock must by 50% duty cycle).

                    This feature can be modified afterwards using unitary function @ref
                  LL_ADC_SetClock(). For more details, refer to description of this function. */
...
typedef struct {
    uint32_t
        TriggerSource; /*!< Set ADC group regular conversion trigger source: internal (SW start) or
                          from external peripheral (timer event, external interrupt line). This
                          parameter can be a value of @ref ADC_LL_EC_REG_TRIGGER_SOURCE
                          ...
                          set by HW default value). In case of need to modify trigger edge, use
    ...
    uint32_t
        SequencerLength; /*!< Set ADC group regular sequencer length.
                              This parameter can be a value of @ref ADC_LL_EC_REG_SEQ_SCAN_LENGTH

                              This feature can be modified afterwards using unitary function @ref
                            LL_ADC_REG_SetSequencerLength(). */

    uint32_t SequencerDiscont; /*!< Set ADC group regular sequencer discontinuous mode: sequence
                                  subdivided and scan conversions interrupted every selected number
                                  of ranks. This parameter can be a value of @ref
                                  ADC_LL_EC_REG_SEQ_DISCONT_MODE
                                    @note This parameter has an effect only if group regular
                                  sequencer is enabled (scan length of 2 ranks or more).

                                    This feature can be modified afterwards using unitary function
                                  @ref LL_ADC_REG_SetSequencerDiscont(). */

    uint32_t
        ContinuousMode; /*!< Set ADC continuous conversion mode on ADC group regular, whether ADC
                           conversions are performed in single mode (one conversion per trigger) or
                           in continuous mode (after the first trigger, following conversions
                           launched successively automatically). This parameter can be a value of
                           @ref ADC_LL_EC_REG_CONTINUOUS_MODE Note: It is not possible to enable
                           both ADC group regular continuous mode and discontinuous mode.

                             This feature can be modified afterwards using unitary function @ref
                           LL_ADC_REG_SetContinuousMode(). */

    uint32_t DMATransfer; /*!< Set ADC group regular conversion data transfer: no transfer or
                             transfer by DMA, and DMA requests mode. This parameter can be a value
                             of @ref ADC_LL_EC_REG_DMA_TRANSFER
...
typedef struct {
    uint32_t
        TriggerSource; /*!< Set ADC group injected conversion trigger source: internal (SW start) or
                          from external peripheral (timer event, external interrupt line). This
                          parameter can be a value of @ref ADC_LL_EC_INJ_TRIGGER_SOURCE
                            @note On this STM32 series, setting trigger source to external trigger
                          also set trigger polarity to rising edge (default setting for
                          compatibility with some ADC on other STM32 families having this setting
                          set by HW default value). In case of need to modify trigger edge, use
    ...
    uint32_t
        SequencerLength; /*!< Set ADC group injected sequencer length.
                              This parameter can be a value of @ref ADC_LL_EC_INJ_SEQ_SCAN_LENGTH

                              This feature can be modified afterwards using unitary function @ref
                            LL_ADC_INJ_SetSequencerLength(). */

    uint32_t SequencerDiscont; /*!< Set ADC group injected sequencer discontinuous mode: sequence
                                  subdivided and scan conversions interrupted every selected number
                                  of ranks. This parameter can be a value of @ref
                                  ADC_LL_EC_INJ_SEQ_DISCONT_MODE
                                    @note This parameter has an effect only if group injected
                                  sequencer is enabled (scan length of 2 ranks or more).
    ...
    uint32_t TrigAuto; /*!< Set ADC group injected conversion trigger: independent or from ADC group
                          regular. This parameter can be a value of @ref ADC_LL_EC_INJ_TRIG_AUTO
                            Note: This parameter must be set to set to independent trigger if
...
#    define LL_ADC_IT_JEOC \
        ADC_IER_JEOCIE /*!< ADC interruption ADC group injected end of unitary conversion */
#    define LL_ADC_IT_JEOS \
        ADC_IER_JEOSIE /*!< ADC interruption ADC group injected end of sequence conversions */
#    define LL_ADC_IT_JQOVF \
        ADC_IER_JQOVFIE /*!< ADC interruption ADC group injected contexts queue overflow */
...
#    define LL_ADC_DMA_REG_REGULAR_DATA                                                         \
        (0x00000000UL) /* ADC group regular conversion data register (corresponding to register \
                          DR) to be used with ADC configured in independent mode. Without DMA   \
                          transfer, register accessed by LL function @ref                       \
...
#        define LL_ADC_CLOCK_SYNC_PCLK_DIV2                                                     \
            (ADC_CCR_CKMODE_1) /*!< ADC synchronous clock derived from AHB clock with prescaler \
                                  division by 2 */
#        define LL_ADC_CLOCK_SYNC_PCLK_DIV4                                                    \
            (ADC_CCR_CKMODE_1 | ADC_CCR_CKMODE_0)  /*!< ADC synchronous clock derived from AHB \
...
#    define LL_ADC_CLOCK_ASYNC_DIV6 \
        (ADC_CCR_PRESC_1 |          \
         ADC_CCR_PRESC_0) /*!< ADC asynchronous clock with prescaler division by 6   */
...
#    define LL_ADC_CLOCK_ASYNC_DIV10 \
        (ADC_CCR_PRESC_2 |           \
         ADC_CCR_PRESC_0) /*!< ADC asynchronous clock with prescaler division by 10  */
#    define LL_ADC_CLOCK_ASYNC_DIV12 \
        (ADC_CCR_PRESC_2 |           \
         ADC_CCR_PRESC_1) /*!< ADC asynchronous clock with prescaler division by 12  */
...
#    define LL_ADC_CLOCK_ASYNC_DIV64 \
        (ADC_CCR_PRESC_3 |           \
         ADC_CCR_PRESC_0) /*!< ADC asynchronous clock with prescaler division by 64  */
#    define LL_ADC_CLOCK_ASYNC_DIV128 \
        (ADC_CCR_PRESC_3 |            \
         ADC_CCR_PRESC_1) /*!< ADC asynchronous clock with prescaler division by 128 */
...
#        define LL_ADC_CLOCK_SYNC_PCLK_DIV1 \
            (ADC_CFGR2_CKMODE_1 |           \
             ADC_CFGR2_CKMODE_0) /*!< ADC synchronous clock derived from AHB clock not divided  */
#        define LL_ADC_CLOCK_ASYNC                                                          \
            (0x00000000UL) /*!< ADC asynchronous clock. Asynchronous clock prescaler can be \
                              configured using function @ref LL_ADC_SetCommonClock(). */
/**
 * @}
 */
#    endif /* ADC_SUPPORT_2_5_MSPS */
...
#    define LL_ADC_DATA_ALIGN_RIGHT                                                         \
        (0x00000000UL) /*!< ADC conversion data alignment: right aligned (alignment on data \
                          register LSB bit 0)*/
#    define LL_ADC_DATA_ALIGN_LEFT                                                           \
        (ADC_CFGR_ALIGN) /*!< ADC conversion data alignment: left aligned (alignment on data \
                            register MSB bit 15)*/
/**
 * @}
 */
...
#        define LL_ADC_LP_AUTOWAIT_AUTOPOWEROFF                                                    \
            (ADC_CFGR1_WAIT |                                                                      \
             ADC_CFGR1_AUTOFF) /*!< ADC low power modes auto wait and auto power-off combined. See \
                                  description with function @ref LL_ADC_SetLowPowerMode(). */
#    else
#        define LL_ADC_LP_AUTOWAIT                                                                \
            (ADC_CFGR_AUTDLY) /*!< ADC low power mode auto delay: Dynamic low power mode, ADC     \
                                 conversions are performed only when necessary (when previous ADC \
                                 conversion data is read). See description with function @ref     \
                                 LL_ADC_SetLowPowerMode(). */
#    endif                    /* ADC_SUPPORT_2_5_MSPS */
...
#    define LL_ADC_TRIGGER_FREQ_HIGH                                                              \
        (0x00000000UL) /*!< ADC trigger frequency mode set to high frequency. Note: ADC trigger   \
                          frequency mode must be set to low frequency when a duration is exceeded \
                          before ADC conversion start trigger event (between ADC enable and ADC   \
                          conversion start trigger event or between two ADC conversion start      \
                          trigger event). Duration value: Refer to device datasheet, parameter    \
                          "tIdle". */
#    define LL_ADC_TRIGGER_FREQ_LOW                                                                \
        (ADC_CFGR2_LFTRIG) /*!< ADC trigger frequency mode set to low frequency. Note: ADC trigger \
                              frequency mode must be set to low frequency when a duration is       \
                              exceeded before ADC conversion start trigger event (between ADC      \
                              enable and ADC conversion start trigger event or between two ADC     \
                              conversion start trigger event). Duration value: Refer to device     \
...
#    if defined(ADC_SUPPORT_2_5_MSPS)
/** @defgroup ADC_LL_EC_SAMPLINGTIME_COMMON  ADC instance - Sampling time common to a group of
 * channels
 * @{
 */
#        define LL_ADC_SAMPLINGTIME_COMMON_1                                                    \
            (ADC_SMPR_SMP1_BITOFFSET_POS) /*!< Set sampling time common to a group of channels: \
                                             sampling time nb 1 */
#        define LL_ADC_SAMPLINGTIME_COMMON_2                                                  \
            (ADC_SMPR_SMP2_BITOFFSET_POS |                                                    \
             ADC_SAMPLING_TIME_CH_MASK) /*!< Set sampling time common to a group of channels: \
                                           sampling time nb 2 */
/**
 * @}
 */
...
#    define LL_ADC_OFFSET_1                                                                      \
        ADC_OFR1_REGOFFSET /*!< ADC offset number 1: ADC channel and offset level to which the   \
                              offset programmed will be applied (independently of channel mapped \
                              on ADC group regular or group injected) */
#    define LL_ADC_OFFSET_2                                                                      \
        ADC_OFR2_REGOFFSET /*!< ADC offset number 2: ADC channel and offset level to which the   \
                              offset programmed will be applied (independently of channel mapped \
                              on ADC group regular or group injected) */
#    define LL_ADC_OFFSET_3                                                                      \
        ADC_OFR3_REGOFFSET /*!< ADC offset number 3: ADC channel and offset level to which the   \
                              offset programmed will be applied (independently of channel mapped \
                              on ADC group regular or group injected) */
#    define LL_ADC_OFFSET_4                                                                      \
        ADC_OFR4_REGOFFSET /*!< ADC offset number 4: ADC channel and offset level to which the   \
                              offset programmed will be applied (independently of channel mapped \
                              on ADC group regular or group injected) */
/**
 * @}
...
#    define LL_ADC_OFFSET_ENABLE                                                                   \
        (ADC_OFR1_OFFSET1_EN) /*!< ADC offset enabled (among ADC selected offset number 1, 2, 3 or \
                                 4) */
/**
 * @}
 */
...
#        define LL_ADC_GROUP_INJECTED \
            (0x00000002UL) /*!< ADC group injected (not available on all STM32 devices)*/
...
#        define LL_ADC_CHANNEL_0                                                               \
            (ADC_CHANNEL_0_NUMBER | ADC_CHANNEL_0_BITFIELD) /*!< ADC external channel (channel \
                                                               connected to GPIO pin) ADCx_IN0  */
#        define LL_ADC_CHANNEL_1                                                               \
            (ADC_CHANNEL_1_NUMBER | ADC_CHANNEL_1_BITFIELD) /*!< ADC external channel (channel \
                                                               connected to GPIO pin) ADCx_IN1  */
#        define LL_ADC_CHANNEL_2                                                               \
            (ADC_CHANNEL_2_NUMBER | ADC_CHANNEL_2_BITFIELD) /*!< ADC external channel (channel \
                                                               connected to GPIO pin) ADCx_IN2  */
#        define LL_ADC_CHANNEL_3                                                               \
            (ADC_CHANNEL_3_NUMBER | ADC_CHANNEL_3_BITFIELD) /*!< ADC external channel (channel \
                                                               connected to GPIO pin) ADCx_IN3  */
#        define LL_ADC_CHANNEL_4                                                               \
            (ADC_CHANNEL_4_NUMBER | ADC_CHANNEL_4_BITFIELD) /*!< ADC external channel (channel \
                                                               connected to GPIO pin) ADCx_IN4  */
#        define LL_ADC_CHANNEL_5                                                               \
            (ADC_CHANNEL_5_NUMBER | ADC_CHANNEL_5_BITFIELD) /*!< ADC external channel (channel \
                                                               connected to GPIO pin) ADCx_IN5  */
#        define LL_ADC_CHANNEL_6                                                               \
            (ADC_CHANNEL_6_NUMBER | ADC_CHANNEL_6_BITFIELD) /*!< ADC external channel (channel \
                                                               connected to GPIO pin) ADCx_IN6  */
#        define LL_ADC_CHANNEL_7                                                               \
            (ADC_CHANNEL_7_NUMBER | ADC_CHANNEL_7_BITFIELD) /*!< ADC external channel (channel \
                                                               connected to GPIO pin) ADCx_IN7  */
#        define LL_ADC_CHANNEL_8                                                               \
            (ADC_CHANNEL_8_NUMBER | ADC_CHANNEL_8_BITFIELD) /*!< ADC external channel (channel \
                                                               connected to GPIO pin) ADCx_IN8  */
#        define LL_ADC_CHANNEL_9                                                               \
            (ADC_CHANNEL_9_NUMBER | ADC_CHANNEL_9_BITFIELD) /*!< ADC external channel (channel \
...
#        define LL_ADC_CHANNEL_VREFINT                                                            \
            (LL_ADC_CHANNEL_13 |                                                                  \
             ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to VrefInt: Internal \
                                            voltage reference. */
#        define LL_ADC_CHANNEL_TEMPSENSOR                                                        \
            (LL_ADC_CHANNEL_12 | ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected \
                                                                to Temperature sensor. */
#        define LL_ADC_CHANNEL_VBAT                                                                \
            (LL_ADC_CHANNEL_14 |                                                                   \
             ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to Vbat/3: Vbat       \
...
#        define LL_ADC_CHANNEL_VREFINT                                                            \
            (LL_ADC_CHANNEL_0 |                                                                   \
             ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to VrefInt: Internal \
                                            voltage reference. */
#        define LL_ADC_CHANNEL_TEMPSENSOR                                                        \
            (LL_ADC_CHANNEL_17 | ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected \
                                                                to Temperature sensor. */
#        define LL_ADC_CHANNEL_VBAT                                                                \
            (LL_ADC_CHANNEL_18 |                                                                   \
             ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to Vbat/2: Vbat       \
                                            voltage through a divider ladder of factor 1/2 to have \
                                            Vbat always below Vdda. */
...
#        define LL_ADC_REG_TRIG_EXT_TIM1_TRGO2                                                   \
            (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_1 |                                             \
             ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from       \
                                               external peripheral: TIM1 TRGO2. Trigger edge set \
                                               to rising edge (default setting). */
#        define LL_ADC_REG_TRIG_EXT_TIM1_CH1                                                      \
            (ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from        \
                                               external peripheral: TIM1 channel 1 event (capture \
                                               compare: input capture or output capture). Trigger \
                                               edge set to rising edge (default setting). */
#        define LL_ADC_REG_TRIG_EXT_TIM1_CH2                                                      \
            (ADC_CFGR_EXTSEL_0 |                                                                  \
             ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from        \
                                               external peripheral: TIM1 channel 2 event (capture \
                                               compare: input capture or output capture). Trigger \
                                               edge set to rising edge (default setting). */
#        define LL_ADC_REG_TRIG_EXT_TIM1_CH3                                                      \
            (ADC_CFGR_EXTSEL_1 |                                                                  \
             ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from        \
                                               external peripheral: TIM1 channel 3 event (capture \
                                               compare: input capture or output capture). Trigger \
                                               edge set to rising edge (default setting). */
#        define LL_ADC_REG_TRIG_EXT_TIM2_TRGO                                                      \
...
#        define LL_ADC_REG_TRIG_EXT_TIM2_CH2                                                      \
            (ADC_CFGR_EXTSEL_1 | ADC_CFGR_EXTSEL_0 |                                              \
             ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger from        \
                                               external peripheral: TIM2 channel 2 event (capture \
                                               compare: input capture or output capture). Trigger \
                                               edge set to rising edge (default setting). */
#        define LL_ADC_REG_TRIG_EXT_EXTI_LINE11                                                   \
...
#    define LL_ADC_REG_TRIG_EXT_RISINGFALLING                                                    \
        (ADC_CFGR_EXTEN_1 | ADC_CFGR_EXTEN_0) /*!< ADC group regular conversion trigger polarity \
...
#    define LL_ADC_REG_CONV_SINGLE                                                           \
        (0x00000000UL) /*!< ADC conversions are performed in single mode: one conversion per \
                          trigger */
#    define LL_ADC_REG_CONV_CONTINUOUS                                                         \
        (ADC_CFGR_CONT) /*!< ADC conversions are performed in continuous mode: after the first \
...
#    define LL_ADC_REG_DMA_TRANSFER_LIMITED                                                       \
        (ADC_CFGR_DMAEN) /*!< ADC conversion data are transferred by DMA, in limited mode (one    \
                            shot mode): DMA transfer requests are stopped when number of DMA data \
                            transfers (number of ADC conversions) is reached. This ADC mode is    \
                            intended to be used with DMA mode non-circular. */
#    define LL_ADC_REG_DMA_TRANSFER_UNLIMITED                                                     \
        (ADC_CFGR_DMACFG |                                                                        \
         ADC_CFGR_DMAEN) /*!< ADC conversion data are transferred by DMA, in unlimited mode: DMA  \
                            transfer requests are unlimited, whatever number of DMA data          \
                            transferred (number of ADC conversions). This ADC mode is intended to \
                            be used with DMA mode circular. */
/**
 * @}
 */

/** @defgroup ADC_LL_EC_REG_OVR_DATA_BEHAVIOR  ADC group regular - Overrun behavior on conversion
 * data
 * @{
 */
...
#        define LL_ADC_REG_SEQ_FIXED                                                             \
            (0x00000000UL) /*!< Sequencer configured to fully configurable: sequencer length and \
                              each rank affectation to a channel are configurable. Refer to      \
                              description of function @ref LL_ADC_REG_SetSequencerLength(). */
#        define LL_ADC_REG_SEQ_CONFIGURABLE                                                      \
            (ADC_CFGR1_CHSELRMOD) /*!< Sequencer configured to not fully configurable: sequencer \
                                     length and each rank affectation to a channel are fixed by  \
                                     channel HW number. Refer to description of function @ref    \
...
#        define LL_ADC_REG_SEQ_SCAN_DISABLE                                                       \
            (ADC_CHSELR_SQ2) /*!< ADC group regular sequencer disable (equivalent to sequencer of \
                                1 rank: ADC conversion on only 1 channel) */
#        define LL_ADC_REG_SEQ_SCAN_ENABLE_2RANKS                                                 \
            (ADC_CHSELR_SQ3) /*!< ADC group regular sequencer enable with 2 ranks in the sequence \
                              */
#        define LL_ADC_REG_SEQ_SCAN_ENABLE_3RANKS                                                 \
            (ADC_CHSELR_SQ4) /*!< ADC group regular sequencer enable with 3 ranks in the sequence \
                              */
#        define LL_ADC_REG_SEQ_SCAN_ENABLE_4RANKS                                                 \
            (ADC_CHSELR_SQ5) /*!< ADC group regular sequencer enable with 4 ranks in the sequence \
                              */
#        define LL_ADC_REG_SEQ_SCAN_ENABLE_5RANKS                                                 \
            (ADC_CHSELR_SQ6) /*!< ADC group regular sequencer enable with 5 ranks in the sequence \
                              */
#        define LL_ADC_REG_SEQ_SCAN_ENABLE_6RANKS                                                 \
            (ADC_CHSELR_SQ7) /*!< ADC group regular sequencer enable with 6 ranks in the sequence \
                              */
#        define LL_ADC_REG_SEQ_SCAN_ENABLE_7RANKS                                                 \
            (ADC_CHSELR_SQ8) /*!< ADC group regular sequencer enable with 7 ranks in the sequence \
                              */
#        define LL_ADC_REG_SEQ_SCAN_ENABLE_8RANKS \
            (0x00000000UL) /*!< ADC group regular sequencer enable with 8 ranks in the sequence */
#    else
#        define LL_ADC_REG_SEQ_SCAN_DISABLE                                                       \
            (0x00000000UL) /*!< ADC group regular sequencer disable (equivalent to sequencer of 1 \
                              rank: ADC conversion on only 1 channel) */
#        define LL_ADC_REG_SEQ_SCAN_ENABLE_2RANKS \
...
#        define LL_ADC_REG_SEQ_SCAN_ENABLE_4RANKS \
            (ADC_SQR1_L_1 |                       \
             ADC_SQR1_L_0) /*!< ADC group regular sequencer enable with 4 ranks in the sequence */
#        define LL_ADC_REG_SEQ_SCAN_ENABLE_5RANKS \
            (ADC_SQR1_L_2) /*!< ADC group regular sequencer enable with 5 ranks in the sequence */
#        define LL_ADC_REG_SEQ_SCAN_ENABLE_6RANKS \
            (ADC_SQR1_L_2 |                       \
             ADC_SQR1_L_0) /*!< ADC group regular sequencer enable with 6 ranks in the sequence */
#        define LL_ADC_REG_SEQ_SCAN_ENABLE_7RANKS \
            (ADC_SQR1_L_2 |                       \
             ADC_SQR1_L_1) /*!< ADC group regular sequencer enable with 7 ranks in the sequence */
#        define LL_ADC_REG_SEQ_SCAN_ENABLE_8RANKS \
            (ADC_SQR1_L_2 | ADC_SQR1_L_1 |        \
             ADC_SQR1_L_0) /*!< ADC group regular sequencer enable with 8 ranks in the sequence */
...
#        define LL_ADC_REG_SEQ_SCAN_ENABLE_10RANKS                                                 \
            (ADC_SQR1_L_3 | ADC_SQR1_L_0) /*!< ADC group regular sequencer enable with 10 ranks in \
                                             the sequence */
#        define LL_ADC_REG_SEQ_SCAN_ENABLE_11RANKS                                                 \
            (ADC_SQR1_L_3 | ADC_SQR1_L_1) /*!< ADC group regular sequencer enable with 11 ranks in \
                                             the sequence */
#        define LL_ADC_REG_SEQ_SCAN_ENABLE_12RANKS                                               \
            (ADC_SQR1_L_3 | ADC_SQR1_L_1 | ADC_SQR1_L_0) /*!< ADC group regular sequencer enable \
                                                            with 12 ranks in the sequence */
#        define LL_ADC_REG_SEQ_SCAN_ENABLE_13RANKS                                                 \
            (ADC_SQR1_L_3 | ADC_SQR1_L_2) /*!< ADC group regular sequencer enable with 13 ranks in \
                                             the sequence */
#        define LL_ADC_REG_SEQ_SCAN_ENABLE_14RANKS                                               \
            (ADC_SQR1_L_3 | ADC_SQR1_L_2 | ADC_SQR1_L_0) /*!< ADC group regular sequencer enable \
                                                            with 14 ranks in the sequence */
#        define LL_ADC_REG_SEQ_SCAN_ENABLE_15RANKS                                               \
            (ADC_SQR1_L_3 | ADC_SQR1_L_2 | ADC_SQR1_L_1) /*!< ADC group regular sequencer enable \
...
#        define LL_ADC_REG_SEQ_SCAN_DIR_FORWARD                                                   \
            (0x00000000UL) /*!< On this STM32 series, parameter relevant only is sequencer set to \
                              mode not fully configurable, refer to function @ref                 \
                              LL_ADC_REG_SetSequencerConfigurable(). ADC group regular sequencer  \
                              scan direction forward: from lowest channel number to highest       \
                              channel number (scan of all ranks, ADC conversion of ranks with     \
                              channels enabled in sequencer). On some other STM32 families, this  \
                              setting is not available and the default scan direction is forward. \
                            */
#        define LL_ADC_REG_SEQ_SCAN_DIR_BACKWARD                                                  \
            (ADC_CFGR1_SCANDIR) /*!< On this STM32 series, parameter relevant only is sequencer   \
                                   set to mode not fully configurable, refer to function @ref     \
                                   LL_ADC_REG_SetSequencerConfigurable(). ADC group regular       \
                                   sequencer scan direction backward: from highest channel number \
                                   to lowest channel number (scan of all ranks, ADC conversion of \
                                   ranks with channels enabled in sequencer) */
/**
 * @}
 */
...
#    else
#        define LL_ADC_REG_SEQ_DISCONT_1RANK                                                  \
            (ADC_CFGR_DISCEN) /*!< ADC group regular sequencer discontinuous mode enable with \
                                 sequence interruption every rank */
#        define LL_ADC_REG_SEQ_DISCONT_2RANKS                                                  \
            (ADC_CFGR_DISCNUM_0 |                                                              \
             ADC_CFGR_DISCEN) /*!< ADC group regular sequencer discontinuous mode enabled with \
...
#        define LL_ADC_REG_RANK_10 \
            (ADC_SQR3_REGOFFSET |  \
             ADC_REG_RANK_10_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 10 */
#        define LL_ADC_REG_RANK_11 \
            (ADC_SQR3_REGOFFSET |  \
             ADC_REG_RANK_11_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 11 */
#        define LL_ADC_REG_RANK_12 \
            (ADC_SQR3_REGOFFSET |  \
             ADC_REG_RANK_12_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 12 */
#        define LL_ADC_REG_RANK_13 \
            (ADC_SQR3_REGOFFSET |  \
             ADC_REG_RANK_13_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 13 */
#        define LL_ADC_REG_RANK_14 \
            (ADC_SQR3_REGOFFSET |  \
             ADC_REG_RANK_14_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 14 */
#        define LL_ADC_REG_RANK_15 \
            (ADC_SQR4_REGOFFSET |  \
             ADC_REG_RANK_15_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 15 */
#        define LL_ADC_REG_RANK_16 \
            (ADC_SQR4_REGOFFSET |  \
             ADC_REG_RANK_16_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 16 */
#    endif                                       /* ADC_SUPPORT_2_5_MSPS */
/**
 * @}
 */
...
#        define LL_ADC_INJ_TRIG_SOFTWARE                                                           \
            (0x00000000UL) /*!< ADC group injected conversion trigger internal: SW start.. Trigger \
                              edge set to rising edge (default setting). */
#        define LL_ADC_INJ_TRIG_EXT_TIM1_TRGO                                                      \
            (ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from        \
                                               external peripheral: TIM1 TRGO. Trigger edge set to \
                                               rising edge (default setting). */
...
#        define LL_ADC_INJ_TRIG_EXT_TIM2_CH1                                                      \
            (ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0 |                                            \
             ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from       \
                                               external peripheral: TIM2 channel 1 event (capture \
                                               compare: input capture or output capture). Trigger \
                                               edge set to rising edge (default setting). */
#        define LL_ADC_INJ_TRIG_EXT_EXTI_LINE15                                                   \
            (ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_1 |                                            \
             ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger from       \
                                               external peripheral: external interrupt line 15.   \
                                               Trigger edge set to rising edge (default setting). \
                                             */
/**
 * @}
...
#        define LL_ADC_INJ_TRIG_EXT_RISING                                                        \
            (ADC_JSQR_JEXTEN_0) /*!< ADC group injected conversion trigger polarity set to rising \
                                   edge */
#        define LL_ADC_INJ_TRIG_EXT_FALLING                                                        \
            (ADC_JSQR_JEXTEN_1) /*!< ADC group injected conversion trigger polarity set to falling \
                                   edge */
#        define LL_ADC_INJ_TRIG_EXT_RISINGFALLING                                               \
            (ADC_JSQR_JEXTEN_1 |                                                                \
             ADC_JSQR_JEXTEN_0) /*!< ADC group injected conversion trigger polarity set to both \
...
#        define LL_ADC_INJ_TRIG_INDEPENDENT                                                        \
            (0x00000000UL) /*!< ADC group injected conversion trigger independent. Setting         \
                              mandatory if ADC group injected injected trigger source is set to an \
                              external trigger. */
#        define LL_ADC_INJ_TRIG_FROM_GRP_REGULAR                                                 \
            (ADC_CFGR_JAUTO) /*!< ADC group injected conversion trigger from ADC group regular.  \
                                Setting compliant only with group injected trigger source set to \
                                SW start, without any further action on  ADC group injected      \
...
#        define LL_ADC_INJ_QUEUE_2CONTEXTS_LAST_ACTIVE                                            \
            (0x00000000UL) /* Group injected sequence context queue is enabled and can contain up \
                              to 2 contexts. When all contexts have been processed, the queue     \
                              maintains the last context active perpetually. */
#        define LL_ADC_INJ_QUEUE_2CONTEXTS_END_EMPTY                                              \
            (ADC_CFGR_JQM) /* Group injected sequence context queue is enabled and can contain up \
                              to 2 contexts. When all contexts have been processed, the queue is  \
                              empty and injected group triggers are disabled. */
#        define LL_ADC_INJ_QUEUE_DISABLE                                                           \
            (ADC_CFGR_JQDIS) /* Group injected sequence context queue is disabled: only 1 sequence \
                                can be configured and is active perpetually. */
/**
 * @}
 */
...
#        define LL_ADC_INJ_SEQ_SCAN_DISABLE                                                        \
            (0x00000000UL) /*!< ADC group injected sequencer disable (equivalent to sequencer of 1 \
                              rank: ADC conversion on only 1 channel) */
...
#        define LL_ADC_INJ_SEQ_DISCONT_1RANK                                                    \
            (ADC_CFGR_JDISCEN) /*!< ADC group injected sequencer discontinuous mode enable with \
                                  sequence interruption every rank */
/**
 * @}
 */
...
#        define LL_ADC_SAMPLINGTIME_1CYCLE_5 \
            (0x00000000UL) /*!< Sampling time 1.5 ADC clock cycle */
#        define LL_ADC_SAMPLINGTIME_3CYCLES_5 \
            (ADC_SMPR_SMP1_0) /*!< Sampling time 3.5 ADC clock cycles */
#        define LL_ADC_SAMPLINGTIME_7CYCLES_5 \
            (ADC_SMPR_SMP1_1) /*!< Sampling time 7.5 ADC clock cycles */
#        define LL_ADC_SAMPLINGTIME_12CYCLES_5 \
            (ADC_SMPR_SMP1_1 | ADC_SMPR_SMP1_0) /*!< Sampling time 12.5 ADC clock cycles */
#        define LL_ADC_SAMPLINGTIME_19CYCLES_5 \
            (ADC_SMPR_SMP1_2) /*!< Sampling time 19.5 ADC clock cycles */
#        define LL_ADC_SAMPLINGTIME_39CYCLES_5 \
            (ADC_SMPR_SMP1_2 | ADC_SMPR_SMP1_0) /*!< Sampling time 39.5 ADC clock cycles */
#        define LL_ADC_SAMPLINGTIME_79CYCLES_5 \
            (ADC_SMPR_SMP1_2 | ADC_SMPR_SMP1_1) /*!< Sampling time 79.5 ADC clock cycles */
#        define LL_ADC_SAMPLINGTIME_160CYCLES_5  \
            (ADC_SMPR_SMP1_2 | ADC_SMPR_SMP1_1 | \
...
#        define LL_ADC_SINGLE_ENDED                                                              \
            (0x00000000UL) /*!< ADC channel ending set to single ended (literal also used to set \
                              calibration mode) */
#    else
#        define LL_ADC_SINGLE_ENDED                                                                \
            (ADC_CALFACT_CALFACT_S) /*!< ADC channel ending set to single ended (literal also used \
                                       to set calibration mode) */
#        define LL_ADC_DIFFERENTIAL_ENDED                                                          \
            (ADC_CR_ADCALDIF |                                                                     \
             ADC_CALFACT_CALFACT_D) /*!< ADC channel ending set to differential (literal also used \
                                       to set calibration mode) */
#        define LL_ADC_BOTH_SINGLE_DIFF_ENDED                                                 \
            (LL_ADC_SINGLE_ENDED |                                                            \
             LL_ADC_DIFFERENTIAL_ENDED) /*!< ADC channel ending set to both single ended and  \
                                           differential (literal used only to set calibration \
                                           factors) */
#    endif                              /* ADC_SUPPORT_2_5_MSPS */
/**
 * @}
 ...
 */
#    define LL_ADC_AWD1 \
        (ADC_AWD_CR1_CHANNEL_MASK | ADC_AWD_CR1_REGOFFSET) /*!< ADC analog watchdog number 1 */
#    if defined(ADC_SUPPORT_2_5_MSPS)
/* Feature "ADC analog watchdog 2 and 3" not available on ADC peripheral of this STM32WB device */
#    else
#        define LL_ADC_AWD2                                                                       \
            (ADC_AWD_CR23_CHANNEL_MASK | ADC_AWD_CR2_REGOFFSET) /*!< ADC analog watchdog number 2 \
                                                                 */
#        define LL_ADC_AWD3                                                                       \
            (ADC_AWD_CR23_CHANNEL_MASK | ADC_AWD_CR3_REGOFFSET) /*!< ADC analog watchdog number 3 \
                                                                 */
#    endif                                                      /* ADC_SUPPORT_2_5_MSPS */
/**
 * @}
...
#        define LL_ADC_AWD_ALL_CHANNELS_REG                                                     \
            (ADC_AWD_CR23_CHANNEL_MASK |                                                        \
             ADC_CFGR_AWD1EN) /*!< ADC analog watchdog monitoring of all channels, converted by \
                                 group regular only */
#        define LL_ADC_AWD_ALL_CHANNELS_INJ                                                      \
            (ADC_AWD_CR23_CHANNEL_MASK |                                                         \
             ADC_CFGR_JAWD1EN) /*!< ADC analog watchdog monitoring of all channels, converted by \
                                  group injected only */
...
#        define LL_ADC_AWD_CHANNEL_0_REG                                                       \
            ((LL_ADC_CHANNEL_0 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN |                      \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel     \
                                  (channel connected to GPIO pin) ADCx_IN0, converted by group \
                                  regular only */
...
#        define LL_ADC_AWD_CHANNEL_0_REG_INJ                                                    \
            ((LL_ADC_CHANNEL_0 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |    \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel      \
                                  (channel connected to GPIO pin) ADCx_IN0, converted by either \
                                  group regular or injected */
#        define LL_ADC_AWD_CHANNEL_1_REG                                                       \
...
#        define LL_ADC_AWD_CHANNEL_1_REG_INJ                                                    \
            ((LL_ADC_CHANNEL_1 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |    \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel      \
                                  (channel connected to GPIO pin) ADCx_IN1, converted by either \
                                  group regular or injected */
#        define LL_ADC_AWD_CHANNEL_2_REG                                                       \
...
#        define LL_ADC_AWD_CHANNEL_2_REG_INJ                                                    \
            ((LL_ADC_CHANNEL_2 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |    \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel      \
                                  (channel connected to GPIO pin) ADCx_IN2, converted by either \
                                  group regular or injected */
#        define LL_ADC_AWD_CHANNEL_3_REG                                                       \
...
#        define LL_ADC_AWD_CHANNEL_3_REG_INJ                                                    \
            ((LL_ADC_CHANNEL_3 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |    \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel      \
                                  (channel connected to GPIO pin) ADCx_IN3, converted by either \
                                  group regular or injected */
#        define LL_ADC_AWD_CHANNEL_4_REG                                                       \
...
#        define LL_ADC_AWD_CHANNEL_4_REG_INJ                                                    \
            ((LL_ADC_CHANNEL_4 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |    \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel      \
                                  (channel connected to GPIO pin) ADCx_IN4, converted by either \
                                  group regular or injected */
#        define LL_ADC_AWD_CHANNEL_5_REG                                                       \
...
#        define LL_ADC_AWD_CHANNEL_5_REG_INJ                                                    \
            ((LL_ADC_CHANNEL_5 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |    \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel      \
                                  (channel connected to GPIO pin) ADCx_IN5, converted by either \
                                  group regular or injected */
#        define LL_ADC_AWD_CHANNEL_6_REG                                                       \
...
#        define LL_ADC_AWD_CHANNEL_6_REG_INJ                                                    \
            ((LL_ADC_CHANNEL_6 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |    \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel      \
                                  (channel connected to GPIO pin) ADCx_IN6, converted by either \
                                  group regular or injected */
#        define LL_ADC_AWD_CHANNEL_7_REG                                                       \
...
#        define LL_ADC_AWD_CHANNEL_7_REG_INJ                                                    \
            ((LL_ADC_CHANNEL_7 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |    \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel      \
                                  (channel connected to GPIO pin) ADCx_IN7, converted by either \
                                  group regular or injected */
#        define LL_ADC_AWD_CHANNEL_8_REG                                                       \
...
#        define LL_ADC_AWD_CHANNEL_8_REG_INJ                                                    \
            ((LL_ADC_CHANNEL_8 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |    \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel      \
                                  (channel connected to GPIO pin) ADCx_IN8, converted by either \
                                  group regular or injected */
#        define LL_ADC_AWD_CHANNEL_9_REG                                                       \
...
#        define LL_ADC_AWD_CHANNEL_9_REG_INJ                                                    \
            ((LL_ADC_CHANNEL_9 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |    \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel      \
                                  (channel connected to GPIO pin) ADCx_IN9, converted by either \
                                  group regular or injected */
#        define LL_ADC_AWD_CHANNEL_10_REG                                                       \
...
#        define LL_ADC_AWD_CHANNEL_10_REG_INJ                                                    \
            ((LL_ADC_CHANNEL_10 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |    \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel       \
                                  (channel connected to GPIO pin) ADCx_IN10, converted by either \
                                  group regular or injected */
#        define LL_ADC_AWD_CHANNEL_11_REG                                                       \
...
#        define LL_ADC_AWD_CHANNEL_11_REG_INJ                                                    \
            ((LL_ADC_CHANNEL_11 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |    \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel       \
                                  (channel connected to GPIO pin) ADCx_IN11, converted by either \
                                  group regular or injected */
#        define LL_ADC_AWD_CHANNEL_12_REG                                                       \
...
#        define LL_ADC_AWD_CHANNEL_12_REG_INJ                                                    \
            ((LL_ADC_CHANNEL_12 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |    \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel       \
                                  (channel connected to GPIO pin) ADCx_IN12, converted by either \
                                  group regular or injected */
#        define LL_ADC_AWD_CHANNEL_13_REG                                                       \
...
#        define LL_ADC_AWD_CHANNEL_13_REG_INJ                                                    \
            ((LL_ADC_CHANNEL_13 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |    \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel       \
                                  (channel connected to GPIO pin) ADCx_IN13, converted by either \
                                  group regular or injected */
#        define LL_ADC_AWD_CHANNEL_14_REG                                                       \
...
#        define LL_ADC_AWD_CHANNEL_14_REG_INJ                                                    \
            ((LL_ADC_CHANNEL_14 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |    \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel       \
                                  (channel connected to GPIO pin) ADCx_IN14, converted by either \
                                  group regular or injected */
#        define LL_ADC_AWD_CHANNEL_15_REG                                                       \
...
#        define LL_ADC_AWD_CHANNEL_15_REG_INJ                                                    \
            ((LL_ADC_CHANNEL_15 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |    \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel       \
                                  (channel connected to GPIO pin) ADCx_IN15, converted by either \
                                  group regular or injected */
#        define LL_ADC_AWD_CHANNEL_16_REG                                                       \
...
#        define LL_ADC_AWD_CHANNEL_16_REG_INJ                                                    \
            ((LL_ADC_CHANNEL_16 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |    \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel       \
                                  (channel connected to GPIO pin) ADCx_IN16, converted by either \
                                  group regular or injected */
#        define LL_ADC_AWD_CHANNEL_17_REG                                                       \
...
#        define LL_ADC_AWD_CHANNEL_17_REG_INJ                                                    \
            ((LL_ADC_CHANNEL_17 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |    \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel       \
                                  (channel connected to GPIO pin) ADCx_IN17, converted by either \
                                  group regular or injected */
#        define LL_ADC_AWD_CHANNEL_18_REG                                                       \
...
#        define LL_ADC_AWD_CHANNEL_18_REG_INJ                                                    \
            ((LL_ADC_CHANNEL_18 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN |    \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external channel       \
                                  (channel connected to GPIO pin) ADCx_IN18, converted by either \
                                  group regular or injected */
#        define LL_ADC_AWD_CH_VREFINT_REG                                                        \
            ((LL_ADC_CHANNEL_VREFINT & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN |                  \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel       \
                                  connected to VrefInt: Internal voltage reference, converted by \
                                  group regular only */
...
#        define LL_ADC_AWD_CH_TEMPSENSOR_REG                                                       \
            ((LL_ADC_CHANNEL_TEMPSENSOR & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN |                 \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel         \
                                  connected to Temperature sensor, converted by group regular only \
                                */
#        define LL_ADC_AWD_CH_TEMPSENSOR_INJ                                                   \
            ((LL_ADC_CHANNEL_TEMPSENSOR & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN |            \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel     \
                                  connected to Temperature sensor, converted by group injected \
                                  only */
#        define LL_ADC_AWD_CH_TEMPSENSOR_REG_INJ                                             \
            ((LL_ADC_CHANNEL_TEMPSENSOR & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN |          \
             ADC_CFGR_AWD1EN |                                                               \
             ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal channel   \
                                  connected to Temperature sensor, converted by either group \
                                  regular or injected */
#        define LL_ADC_AWD_CH_VBAT_REG                                                          \
...
#        define LL_ADC_AWD_THRESHOLDS_HIGH_LOW                                                \
            (ADC_TR1_HT1 | ADC_TR1_LT1) /*!< ADC analog watchdog both thresholds high and low \
                                           concatenated into the same data */
#    endif                              /* ADC_SUPPORT_2_5_MSPS */
/**
 * @}
...
#        define LL_ADC_OVS_GRP_REGULAR_CONTINUED                                                \
            (ADC_CFGR2_OVSE) /*!< ADC oversampling on conversions of ADC group regular. Literal \
                                suffix "continued" is kept for compatibility with other STM32   \
                                devices featuring ADC group injected, in this case other        \
                                oversampling scope parameters are available. */
#    else
#        define LL_ADC_OVS_DISABLE (0x00000000UL) /*!< ADC oversampling disabled. */
#        define LL_ADC_OVS_GRP_REGULAR_CONTINUED                                                  \
            (ADC_CFGR2_ROVSE) /*!< ADC oversampling on conversions of ADC group regular. If group \
                                 injected interrupts group regular: when ADC group injected is    \
                                 triggered, the oversampling on ADC group regular is temporary    \
                                 stopped and continued afterwards. */
#        define LL_ADC_OVS_GRP_REGULAR_RESUMED                                                    \
            (ADC_CFGR2_ROVSM |                                                                    \
             ADC_CFGR2_ROVSE) /*!< ADC oversampling on conversions of ADC group regular. If group \
                                 injected interrupts group regular: when ADC group injected is    \
                                 triggered, the oversampling on ADC group regular is resumed from \
                                 start (oversampler buffer reset). */
#        define LL_ADC_OVS_GRP_INJECTED \
            (ADC_CFGR2_JOVSE) /*!< ADC oversampling on conversions of ADC group injected. */
#        define LL_ADC_OVS_GRP_INJ_REG_RESUMED                                                    \
            (ADC_CFGR2_JOVSE |                                                                    \
             ADC_CFGR2_ROVSE) /*!< ADC oversampling on conversions of both ADC groups regular and \
                                 injected. If group injected interrupting group regular: when ADC \
                                 group injected is triggered, the oversampling on ADC group       \
...
#    define LL_ADC_OVS_REG_CONT                                                                   \
        (0x00000000UL) /*!< ADC oversampling discontinuous mode: continuous mode (all conversions \
                          of oversampling ratio are done from 1 trigger) */
#    if defined(ADC_SUPPORT_2_5_MSPS)
#        define LL_ADC_OVS_REG_DISCONT                                                          \
            (ADC_CFGR2_TOVS) /*!< ADC oversampling discontinuous mode: discontinuous mode (each \
                                conversion of oversampling ratio needs a trigger) */
#    else
#        define LL_ADC_OVS_REG_DISCONT                                                           \
            (ADC_CFGR2_TROVS) /*!< ADC oversampling discontinuous mode: discontinuous mode (each \
                                 conversion of oversampling ratio needs a trigger) */
#    endif                    /* ADC_SUPPORT_2_5_MSPS */
/**
 * @}
...
#    define LL_ADC_OVS_RATIO_2                                                                   \
        (0x00000000UL) /*!< ADC oversampling ratio of 2 (2 ADC conversions are performed, sum of \
...
#    define LL_ADC_OVS_RATIO_4                                                                    \
        (ADC_CFGR2_OVSR_0) /*!< ADC oversampling ratio of 4 (4 ADC conversions are performed, sum \
                              of these conversions data is computed to result as the ADC          \
                              oversampling conversion data (before potential shift) */
#    define LL_ADC_OVS_RATIO_8                                                                    \
        (ADC_CFGR2_OVSR_1) /*!< ADC oversampling ratio of 8 (8 ADC conversions are performed, sum \
                              of these conversions data is computed to result as the ADC          \
                              oversampling conversion data (before potential shift) */
#    define LL_ADC_OVS_RATIO_16                                                                 \
        (ADC_CFGR2_OVSR_1 |                                                                     \
         ADC_CFGR2_OVSR_0) /*!< ADC oversampling ratio of 16 (16 ADC conversions are performed, \
                              sum of these conversions data is computed to result as the ADC    \
                              oversampling conversion data (before potential shift) */
#    define LL_ADC_OVS_RATIO_32                                                                 \
        (ADC_CFGR2_OVSR_2) /*!< ADC oversampling ratio of 32 (32 ADC conversions are performed, \
                              sum of these conversions data is computed to result as the ADC    \
                              oversampling conversion data (before potential shift) */
#    define LL_ADC_OVS_RATIO_64                                                                 \
        (ADC_CFGR2_OVSR_2 |                                                                     \
         ADC_CFGR2_OVSR_0) /*!< ADC oversampling ratio of 64 (64 ADC conversions are performed, \
                              sum of these conversions data is computed to result as the ADC    \
                              oversampling conversion data (before potential shift) */
#    define LL_ADC_OVS_RATIO_128                                                                  \
        (ADC_CFGR2_OVSR_2 |                                                                       \
         ADC_CFGR2_OVSR_1) /*!< ADC oversampling ratio of 128 (128 ADC conversions are performed, \
                              sum of these conversions data is computed to result as the ADC      \
                              oversampling conversion data (before potential shift) */
#    define LL_ADC_OVS_RATIO_256                                                                  \
        (ADC_CFGR2_OVSR_2 | ADC_CFGR2_OVSR_1 |                                                    \
         ADC_CFGR2_OVSR_0) /*!< ADC oversampling ratio of 256 (256 ADC conversions are performed, \
                              sum of these conversions data is computed to result as the ADC      \
                              oversampling conversion data (before potential shift) */
/**
 * @}
...
#    define LL_ADC_OVS_SHIFT_NONE                                                             \
        (0x00000000UL) /*!< ADC oversampling no shift (sum of the ADC conversions data is not \
                          divided to result as the ADC oversampling conversion data) */
#    define LL_ADC_OVS_SHIFT_RIGHT_1                                                            \
        (ADC_CFGR2_OVSS_0) /*!< ADC oversampling shift of 1 (sum of the ADC conversions data is \
                              divided by 2 to result as the ADC oversampling conversion data) */
#    define LL_ADC_OVS_SHIFT_RIGHT_2                                                            \
        (ADC_CFGR2_OVSS_1) /*!< ADC oversampling shift of 2 (sum of the ADC conversions data is \
                              divided by 4 to result as the ADC oversampling conversion data) */
#    define LL_ADC_OVS_SHIFT_RIGHT_3                                                            \
        (ADC_CFGR2_OVSS_1 |                                                                     \
         ADC_CFGR2_OVSS_0) /*!< ADC oversampling shift of 3 (sum of the ADC conversions data is \
                              divided by 8 to result as the ADC oversampling conversion data) */
#    define LL_ADC_OVS_SHIFT_RIGHT_4                                                            \
        (ADC_CFGR2_OVSS_2) /*!< ADC oversampling shift of 4 (sum of the ADC conversions data is \
                              divided by 16 to result as the ADC oversampling conversion data) */
#    define LL_ADC_OVS_SHIFT_RIGHT_5                                                            \
        (ADC_CFGR2_OVSS_2 |                                                                     \
         ADC_CFGR2_OVSS_0) /*!< ADC oversampling shift of 5 (sum of the ADC conversions data is \
                              divided by 32 to result as the ADC oversampling conversion data) */
#    define LL_ADC_OVS_SHIFT_RIGHT_6                                                            \
        (ADC_CFGR2_OVSS_2 |                                                                     \
         ADC_CFGR2_OVSS_1) /*!< ADC oversampling shift of 6 (sum of the ADC conversions data is \
                              divided by 64 to result as the ADC oversampling conversion data) */
#    define LL_ADC_OVS_SHIFT_RIGHT_7                                                            \
        (ADC_CFGR2_OVSS_2 | ADC_CFGR2_OVSS_1 |                                                  \
         ADC_CFGR2_OVSS_0) /*!< ADC oversampling shift of 7 (sum of the ADC conversions data is \
                              divided by 128 to result as the ADC oversampling conversion data) */
#    define LL_ADC_OVS_SHIFT_RIGHT_8                                                            \
        (ADC_CFGR2_OVSS_3) /*!< ADC oversampling shift of 8 (sum of the ADC conversions data is \
                              divided by 256 to result as the ADC oversampling conversion data) */
/**
 * @}
 */
...
#    define LL_ADC_DELAY_TEMPSENSOR_BUFFER_STAB_US                                            \
        (15UL) /*!< Delay for temperature sensor buffer stabilization time (starting from ADC \
                  enable, refer to @ref LL_ADC_Enable()) */
 ...
 *
 *         (7) On STM32WB devices (except devices: STM32WB10xx, STM32WB15xx, STM32WB1Mxx) fast
 * channel (0.188 us for 12-bit resolution (ADC conversion rate up to 5.33 Ms/s)). Other channels
 * are slow channels (0.238 us for 12-bit resolution (ADC conversion rate up to 4.21 Ms/s)).
 ...
 * channel (0.188 us for 12-bit resolution (ADC conversion rate up to 5.33 Ms/s)). Other channels
 * are slow channels (0.238 us for 12-bit resolution (ADC conversion rate up to 4.21 Ms/s)).\n (4)
 * For ADC channel read back from ADC register, comparison with internal channel parameter to be
...
#        define __LL_ADC_DECIMAL_NB_TO_CHANNEL(__DECIMAL_NB__)                        \
            (((__DECIMAL_NB__) <= 9UL)                                                \
                 ...
                 : (((__DECIMAL_NB__) << ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS) |       \
                    (ADC_AWD2CR_AWD2CH_0 << (__DECIMAL_NB__)) |                       \
                    (ADC_SMPR2_REGOFFSET |                                            \
                     (((3UL * ((__DECIMAL_NB__)-10UL))) << ADC_CHANNEL_SMPx_BITOFFSET_POS))))
#    endif /* ADC_SUPPORT_2_5_MSPS */
 ...
 * (channel connected to a GPIO pin). Value "1" if the channel corresponds to a parameter definition
 ...
 *
 *         (0) On STM32WB, parameter available only on analog watchdog number: AWD1.
 *         (1) On STM32WB series, parameter not available on devices: STM32WB10xx, STM32WB15xx,
 * STM32WB1Mxx.
 */
#        define __LL_ADC_ANALOGWD_CHANNEL_GROUP(__CHANNEL__, __GROUP__)                        \
            (((__GROUP__) == LL_ADC_GROUP_REGULAR)                                             \
             ...
             : ((__GROUP__) == LL_ADC_GROUP_INJECTED)                                          \
                 ...
                 : (((__CHANNEL__)&ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN | \
                    ADC_CFGR_AWD1SGL))
#    endif /* ADC_SUPPORT_2_5_MSPS */
...
#    define __LL_ADC_ANALOGWD_THRESHOLDS_HIGH_LOW(__AWD_THRESHOLD_TYPE__, __AWD_THRESHOLDS__)      \
        (((__AWD_THRESHOLDS__) >>                                                                  \
          (((__AWD_THRESHOLD_TYPE__)&ADC_AWD_TRX_BIT_HIGH_MASK) >> ADC_AWD_TRX_BIT_HIGH_SHIFT4)) & \
 ...
 * @param  __TEMPSENSOR_TYP_AVGSLOPE__   Device datasheet data: Temperature sensor slope typical
 * value (unit: uV/DegCelsius). On STM32WB, refer to device datasheet parameter "Avg_Slope".
 * @param  __TEMPSENSOR_TYP_CALX_V__     Device datasheet data: Temperature sensor voltage typical
 * value (at temperature and Vref+ defined in parameters below) (unit: mV). On STM32WB, refer to
 * device datasheet parameter "V30" (corresponding to TS_CAL1).
 * @param  __TEMPSENSOR_CALX_TEMP__      Device datasheet data: Temperature at which temperature
 * sensor voltage (see parameter above) is corresponding (unit: mV)
 * @param  __VREFANALOG_VOLTAGE__        Analog voltage reference (Vref+) voltage (unit: mV)
 * @param  __TEMPSENSOR_ADC_DATA__       ADC conversion data of internal temperature sensor (unit:
 * digital value).
 * @param  __ADC_RESOLUTION__            ADC resolution at which internal temperature sensor voltage
 * has been measured. This parameter can be one of the following values:
 *         @arg @ref LL_ADC_RESOLUTION_12B
 *         @arg @ref LL_ADC_RESOLUTION_10B
 *         @arg @ref LL_ADC_RESOLUTION_8B
 *         @arg @ref LL_ADC_RESOLUTION_6B
...
/** @defgroup ADC_LL_EF_Configuration_ADC_Common Configuration of ADC hierarchical scope: common to
 ...
 * @note   ADC clock source and prescaler must be selected in function of system clock to not exceed
 * ADC maximum frequency, depending on devices. Example: STM32WB55xx ADC maximum frequency is 64MHz
 * (corresponding to 4.27Msmp/s maximum) Example: STM32WB50xx ADC maximum frequency is 32MHz
 * (corresponding to 2.13Msmp/s maximum) For ADC maximum frequency, refer to datasheet of the
 * selected device.
 * @note   On this STM32 series, if ADC group injected is used, some
 *         clock ratio constraints between ADC clock and AHB clock
 *         must be respected.
...
/** @defgroup ADC_LL_EF_Configuration_ADC_Instance Configuration of ADC hierarchical scope: ADC
 * instance
 * @{
 */
 ...
 *
 *         (1) On STM32WB series, parameter available only on devices: STM32WB10xx, STM32WB15xx,
 * STM32WB1Mxx.
 * @retval None
 */
...
__STATIC_INLINE void LL_ADC_SetSamplingTimeCommonChannels(ADC_TypeDef* ADCx, uint32_t SamplingTimeY,
    ...
    MODIFY_REG(ADCx->SMPR, ADC_SMPR_SMP1 << (SamplingTimeY & ADC_SAMPLING_TIME_SMP_SHIFT_MASK),
...
__STATIC_INLINE uint32_t LL_ADC_GetSamplingTimeCommonChannels(ADC_TypeDef* ADCx,
                                                              uint32_t SamplingTimeY) {
    return (uint32_t)((READ_BIT(ADCx->SMPR, ADC_SMPR_SMP1 << (SamplingTimeY &
 ...
 *         ADC must be disabled or enabled without conversion on going
 *         on either groups regular or injected.
 * @note   On STM32WB (except devices: STM32WB10xx, STM32WB15xx, STM32WB1Mxx), some fast channels
 * are available: fast analog inputs coming from GPIO pads (ADC_IN1..5).
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_SetOffset(ADC_TypeDef* ADCx, uint32_t Offsety, uint32_t Channel,
 ...
 *
 *         (1) On STM32WB series, parameter not available on devices: STM32WB10xx, STM32WB15xx,
 * STM32WB1Mxx. (2) On STM32WB series, parameter available only devices: STM32WB10xx, STM32WB15xx,
 * STM32WB1Mxx.
 * @retval None
 */
...
#    if defined(ADC_SUPPORT_2_5_MSPS)
    ...
    uint32_t ShiftExten =
        ((TriggerSource & ADC_CFGR1_EXTEN) >> (ADC_REG_TRIG_EXTEN_BITOFFSET_POS - 2UL));

    /* Set bitfield corresponding to ADC_CFGR1_EXTEN and ADC_CFGR1_EXTSEL       */
    /* to match with triggers literals definition.                              */
    return ((TriggerSource & (ADC_REG_TRIG_SOURCE_MASK >> ShiftExten) & ADC_CFGR1_EXTSEL) |
...
#    else
    ...
    uint32_t ShiftExten =
        ((TriggerSource & ADC_CFGR_EXTEN) >> (ADC_REG_TRIG_EXTEN_BITOFFSET_POS - 2UL));
...
#    else
    ...
    __IO uint32_t* preg = __ADC_PTR_REG_OFFSET(
        ADCx->SQR1, ((Rank & ADC_REG_SQRX_REGOFFSET_MASK) >> ADC_SQRX_REGOFFSET_POS));
...
#    if defined(ADC_SUPPORT_2_5_MSPS)
    return (
        uint32_t)((READ_BIT(ADCx->CHSELR, ADC_CHSELR_SQ1 << (Rank & ADC_REG_RANK_ID_SQRX_MASK)) >>
                   (Rank & ADC_REG_RANK_ID_SQRX_MASK))
...
#    else
    ...
    return (uint32_t)((READ_BIT(*preg, ADC_CHANNEL_ID_NUMBER_MASK_POSBIT0
                                           << (Rank & ADC_REG_RANK_ID_SQRX_MASK)) >>
                       (Rank & ADC_REG_RANK_ID_SQRX_MASK))
                      << ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS);
#    endif /* ADC_SUPPORT_2_5_MSPS */
...
__STATIC_INLINE uint32_t LL_ADC_REG_GetSequencerChannels(ADC_TypeDef* ADCx) {
    ...
    return ((((ChannelsBitfield & ADC_CHSELR_CHSEL0) >> ADC_CHSELR_CHSEL0_BITOFFSET_POS) *
             LL_ADC_CHANNEL_0) |
            ...
            (((ChannelsBitfield & ADC_CHSELR_CHSEL9) >> ADC_CHSELR_CHSEL9_BITOFFSET_POS) *
             LL_ADC_CHANNEL_9) |
            (((ChannelsBitfield & ADC_CHSELR_CHSEL10) >> ADC_CHSELR_CHSEL10_BITOFFSET_POS) *
             LL_ADC_CHANNEL_10) |
            (((ChannelsBitfield & ADC_CHSELR_CHSEL11) >> ADC_CHSELR_CHSEL11_BITOFFSET_POS) *
             LL_ADC_CHANNEL_11) |
            (((ChannelsBitfield & ADC_CHSELR_CHSEL12) >> ADC_CHSELR_CHSEL12_BITOFFSET_POS) *
             LL_ADC_CHANNEL_12) |
            (((ChannelsBitfield & ADC_CHSELR_CHSEL13) >> ADC_CHSELR_CHSEL13_BITOFFSET_POS) *
             LL_ADC_CHANNEL_13) |
            (((ChannelsBitfield & ADC_CHSELR_CHSEL14) >> ADC_CHSELR_CHSEL14_BITOFFSET_POS) *
             LL_ADC_CHANNEL_14) |
            (((ChannelsBitfield & ADC_CHSELR_CHSEL15) >> ADC_CHSELR_CHSEL15_BITOFFSET_POS) *
             LL_ADC_CHANNEL_15) |
            (((ChannelsBitfield & ADC_CHSELR_CHSEL16) >> ADC_CHSELR_CHSEL16_BITOFFSET_POS) *
             LL_ADC_CHANNEL_16) |
            (((ChannelsBitfield & ADC_CHSELR_CHSEL17) >> ADC_CHSELR_CHSEL17_BITOFFSET_POS) *
             LL_ADC_CHANNEL_17) |
            (((ChannelsBitfield & ADC_CHSELR_CHSEL18) >> ADC_CHSELR_CHSEL18_BITOFFSET_POS) *
             LL_ADC_CHANNEL_18));
}
#    endif /* ADC_SUPPORT_2_5_MSPS */
/**
...
__STATIC_INLINE uint32_t LL_ADC_INJ_GetTriggerSource(const ADC_TypeDef* ADCx) {
    ...
    uint32_t ShiftJexten =
        ((TriggerSource & ADC_JSQR_JEXTEN) >> (ADC_INJ_TRIG_EXTEN_BITOFFSET_POS - 2UL));
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_INJ_SetSequencerRanks(ADC_TypeDef* ADCx, uint32_t Rank,
                                                  uint32_t Channel) {
    /* Set bits with content of parameter "Channel" with bits position          */
    /* in register depending on parameter "Rank".                               */
    /* Parameters "Rank" and "Channel" are used with masks because containing   */
...
__STATIC_INLINE void LL_ADC_INJ_ConfigQueueContext(ADC_TypeDef* ADCx, uint32_t TriggerSource,
    ...
    MODIFY_REG(
        ADCx->JSQR,
        ADC_JSQR_JEXTSEL | ADC_JSQR_JEXTEN | ADC_JSQR_JSQ4 | ADC_JSQR_JSQ3 | ADC_JSQR_JSQ2 |
            ADC_JSQR_JSQ1 | ADC_JSQR_JL,
...
__STATIC_INLINE void LL_ADC_SetChannelSamplingTime(ADC_TypeDef* ADCx, uint32_t Channel,
    ...
    MODIFY_REG(ADCx->SMPR, (Channel << ADC_SMPR_SMPSEL0_BITOFFSET_POS),
               (Channel << ADC_SMPR_SMPSEL0_BITOFFSET_POS) &
                   (SamplingTimeY & ADC_SAMPLING_TIME_CH_MASK));
}
#    else
/**
 * @brief  Set sampling time of the selected ADC channel
...
__STATIC_INLINE uint32_t LL_ADC_GetChannelSamplingTime(const ADC_TypeDef* ADCx, uint32_t Channel) {
    ...
    uint32_t smp_channel_posbit0 =
        ((smpr & ADC_SAMPLING_TIME_CH_MASK) >>
         ((((Channel & ADC_CHANNEL_ID_NUMBER_MASK) >> ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS) +
...
#        else
    ...
    return (
        uint32_t)(READ_BIT(*preg, ADC_SMPR1_SMP0 << ((Channel & ADC_CHANNEL_SMPx_BITOFFSET_MASK) >>
                                                     ADC_CHANNEL_SMPx_BITOFFSET_POS)) >>
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_SetChannelSingleDiff(ADC_TypeDef* ADCx, uint32_t Channel,
                                                 uint32_t SingleDiff) {
...
/** @defgroup ADC_LL_EF_Configuration_ADC_AnalogWatchdog Configuration of ADC transversal scope:
 * analog watchdog
 * @{
 */
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_SetAnalogWDMonitChannels(ADC_TypeDef* ADCx, uint32_t AWDy,
                                                     uint32_t AWDChannelGroup) {
#    if defined(ADC_SUPPORT_2_5_MSPS)
    /* Prevent unused argument(s) compilation warning */
    (void)(AWDy);

    MODIFY_REG(ADCx->CFGR1, (LL_ADC_AWD1 & ADC_AWD_CR_ALL_CHANNEL_MASK),
...
#    else
    ...
    /* containing other bits reserved for other purpose.                        */
    __IO uint32_t* preg = __ADC_PTR_REG_OFFSET(
        ADCx->CFGR, ((AWDy & ADC_AWD_CRX_REGOFFSET_MASK) >> ADC_AWD_CRX_REGOFFSET_POS) +
 ...
 *             by bitfield.
 *         (2) On STM32WB series, parameter not available on devices: STM32WB10xx, STM32WB15xx,
 * STM32WB1Mxx.
 * @retval Returned value can be one of the following values:
 *         @arg @ref LL_ADC_AWD_DISABLE
 *         @arg @ref LL_ADC_AWD_ALL_CHANNELS_REG        (0)
...
#    if defined(ADC_SUPPORT_2_5_MSPS)
    ...
    uint32_t AnalogWDMonitChannels =
        (READ_BIT(ADCx->CFGR1, LL_ADC_AWD1) & LL_ADC_AWD1 & ADC_AWD_CR_ALL_CHANNEL_MASK);
    ...
    if (AnalogWDMonitChannels != 0UL) {
        if ((AnalogWDMonitChannels & ADC_CFGR1_AWD1SGL) == 0UL) {
            ...
            AnalogWDMonitChannels = (AnalogWDMonitChannels & (~(ADC_CFGR1_AWD1CH)));
        }
        else {
        ...
        if (AWDy == LL_ADC_AWD1) {
            if ((AnalogWDMonitChannels & ADC_CFGR_AWD1SGL) == 0UL) {
                ...
                AnalogWDMonitChannels =
                    ((AnalogWDMonitChannels | (ADC_AWD_CR23_CHANNEL_MASK)) & (~(ADC_CFGR_AWD1CH)));
            }
            else {
                /* AWD monitoring a single channel */
                AnalogWDMonitChannels =
 ...
 * @note For devices STM32WB15xx and STM32WB10xx, register ADC_TR is equivalent to ADC_TR1 (generic
 * naming)
 * @param  ADCx ADC instance
 * @param  AWDy This parameter can be one of the following values:
 *         @arg @ref LL_ADC_AWD1
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_ConfigAnalogWDThresholds(ADC_TypeDef* ADCx, uint32_t AWDy,
...
#    if defined(ADC_SUPPORT_2_5_MSPS)
    ...
    MODIFY_REG(ADCx->TR, ADC_TR_HT | ADC_TR_LT,
               (AWDThresholdHighValue << ADC_TR_HT_BITOFFSET_POS) | AWDThresholdLowValue);
#    else
    __IO uint32_t* preg = __ADC_PTR_REG_OFFSET(
        ADCx->TR1, ((AWDy & ADC_AWD_TRX_REGOFFSET_MASK) >> ADC_AWD_TRX_REGOFFSET_POS));
 ...
 *         @arg @ref LL_ADC_AWD3 (1)
 *
 *         (1) On STM32WB series, parameter not available on devices: STM32WB10xx, STM32,
 * STM32WB1Mxx.
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_SetAnalogWDThresholds(ADC_TypeDef* ADCx, uint32_t AWDy,
...
#    if defined(ADC_SUPPORT_2_5_MSPS)
    ...
    MODIFY_REG(ADCx->TR, AWDThresholdsHighLow,
               AWDThresholdValue << ((AWDThresholdsHighLow & ADC_AWD_TRX_BIT_HIGH_MASK) >>
...
#    else
/** @defgroup ADC_LL_EF_Configuration_ADC_oversampling Configuration of ADC transversal scope:
 * oversampling
 * @{
 */
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_ConfigOverSamplingRatioShift(ADC_TypeDef* ADCx, uint32_t Ratio,
                                                         uint32_t Shift) {
...
/** @defgroup ADC_LL_EF_Operation_ADC_Group_Regular Operation on ADC hierarchical scope: group
 * regular
 * @{
 */
...
/* Feature "ADC group injected" not available on ADC peripheral of this STM32WB device */
#    else
/** @defgroup ADC_LL_EF_Operation_ADC_Group_Injected Operation on ADC hierarchical scope: group
 * injected
 * @{
 */
...
__STATIC_INLINE uint32_t LL_ADC_INJ_ReadConversionData32(const ADC_TypeDef* ADCx, uint32_t Rank) {
    const __IO uint32_t* preg = __ADC_PTR_REG_OFFSET(
        ADCx->JDR1, ((Rank & ADC_INJ_JDRX_REGOFFSET_MASK) >> ADC_JDRX_REGOFFSET_POS));
