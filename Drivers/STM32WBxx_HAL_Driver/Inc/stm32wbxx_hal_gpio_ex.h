...
#    define GPIO_AF0_JTMS_SWDIO \
        ((uint8_t)0x00) /*!< JTMS-SWDIO Alternate Function mapping          */
#    define GPIO_AF0_JTCK_SWCLK \
        ((uint8_t)0x00)                      /*!< JTCK-SWCLK Alternate Function mapping          */
...
#    define GPIO_AF0_JTD_TRACE \
        ((uint8_t)0x00)                     /*!< JTDO-TRACESWO Alternate Function mapping       */
#    define GPIO_AF0_NJTRST ((uint8_t)0x00) /*!< NJTRST Alternate Function mapping              */
#    define GPIO_AF0_RTC_REFIN \
        ((uint8_t)0x00)                      /*!< RTC_REFIN Alternate Function mapping           */
...
#    define GPIO_AF0_TRIG_INOUT \
        ((uint8_t)0x00)                      /*!< TRIG_INOUT Alternate Function mapping          */
...
#    define IS_GPIO_AF(AF)                                                                \
        (((AF) <= (uint8_t)0x0F) && ((AF) != (uint8_t)0x09) && ((AF) != (uint8_t)0x0A) && \
         ((AF) != (uint8_t)0x0B) && ((AF) != (uint8_t)0x0D))
...
#    define IS_GPIO_AF(AF) \
        (((AF) <= (uint8_t)0x0F) && ((AF) != (uint8_t)0x0B) && ((AF) != (uint8_t)0x0D))
...
#    define IS_GPIO_AF(AF)                                                                \
        (((AF) <= (uint8_t)0x0F) && ((AF) != (uint8_t)0x0A) && ((AF) != (uint8_t)0x0B) && \
         ((AF) != (uint8_t)0x0D))
