...
#    define LL_CRS_SYNC_SOURCE_USB CRS_CFGR_SYNCSRC_1 /*!< Synchro Signal source USB SOF \
                                                         (default)*/
/**
 * @}
 */
...
#    define LL_CRS_FREQ_ERROR_DIR_DOWN \
        CRS_ISR_FEDIR /*!< Downcounting direction, the actual frequency is below the target */
/**
 * @}
 */
 ...
 *         Otherwise it can be calculated in using macro @ref __LL_CRS_CALC_CALCULATE_RELOADVALUE
 * (_FTARGET_, _FSYNC_)
 * @retval None
 */
 ...
 *         @arg @ref LL_CRS_SYNC_DIV_1 or @ref LL_CRS_SYNC_DIV_2 or @ref LL_CRS_SYNC_DIV_4 or @ref
 * LL_CRS_SYNC_DIV_8 or @ref LL_CRS_SYNC_DIV_16 or @ref LL_CRS_SYNC_DIV_32 or @ref
 * LL_CRS_SYNC_DIV_64 or @ref LL_CRS_SYNC_DIV_128
...
__STATIC_INLINE void LL_CRS_ConfigSynchronization(uint32_t HSI48CalibrationValue,
                                                  uint32_t ErrorLimitValue, uint32_t ReloadValue,
                                                  uint32_t Settings) {
    MODIFY_REG(CRS->CR, CRS_CR_TRIM, HSI48CalibrationValue);
    MODIFY_REG(CRS->CFGR,
               CRS_CFGR_RELOAD | CRS_CFGR_FELIM | CRS_CFGR_SYNCDIV | CRS_CFGR_SYNCSRC |
                   CRS_CFGR_SYNCPOL,
