...
typedef struct {
    ...
    uint32_t
        OutPut; /*!< Specifies which signal will be routed to the RTC output.
...
typedef struct {
    uint8_t Hours; /*!< Specifies the RTC Time Hour.
                      ...
                      the RTC_HourFormat_12 is selected. This parameter must be a number between
    ...
    uint32_t
        SecondFraction; /*!< Specifies the range or granularity of Sub Second register content
...
typedef struct {
    ...
    uint8_t AlarmDateWeekDay; /*!< Specifies the RTC Alarm Date/WeekDay.
                                   If the Alarm Date is selected, this parameter must be set to a
                                 value in the 1-31 range. If the Alarm WeekDay is selected, this
...
#endif /* USE_HAL_RTC_REGISTER_CALLBACKS */
{
    ...
    void (*AlarmAEventCallback)(
        struct __RTC_HandleTypeDef* hrtc); /*!< RTC Alarm A Event callback         */

    void (*AlarmBEventCallback)(
        struct __RTC_HandleTypeDef* hrtc); /*!< RTC Alarm B Event callback         */

    void (*TimeStampEventCallback)(
        struct __RTC_HandleTypeDef* hrtc); /*!< RTC TimeStamp Event callback       */

    void (*WakeUpTimerEventCallback)(
        struct __RTC_HandleTypeDef* hrtc); /*!< RTC WakeUpTimer Event callback     */

    void (*Tamper1EventCallback)(
        struct __RTC_HandleTypeDef* hrtc); /*!< RTC Tamper 1 Event callback        */

    void (*Tamper2EventCallback)(
        struct __RTC_HandleTypeDef* hrtc); /*!< RTC Tamper 2 Event callback        */

    void (*Tamper3EventCallback)(
        struct __RTC_HandleTypeDef* hrtc); /*!< RTC Tamper 3 Event callback        */
 ...
 */
typedef void (*pRTC_CallbackTypeDef)(
    RTC_HandleTypeDef* hrtc); /*!< pointer to an RTC callback function */
#endif                        /* USE_HAL_RTC_REGISTER_CALLBACKS */
...
#define RTC_ALARMMASK_ALL                                                              \
    ((uint32_t)(RTC_ALARMMASK_NONE | RTC_ALARMMASK_DATEWEEKDAY | RTC_ALARMMASK_HOURS | \
...
#define RTC_ALARMSUBSECONDMASK_ALL                                  \
    ((uint32_t)0x00000000U) /*!< All Alarm SS fields are masked.    \
                              There is no comparison on sub seconds \
                              for Alarm */
#define RTC_ALARMSUBSECONDMASK_SS14_1                           \
    RTC_ALRMASSR_MASKSS_0 /*!< SS[14:1] are don't care in Alarm \
                             comparison. Only SS[0] is compared.    */
#define RTC_ALARMSUBSECONDMASK_SS14_2                           \
    RTC_ALRMASSR_MASKSS_1 /*!< SS[14:2] are don't care in Alarm \
                              comparison. Only SS[1:0] are compared  */
#define RTC_ALARMSUBSECONDMASK_SS14_3                                         \
    ((uint32_t)(RTC_ALRMASSR_MASKSS_0 |                                       \
                RTC_ALRMASSR_MASKSS_1)) /*!< SS[14:3] are don't care in Alarm \
                                            comparison. Only SS[2:0] are compared  */
#define RTC_ALARMSUBSECONDMASK_SS14_4                           \
    RTC_ALRMASSR_MASKSS_2 /*!< SS[14:4] are don't care in Alarm \
                              comparison. Only SS[3:0] are compared  */
#define RTC_ALARMSUBSECONDMASK_SS14_5                                         \
    ((uint32_t)(RTC_ALRMASSR_MASKSS_0 |                                       \
                RTC_ALRMASSR_MASKSS_2)) /*!< SS[14:5] are don't care in Alarm \
                                             comparison. Only SS[4:0] are compared  */
#define RTC_ALARMSUBSECONDMASK_SS14_6                                         \
    ((uint32_t)(RTC_ALRMASSR_MASKSS_1 |                                       \
                RTC_ALRMASSR_MASKSS_2)) /*!< SS[14:6] are don't care in Alarm \
                                             comparison. Only SS[5:0] are compared  */
#define RTC_ALARMSUBSECONDMASK_SS14_7                                         \
    ((uint32_t)(RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_1 |               \
                RTC_ALRMASSR_MASKSS_2)) /*!< SS[14:7] are don't care in Alarm \
                                       `     comparison. Only SS[6:0] are compared  */
#define RTC_ALARMSUBSECONDMASK_SS14_8                           \
    RTC_ALRMASSR_MASKSS_3 /*!< SS[14:8] are don't care in Alarm \
                               comparison. Only SS[7:0] are compared  */
#define RTC_ALARMSUBSECONDMASK_SS14_9                                         \
    ((uint32_t)(RTC_ALRMASSR_MASKSS_0 |                                       \
                RTC_ALRMASSR_MASKSS_3)) /*!< SS[14:9] are don't care in Alarm \
                                             comparison. Only SS[8:0] are compared  */
#define RTC_ALARMSUBSECONDMASK_SS14_10                                         \
    ((uint32_t)(RTC_ALRMASSR_MASKSS_1 |                                        \
                RTC_ALRMASSR_MASKSS_3)) /*!< SS[14:10] are don't care in Alarm \
                                             comparison. Only SS[9:0] are compared  */
#define RTC_ALARMSUBSECONDMASK_SS14_11                                         \
    ((uint32_t)(RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_1 |                \
                RTC_ALRMASSR_MASKSS_3)) /*!< SS[14:11] are don't care in Alarm \
                                             comparison. Only SS[10:0] are compared */
#define RTC_ALARMSUBSECONDMASK_SS14_12                                         \
    ((uint32_t)(RTC_ALRMASSR_MASKSS_2 |                                        \
                RTC_ALRMASSR_MASKSS_3)) /*!< SS[14:12] are don't care in Alarm \
                                             comparison.Only SS[11:0] are compared  */
#define RTC_ALARMSUBSECONDMASK_SS14_13                                         \
    ((uint32_t)(RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_2 |                \
                RTC_ALRMASSR_MASKSS_3)) /*!< SS[14:13] are don't care in Alarm \
                                             comparison. Only SS[12:0] are compared */
#define RTC_ALARMSUBSECONDMASK_SS14                                        \
    ((uint32_t)(RTC_ALRMASSR_MASKSS_1 | RTC_ALRMASSR_MASKSS_2 |            \
                RTC_ALRMASSR_MASKSS_3)) /*!< SS[14] is don't care in Alarm \
                                             comparison.Only SS[13:0] are compared  */
#define RTC_ALARMSUBSECONDMASK_NONE                               \
    RTC_ALRMASSR_MASKSS /*!< SS[14:0] are compared and must match \
                             to activate alarm. */
/**
 * @}
 */
...
#define __HAL_RTC_IS_CALENDAR_INITIALIZED(__HANDLE__) \
    ((((RTC->ISR) & (RTC_ISR_INITS)) == RTC_ISR_INITS) ? 1U : 0U)
...
#define RTC_TR_RESERVED_MASK                                                              \
    ((uint32_t)(RTC_TR_PM | RTC_TR_HT | RTC_TR_HU | RTC_TR_MNT | RTC_TR_MNU | RTC_TR_ST | \
                RTC_TR_SU))
#define RTC_DR_RESERVED_MASK \
    ((uint32_t)(RTC_DR_YT | RTC_DR_YU | RTC_DR_WDU | RTC_DR_MT | RTC_DR_MU | RTC_DR_DT | RTC_DR_DU))
...
#define IS_RTC_DAYLIGHT_SAVING(SAVE)                                                 \
    (((SAVE) == RTC_DAYLIGHTSAVING_SUB1H) || ((SAVE) == RTC_DAYLIGHTSAVING_ADD1H) || \
...
#define IS_RTC_WEEKDAY(WEEKDAY)                                                     \
    (((WEEKDAY) == RTC_WEEKDAY_MONDAY) || ((WEEKDAY) == RTC_WEEKDAY_TUESDAY) ||     \
     ((WEEKDAY) == RTC_WEEKDAY_WEDNESDAY) || ((WEEKDAY) == RTC_WEEKDAY_THURSDAY) || \
     ((WEEKDAY) == RTC_WEEKDAY_FRIDAY) || ((WEEKDAY) == RTC_WEEKDAY_SATURDAY) ||    \
...
#define IS_RTC_ALARM_SUB_SECOND_MASK(MASK)                                                       \
    (((MASK) == RTC_ALARMSUBSECONDMASK_ALL) || ((MASK) == RTC_ALARMSUBSECONDMASK_SS14_1) ||      \
     ((MASK) == RTC_ALARMSUBSECONDMASK_SS14_2) || ((MASK) == RTC_ALARMSUBSECONDMASK_SS14_3) ||   \
     ((MASK) == RTC_ALARMSUBSECONDMASK_SS14_4) || ((MASK) == RTC_ALARMSUBSECONDMASK_SS14_5) ||   \
     ((MASK) == RTC_ALARMSUBSECONDMASK_SS14_6) || ((MASK) == RTC_ALARMSUBSECONDMASK_SS14_7) ||   \
     ((MASK) == RTC_ALARMSUBSECONDMASK_SS14_8) || ((MASK) == RTC_ALARMSUBSECONDMASK_SS14_9) ||   \
     ((MASK) == RTC_ALARMSUBSECONDMASK_SS14_10) || ((MASK) == RTC_ALARMSUBSECONDMASK_SS14_11) || \
     ((MASK) == RTC_ALARMSUBSECONDMASK_SS14_12) || ((MASK) == RTC_ALARMSUBSECONDMASK_SS14_13) || \
