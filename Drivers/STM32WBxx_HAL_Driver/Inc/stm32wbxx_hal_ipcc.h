...
typedef enum {
    ...
    IPCC_CHANNEL_STATUS_OCCUPIED =
        0x01U /*!< An MCU has posted a msg the other MCU hasn't retrieved */
...
typedef struct __IPCC_HandleTypeDef {
    ...
    void (*ChannelCallbackRx[IPCC_CHANNEL_NUMBER])(
        struct __IPCC_HandleTypeDef* hipcc, uint32_t ChannelIndex,
        IPCC_CHANNELDirTypeDef ChannelDir); /*!< Rx Callback registration table */
    void (*ChannelCallbackTx[IPCC_CHANNEL_NUMBER])(
        struct __IPCC_HandleTypeDef* hipcc, uint32_t ChannelIndex,
        IPCC_CHANNELDirTypeDef ChannelDir); /*!< Tx Callback registration table */
 ...
 */
typedef void ChannelCb(IPCC_HandleTypeDef* hipcc, uint32_t ChannelIndex,
...
void HAL_IPCC_TxCallback(IPCC_HandleTypeDef* hipcc, uint32_t ChannelIndex,
                         IPCC_CHANNELDirTypeDef ChannelDir);
void HAL_IPCC_RxCallback(IPCC_HandleTypeDef* hipcc, uint32_t ChannelIndex,
                         IPCC_CHANNELDirTypeDef ChannelDir);
/**
 * @}
 */
