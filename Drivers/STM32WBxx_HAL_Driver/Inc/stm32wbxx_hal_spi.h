 ...
 * @param  __BIT__ specifies the SPI MSB LSB transmission (whether data transfer starts from MSB or
 * LSB bit). This parameter can be a value of @ref SPI_MSB_LSB_transmission
 * @retval None
 */
