...
typedef struct {
    ...
    uint32_t
        NSS; /*!< Specifies whether the NSS signal is managed by hardware (NSS pin) or by software
                using the SSI bit. This parameter can be a value of @ref SPI_LL_EC_NSS_MODE.

                  This feature can be modified afterwards using unitary function @ref
                LL_SPI_SetNSSMode().*/

    uint32_t BaudRate; /*!< Specifies the BaudRate prescaler value which will be used to configure
                          the transmit and receive SCK clock. This parameter can be a value of @ref
                          SPI_LL_EC_BAUDRATEPRESCALER.
                            @note The communication clock is derived from the master clock. The
                          slave clock does not need to be set.
...
#    define LL_SPI_DATAWIDTH_14BIT \
        (SPI_CR2_DS_3 | SPI_CR2_DS_2 | SPI_CR2_DS_0) /*!< Data length for SPI transfer: 14 bits */
#    define LL_SPI_DATAWIDTH_15BIT \
        (SPI_CR2_DS_3 | SPI_CR2_DS_2 | SPI_CR2_DS_1) /*!< Data length for SPI transfer: 15 bits */
...
#    define LL_SPI_RX_FIFO_TH_HALF                                                             \
        0x00000000U /*!< RXNE event is generated if FIFO level is greater than or equal to 1/2 \
                       (16-bit) */
#    define LL_SPI_RX_FIFO_TH_QUARTER                                                              \
        (SPI_CR2_FRXTH) /*!< RXNE event is generated if FIFO level is greater than or equal to 1/4 \
                           (8-bit)  */
/**
 * @}
 */
 ...
 * @note   These bits should not be changed when communication is ongoing. SPI BaudRate =
 * fPCLK/Prescaler.
 ...
 * @note   This bit should not be changed when communication is ongoing. This bit is not used in SPI
 * TI mode.
 ...
 *         In master mode, the MOSI pin is used and in slave mode, the MISO pin is used for
 * Half-Duplex.
