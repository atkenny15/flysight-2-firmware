...
#    define __STM32WBxx_HAL_VERSION                                                      \
        ((__STM32WBxx_HAL_VERSION_MAIN << 24U) | (__STM32WBxx_HAL_VERSION_SUB1 << 16U) | \
         (__STM32WBxx_HAL_VERSION_SUB2 << 8U) | (__STM32WBxx_HAL_VERSION_RC))
 ...
 *          This parameter can be one of the following values:
 *            @arg @ref SYSCFG_VREFBUF_HIGH_IMPEDANCE_DISABLE : VREF+ pin is internally connect to
 * VREFINT output.
