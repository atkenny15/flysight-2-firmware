...
static HAL_StatusTypeDef HAL_PCD_EP_DB_Transmit(PCD_HandleTypeDef* hpcd, PCD_EPTypeDef* ep,
                                                uint16_t wEPVal);
 ...
 *         USB PCD Data OUT Stage Callback is redirected to the weak HAL_PCD_DataOutStageCallback()
 * predefined callback
 * @param  hpcd PCD handle
 * @retval HAL status
 */
 ...
 *         USB PCD Data OUT Stage Callback is redirected to the weak HAL_PCD_DataInStageCallback()
 * predefined callback
 * @param  hpcd PCD handle
 * @retval HAL status
 */
