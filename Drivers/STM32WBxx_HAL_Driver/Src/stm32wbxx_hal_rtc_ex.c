...
#        define RTC_TAMPCR_MASK                                                 \
            ((uint32_t)RTC_TAMPCR_TAMPTS | (uint32_t)RTC_TAMPCR_TAMPFREQ |      \
             (uint32_t)RTC_TAMPCR_TAMPFLT | (uint32_t)RTC_TAMPCR_TAMPPRCH |     \
             (uint32_t)RTC_TAMPCR_TAMPPUDIS | (uint32_t)RTC_TAMPCR_TAMPIE |     \
             (uint32_t)RTC_TAMPCR_TAMP1IE | (uint32_t)RTC_TAMPCR_TAMP1NOERASE | \
             (uint32_t)RTC_TAMPCR_TAMP1MF | (uint32_t)RTC_TAMPCR_TAMP2IE |      \
             (uint32_t)RTC_TAMPCR_TAMP2NOERASE | (uint32_t)RTC_TAMPCR_TAMP2MF | \
             (uint32_t)RTC_TAMPCR_TAMP3IE | (uint32_t)RTC_TAMPCR_TAMP3NOERASE | \
...
#        define RTC_TAMPCR_MASK                                                 \
            ((uint32_t)RTC_TAMPCR_TAMPTS | (uint32_t)RTC_TAMPCR_TAMPFREQ |      \
             (uint32_t)RTC_TAMPCR_TAMPFLT | (uint32_t)RTC_TAMPCR_TAMPPRCH |     \
             (uint32_t)RTC_TAMPCR_TAMPPUDIS | (uint32_t)RTC_TAMPCR_TAMPIE |     \
             (uint32_t)RTC_TAMPCR_TAMP2IE | (uint32_t)RTC_TAMPCR_TAMP2NOERASE | \
             (uint32_t)RTC_TAMPCR_TAMP2MF | (uint32_t)RTC_TAMPCR_TAMP3IE |      \
             (uint32_t)RTC_TAMPCR_TAMP3NOERASE | (uint32_t)RTC_TAMPCR_TAMP3MF)
#    else
#        define RTC_TAMPCR_MASK                                                 \
            ((uint32_t)RTC_TAMPCR_TAMPTS | (uint32_t)RTC_TAMPCR_TAMPFREQ |      \
             (uint32_t)RTC_TAMPCR_TAMPFLT | (uint32_t)RTC_TAMPCR_TAMPPRCH |     \
...
#    endif /* RTC_TAMPER3_SUPPORT */
    ...
    tmpreg = (uint32_t)((uint32_t)sTamper->Tamper | (uint32_t)sTamper->Trigger |
                        (uint32_t)sTamper->NoErase | (uint32_t)sTamper->MaskFlag |
    ...
    hrtc->Instance->TAMPCR &= (uint32_t) ~((uint32_t)sTamper->Tamper |
                                           (uint32_t)(sTamper->Tamper << 1) | RTC_TAMPCR_MASK);
...
#    endif /* RTC_TAMPER3_SUPPORT */
    ...
    /* Configure the RTC_TAMPCR register */
    tmpreg =
        (uint32_t)((uint32_t)sTamper->Tamper | (uint32_t)sTamper->Interrupt |
                   (uint32_t)sTamper->Trigger | (uint32_t)sTamper->NoErase |
                   (uint32_t)sTamper->MaskFlag | (uint32_t)sTamper->Filter |
...
HAL_StatusTypeDef HAL_RTCEx_SetSmoothCalib(RTC_HandleTypeDef* hrtc, uint32_t SmoothCalibPeriod,
    ...
    hrtc->Instance->CALR =
        (uint32_t)((uint32_t)SmoothCalibPeriod | (uint32_t)SmoothCalibPlusPulses |
                   (uint32_t)SmoothCalibMinusPulsesValue);
