...
#        if defined(ADC_SUPPORT_2_5_MSPS)
    if (READ_BIT(ADCx->CR, (ADC_CR_ADSTP | ADC_CR_ADSTART | ADC_CR_ADDIS | ADC_CR_ADEN)) == 0UL)
#        else
    if (READ_BIT(ADCx->CR, (ADC_CR_JADSTP | ADC_CR_ADSTP | ADC_CR_JADSTART | ADC_CR_ADSTART |
...
#        endif /* ADC_SUPPORT_2_5_MSPS */
    {
        ...
        /* Reset register IER */
        CLEAR_BIT(ADCx->IER,
                  (LL_ADC_IT_ADRDY | LL_ADC_IT_EOC | LL_ADC_IT_EOS | LL_ADC_IT_OVR | LL_ADC_IT_EOSMP
#        if !defined(ADC_SUPPORT_2_5_MSPS)
                   | LL_ADC_IT_JEOC | LL_ADC_IT_JEOS | LL_ADC_IT_JQOVF
#        endif /* !ADC_SUPPORT_2_5_MSPS */
...
#        endif /* ADC_SUPPORT_2_5_MSPS */
        ...
        SET_BIT(ADCx->ISR, (LL_ADC_FLAG_ADRDY | LL_ADC_FLAG_EOC | LL_ADC_FLAG_EOS |
                            LL_ADC_FLAG_OVR | LL_ADC_FLAG_EOSMP
#        if !defined(ADC_SUPPORT_2_5_MSPS)
...
#        if defined(ADC_SUPPORT_2_5_MSPS)
        ...
        /*       level.                                                           */
        CLEAR_BIT(ADCx->CFGR2, (ADC_CFGR2_CKMODE | ADC_CFGR2_LFTRIG));
...
#        else
        ...
        CLEAR_BIT(ADCx->SMPR1, (ADC_SMPR1_SMP9 | ADC_SMPR1_SMP8 | ADC_SMPR1_SMP7 | ADC_SMPR1_SMP6 |
        ...
        /* Reset register JSQR */
        CLEAR_BIT(ADCx->JSQR, (ADC_JSQR_JL | ADC_JSQR_JEXTSEL | ADC_JSQR_JEXTEN | ADC_JSQR_JSQ4 |
                               ADC_JSQR_JSQ3 | ADC_JSQR_JSQ2 | ADC_JSQR_JSQ1));
...
#        if defined(ADC_SUPPORT_2_5_MSPS)
        MODIFY_REG(ADCx->CFGR1, ADC_CFGR1_RES | ADC_CFGR1_ALIGN | ADC_CFGR1_WAIT | ADC_CFGR1_AUTOFF,
