...
void hci_user_evt_proc(void) {
     ...
     * a "blocking" mode hci_user_evt_proc() as long as events are received without giving the
     ...
     * is made to call again hci_user_evt_proc(). This gives the opportunity to the application to
...
static void TlEvtReceived(TL_EvtPacket_t* hcievt) {
    if (((hcievt->evtserial.evt.evtcode) == TL_BLEEVT_CS_OPCODE) ||
        ...
        hci_notify_asynch_evt((void*)&HciAsynchEventQueue); /**< Notify the application a full HCI
