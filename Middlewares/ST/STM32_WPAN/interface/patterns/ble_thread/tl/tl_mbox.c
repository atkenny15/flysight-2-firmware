...
int32_t TL_BLE_SendAclData(uint8_t* buffer, uint16_t size) {
    ...
    ((TL_AclDataPacket_t*)(TL_RefTable.p_ble_table->phci_acl_data_buffer))->AclDataSerial.type =
...
void TL_OT_SendCmd(void) {
    ((TL_CmdPacket_t*)(TL_RefTable.p_thread_table->otcmdrsp_buffer))->cmdserial.type =
        TL_OTCMD_PKT_TYPE;
...
void TL_CLI_SendCmd(void) {
    ((TL_CmdPacket_t*)(TL_RefTable.p_thread_table->clicmdrsp_buffer))->cmdserial.type =
        TL_CLICMD_PKT_TYPE;
...
void TL_THREAD_SendAck(void) {
    ((TL_CmdPacket_t*)(TL_RefTable.p_thread_table->notack_buffer))->cmdserial.type =
        TL_OTACK_PKT_TYPE;
...
void TL_LLDTESTS_SendCliCmd(void) {
    ((TL_CmdPacket_t*)(TL_RefTable.p_lld_tests_table->clicmdrsp_buffer))->cmdserial.type =
        TL_CLICMD_PKT_TYPE;
...
void TL_BLE_LLD_SendCliCmd(void) {
    ((TL_CmdPacket_t*)(TL_RefTable.p_ble_lld_table->cmdrsp_buffer))->cmdserial.type =
        TL_CLICMD_PKT_TYPE;
...
void TL_MAC_802_15_4_SendCmd(void) {
    ((TL_CmdPacket_t*)(TL_RefTable.p_mac_802_15_4_table->p_cmdrsp_buffer))->cmdserial.type =
        TL_OTCMD_PKT_TYPE;
...
void TL_MAC_802_15_4_SendAck(void) {
    ((TL_CmdPacket_t*)(TL_RefTable.p_mac_802_15_4_table->p_notack_buffer))->cmdserial.type =
        TL_OTACK_PKT_TYPE;
...
void HW_IPCC_MAC_802_15_4_CmdEvtNot(void) {
    TL_MAC_802_15_4_CmdEvtReceived(
        (TL_EvtPacket_t*)(TL_RefTable.p_mac_802_15_4_table->p_cmdrsp_buffer));

    return;
}

void HW_IPCC_MAC_802_15_4_EvtNot(void) {
    TL_MAC_802_15_4_NotReceived(
        (TL_EvtPacket_t*)(TL_RefTable.p_mac_802_15_4_table->p_notack_buffer));
...
void TL_ZIGBEE_SendM4RequestToM0(void) {
    ((TL_CmdPacket_t*)(TL_RefTable.p_zigbee_table->appliCmdM4toM0_buffer))->cmdserial.type =
        TL_OTCMD_PKT_TYPE;
...
void TL_ZIGBEE_SendM4AckToM0Notify(void) {
    ((TL_CmdPacket_t*)(TL_RefTable.p_zigbee_table->notifM0toM4_buffer))->cmdserial.type =
        TL_OTACK_PKT_TYPE;
...
void HW_IPCC_ZIGBEE_RecvM0RequestToM4(void) {
    TL_ZIGBEE_M0RequestReceived(
        (TL_EvtPacket_t*)(TL_RefTable.p_zigbee_table->requestM0toM4_buffer));
...
void TL_ZIGBEE_SendM4AckToM0Request(void) {
    ((TL_CmdPacket_t*)(TL_RefTable.p_zigbee_table->requestM0toM4_buffer))->cmdserial.type =
        TL_OTACK_PKT_TYPE;
...
static void SendFreeBuf(void) {
    ...
    while (FALSE == LST_is_empty(&LocalFreeBufQueue)) {
        ...
        LST_insert_tail((tListNode*)(TL_RefTable.p_mem_manager_table->pevt_free_buffer_queue),
                        p_node);
    }
    ...
    switch (packet_type) {
        case TL_MB_MM_RELEASE_BUFFER:
            ...
            switch (p_evt_packet->evtserial.evt.evtcode) {
                case TL_BLEEVT_CS_OPCODE:
                    ...
                    TL_MM_DBG_MSG(" cmd opcode: 0x%04X",
        ...
        case TL_MB_BLE_CMD:
            ...
            if (p_cmd_packet->cmdserial.cmd.plen != 0) {
                ...
                TL_HCI_CMD_DBG_BUF(p_cmd_packet->cmdserial.cmd.payload,
                                   p_cmd_packet->cmdserial.cmd.plen, "");
            }
            TL_HCI_CMD_DBG_MSG("\r\n");
        ...
        case TL_MB_BLE_CMD_RSP:
            ...
            switch (p_evt_packet->evtserial.evt.evtcode) {
                case TL_BLEEVT_CS_OPCODE:
                    ...
                    TL_HCI_CMD_DBG_MSG(
                        " numhci: 0x%02X",
                        ((TL_CsEvt_t*)(p_evt_packet->evtserial.evt.payload))->numcmd);
                    TL_HCI_CMD_DBG_MSG(
                        " status: 0x%02X",
                        ((TL_CsEvt_t*)(p_evt_packet->evtserial.evt.payload))->status);
                    break;
                ...
                case TL_BLEEVT_CC_OPCODE:
                    ...
                    TL_HCI_CMD_DBG_MSG(
                        " numhci: 0x%02X",
                        ((TL_CcEvt_t*)(p_evt_packet->evtserial.evt.payload))->numcmd);
                    TL_HCI_CMD_DBG_MSG(
                        " status: 0x%02X",
                    ...
                    if ((p_evt_packet->evtserial.evt.plen - 4) != 0) {
                        TL_HCI_CMD_DBG_MSG(" payload:");
                        TL_HCI_CMD_DBG_BUF(
                            &((TL_CcEvt_t*)(p_evt_packet->evtserial.evt.payload))->payload[1],
        ...
        case TL_MB_BLE_ASYNCH_EVT:
            ...
            if (p_evt_packet->evtserial.evt.evtcode != TL_BLEEVT_VS_OPCODE) {
                ...
                if ((p_evt_packet->evtserial.evt.plen) != 0) {
                    ...
                    TL_HCI_EVT_DBG_BUF(p_evt_packet->evtserial.evt.payload,
                                       p_evt_packet->evtserial.evt.plen, "");
                }
            }
            else {
                TL_HCI_EVT_DBG_MSG("ble evt: 0x%02X", p_evt_packet->evtserial.evt.evtcode);
                ...
                if ((p_evt_packet->evtserial.evt.plen - 2) != 0) {
                    TL_HCI_EVT_DBG_MSG(" payload:");
                    TL_HCI_EVT_DBG_BUF(
                        ((TL_AsynchEvt_t*)(p_evt_packet->evtserial.evt.payload))->payload,
        ...
        case TL_MB_SYS_CMD:
            ...
            if (p_cmd_packet->cmdserial.cmd.plen != 0) {
                ...
                TL_SHCI_CMD_DBG_BUF(p_cmd_packet->cmdserial.cmd.payload,
                                    p_cmd_packet->cmdserial.cmd.plen, "");
            }
            TL_SHCI_CMD_DBG_MSG("\r\n");
        ...
        case TL_MB_SYS_ASYNCH_EVT:
            p_evt_packet = (TL_EvtPacket_t*)buffer;
            if (p_evt_packet->evtserial.evt.evtcode != TL_BLEEVT_VS_OPCODE) {
                TL_SHCI_EVT_DBG_MSG("unknown sys evt received: %02X",
                                    p_evt_packet->evtserial.evt.evtcode);
            }
            else {
