 ...
 * @return None
 */
void hci_read_remote_version_information_complete_event(uint8_t Status, uint16_t Connection_Handle,
 ...
 * @return None
 */
void hci_le_connection_update_complete_event(uint8_t Status, uint16_t Connection_Handle,
                                             uint16_t Conn_Interval, uint16_t Conn_Latency,
 ...
 * @return None
 */
void hci_le_read_remote_features_complete_event(uint8_t Status, uint16_t Connection_Handle,
 ...
 * @return None
 */
void hci_le_long_term_key_request_event(uint16_t Connection_Handle, const uint8_t* Random_Number,
 ...
 * @return None
 */
void hci_le_data_length_change_event(uint16_t Connection_Handle, uint16_t MaxTxOctets,
                                     uint16_t MaxTxTime, uint16_t MaxRxOctets, uint16_t MaxRxTime);
 ...
 * @return None
 */
void hci_le_phy_update_complete_event(uint8_t Status, uint16_t Connection_Handle, uint8_t TX_PHY,
                                      uint8_t RX_PHY);
 ...
 * @return None
 */
void hci_le_advertising_set_terminated_event(uint8_t Status, uint8_t Advertising_Handle,
 ...
 * @return None
 */
void hci_le_scan_request_received_event(uint8_t Advertising_Handle, uint8_t Scanner_Address_Type,
 ...
 * @return None
 */
void aci_gap_proc_complete_event(uint8_t Procedure_Code, uint8_t Status, uint8_t Data_Length,
                                 const uint8_t* Data);
 ...
 * @return None
 */
void aci_att_read_by_type_resp_event(uint16_t Connection_Handle, uint8_t Handle_Value_Pair_Length,
                                     uint8_t Data_Length, const uint8_t* Handle_Value_Pair_Data);
 ...
 * @return None
 */
void aci_att_read_blob_resp_event(uint16_t Connection_Handle, uint8_t Event_Data_Length,
                                  const uint8_t* Attribute_Value);
 ...
 * @return None
 */
void aci_att_read_multiple_resp_event(uint16_t Connection_Handle, uint8_t Event_Data_Length,
 ...
 * @return None
 */
void aci_att_prepare_write_resp_event(uint16_t Connection_Handle, uint16_t Attribute_Handle,
 ...
 * @return None
 */
void aci_gatt_indication_event(uint16_t Connection_Handle, uint16_t Attribute_Handle,
                               uint8_t Attribute_Value_Length, const uint8_t* Attribute_Value);
 ...
 * @return None
 */
void aci_gatt_write_permit_req_event(uint16_t Connection_Handle, uint16_t Attribute_Handle,
 ...
 * @return None
 */
void aci_gatt_read_permit_req_event(uint16_t Connection_Handle, uint16_t Attribute_Handle,
                                    uint16_t Offset);
 ...
 * @return None
 */
void aci_gatt_read_multi_permit_req_event(uint16_t Connection_Handle, uint8_t Number_of_Handles,
 ...
 * @return None
 */
void aci_gatt_prepare_write_permit_req_event(uint16_t Connection_Handle, uint16_t Attribute_Handle,
                                             uint16_t Offset, uint8_t Data_Length,
                                             const uint8_t* Data);
 ...
 * @return None
 */
void aci_gatt_eatt_bearer_event(uint8_t Channel_Index, uint8_t EAB_State, uint8_t Status);
 ...
 * @return None
 */
void aci_gatt_mult_notification_event(uint16_t Connection_Handle, uint16_t Offset,
 ...
 * @return None
 */
void aci_gatt_indication_ext_event(uint16_t Connection_Handle, uint16_t Attribute_Handle,
 ...
 * @return None
 */
void aci_gatt_notification_ext_event(uint16_t Connection_Handle, uint16_t Attribute_Handle,
                                     uint16_t Offset, uint16_t Attribute_Value_Length,
                                     const uint8_t* Attribute_Value);
 ...
 * @return None
 */
void aci_l2cap_proc_timeout_event(uint16_t Connection_Handle, uint8_t Data_Length,
                                  const uint8_t* Data);
 ...
 * @return None
 */
void aci_l2cap_connection_update_req_event(uint16_t Connection_Handle, uint8_t Identifier,
 ...
 * @return None
 */
void aci_l2cap_command_reject_event(uint16_t Connection_Handle, uint8_t Identifier, uint16_t Reason,
                                    uint8_t Data_Length, const uint8_t* Data);
 ...
 * @return None
 */
void aci_l2cap_coc_connect_event(uint16_t Connection_Handle, uint16_t SPSM, uint16_t MTU,
 ...
 * @return None
 */
void aci_l2cap_coc_connect_confirm_event(uint16_t Connection_Handle, uint16_t MTU, uint16_t MPS,
 ...
 * @return None
 */
void aci_l2cap_coc_reconf_event(uint16_t Connection_Handle, uint16_t MTU, uint16_t MPS,
                                uint8_t Channel_Number, const uint8_t* Channel_Index_List);
 ...
 * @return None
 */
void aci_l2cap_coc_reconf_confirm_event(uint16_t Connection_Handle, uint16_t Result);
 ...
 * @return None
 */
void aci_l2cap_coc_flow_control_event(uint8_t Channel_Index, uint16_t Credits);
 ...
 * @return None
 */
void aci_l2cap_coc_rx_data_event(uint8_t Channel_Index, uint16_t Length, const uint8_t* Data);
...
void aci_hal_end_of_radio_activity_event(uint8_t Last_State, uint8_t Next_State,
                                         uint32_t Next_State_SysTime, uint8_t Last_State_Slot,
 ...
 * @return None
 */
void aci_hal_fw_error_event(uint8_t FW_Error_Type, uint8_t Data_Length, const uint8_t* Data);
