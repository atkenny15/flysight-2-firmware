...
__WEAK void hci_disconnection_complete_event(uint8_t Status, uint16_t Connection_Handle,
                                             uint8_t Reason) {
}
...
static void hci_disconnection_complete_event_process(const uint8_t* in) {
    ...
    hci_disconnection_complete_event(rp0->Status, rp0->Connection_Handle, rp0->Reason);
}

/* HCI_ENCRYPTION_CHANGE_EVENT callback function */
__WEAK void hci_encryption_change_event(uint8_t Status, uint16_t Connection_Handle,
...
static void hci_encryption_change_event_process(const uint8_t* in) {
    ...
    hci_encryption_change_event(rp0->Status, rp0->Connection_Handle, rp0->Encryption_Enabled);
}
...
static void hci_read_remote_version_information_complete_event_process(const uint8_t* in) {
    ...
    hci_read_remote_version_information_complete_event(
        rp0->Status, rp0->Connection_Handle, rp0->Version, rp0->Manufacturer_Name, rp0->Subversion);
}
...
__WEAK void hci_number_of_completed_packets_event(
    uint8_t Number_of_Handles, const Handle_Packets_Pair_Entry_t* Handle_Packets_Pair_Entry) {
}

/* HCI_NUMBER_OF_COMPLETED_PACKETS_EVENT process function */
static void hci_number_of_completed_packets_event_process(const uint8_t* in) {
    hci_number_of_completed_packets_event_rp0* rp0 = (void*)in;
    hci_number_of_completed_packets_event(rp0->Number_of_Handles, rp0->Handle_Packets_Pair_Entry);
}

/* HCI_ENCRYPTION_KEY_REFRESH_COMPLETE_EVENT callback function */
__WEAK void hci_encryption_key_refresh_complete_event(uint8_t Status, uint16_t Connection_Handle) {
}

/* HCI_ENCRYPTION_KEY_REFRESH_COMPLETE_EVENT process function */
static void hci_encryption_key_refresh_complete_event_process(const uint8_t* in) {
    hci_encryption_key_refresh_complete_event_rp0* rp0 = (void*)in;
    hci_encryption_key_refresh_complete_event(rp0->Status, rp0->Connection_Handle);
}

/* HCI_LE_CONNECTION_COMPLETE_EVENT callback function */
__WEAK void hci_le_connection_complete_event(uint8_t Status, uint16_t Connection_Handle,
...
static void hci_le_connection_complete_event_process(const uint8_t* in) {
    ...
    hci_le_connection_complete_event(rp0->Status, rp0->Connection_Handle, rp0->Role,
                                     rp0->Peer_Address_Type, rp0->Peer_Address, rp0->Conn_Interval,
                                     rp0->Conn_Latency, rp0->Supervision_Timeout,
...
__WEAK void hci_le_connection_update_complete_event(uint8_t Status, uint16_t Connection_Handle,
...
static void hci_le_connection_update_complete_event_process(const uint8_t* in) {
    ...
    hci_le_connection_update_complete_event(rp0->Status, rp0->Connection_Handle, rp0->Conn_Interval,
                                            rp0->Conn_Latency, rp0->Supervision_Timeout);
}

/* HCI_LE_READ_REMOTE_FEATURES_COMPLETE_EVENT callback function */
__WEAK void hci_le_read_remote_features_complete_event(uint8_t Status, uint16_t Connection_Handle,
...
static void hci_le_read_remote_features_complete_event_process(const uint8_t* in) {
    ...
    hci_le_read_remote_features_complete_event(rp0->Status, rp0->Connection_Handle,
                                               rp0->LE_Features);
}
...
static void hci_le_long_term_key_request_event_process(const uint8_t* in) {
    ...
    hci_le_long_term_key_request_event(rp0->Connection_Handle, rp0->Random_Number,
                                       rp0->Encrypted_Diversifier);
}

/* HCI_LE_DATA_LENGTH_CHANGE_EVENT callback function */
__WEAK void hci_le_data_length_change_event(uint16_t Connection_Handle, uint16_t MaxTxOctets,
                                            uint16_t MaxTxTime, uint16_t MaxRxOctets,
                                            uint16_t MaxRxTime) {
}
...
static void hci_le_data_length_change_event_process(const uint8_t* in) {
    ...
    hci_le_data_length_change_event(rp0->Connection_Handle, rp0->MaxTxOctets, rp0->MaxTxTime,
                                    rp0->MaxRxOctets, rp0->MaxRxTime);
}
...
static void hci_le_read_local_p256_public_key_complete_event_process(const uint8_t* in) {
    ...
    hci_le_read_local_p256_public_key_complete_event(rp0->Status, rp0->Local_P256_Public_Key);
}

/* HCI_LE_GENERATE_DHKEY_COMPLETE_EVENT callback function */
__WEAK void hci_le_generate_dhkey_complete_event(uint8_t Status, const uint8_t* DHKey) {
}

/* HCI_LE_GENERATE_DHKEY_COMPLETE_EVENT process function */
static void hci_le_generate_dhkey_complete_event_process(const uint8_t* in) {
    hci_le_generate_dhkey_complete_event_rp0* rp0 = (void*)in;
    hci_le_generate_dhkey_complete_event(rp0->Status, rp0->DHKey);
}

/* HCI_LE_ENHANCED_CONNECTION_COMPLETE_EVENT callback function */
__WEAK void hci_le_enhanced_connection_complete_event(
    uint8_t Status, uint16_t Connection_Handle, uint8_t Role, uint8_t Peer_Address_Type,
    const uint8_t* Peer_Address, const uint8_t* Local_Resolvable_Private_Address,
    const uint8_t* Peer_Resolvable_Private_Address, uint16_t Conn_Interval, uint16_t Conn_Latency,
...
static void hci_le_enhanced_connection_complete_event_process(const uint8_t* in) {
    ...
    hci_le_enhanced_connection_complete_event(
        rp0->Status, rp0->Connection_Handle, rp0->Role, rp0->Peer_Address_Type, rp0->Peer_Address,
        rp0->Local_Resolvable_Private_Address, rp0->Peer_Resolvable_Private_Address,
        rp0->Conn_Interval, rp0->Conn_Latency, rp0->Supervision_Timeout,
        rp0->Central_Clock_Accuracy);
}

/* HCI_LE_DIRECTED_ADVERTISING_REPORT_EVENT callback function */
__WEAK void hci_le_directed_advertising_report_event(
    uint8_t Num_Reports, const Direct_Advertising_Report_t* Direct_Advertising_Report) {
}

/* HCI_LE_DIRECTED_ADVERTISING_REPORT_EVENT process function */
static void hci_le_directed_advertising_report_event_process(const uint8_t* in) {
    hci_le_directed_advertising_report_event_rp0* rp0 = (void*)in;
    hci_le_directed_advertising_report_event(rp0->Num_Reports, rp0->Direct_Advertising_Report);
}

/* HCI_LE_PHY_UPDATE_COMPLETE_EVENT callback function */
__WEAK void hci_le_phy_update_complete_event(uint8_t Status, uint16_t Connection_Handle,
...
static void hci_le_phy_update_complete_event_process(const uint8_t* in) {
    ...
    hci_le_phy_update_complete_event(rp0->Status, rp0->Connection_Handle, rp0->TX_PHY, rp0->RX_PHY);
}

/* HCI_LE_EXTENDED_ADVERTISING_REPORT_EVENT callback function */
__WEAK void hci_le_extended_advertising_report_event(
    uint8_t Num_Reports, uint16_t Event_Type, uint8_t Address_Type, const uint8_t* Address,
    uint8_t Primary_PHY, uint8_t Secondary_PHY, uint8_t Advertising_SID, uint8_t TX_Power,
    uint8_t RSSI, uint16_t Periodic_Adv_Interval, uint8_t Direct_Address_Type,
    const uint8_t* Direct_Address, uint8_t Data_Length, const uint8_t* Data) {
}

/* HCI_LE_EXTENDED_ADVERTISING_REPORT_EVENT process function */
static void hci_le_extended_advertising_report_event_process(const uint8_t* in) {
    hci_le_extended_advertising_report_event_rp0* rp0 = (void*)in;
    hci_le_extended_advertising_report_event(rp0->Num_Reports, rp0->Event_Type, rp0->Address_Type,
                                             rp0->Address, rp0->Primary_PHY, rp0->Secondary_PHY,
                                             rp0->Advertising_SID, rp0->TX_Power, rp0->RSSI,
                                             rp0->Periodic_Adv_Interval, rp0->Direct_Address_Type,
                                             rp0->Direct_Address, rp0->Data_Length, rp0->Data);
}
...
__WEAK void hci_le_advertising_set_terminated_event(uint8_t Status, uint8_t Advertising_Handle,
                                                    uint16_t Connection_Handle,
...
static void hci_le_advertising_set_terminated_event_process(const uint8_t* in) {
    ...
    hci_le_advertising_set_terminated_event(rp0->Status, rp0->Advertising_Handle,
...
static void hci_le_scan_request_received_event_process(const uint8_t* in) {
    ...
    hci_le_scan_request_received_event(rp0->Advertising_Handle, rp0->Scanner_Address_Type,
                                       rp0->Scanner_Address);
}
...
__WEAK void aci_hal_end_of_radio_activity_event(uint8_t Last_State, uint8_t Next_State,
                                                uint32_t Next_State_SysTime,
                                                uint8_t Last_State_Slot, uint8_t Next_State_Slot) {
}

/* ACI_HAL_END_OF_RADIO_ACTIVITY_EVENT process function */
static void aci_hal_end_of_radio_activity_event_process(const uint8_t* in) {
    aci_hal_end_of_radio_activity_event_rp0* rp0 = (void*)in;
    aci_hal_end_of_radio_activity_event(rp0->Last_State, rp0->Next_State, rp0->Next_State_SysTime,
                                        rp0->Last_State_Slot, rp0->Next_State_Slot);
}

/* ACI_HAL_SCAN_REQ_REPORT_EVENT callback function */
__WEAK void aci_hal_scan_req_report_event(uint8_t RSSI, uint8_t Peer_Address_Type,
...
static void aci_hal_scan_req_report_event_process(const uint8_t* in) {
    ...
    aci_hal_scan_req_report_event(rp0->RSSI, rp0->Peer_Address_Type, rp0->Peer_Address);
}

/* ACI_HAL_FW_ERROR_EVENT callback function */
__WEAK void aci_hal_fw_error_event(uint8_t FW_Error_Type, uint8_t Data_Length,
                                   const uint8_t* Data) {
}
...
static void aci_hal_fw_error_event_process(const uint8_t* in) {
    ...
    aci_hal_fw_error_event(rp0->FW_Error_Type, rp0->Data_Length, rp0->Data);
}
...
__WEAK void aci_gap_pairing_complete_event(uint16_t Connection_Handle, uint8_t Status,
                                           uint8_t Reason) {
}
...
static void aci_gap_pairing_complete_event_process(const uint8_t* in) {
    ...
    aci_gap_pairing_complete_event(rp0->Connection_Handle, rp0->Status, rp0->Reason);
}
...
__WEAK void aci_gap_proc_complete_event(uint8_t Procedure_Code, uint8_t Status, uint8_t Data_Length,
                                        const uint8_t* Data) {
}
...
static void aci_gap_proc_complete_event_process(const uint8_t* in) {
    ...
    aci_gap_proc_complete_event(rp0->Procedure_Code, rp0->Status, rp0->Data_Length, rp0->Data);
}
...
static void aci_gap_numeric_comparison_value_event_process(const uint8_t* in) {
    ...
    aci_gap_numeric_comparison_value_event(rp0->Connection_Handle, rp0->Numeric_Value);
}
...
static void aci_gap_keypress_notification_event_process(const uint8_t* in) {
    ...
    aci_gap_keypress_notification_event(rp0->Connection_Handle, rp0->Notification_Type);
}

/* ACI_L2CAP_CONNECTION_UPDATE_RESP_EVENT callback function */
__WEAK void aci_l2cap_connection_update_resp_event(uint16_t Connection_Handle, uint16_t Result) {
}

/* ACI_L2CAP_CONNECTION_UPDATE_RESP_EVENT process function */
static void aci_l2cap_connection_update_resp_event_process(const uint8_t* in) {
    aci_l2cap_connection_update_resp_event_rp0* rp0 = (void*)in;
    aci_l2cap_connection_update_resp_event(rp0->Connection_Handle, rp0->Result);
}

/* ACI_L2CAP_PROC_TIMEOUT_EVENT callback function */
__WEAK void aci_l2cap_proc_timeout_event(uint16_t Connection_Handle, uint8_t Data_Length,
                                         const uint8_t* Data) {
}
...
static void aci_l2cap_proc_timeout_event_process(const uint8_t* in) {
    ...
    aci_l2cap_proc_timeout_event(rp0->Connection_Handle, rp0->Data_Length, rp0->Data);
}

/* ACI_L2CAP_CONNECTION_UPDATE_REQ_EVENT callback function */
__WEAK void aci_l2cap_connection_update_req_event(uint16_t Connection_Handle, uint8_t Identifier,
                                                  uint16_t L2CAP_Length, uint16_t Interval_Min,
...
static void aci_l2cap_connection_update_req_event_process(const uint8_t* in) {
    ...
    aci_l2cap_connection_update_req_event(rp0->Connection_Handle, rp0->Identifier,
                                          rp0->L2CAP_Length, rp0->Interval_Min, rp0->Interval_Max,
                                          rp0->Latency, rp0->Timeout_Multiplier);
}

/* ACI_L2CAP_COMMAND_REJECT_EVENT callback function */
__WEAK void aci_l2cap_command_reject_event(uint16_t Connection_Handle, uint8_t Identifier,
                                           uint16_t Reason, uint8_t Data_Length,
                                           const uint8_t* Data) {
}
...
static void aci_l2cap_command_reject_event_process(const uint8_t* in) {
    ...
    aci_l2cap_command_reject_event(rp0->Connection_Handle, rp0->Identifier, rp0->Reason,
                                   rp0->Data_Length, rp0->Data);
}

/* ACI_L2CAP_COC_CONNECT_EVENT callback function */
__WEAK void aci_l2cap_coc_connect_event(uint16_t Connection_Handle, uint16_t SPSM, uint16_t MTU,
...
static void aci_l2cap_coc_connect_event_process(const uint8_t* in) {
    ...
    aci_l2cap_coc_connect_event(rp0->Connection_Handle, rp0->SPSM, rp0->MTU, rp0->MPS,
                                rp0->Initial_Credits, rp0->Channel_Number);
}

/* ACI_L2CAP_COC_CONNECT_CONFIRM_EVENT callback function */
__WEAK void aci_l2cap_coc_connect_confirm_event(uint16_t Connection_Handle, uint16_t MTU,
                                                uint16_t MPS, uint16_t Initial_Credits,
                                                uint16_t Result, uint8_t Channel_Number,
...
static void aci_l2cap_coc_connect_confirm_event_process(const uint8_t* in) {
    ...
    aci_l2cap_coc_connect_confirm_event(rp0->Connection_Handle, rp0->MTU, rp0->MPS,
                                        rp0->Initial_Credits, rp0->Result, rp0->Channel_Number,
                                        rp0->Channel_Index_List);
}

/* ACI_L2CAP_COC_RECONF_EVENT callback function */
__WEAK void aci_l2cap_coc_reconf_event(uint16_t Connection_Handle, uint16_t MTU, uint16_t MPS,
...
static void aci_l2cap_coc_reconf_event_process(const uint8_t* in) {
    ...
    aci_l2cap_coc_reconf_event(rp0->Connection_Handle, rp0->MTU, rp0->MPS, rp0->Channel_Number,
                               rp0->Channel_Index_List);
}

/* ACI_L2CAP_COC_RECONF_CONFIRM_EVENT callback function */
__WEAK void aci_l2cap_coc_reconf_confirm_event(uint16_t Connection_Handle, uint16_t Result) {
}

/* ACI_L2CAP_COC_RECONF_CONFIRM_EVENT process function */
static void aci_l2cap_coc_reconf_confirm_event_process(const uint8_t* in) {
    aci_l2cap_coc_reconf_confirm_event_rp0* rp0 = (void*)in;
    aci_l2cap_coc_reconf_confirm_event(rp0->Connection_Handle, rp0->Result);
}
...
__WEAK void aci_l2cap_coc_flow_control_event(uint8_t Channel_Index, uint16_t Credits) {
}

/* ACI_L2CAP_COC_FLOW_CONTROL_EVENT process function */
static void aci_l2cap_coc_flow_control_event_process(const uint8_t* in) {
    aci_l2cap_coc_flow_control_event_rp0* rp0 = (void*)in;
    aci_l2cap_coc_flow_control_event(rp0->Channel_Index, rp0->Credits);
}

/* ACI_L2CAP_COC_RX_DATA_EVENT callback function */
__WEAK void aci_l2cap_coc_rx_data_event(uint8_t Channel_Index, uint16_t Length,
                                        const uint8_t* Data) {
}
...
static void aci_l2cap_coc_rx_data_event_process(const uint8_t* in) {
    ...
    aci_l2cap_coc_rx_data_event(rp0->Channel_Index, rp0->Length, rp0->Data);
}
...
__WEAK void aci_gatt_attribute_modified_event(uint16_t Connection_Handle, uint16_t Attr_Handle,
...
static void aci_gatt_attribute_modified_event_process(const uint8_t* in) {
    ...
    aci_gatt_attribute_modified_event(rp0->Connection_Handle, rp0->Attr_Handle, rp0->Offset,
                                      rp0->Attr_Data_Length, rp0->Attr_Data);
}
...
__WEAK void aci_att_exchange_mtu_resp_event(uint16_t Connection_Handle, uint16_t Server_RX_MTU) {
}

/* ACI_ATT_EXCHANGE_MTU_RESP_EVENT process function */
static void aci_att_exchange_mtu_resp_event_process(const uint8_t* in) {
    aci_att_exchange_mtu_resp_event_rp0* rp0 = (void*)in;
    aci_att_exchange_mtu_resp_event(rp0->Connection_Handle, rp0->Server_RX_MTU);
}

/* ACI_ATT_FIND_INFO_RESP_EVENT callback function */
__WEAK void aci_att_find_info_resp_event(uint16_t Connection_Handle, uint8_t Format,
...
static void aci_att_find_info_resp_event_process(const uint8_t* in) {
    ...
    aci_att_find_info_resp_event(rp0->Connection_Handle, rp0->Format, rp0->Event_Data_Length,
                                 rp0->Handle_UUID_Pair);
}

/* ACI_ATT_FIND_BY_TYPE_VALUE_RESP_EVENT callback function */
__WEAK void aci_att_find_by_type_value_resp_event(
    uint16_t Connection_Handle, uint8_t Num_of_Handle_Pair,
...
static void aci_att_find_by_type_value_resp_event_process(const uint8_t* in) {
    ...
    aci_att_find_by_type_value_resp_event(rp0->Connection_Handle, rp0->Num_of_Handle_Pair,
...
static void aci_att_read_by_type_resp_event_process(const uint8_t* in) {
    ...
    aci_att_read_by_type_resp_event(rp0->Connection_Handle, rp0->Handle_Value_Pair_Length,
                                    rp0->Data_Length, rp0->Handle_Value_Pair_Data);
}

/* ACI_ATT_READ_RESP_EVENT callback function */
__WEAK void aci_att_read_resp_event(uint16_t Connection_Handle, uint8_t Event_Data_Length,
...
static void aci_att_read_resp_event_process(const uint8_t* in) {
    ...
    aci_att_read_resp_event(rp0->Connection_Handle, rp0->Event_Data_Length, rp0->Attribute_Value);
}

/* ACI_ATT_READ_BLOB_RESP_EVENT callback function */
__WEAK void aci_att_read_blob_resp_event(uint16_t Connection_Handle, uint8_t Event_Data_Length,
                                         const uint8_t* Attribute_Value) {
}
...
static void aci_att_read_blob_resp_event_process(const uint8_t* in) {
    ...
    aci_att_read_blob_resp_event(rp0->Connection_Handle, rp0->Event_Data_Length,
                                 rp0->Attribute_Value);
}

/* ACI_ATT_READ_MULTIPLE_RESP_EVENT callback function */
__WEAK void aci_att_read_multiple_resp_event(uint16_t Connection_Handle, uint8_t Event_Data_Length,
...
static void aci_att_read_multiple_resp_event_process(const uint8_t* in) {
    ...
    aci_att_read_multiple_resp_event(rp0->Connection_Handle, rp0->Event_Data_Length,
                                     rp0->Set_Of_Values);
}
...
static void aci_att_read_by_group_type_resp_event_process(const uint8_t* in) {
    ...
    aci_att_read_by_group_type_resp_event(rp0->Connection_Handle, rp0->Attribute_Data_Length,
                                          rp0->Data_Length, rp0->Attribute_Data_List);
}

/* ACI_ATT_PREPARE_WRITE_RESP_EVENT callback function */
__WEAK void aci_att_prepare_write_resp_event(uint16_t Connection_Handle, uint16_t Attribute_Handle,
                                             uint16_t Offset, uint8_t Part_Attribute_Value_Length,
...
static void aci_att_prepare_write_resp_event_process(const uint8_t* in) {
    ...
    aci_att_prepare_write_resp_event(rp0->Connection_Handle, rp0->Attribute_Handle, rp0->Offset,
                                     rp0->Part_Attribute_Value_Length, rp0->Part_Attribute_Value);
}
...
__WEAK void aci_gatt_indication_event(uint16_t Connection_Handle, uint16_t Attribute_Handle,
...
static void aci_gatt_indication_event_process(const uint8_t* in) {
    ...
    aci_gatt_indication_event(rp0->Connection_Handle, rp0->Attribute_Handle,
                              rp0->Attribute_Value_Length, rp0->Attribute_Value);
}

/* ACI_GATT_NOTIFICATION_EVENT callback function */
__WEAK void aci_gatt_notification_event(uint16_t Connection_Handle, uint16_t Attribute_Handle,
                                        uint8_t Attribute_Value_Length,
                                        const uint8_t* Attribute_Value) {
}
...
static void aci_gatt_notification_event_process(const uint8_t* in) {
    ...
    aci_gatt_notification_event(rp0->Connection_Handle, rp0->Attribute_Handle,
                                rp0->Attribute_Value_Length, rp0->Attribute_Value);
}

/* ACI_GATT_PROC_COMPLETE_EVENT callback function */
__WEAK void aci_gatt_proc_complete_event(uint16_t Connection_Handle, uint8_t Error_Code) {
}

/* ACI_GATT_PROC_COMPLETE_EVENT process function */
static void aci_gatt_proc_complete_event_process(const uint8_t* in) {
    aci_gatt_proc_complete_event_rp0* rp0 = (void*)in;
    aci_gatt_proc_complete_event(rp0->Connection_Handle, rp0->Error_Code);
}

/* ACI_GATT_ERROR_RESP_EVENT callback function */
__WEAK void aci_gatt_error_resp_event(uint16_t Connection_Handle, uint8_t Req_Opcode,
...
static void aci_gatt_error_resp_event_process(const uint8_t* in) {
    ...
    aci_gatt_error_resp_event(rp0->Connection_Handle, rp0->Req_Opcode, rp0->Attribute_Handle,
                              rp0->Error_Code);
}
...
static void aci_gatt_disc_read_char_by_uuid_resp_event_process(const uint8_t* in) {
    ...
    aci_gatt_disc_read_char_by_uuid_resp_event(rp0->Connection_Handle, rp0->Attribute_Handle,
                                               rp0->Attribute_Value_Length, rp0->Attribute_Value);
}

/* ACI_GATT_WRITE_PERMIT_REQ_EVENT callback function */
__WEAK void aci_gatt_write_permit_req_event(uint16_t Connection_Handle, uint16_t Attribute_Handle,
...
static void aci_gatt_write_permit_req_event_process(const uint8_t* in) {
    ...
    aci_gatt_write_permit_req_event(rp0->Connection_Handle, rp0->Attribute_Handle, rp0->Data_Length,
                                    rp0->Data);
}

/* ACI_GATT_READ_PERMIT_REQ_EVENT callback function */
__WEAK void aci_gatt_read_permit_req_event(uint16_t Connection_Handle, uint16_t Attribute_Handle,
                                           uint16_t Offset) {
}
...
static void aci_gatt_read_permit_req_event_process(const uint8_t* in) {
    ...
    aci_gatt_read_permit_req_event(rp0->Connection_Handle, rp0->Attribute_Handle, rp0->Offset);
}
...
static void aci_gatt_read_multi_permit_req_event_process(const uint8_t* in) {
    ...
    aci_gatt_read_multi_permit_req_event(rp0->Connection_Handle, rp0->Number_of_Handles,
                                         rp0->Handle_Item);
}
...
static void aci_gatt_tx_pool_available_event_process(const uint8_t* in) {
    ...
    aci_gatt_tx_pool_available_event(rp0->Connection_Handle, rp0->Available_Buffers);
}
...
static void aci_gatt_prepare_write_permit_req_event_process(const uint8_t* in) {
    ...
    aci_gatt_prepare_write_permit_req_event(rp0->Connection_Handle, rp0->Attribute_Handle,
                                            rp0->Offset, rp0->Data_Length, rp0->Data);
}

/* ACI_GATT_EATT_BEARER_EVENT callback function */
__WEAK void aci_gatt_eatt_bearer_event(uint8_t Channel_Index, uint8_t EAB_State, uint8_t Status) {
}

/* ACI_GATT_EATT_BEARER_EVENT process function */
static void aci_gatt_eatt_bearer_event_process(const uint8_t* in) {
    aci_gatt_eatt_bearer_event_rp0* rp0 = (void*)in;
    aci_gatt_eatt_bearer_event(rp0->Channel_Index, rp0->EAB_State, rp0->Status);
}

/* ACI_GATT_MULT_NOTIFICATION_EVENT callback function */
__WEAK void aci_gatt_mult_notification_event(uint16_t Connection_Handle, uint16_t Offset,
...
static void aci_gatt_mult_notification_event_process(const uint8_t* in) {
    ...
    aci_gatt_mult_notification_event(rp0->Connection_Handle, rp0->Offset, rp0->Data_Length,
                                     rp0->Data);
}
...
__WEAK void aci_gatt_read_ext_event(uint16_t Connection_Handle, uint16_t Offset,
...
static void aci_gatt_read_ext_event_process(const uint8_t* in) {
    ...
    aci_gatt_read_ext_event(rp0->Connection_Handle, rp0->Offset, rp0->Event_Data_Length,
                            rp0->Attribute_Value);
}

/* ACI_GATT_INDICATION_EXT_EVENT callback function */
__WEAK void aci_gatt_indication_ext_event(uint16_t Connection_Handle, uint16_t Attribute_Handle,
                                          uint16_t Offset, uint16_t Attribute_Value_Length,
                                          const uint8_t* Attribute_Value) {
}
...
static void aci_gatt_indication_ext_event_process(const uint8_t* in) {
    ...
    aci_gatt_indication_ext_event(rp0->Connection_Handle, rp0->Attribute_Handle, rp0->Offset,
                                  rp0->Attribute_Value_Length, rp0->Attribute_Value);
}

/* ACI_GATT_NOTIFICATION_EXT_EVENT callback function */
__WEAK void aci_gatt_notification_ext_event(uint16_t Connection_Handle, uint16_t Attribute_Handle,
                                            uint16_t Offset, uint16_t Attribute_Value_Length,
                                            const uint8_t* Attribute_Value) {
}
...
static void aci_gatt_notification_ext_event_process(const uint8_t* in) {
    ...
    aci_gatt_notification_ext_event(rp0->Connection_Handle, rp0->Attribute_Handle, rp0->Offset,
                                    rp0->Attribute_Value_Length, rp0->Attribute_Value);
}
