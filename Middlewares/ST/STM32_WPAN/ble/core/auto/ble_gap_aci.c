...
tBleStatus aci_gap_set_limited_discoverable(
    ...
    /* var_len_data input */
    {
        ...
        index_input += 1;
        Osal_MemCpy((void*)&cp1->Service_Uuid_List, (const void*)Service_Uuid_List,
                    Service_Uuid_length);
...
tBleStatus aci_gap_start_auto_connection_establish_proc(
    ...
    index_input += 1;
    Osal_MemCpy((void*)&cp0->Peer_Entry, (const void*)Peer_Entry,
...
tBleStatus aci_gap_set_broadcast_mode(uint16_t Advertising_Interval_Min,
    ...
    /* var_len_data input */
    {
        ...
        index_input += 1;
        Osal_MemCpy((void*)&cp1->Peer_Entry, (const void*)Peer_Entry,
                    Num_of_Peer_Entries * (sizeof(Peer_Entry_t)));
        index_input += Num_of_Peer_Entries * (sizeof(Peer_Entry_t));
    }
    Osal_MemSet(&rq, 0, sizeof(rq));
...
tBleStatus aci_gap_get_bonded_devices(uint8_t* Num_of_Addresses,
    ...
    *Num_of_Addresses = resp.Num_of_Addresses;
    Osal_MemCpy((void*)Bonded_Device_Entry, (const void*)resp.Bonded_Device_Entry,
...
tBleStatus aci_gap_add_devices_to_resolving_list(uint8_t Num_of_Resolving_list_Entries,
    ...
    struct hci_request rq;
    uint8_t cmd_buffer[BLE_CMD_MAX_PARAM_LEN];
    aci_gap_add_devices_to_resolving_list_cp0* cp0 =
        (aci_gap_add_devices_to_resolving_list_cp0*)(cmd_buffer);
    ...
    /* var_len_data input */
    {
        Osal_MemCpy((void*)&cp0->Identity_Entry, (const void*)Identity_Entry,
                    Num_of_Resolving_list_Entries * (sizeof(Identity_Entry_t)));
...
tBleStatus aci_gap_add_devices_to_list(uint8_t Num_of_List_Entries, const List_Entry_t* List_Entry,
    ...
    /* var_len_data input */
    {
        Osal_MemCpy((void*)&cp0->List_Entry, (const void*)List_Entry,
                    Num_of_List_Entries * (sizeof(List_Entry_t)));
