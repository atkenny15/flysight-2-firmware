...
#define HCI_COMMAND_PKT_MAX_SIZE (HCI_COMMAND_HDR_SIZE + HCI_COMMAND_MAX_PARAM_LEN)
#define HCI_ACLDATA_PKT_MAX_SIZE (HCI_ACLDATA_HDR_SIZE + HCI_ACLDATA_MAX_DATA_LEN)
#define HCI_EVENT_PKT_MAX_SIZE (HCI_EVENT_HDR_SIZE + HCI_EVENT_MAX_PARAM_LEN)
