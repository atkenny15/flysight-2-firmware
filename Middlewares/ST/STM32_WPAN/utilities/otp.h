 ...
 *        The user shall fill the OTP from the base address to the top of the OTP so that the more
 * recent declaration is returned by the API The OTP manager handles only 64bits parameter | Id    |
 * Parameter | | 8bits | 58bits    | | MSB   |  LSB      |
 *
