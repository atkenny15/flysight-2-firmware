 ...
 * @paramt strFormat string as expected by "printf" function. Used to desrcibe buffer content
 * information.
 ...
 * @note   Indicate the end of the transmission of a DBG_TRACE trace buffer to DBG_TRACE USART. If
 * queue contains new trace data to transmit, start a new transmission.
 * @retval None
 */
static void DbgTrace_TxCpltCallback(void) {
#    if (DBG_TRACE_USE_CIRCULAR_QUEUE != 0)
