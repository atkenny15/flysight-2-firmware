...
**                                                                        **
**  FlySight 2 firmware                                                   **
**  Copyright 2023 Bionic Avionics Inc., Luke Hederman                    **
**                                                                        **
...
// Calculate relative bearing from lat1/lon1 to lat2/lon2 given heading from GPS
// Heading in degrees
int calcDirection(int32_t lat1, int32_t lon1, int32_t lat2, int32_t lon2, int32_t head) {
